...
class TemplateManager
{
	...
	private function checkSettings()
	{
		...
		$cutlistCategories = \SmartCut\Cutlist\Settings\getProductCategories($this->cutlistSettings['product_category']);
	...
	private function deleteExistingTemplates()
	{
		...
		foreach (TEMPLATES as $name => $productData) {
			$args = [
				'post_type' => 'product',
	...
	private function setupProductSettings(\WC_Product $product, $productData)
	{
		...
		$settings = [
			...
			'pricing_strategy' => $productData['pricing_strategy'] ?? 'full_sheet',
