...
include_once 'health-checker.php';
include_once 'template-creator.php';
...
function getGlobalSettings()
{
	...
	if (!is_array($options)) {
		...
		update_option('smartcut_options', $defaults);
		return $defaults;
	}
...
class SettingsManager
{
	...
	public function handleResetSettings()
	{
		...
		update_option('smartcut_options', $this->getDefaultOptions());
