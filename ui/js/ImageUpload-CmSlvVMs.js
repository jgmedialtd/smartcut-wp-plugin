import { d as B, A as L, l as $, r as O, o, c as d, m as v, u as R, b as U, a as u, F as D, f as V, B as A, s as _ } from "./vendor-vue-DcIxm_xE.js";
import { _ as M } from "./Launch-CoGHL0vS.js";
const P = { id: "uploader" }, E = {
  ...
  emits: ["update", "remove"],
  setup(g, { emit: w }) {
    const b = A(() => import("./ObjectViewer-BvG3JkRw.js")), h = _(null), a = _({
      shapeId: "",
      files: [],
      previewUrls: [],
      metadata: []
...
}), Q = /* @__PURE__ */ M(J, [["__scopeId", "data-v-516982a0"]]);
export {
  Q as default
};
