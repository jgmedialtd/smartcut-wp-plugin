import { x as p, d as xe, k as ve, o as s, j as le, p as Se, c as n, t as o, F as B, f as K, b as m, a, s as H, m as Ee, u as h, V as ct, h as Qe, A as Ae, w as pe, n as se, g as G, i as oe, e as ut, P as dt, W as ft, l as gt, H as vt, X as Ke, Y as mt } from "./vendor-vue-D6ZfZC0P.js";
import { S as ht, _ as pt, L as Ze, C as bt, z as kt, D as Ye, M as yt, q as wt, G as Ct, u as $t } from "./EcommerceCalculator-D4REKTU7.js";
import { t as w } from "./i18n-cONG3r0U.js";
import { u as _t, g as Y, S as St } from "./Vanilla-D2h50ts_.js";
import { Icon as xt } from "./index-DQLns-fu.js";
import { _ as Ue } from "./Launch-BnHg2-HI.js";
import { C as Ft, a as Tt } from "./CatalogueSort-DlWNXAIx.js";
const Mt = [
  "material",
  "name",
  "grain",
  ...
  "imageUrl",
  "db_sawId"
], Pt = 5e3, Ne = /* @__PURE__ */ new Map(), Lt = /[-_]\d+(?:_\d+)?x\d+(?:_\d+)?$/;
function Rt(t) {
  if (!t) return t;
  const P = Ne.get(t);
  if (P !== void 0) return P;
  const e = t.replace(Lt, "");
  return Ne.size >= Pt && Ne.clear(), Ne.set(t, e), e;
}
function zt(t) {
  const P = [];
  for (const c of Mt) {
...
const At = { key: 0 }, Nt = {
  ...
  setup(t) {
    ...
    return ve(
      ...
      default: Se(() => [
        !c.value && !b.value && f.value ? (s(), n("div", At, [
          f.value.fullDescription ? (s(), n("p", Nt, o(f.value.fullDescription), 1)) : (s(), n("p", Ut, "No description available for this brand yet.")),
          f.value.urls && f.value.urls.length ? (s(), n("ul", Bt, [
            (s(!0), n(B, null, K(f.value.urls, (k) => (s(), n("li", {
              key: k.url
            }, [
              a("a", {
                href: k.url,
...
}), Kt = /* @__PURE__ */ Ue(Gt, [["__scopeId", "data-v-cc403927"]]), Et = ["onKeydown"], jt = { class: "stock-filter-row__thumb" }, Ht = ["src", "alt"], Wt = { class: "stock-filter-row__material" }, Jt = { class: "stock-filter-row__name" }, Qt = {
  key: 0,
...
}, Ns = { class: "stock-filter-card__footer" }, Us = {
  key: 0,
  class: "stock-filter-card__price"
}, Bs = { class: "price__value" }, Vs = {
  key: 1,
  class: "stock-filter-card__price"
}, qs = {
  key: 0,
  ...
  setup(t, { emit: P }) {
    const e = t, c = P, b = H(!1), f = H(!1), _ = H(!1), L = p(() => e.stock._catalogueKey), $ = p(() => bt(e.stock)), M = p(() => $.value.brand || $.value.variant || $.value.material || ""), S = p(() => e.stock._hasDetailContent === !0), k = p(() => (e.stock.description || "").trim() || void 0), F = p(() => {
      ...
      const d = [], C = /* @__PURE__ */ new Set(), N = (te) => {
        if (te == null) return;
        ...
        if (te == null) return;
        const Q = String(te).trim();
        !Q || T.includes(Q.toLowerCase()) || N(Q);
      };
      ee($.value.variant);
      const $e = O.value && e.group?.weightRange ? `${e.group.weightRange.min}–${e.group.weightRange.max}kg` : e.stock.weight ? `${e.stock.weight}kg` : "";
      return $e && ee($e), d;
    }), D = p(() => {
      const d = [], C = ($.value.material || "").trim(), N = (e.stock.category || "").trim();
      return C && d.push({ kind: "material", label: C }), N && N.toLowerCase() !== C.toLowerCase() && d.push({ kind: "category", label: N }), d;
    });
    function be(d, C) {
    ...
    const we = p(() => e.group?.priceRange ? `${e.formatPrice(e.group.priceRange.min, e.locale)} – ${e.formatPrice(e.group.priceRange.max, e.locale)}` : null), Be = p(() => e.group?.weightRange ? `${e.group.weightRange.min}–${e.group.weightRange.max}kg` : null);
    function Te(d, C) {
      if (C.stopPropagation(), e.filteredOutThicknesses?.has(d)) return;
      const N = e.group?.items.find((T) => T.t === d);
      N && c("toggle-thickness", N, d);
    }
    function Me() {
      ...
      return s(), n(B, null, [
        t.displayMode === "list" ? Qe((s(), n("article", {
          ...
          t.visibleColumns.thickness ? (s(), n("div", ns, [
            O.value ? (s(), n("div", os, [
              (s(!0), n(B, null, K(t.group.thicknesses, (T) => (s(), n("button", {
                key: T,
                type: "button",
          ...
          t.visibleColumns.weight ? (s(), n("div", cs, o(Be.value || (t.stock.weight ? `${t.stock.weight}kg` : "")), 1)) : m("", !0),
          ...
          [N, z.value && t.disabledReason ? t.disabledReason : ""]
        ]) : Qe((s(), n("article", {
          key: 1,
          ...
          a("div", _s, [
            ...
            y.value.length ? (s(), n("div", Fs, [
              (s(!0), n(B, null, K(y.value, (T, ee) => (s(), n("span", {
                key: ee,
                class: "spec-item"
              }, o(T), 1))), 128))
            ])) : m("", !0),
            ...
            D.value.length ? (s(), n("div", Ts, [
              (s(!0), n(B, null, K(D.value, (T) => (s(), n("span", {
                key: T.kind,
                class: G(["c-badge", `spec-badge--${T.kind}`])
              }, o(T.label), 3))), 128))
            ])) : m("", !0),
            Fe.value.length ? (s(), n("div", Ms, [
              (s(!0), n(B, null, K(Fe.value, (T) => (s(), n("span", {
                key: T,
            ...
            U.value || t.stock.sample?.enabled ? (s(), n("div", Rs, [
          ...
          a("div", Ns, [
            O.value && we.value ? (s(), n("div", Us, [
              a("span", Bs, o(we.value), 1)
...
}), Hs = /* @__PURE__ */ Ue(js, [["__scopeId", "data-v-6162d8fe"]]), Ws = { class: "stock-filter-panel" }, Js = { class: "filter-panel-content" }, Qs = {
  key: 0,
    ...
    return (g, u) => (s(), n("div", Ws, [
      a("div", Js, [
        f.value > 0 || t.preAppliedChips.length > 0 ? (s(), n("div", Qs, [
          a("div", Ys, [
            (s(!0), n(B, null, K(t.preAppliedChips, (v) => (s(), n("span", {
              key: `pre:${v.key}`,
            ...
            (s(!0), n(B, null, K(M.value, (v) => (s(), n("span", {
              key: v.key,
        ...
        a("div", nl, [
          (s(!0), n(B, null, K(L.value, (v) => (s(), n("div", {
            key: v.field,
            class: "filter-group"
          }, [
            a("div", ol, [
            ...
            a("div", al, [
              v.type === "select" ? (s(), n("div", rl, [
                a("select", {
                  ...
                  (s(!0), n(B, null, K(F(v), (x) => (s(), n("option", {
                    key: x.value,
                    value: x.value
...
}), yl = /* @__PURE__ */ Ue(kl, [["__scopeId", "data-v-9e7cab3a"]]), wl = { class: "stock-filter-results" }, Cl = { class: "results-header" }, $l = { class: "results-info" }, _l = {
  key: 0,
  class: "results-count"
}, Sl = {
  key: 1,
    ...
    return (f, _) => (s(), n("div", wl, [
      ...
      t.loading ? (s(), le(Ze, {
        ...
        t.displayMode === "list" ? (s(), n("div", {
          ...
          t.visibleColumns.color ? (s(), n("div", Nl, o(h(w)("fields.color")), 1)) : m("", !0),
          t.visibleColumns.thickness ? (s(), n("div", Ul, o(h(w)("fields.t")), 1)) : m("", !0),
          t.visibleColumns.quantity ? (s(), n("div", Bl, o(h(w)("fields.q")), 1)) : m("", !0),
      ...
      t.totalPages > 1 ? (s(), n("div", Gl, [
        ...
        a("div", El, [
          (s(!0), n(B, null, K(b.value, (L) => (s(), n("button", {
            key: L,
            type: "button",
...
}), Jl = /* @__PURE__ */ Ue(Wl, [["__scopeId", "data-v-26b6e10c"]]), Ql = {
  id: "stock-filter",
  ...
  setup(t, { expose: P, emit: e }) {
    ...
    }), { addNotice: Fe } = $t(), ce = ft(St, []), U = H(!1), O = H(1), J = H(/* @__PURE__ */ new Map());
    function he(i, r, l) {
      for (const I of i)
        I.customData = {
          ...I.customData || {},
    ...
    const Z = p(() => c.config.itemsPerPage || 20), ke = p(() => c.serverPagination ? [] : je(ie.value)), ye = p(() => je(z.value)), ge = p(() => {
      if (c.serverPagination && !U.value) return [];
      const i = U.value ? ye.value : ke.value, l = ((U.value ? O.value : de.value) - 1) * Z.value;
      return i.slice(l, l + Z.value);
    }), we = p(() => U.value ? ge.value.flatMap((i) => i.items) : c.serverPagination ? X.value : ge.value.flatMap((i) => i.items)), { groupedStock: Be, getFilteredOutThicknesses: Te } = Dt(we, M), Me = p(() => U.value ? ge.value : c.serverPagination ? Be.value : ge.value);
    function Pe(i) {
    ...
    const Le = p(() => {
      ...
      return i;
    }), Ce = p(() => U.value ? ye.value.length : c.serverPagination ? j.value : ke.value.length), ne = p(() => {
      const i = Ce.value;
      return Math.max(1, Math.ceil(i / Z.value));
    }), Ve = p(() => U.value ? O.value : de.value);
    function d(i) {
      const r = ne.value, l = Math.max(1, Math.min(i, r));
      U.value ? O.value = l : W(l);
    }
    ve(ke, (i) => {
      if (c.serverPagination || U.value) return;
    ...
    const C = p(() => c.loading || me.value), N = H(!1);
    ve(z, (i) => {
      N.value || (ce.value = i.map((r) => Y(r)));
    }, { deep: !0 });
    async function T(i) {
      if (!c.serverPagination) return null;
      const { apiUrl: r, orgSlug: l, isCustomDomain: I } = c.serverPagination, A = I ? `${r}ecommerce/stock` : `${r}ecommerce/${l}/stock`;
      try {
        const V = new URL(A);
    ...
    async function ee() {
      if (ce.value.length) {
        ...
        try {
          ...
          for (const A of i) {
            let V = c.stockOptions.find((q) => Y(q) === A);
            !V && c.serverPagination && (V = await T(A)), V && (r.push(A), l.push(V));
          }
          ...
          for (const A of l) {
            ...
            if (!u(A)) {
              g(A);
              const q = R(A);
              qe([q], A), J.value.set(V, [q]), he([q], V, A);
            }
          }
        } finally {
          N.value = !1;
    ...
    return P({
      ...
      t.debug ? (s(), n("div", Yl, [
        ...
        a("div", sn, [
          ...
          (s(!0), n(B, null, K(J.value, ([l, I]) => (s(), n("div", {
            key: l,
            style: { margin: "4px 0", padding: "4px", background: "#2a2a4e", "border-radius": "2px" }
          }, [
            a("div", null, [
      ...
      Ee(Jl, {
        ...
        default: Se(() => [
          (s(!0), n(B, null, K(Me.value, (l) => (s(), le(Hs, {
            key: l.groupKey,
          ...
          c.showSelectionBar && h(z).length > 0 ? (s(), n("div", an, [
            a("div", rn, [
              ...
              a("button", {
                type: "button",
                class: "c-btn c-btn--sm",
                onClick: r[4] || (r[4] = (l) => U.value = !U.value)
