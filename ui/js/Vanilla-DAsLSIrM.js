...
import { I as _e, i as He, f as c, a as U, b as $ } from "./result.zod-BdTA-p3B.js";
import { c as Ae, E as Je, m as Qe } from "./EcommerceCalculator-Cp9dpABY.js";
import { o as H, h as R, i as u, j as te, k as we, u as Ge, l as Se, m as N, n as Y, q, t as ke } from "./vendor-BwVe8GCL.js";
import { _ as Ke } from "./Launch-CPiAvAe9.js";
function W(_) {
...
const ot = {
  ...
  setup(_, { expose: P, emit: y }) {
    const S = ne(() => import("./StockFilter-gUhWMJXp.js")), B = ne(() => import("./FormulaPricing-Dh472dwc.js")), k = ne(() => import("./ProductBrowser-BIL3ihJj.js")), g = ne(() => import("./Notices-DzzU2HPd.js")), m = ne(() => import("./OrderLookup-B00pRT8G.js")), p = y, w = "production", ie = "4.1.7", v = s(!1), d = s([]), f = s({
      banding: null,
      finish: null,
      planing: null,
      machining: null
