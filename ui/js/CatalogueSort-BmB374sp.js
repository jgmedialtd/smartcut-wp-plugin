import { d as v, s as g, k, o as r, c as l, a as c, h as w, D as y, N as C, b as S, t as b, u as p, F as x, f as O, g as V, x as B } from "./vendor-vue-DcIxm_xE.js";
import { t as e } from "./i18n-BsG8Q9fA.js";
import { _ as f } from "./Launch-CoGHL0vS.js";
const F = { class: "stock-filter-search" }, L = { class: "c-field-action search-input-wrapper" }, M = ["placeholder"], $ = /* @__PURE__ */ v({
...
}), j = /* @__PURE__ */ f($, [["__scopeId", "data-v-9db627d9"]]), D = { class: "stock-filter-sort" }, K = { class: "c-field-action sort-controls" }, N = { class: "sort-label" }, H = ["value"], I = ["value"], P = ["title"], U = {
  width: "14",
  height: "14",
  viewBox: "0 0 16 16",
  fill: "currentColor"
  ...
  setup(o, { emit: h }) {
    ...
    return (t, i) => (r(), l("div", D, [
      c("div", K, [
        c("label", N, b(p(e)("stockFilter.sort_by")) + ":", 1),
        c("select", {
          value: o.sortBy,
          class: "sort-select",
          onChange: m
        ...
        c("button", {
          ...
          (r(), l("svg", U, [
            o.sortOrder === "asc" ? (r(), l("path", Z)) : (r(), l("path", z))
          ]))
        ], 10, P)
      ])
    ]));
