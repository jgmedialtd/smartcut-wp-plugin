import { d as B, o as l, c as d, a as o, t as e, u as t, w as I, h as b, E as L, b as n, i as h, g as V, F as y, f as C, s as m } from "./vendor-vue-CrNGqS0k.js";
import { t as s } from "./i18n-DGE8ywV5.js";
import { _ as A } from "./Launch-9LoYYNsk.js";
const F = { class: "order-lookup" }, M = { class: "order-lookup__header" }, O = { class: "order-lookup__title" }, $ = { class: "order-lookup__subtitle" }, q = { class: "order-lookup__field" }, E = {
  for: "orderId",
  class: "order-lookup__label"
}, N = ["placeholder"], T = { class: "order-lookup__field" }, j = {
  for: "postalCode",
  class: "order-lookup__label"
}, z = ["placeholder"], R = {
  key: 0,
  ...
  key: 1,
  class: "order-lookup__section"
}, ko = { class: "order-lookup__section-title" }, ho = { class: "order-lookup__items" }, vo = { class: "order-lookup__item-header" }, fo = { class: "order-lookup__item-number" }, mo = { class: "order-lookup__item-parts" }, go = {
  key: 0,
...
}, Do = { class: "order-lookup__price-row order-lookup__price-row--total" }, So = /* @__PURE__ */ B({
  __name: "OrderLookup",
  props: {
    apiBaseUrl: {},
    orgSlug: {},
  ...
  setup(g) {
    ...
    return (i, a) => (l(), d("div", F, [
      ...
      r.value ? n("", !0) : (l(), d("form", {
        ...
        o("div", T, [
          o("label", j, e(t(s)("orderLookup.postalCode")), 1),
          b(o("input", {
            id: "postalCode",
        ...
        c.value ? (l(), d("div", R, e(c.value), 1)) : n("", !0),
        o("button", {
          type: "submit",
          class: "c-btn c-btn--primary",
          disabled: f.value || !p.value || !_.value
        }, [
          f.value ? (l(), d("span", H)) : n("", !0),
          h(" " + e(f.value ? t(s)("general.loading") : t(s)("orderLookup.search")), 1)
        ], 8, G)
      ], 32)),
      r.value ? (l(), d("div", J, [
        o("div", K, [
        ...
        o("div", Q, [
          ...
          r.value.shipping?.address ? (l(), d("div", to, [
            ...
            r.value.shipping.method ? (l(), d("div", io, [
              o("span", po, e(t(s)("orderLookup.shippingMethod")) + ":", 1),
              o("span", _o, e(r.value.shipping.method), 1)
            ])) : n("", !0)
          ])) : n("", !0),
          r.value.items && r.value.items.length > 0 ? (l(), d("div", co, [
            o("h4", ko, e(t(s)("orderLookup.items")) + " (" + e(r.value.items.length) + ")", 1),
            o("div", ho, [
              (l(!0), d(y, null, C(r.value.items, (u, x) => (l(), d("div", {
                key: u.id,
                class: "order-lookup__item"
              }, [
                o("div", vo, [
                  o("span", fo, e(t(s)("orderLookup.item")) + " " + e(x + 1), 1),
                  o("span", mo, e(u.partsCount) + " " + e(t(s)("orderLookup.parts")), 1)
                ]),
                u.result?.stock && u.result.stock.length > 0 ? (l(), d("div", go, [
                  (l(!0), d(y, null, C(u.result.stock, (k) => (l(), d("div", {
                    key: k.id,
                    class: "order-lookup__stock-line"
                  }, e(k.q) + "x " + e(k.name || k.material) + " (" + e(k.l) + "×" + e(k.w) + ") ", 1))), 128))
                ])) : n("", !0),
                o("div", bo, e(g.formatPrice(u.pricing.subtotal)), 1),
                u.fileUrls?.pdf ? (l(), d("a", {
                  key: 1,
                  href: u.fileUrls.pdf,
                  target: "_blank",
          ...
          r.value.pdfUrl && !r.value.items?.length ? (l(), d("div", yo, [
            o("a", {
              href: r.value.pdfUrl,
              target: "_blank",
          ...
          o("div", wo, [
            ...
            r.value.pricing.shippingCost ? (l(), d("div", Po, [
...
}), Vo = /* @__PURE__ */ A(So, [["__scopeId", "data-v-a96b0ff6"]]);
export {
  Vo as default
};
