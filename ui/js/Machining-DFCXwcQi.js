...
import { E as Ie, h as Ue, b as Ke } from "./EcommerceCalculator-DIT6YeNX.js";
...
const ct = { class: "inputs" }, ut = {
  ...
  setup(k, { emit: i }) {
    const n = Me(() => import("./ObjectViewer-Cw1RRGKv.js")), e = k, h = i, m = "production", d = P(), o = P(), c = z(() => Ue(s.value)), x = z(() => {
