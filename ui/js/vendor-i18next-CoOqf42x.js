...
const ye = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, Ge = function(r, e) {
  ...
  create(r, e, t, i) {
    ...
    t && (s.expires = /* @__PURE__ */ new Date(), s.expires.setTime(s.expires.getTime() + t * 60 * 1e3)), i && (s.domain = i), document.cookie = Ge(r, e, s);
  },
  read(r) {
...
class ut {
  ...
  init() {
    ...
    this.services = e, this.options = qe(t, this.options || {}, lt()), typeof this.options.convertDetectedLanguage == "string" && this.options.convertDetectedLanguage.indexOf("15897") > -1 && (this.options.convertDetectedLanguage = (s) => s.replace("-", "_")), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = i, this.addDetector(Xe), this.addDetector(et), this.addDetector(it), this.addDetector(st), this.addDetector(nt), this.addDetector(rt), this.addDetector(ot), this.addDetector(at), this.addDetector(tt);
  }
  addDetector(e) {
  ...
  detect() {
    ...
    }), t = t.filter((i) => i != null && !Ze(i)).map((i) => this.options.convertDetectedLanguage(i)), this.services && this.services.languageUtils && this.services.languageUtils.getBestMatchFromCodes ? t : t.length > 0 ? t[0] : null;
  }
  cacheUserLanguage(e) {
