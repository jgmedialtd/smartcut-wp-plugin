import { O as Fe, P as R, Q as _, R as A, T, U as Jt, V as X, W as Re, X as P, Y as U, _ as N, $ as Xe, a0 as $, a1 as se, a2 as re, a3 as G, a4 as Se, a5 as Ie, a6 as j, a7 as ce, a8 as vi, a9 as Ve, aa as at, ab as Ri, ac as ue, ad as We, s as le, ae as $e, af as Z, ag as K, ah as Ue, ai as pe, aj as V, ak as ye, al as xe, am as yt, an as Ai, ao as wt, ap as Zt, aq as Li, ar as ee, as as Te, at as fe, au as Mi, av as me, aw as qi, ax as be, ay as Oi, az as lt, aA as Fi, aB as ei, aC as ti, aD as ii, aE as Gi, aF as _e, aG as Ni, aH as ne, aI as Ge, aJ as si, aK as Bi, aL as Ae, aM as Hi, aN as Wi, aO as Ui, aP as $t, aQ as zi, aR as Ke, aS as Qe, aT as ji, aU as Yi, aV as Xi, N as Ee, S as Le, aW as Vi, aX as Je, aY as Ze, aZ as _i, a_ as Ki, a$ as Qi, b0 as Ji, b1 as W, b2 as Zi, b3 as xt, b4 as es, b5 as we, B as ts, b6 as is, b7 as ze, b8 as je, b9 as ss, ba as v, bb as It, bc as Tt, bd as bt, be as Ct, bf as Pt, bg as kt, bh as Et, I as Dt, F as vt, D as Rt, G as At, A as ns, bi as Lt, bj as Mt, bk as qt, bl as Ot, bm as Ft, bn as Gt, bo as rs } from "./components-r1yHOfcv.js";
import "./vendor-i18n-BuJwRgtG.js";
import { ag as Ne, ah as ni } from "./vendor-4AnxBRif.js";
function os(e) {
  return {
    cutAxis: e === "l" ? "x" : "y",
...
function fs(e, t = !0) {
  ...
  return e.shapes = i, A([
    ...
    () => Jt(e.shapes, "removeGroupsFromSegment")
  ]), e;
}
function ai(e, t) {
...
function pt(e, t, i) {
  ...
  switch (e.cutType) {
    case "efficiency":
      if (t?.saw?.stockType === "roll")
        return ae(J.roll.efficiency(), i);
      break;
    case "beam":
      return ae(J.guillotine.beam(), i);
    case "guillotine": {
      if (t?.saw?.stockType === "roll")
        return ae(J.roll.guillotine(), i);
  ...
  return ae(J[e.cutType].standard(), i);
}
class Ns {
  CLO;
  selectionMethod;
...
function Ks(e, t, i) {
  if (!e || !t || !i) return 0;
  const n = Qs(e, t), a = jt(e), s = jt(t), r = a + s, l = Math.max(n.l * n.w, r), o = Math.min(1, Math.max(0, r / l)), c = Math.min(1, Math.max(
    0,
    Js(e, t, i) || 0
  )), f = o * 0.7 + c * 0.3;
...
function en(e, t, i = null, n = [], a = null) {
  ...
  const w = ie(f) ?? t.cutDirection;
  if (!w) throw new Error("keyDimension is not defined");
  const p = ct(f);
  if (p) {
    const C = ce(Fe(ie(p))), y = Xe(e, p, C);
...
function Xt(e, t) {
  ...
  const i = e.score.totalShapesPlaced === e.score.containerAvailableShapes || t.score.totalShapesPlaced === t.score.containerAvailableShapes, n = e.score.stockAvailableShapes === e.score.totalShapesPlaced, a = t.score.stockAvailableShapes === t.score.totalShapesPlaced, r = (e?.stock?.saw?.cutPreference || t?.stock?.saw?.cutPreference || "l") === "l" ? "w" : "l", l = e?.stock?.l || t?.stock?.l, o = e?.stock?.w || t?.stock?.w, c = e?.stock?.saw?.bladeWidth || t?.stock?.saw?.bladeWidth || 0, f = r === "w" ? o - c : l - c, u = e.firstShape && (r === "w" ? e.firstShape.w > f * 0.5 : e.firstShape.l > f * 0.5), h = t.firstShape && (r === "w" ? t.firstShape.w > f * 0.5 : t.firstShape.l > f * 0.5), d = e.firstShape?.orientationLock && e.firstShape.orientationLock !== r, m = t.firstShape?.orientationLock && t.firstShape.orientationLock !== r, p = ((x, E) => {
    ...
    if (E.firstShape) {
      const Y = Z(E.firstShape, z, null, x?.stock?.saw), te = r === "w" && E.firstShape.w > f * 0.5 || r === "l" && E.firstShape.l > f * 0.5;
      if (Y && !te && O > 1) {
        const he = f * 0.7;
        return H >= he;
      }
  ...
  if (r === "w" ? (q = o - e.score.maxY - (k > 0 ? c : 0), M = o - t.score.maxY - (D > 0 ? c : 0)) : (q = l - e.score.maxX - (k > 0 ? c : 0), M = l - t.score.maxX - (D > 0 ? c : 0)), k > 0 || D > 0) {
    ...
    if (e.firstShape && (r === "w" && e.firstShape.w > f * 0.5 || r === "l" && e.firstShape.l > f * 0.5)) {
      const te = k > 0 && Z(e.firstShape, z, null, e?.stock?.saw), he = D > 0 && Z(e.firstShape, Y, null, t?.stock?.saw);
      if (te && !he) return -1;
      if (he && !te) return 1;
    }
    if (t.firstShape && (r === "w" && t.firstShape.w > f * 0.5 || r === "l" && t.firstShape.l > f * 0.5)) {
      const te = k > 0 && Z(t.firstShape, z, null, e?.stock?.saw), he = D > 0 && Z(t.firstShape, Y, null, t?.stock?.saw);
      if (te && !he) return -1;
      if (he && !te) return 1;
    }
  }
...
async function De(e, t, i, n = null) {
  if (A([
    () => T(j(t)).to.be.true,
    () => {
      if (i.length) return T(G(i[0]) || ee(i[0])).to.be.true;
    }
...
async function cn(e, t, i, n, a) {
  A([
    ...
    () => {
      if (i.length) return T(G(i[0]) || ee(i[0])).to.be.true;
      if (t.length) return T(G(t[0] || ee(i[0]))).to.be.true;
    }
...
async function un(e, t, i, n, a) {
  ...
  r && n.id === gt(this.bestResult, this.stockList)?.id && s.length - t.length > 0 && ($("guillotine", `runSecondPass added ${s.length - t.length} shape(s) to stock ${n.id}, new total ${s.length}`), r.secondPass = !0, await Q.call(this, r));
}
function rt(e, t) {
  const i = [];
...
async function Oe(e, t, i, n = null, a = null, s = null) {
  ...
  fs(i, !0), A([
    ...
    () => Jt(i.shapes, "segmentCalculations after removeGroupsFromSegment"),
  ...
  if (i.type === "root") {
    ...
    qi(this.shapeList).length > 0, s !== null ? w.type = "allocated strips" : w.type = "basic", await Q.call(this, w);
  }
}
async function ot({
  options: e = null,
  ...
  const r = async (u, h = !0) => {
    ...
    h ? (t.reset(), A([() => T(n.shapes.filter((m) => m.autoId === t.autoId).length, "too many first shapes in segmentShapes").to.equal(1)]), d = oe.call(
      ...
      n,
      t
    ), d.score.totalShapesPlaced && await Q.call(this, d, "strip");
  };
...
async function dn({
  ...
  if (["near", "root"].includes(t.type) && o.l + i.saw.bladeWidth >= t.l && o.w + i.saw.bladeWidth >= t.w) {
    ...
    return await Q.call(this, k, "strip"), { success: !0, firstShapeSegment: o, isHeadCut: c };
  }
  if (r.secondPass) {
  ...
  if (!h || h.l <= 0 || h.w <= 0) {
    ...
    return await Q.call(this, y, "strip"), { success: !0, firstShapeSegment: o, isHeadCut: c };
  }
  ...
  return t.shapes.push(...C), this.config.groups.guillotine.segments && this.config.groups.guillotine.runWithout && S && (this.config.groups.guillotine.segments = !1, t.shapes.filter((y) => y.autoId !== e.autoId && !p.includes(y.autoId)).forEach((y) => y.reset({
    ...
    o,
    e
  ), await Q.call(this, g, "strip")), { success: !0, firstShapeSegment: o, isHeadCut: c };
}
function pn(e, t, i) {
...
async function Ye(e, t, i = !1) {
  ...
  A([
    () => T(t.shapes.every((l) => G(l) || ee(l)), "segment shapes contains groups").to.be.true
  ]);
  let n = [];
  ...
  for (let l = 0; l < r.length; l++) {
    ...
    this.resetShapes(s, {
      removeGroups: !1,
      keepFirstShapeSampleRotations: !0
    }), o.firstShape.isFirstShape = !0, Fi(o) && (t.shapes.find((u) => u.autoId === o.autoId) || t.shapes.push(o), t.shapes = ei(t.shapes, o)), A([
      () => T(X(t.shapes, `segment ${t.id} before running fs tests for ${o.id}`), "duplicates found in segment").to.be.false,
      () => T(X(t.shapes), "duplicates found").to.be.false
    ]), await bi.call(
      this,
      e,
      o,
...
function Sn(e, t) {
  ...
  if (!i.length) return;
  $("guillotine", `All new segments for segment ${e.id}:`, null, i.map((o) => ({ id: o.id, x: o.x, y: o.y, l: o.l, w: o.w, dir: o.cutDirection })));
  ...
  return s.sort((o, c) => o[n] < c[n] ? -1 : o[n] > c[n] ? 1 : o[l] < c[l] ? -1 : o[l] > c[l] ? 1 : 0), s.forEach((o) => {
    const c = e.shapes.filter((u) => !u.added && Z(u, o)), f = /* @__PURE__ */ new Set();
...
async function wn(e, t, i, n) {
  ...
  for (let h = 0; h < r.length; h++) {
    let d = function(L, F, z, Y) {
      return L[F] + L[z] + Y;
    }, m = function(L, F, z, Y, te) {
      return te > 0 ? te - F[z] : L[Y] - F[z];
    };
...
function In(e, t, i, n, a) {
  ...
  return A([
    () => T(l.cutDirection, `segment cut direction ${i.id} is the same as first shape ${e.id}`).to.not.equal(ie(e))
  ]), $("cuts", `FIRST SHAPE SEGMENT [${l?.parent?.type === "root" ? "R" : l.parent.id}]->[${l.autoId}] ${t ? "HEAD" : "NORM"} ${re(l.l, 4)}x${re(l.w, 4)}, SEG DIR ${l.cutDirection.toUpperCase()}, SHAPE DIR ${ie(e).toUpperCase()}`), l;
}
...
function En(e, t) {
  ...
  return e.filter((l) => l.added ? !1 : (ee(l) && l.updateShapeSpacing(t), e.length === 1 || !s ? a(l) : l.l < n && l.w < n ? !1 : a(l)));
}
...
const ge = {
  async calculation(e, t, i) {
    if (e?.tidy && (this.resetShapes(K(i, t)), this.tidyStrategy = !0), await ge.tryFirstShapes.call(this, t, i), !!this.bestResult && (this.tidyStrategy = !1, !e?.tidy && Rn.call(this, this.bestResult, t))) {
      ...
      try {
        ...
        if (!a) return;
        await Q.call(this, a.result), delete t.algoBenchmark;
      } catch (n) {
  ...
  calculateFirstShapeRotations: async function(e, t, i) {
    ...
    for (const a of n) {
      ...
      ne(s.score) && await Q.call(this, s);
    }
  },
  /**
  ...
  linear: async function(e, t, i) {
    ...
    n && t && (Wi(n, t, i), n.stock = t, await Q.call(this, n));
  }
};
async function Dn({
  shapeOrGroup: e,
...
async function Pi(e, t, i = null, n = null, a = {}, s = null) {
  ...
  const r = ne(i) ? i : 0;
  me(e, r, t) && Z(e, t, r) && (fe(e, r, t), s && (a[s] = r), await n.call(this, a));
  const l = 1;
  i === null && !e.isSquare && me(e, l, t) && Z(e, t, l) && (fe(e, l, t), s && (a[s] = l), await n.call(this, a));
}
      ...
      if (y.added && !o.has(y.autoId) && (r.push(y), o.add(y.autoId)), A([
        ...
        if (!D) {
          ...
          if (R(y)) {
            ...
            y.destroy();
          } else (G(y) || ee(y)) && ($("info", `not all shapes cut, resetting shape ${y.id}`), y.reset());
  ...
  for (const s of e) {
    ...
    try {
      ...
      o && c.length ? c.forEach((f) => {
        ...
        n.push(new Je(d)), Array.isArray(s.stockLock) ? s.stockLock.push(d.parentId) : s.stockLock = [d.parentId];
      }) : a.push({
        material: o.name,
        t: s.t,
        shape: s.parentId
...
class Qt extends Ki {
  ...
  async run() {
    ...
    for (let s = this.shapeList.length; s--; ) {
      ...
      ee(r) && (r.added && r.stock && r.placeMyShapes(r.stock), this.shapeList.splice(s, 1), this.shapeList.push(...r.shapes));
    }
    this.groupList = [];
  }
...
function Qn() {
  v("Banding", It), v("banding", It), v("Container", $e), v(W.Container, $e), v("Corner", Tt), v("corner", Tt), v("Cut", Ve), v(W.Cut, Ve), v("Extras", bt), v(W.Extras, bt), v("Finish", Ct), v("finish", Ct), v("Group", _e), v(W.Group, _e), v("GuillotineState", Re), v(W.GuillotineState, Re), v("HingeHole", Pt), v("hingeHole", Pt), v("Hole", kt), v("hole", kt), v("ImageUpload", Et), v("imageUpload", Et), v("InputSaw", Dt), v(W.InputSaw, Dt), v("InputShape", vt), v(W.InputShape, vt), v("InputStock", Rt), v(W.InputStock, Rt), v("InputUserGroup", At), v(W.Group, At), v("Issue", ns), v("Line", be), v(W.Line, be), v("Machining", Lt), v(W.Machining, Lt), v("Offcut", Mt), v(W.Offcut, Mt), v("Optimiser", Qt), v(W.Optimiser, Qt), v("Placeable", qt), v(W.Placeable, qt), v("Planing", Ot), v("planing", Ot), v("Point", Ke), v(W.Point, Ke), v("PointCollection", Qe), v(W.PointCollection, Qe), v("Rectangle", Ft), v(W.Rectangle, Ft), v("Saw", Le), v(W.Saw, Le), v("Segment", se), v(W.Segment, se), v("Shape", Gt), v(W.Shape, Gt), v("Stock", Je), v(W.Stock, Je), rs();
}
export {
  Qn as initializeStaticRegistry
};
