import { d as Ue, J as Ke, y as Xe, K as pe, k as W, l as Je, I as ge, z as Qe, r as Ze, o as g, c as v, a as L, u as T, m as te, b as y, t as F, g as E, j as ve, n as me, F as I, f as J, A as _e, w as et, B as fe, C as tt, s as q, x as Y, h as st, v as it, L as at } from "./vendor-vue-D6ZfZC0P.js";
import { h as C, M as Se, i as Q, u as be } from "./InputUserGroup-pBQzFMX3.js";
import { c as xe, a as nt, h as lt, s as rt, g as ot, I as ht } from "./EcommerceCalculator-D4REKTU7.js";
...
const Dt = { class: "inputs" }, Lt = {
  ...
  setup(w, { emit: a }) {
    const n = tt(() => import("./ObjectViewer-D4FhhG99.js")), e = w, d = a, m = "production", p = q(), h = q(), { show: u, close: S, onToggle: D, onClosed: H, cleanup: k, isShown: $ } = nt(p), O = Y(() => lt(i.value)), se = Y(() => (e.customMachiningProducts?.length ?? 0) > 0), ie = Y(() => {
