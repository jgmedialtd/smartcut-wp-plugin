...
import { F as Fraction, i as isEqual, g as get, d as defaults, a as isNaN$1, c as config$1, b as createDebug, e as expect, f as createDebug$1, v as v4, h as has, s as set, j as autoUpdate, o as offset, k as shift, l as flip, P as Papa } from "./vendor-Bl85u5aa.js";
import { i as instance, B as Browser } from "./vendor-i18n-BYrCBf6t.js";
import { d as defineComponent, c as createElementBlock, o as openBlock, F as Fragment, r as renderList, n as normalizeStyle, a as normalizeClass, b as createBaseVNode, w as withDirectives, t as toDisplayString, v as vShow, e as createCommentVNode, f as createStaticVNode, g as ref, h as computed, i as watch, j as onMounted, k as nextTick, l as onUnmounted, m as mergeProps, u as unref, p as createTextVNode, q as renderSlot, s as createBlock, x as withCtx, y as resolveComponent, z as createVNode, A as onBeforeUnmount, B as defineAsyncComponent, C as useResizeObserver, D as watchThrottled, E as shallowRef, G as useLocalStorage, H as reactive, I as useFloating, T as Transition, J as Teleport, K as arrow, L as mergeModels, M as useModel, N as useThrottleFn, O as markRaw, P as withModifiers, Q as inject, R as TransitionGroup } from "./vendor-vue-Dk_GuyMk.js";
import { u as useInputs, a as useNotices, b as useResults, c as useToolTip, d as useSocket, e as useProgress } from "./composables-_fF_hxOz.js";
import { a as axisTop, b as axisRight, l as linear, c as axisBottom, d as axisLeft, s as select, r as rgb, e as sequential, f as selectAll, g as symbolSquare, h as symbolTriangle, i as arc, p as path, S as Symbol$1, j as format, k as precisionFixed } from "./vendor-d3-D0Icd4Ag.js";
...
function sanitiseStringAnyLanguage(string) {
  if (!checkString(string)) return "";
  string = string.normalize("NFKD").replace(/[\u0300-\u036f]/g, "").replace(/[^a-zA-Z\u00C0-\u024F0-9._\-|\s]/g, "");
  return string.trim();
}
...
function t$2(key, options) {
  var _a;
  if (typeof process !== "undefined" && ((_a = process == null ? void 0 : process.env) == null ? void 0 : _a.VITEST)) {
    return key;
  }
  ...
  return sentenceCase(translation);
}
const translationFileModules = /* @__PURE__ */ Object.assign({ "../translation/ca.json": () => import("./ca-CKJEoZtv.js"), "../translation/cs.json": () => import("./cs-DZl7iN_c.js"), "../translation/da.json": () => import("./da-DHM6KhHu.js"), "../translation/de.json": () => import("./de-DCh-1T2T.js"), "../translation/el.json": () => import("./el-BViVwleG.js"), "../translation/en.json": () => import("./en-D3fM0R9m.js"), "../translation/es.json": () => import("./es-C04bFdb-.js"), "../translation/fi.json": () => import("./fi-CR7CPEWG.js"), "../translation/fr.json": () => import("./fr-BTiY0w9_.js"), "../translation/hi.json": () => import("./hi-DKsxDAy2.js"), "../translation/hr.json": () => import("./hr-w7hHmuQn.js"), "../translation/hu.json": () => import("./hu-DtZinhqP.js"), "../translation/id.json": () => import("./id-Bd8nMuxo.js"), "../translation/it.json": () => import("./it-BYQ2GwiP.js"), "../translation/ja.json": () => import("./ja-syNBNBY4.js"), "../translation/ko.json": () => import("./ko-3UWOr842.js"), "../translation/ms.json": () => import("./ms-BqSC38Gj.js"), "../translation/nl.json": () => import("./nl-BHQRczWD.js"), "../translation/no.json": () => import("./no-p1jGUvCU.js"), "../translation/pl.json": () => import("./pl-BaHxaGaw.js"), "../translation/pt.json": () => import("./pt-Ck7Z8oqA.js"), "../translation/ro.json": () => import("./ro-BvQ_WViB.js"), "../translation/ru.json": () => import("./ru-DXLUSrww.js"), "../translation/sk.json": () => import("./sk-B-PDbkkF.js"), "../translation/sv.json": () => import("./sv-CAKtLPap.js"), "../translation/th.json": () => import("./th-DIALNexB.js"), "../translation/tr.json": () => import("./tr-oRAD_ozG.js"), "../translation/uk.json": () => import("./uk-x0vhMxgX.js"), "../translation/vi.json": () => import("./vi-B7YFB-HL.js"), "../translation/zh.json": () => import("./zh-CbebVUPi.js") });
const SUPPORTED_LANGUAGES = Object.keys(translationFileModules).map((path2) => {
  const match = path2.match(/\/([a-zA-Z0-9_-]+)\.json$/);
  return match ? match[1] : "";
}).filter((lang) => lang !== "");
if (SUPPORTED_LANGUAGES.length === 0) {
  console.warn("[i18n] No language files found in ../translation/. Check paths and bundler setup for import.meta.glob.");
} else {
  console.log(`[i18n] Detected languages: ${SUPPORTED_LANGUAGES.join(", ")}`);
}
const FALLBACK_LANGUAGE = "en";
const i18nextInstance = instance.createInstance();
function t$1(key, options) {
  var _a, _b;
  if (typeof process !== "undefined" && (((_a = process == null ? void 0 : process.env) == null ? void 0 : _a.NODE_ENV) === "test" || ((_b = process == null ? void 0 : process.env) == null ? void 0 : _b.VITEST))) {
    return key;
  }
  if (!i18nextInstance.isInitialized) {
    const keyString2 = Array.isArray(key) ? key.join(", ") : String(key);
    console.warn(`[i18n] t function called before i18next was initialized. Key: ${keyString2}. Returning key.`);
    return keyString2;
  }
  let result = i18nextInstance.t(key, options);
  const keyString = Array.isArray(key) ? key[0] : key;
  if (result === keyString) {
    console.warn(`[i18n] Translation not found - Key: "${keyString}"`);
    console.trace();
  }
  result = typeof result === "string" ? result : String(result);
  return sentenceCase(result);
}
const languageModuleCache = {};
const dynamicImportBackend = {
  ...
  read: async (language, namespace, callback) => {
    try {
      if (languageModuleCache[language]) {
        callback(null, languageModuleCache[language]);
        return;
      }
      console.log(`[i18n] Attempting to load local module for language: ${language}`);
      const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../translation/ca.json": () => import("./ca-CKJEoZtv.js"), "../translation/cs.json": () => import("./cs-DZl7iN_c.js"), "../translation/da.json": () => import("./da-DHM6KhHu.js"), "../translation/de.json": () => import("./de-DCh-1T2T.js"), "../translation/el.json": () => import("./el-BViVwleG.js"), "../translation/en.json": () => import("./en-D3fM0R9m.js"), "../translation/es.json": () => import("./es-C04bFdb-.js"), "../translation/fi.json": () => import("./fi-CR7CPEWG.js"), "../translation/fr.json": () => import("./fr-BTiY0w9_.js"), "../translation/hi.json": () => import("./hi-DKsxDAy2.js"), "../translation/hr.json": () => import("./hr-w7hHmuQn.js"), "../translation/hu.json": () => import("./hu-DtZinhqP.js"), "../translation/id.json": () => import("./id-Bd8nMuxo.js"), "../translation/it.json": () => import("./it-BYQ2GwiP.js"), "../translation/ja.json": () => import("./ja-syNBNBY4.js"), "../translation/ko.json": () => import("./ko-3UWOr842.js"), "../translation/ms.json": () => import("./ms-BqSC38Gj.js"), "../translation/nl.json": () => import("./nl-BHQRczWD.js"), "../translation/no.json": () => import("./no-p1jGUvCU.js"), "../translation/pl.json": () => import("./pl-BaHxaGaw.js"), "../translation/pt.json": () => import("./pt-Ck7Z8oqA.js"), "../translation/ro.json": () => import("./ro-BvQ_WViB.js"), "../translation/ru.json": () => import("./ru-DXLUSrww.js"), "../translation/sk.json": () => import("./sk-B-PDbkkF.js"), "../translation/sv.json": () => import("./sv-CAKtLPap.js"), "../translation/th.json": () => import("./th-DIALNexB.js"), "../translation/tr.json": () => import("./tr-oRAD_ozG.js"), "../translation/uk.json": () => import("./uk-x0vhMxgX.js"), "../translation/vi.json": () => import("./vi-B7YFB-HL.js"), "../translation/zh.json": () => import("./zh-CbebVUPi.js") }), `../translation/${language}.json`, 3);
      languageModuleCache[language] = module.default;
      console.log(`[i18n] Successfully loaded and cached local module for language: ${language}`);
      callback(null, languageModuleCache[language]);
    } catch (error) {
      const errMsg = `[i18n] Failed to load local resource module for language '${language}'. Error: ${error.message}`;
...
async function initializeI18n() {
  ...
  await i18nextInstance.use(Browser).use(dynamicImportBackend).init({
    debug: false,
    fallbackLng: FALLBACK_LANGUAGE,
    supportedLngs: SUPPORTED_LANGUAGES.length > 0 ? SUPPORTED_LANGUAGES : [FALLBACK_LANGUAGE],
    interpolation: {
      format: function(value, format2) {
        if (format2 === "c") return capitalise(value);
        if (format2 === "sc") return sentenceCase(value);
        return value;
      }
    },
    detection: {
  ...
  console.log("[i18n] Initialized. Detected language:", i18nextInstance.language);
  return i18nextInstance;
}
const i18nextReady = initializeI18n().catch((err) => {
  console.error("[i18n] CRITICAL: Initialization failed.", err);
});
...
function handleDecimalFormat(cleanedValue, decimalPlacesToApply) {
  let numericValue;
  if (typeof cleanedValue === "number") {
    numericValue = cleanedValue;
  } else {
    const fraction = new Fraction(cleanedValue);
    numericValue = fraction.valueOf();
  }
  if (typeof decimalPlacesToApply === "number") {
    const multiplier = Math.pow(10, decimalPlacesToApply);
...
function handleFractionFormat(cleanedValue, fractionRoundTo) {
  ...
  if (fractionRoundTo > 0) {
    const scaled = fraction.mul(fractionRoundTo);
    const roundedNumerator = Math.round(scaled.valueOf());
    return new Fraction(roundedNumerator, fractionRoundTo).toFraction(true);
  }
  return fraction.simplify().toFraction(true);
}
function validateNumericInput(value, format2, required = false) {
  const isBlank = value === void 0 || value === null || String(value).trim() === "";
  if (required && isBlank) {
    return { value: null, valid: false, message: "field_required" };
  }
  if (!required && isBlank) {
  ...
  {
    try {
      const cleanedAndParsedStr = cleanNumericInput(inputStr, true);
      const parsed = parseFloat(cleanedAndParsedStr ?? "");
      const isValid = cleanedAndParsedStr !== null && cleanedAndParsedStr !== "" && !isNaN(parsed) && isFinite(parsed);
      return {
        value: isValid ? parsed : value,
        valid: isValid,
        message: isValid ? void 0 : "invalid_number",
        messageData: isValid ? void 0 : "Could not parse as decimal."
      };
    } catch (e) {
      return {
        value,
        ...
        messageData: e.message || "Parsing error"
      };
    }
  }
  return {
...
function localeParseFloat(value) {
  ...
  try {
    ...
    const normalizedValue = stringValue.replace(new RegExp(`\\${thousandsSeparator}`, "g"), "").replace(new RegExp(`\\${decimalSeparator}`, "g"), ".");
    const result = Number(normalizedValue);
    return isFinite(result) ? result : null;
  } catch (e) {
    throw new NumberFormatError(`Failed to parse locale number: "${value}". ${e.message || "Parsing error"}`);
  }
}
function detectFraction(input) {
  ...
  const vulgarFractionChars = Object.keys(vulgarFractionMap).join("");
  const fractionpatternsregex = new RegExp(
    `^-?((\\d+\\s+)?\\d+\\/\\d+|\\d+|\\d+[${vulgarFractionChars}]|[${vulgarFractionChars}]|\\d+'(?:\\s*\\d+(?:\\/\\d+)?"?)?|(\\d+\\s+)?\\d+\\/\\d+"|\\d+")$`
  );
  return fractionpatternsregex.test(cleaned);
}
function cleanNumericInput(input, parseLocale = false) {
  if (input == null || input === "") return null;
  let cleanValue = String(input).trim();
  if (!cleanValue) return null;
  const vulgarCharsForRegex = Object.keys(vulgarFractionMap).join("");
  cleanValue = cleanValue.replace(new RegExp(`(\\d)\\s+([${vulgarCharsForRegex}])`, "g"), "$1$2");
  try {
    const vulgarFractionChars = Object.keys(vulgarFractionMap).join("");
    const vulgarCombinedRegex = new RegExp(`^(-?)(\\d+)([${vulgarFractionChars}])$`);
    const vulgarOnlyRegex = new RegExp(`^(-?)([${vulgarFractionChars}])$`);
    const vulgarCombinedMatch = cleanValue.match(vulgarCombinedRegex);
    const vulgarOnlyMatch = cleanValue.match(vulgarOnlyRegex);
    if (vulgarCombinedMatch) {
      const sign = vulgarCombinedMatch[1];
      const wholeNumber = vulgarCombinedMatch[2];
      const vulgarChar = vulgarCombinedMatch[3];
      const fractionalString = vulgarFractionMap[vulgarChar];
      if (fractionalString) {
        return `${sign}${wholeNumber} ${fractionalString}`;
      } else {
        throw new Error(`Unknown vulgar fraction character: ${vulgarChar}`);
      }
    } else if (vulgarOnlyMatch) {
      const sign = vulgarOnlyMatch[1] || "";
      const vulgarChar = vulgarOnlyMatch[2];
      const fractionalString = vulgarFractionMap[vulgarChar];
      if (fractionalString) {
        return `${sign}${fractionalString}`;
      } else {
        throw new Error(`Unknown vulgar fraction character: ${vulgarChar}`);
      }
    } else if (detectFraction(cleanValue)) {
      let sign = "";
      if (cleanValue.startsWith("-")) {
        sign = "-";
        cleanValue = cleanValue.substring(1).trim();
      }
      const cleanedFraction = cleanValue.replace(/[^0-9\s/]/g, "").replace(/\s+/g, " ").trim();
      if ((cleanedFraction.match(/\//g) || []).length > 1) {
        throw new Error("Invalid fraction format: multiple slashes.");
      }
      return sign + cleanedFraction;
    } else {
      if (parseLocale) {
      ...
      if (parsed === null || isNaN(parsed) || !isFinite(parsed)) return null;
      return parsed.toString();
    }
  } catch (error) {
    throw new NumberFormatError(
      `Failed to clean numeric input: "${input}". ${error.message || "Cleaning error"}`
    );
  }
}
  ...
  for (const key of item.numberFormatKeys) {
    if (typeof item[key] === "object" && item[key] !== null) {
      for (const objectKey in item[key]) {
        if (Object.prototype.hasOwnProperty.call(item[key], objectKey)) {
...
function isCleanDecimalString(str) {
  return /^-?\d*\.?\d+$/.test(str);
}
function isCleanFractionString(str) {
  return /^-?(\d+\s+)?\d+\/\d+$/.test(str) || /^-?\d+$/.test(str);
}
function convertNumberFormat(params) {
  var _a;
  if (params.v == null || params.v === "") {
    return params.nf === "decimal" || !params.nf && ((_a = params.o) == null ? void 0 : _a.numberFormat) !== "fraction" ? null : "";
  }
  const options = params.o ?? {};
  const numberFormat = params.nf ?? (options == null ? void 0 : options.numberFormat) ?? "decimal";
  const decimalPlaces = params.dp ?? (options == null ? void 0 : options.decimalPlaces) ?? defaultDecimalPlaces;
  const parseLocale = params.pl ?? (options == null ? void 0 : options.parseLocale) ?? false;
  const fractionRoundTo = params.fr ?? (options == null ? void 0 : options.fractionRoundTo) ?? defaultFractionRoundTo;
  if (numberFormat === "decimal") {
    if (typeof params.v === "number") {
      if (typeof decimalPlaces === "number" && decimalPlaces !== defaultDecimalPlaces) {
        const multiplier = Math.pow(10, decimalPlaces);
        return Math.round(params.v * multiplier) / multiplier;
      }
      return params.v;
    }
    if (typeof params.v === "string") {
      const trimmed = params.v.trim();
      if (isCleanDecimalString(trimmed) && !parseLocale) {
  ...
  } else if (numberFormat === "fraction") {
    if (typeof params.v === "string") {
      const trimmed = params.v.trim();
      if (isCleanFractionString(trimmed)) {
        try {
          const fraction = new Fraction(trimmed);
          if (isFinite(fraction.valueOf())) {
            if (fractionRoundTo === 0 || fractionRoundTo === defaultFractionRoundTo) {
  ...
  try {
    const cleanedValue = cleanNumericInput(params.v, parseLocale);
    if (cleanedValue === null || cleanedValue === "") {
      return numberFormat === "decimal" ? null : "";
    }
    return numberFormat === "decimal" ? handleDecimalFormat(cleanedValue, decimalPlaces) : handleFractionFormat(cleanedValue, fractionRoundTo);
  } catch (error) {
    if (error instanceof NumberFormatError) {
      throw error;
    }
    throw new NumberFormatError(
      `Failed to convert number format: "${params.v}" to ${numberFormat}. ${error.message}`
    );
  }
}
const SortingErrors = {
...
const compareIDs = (a, b) => {
  ...
  if (aId === null || bId === null || aId === void 0 || bId === void 0) return 0;
  const aIdSplit = aId.toString().split(".");
  const bIdSplit = bId.toString().split(".");
  if (aIdSplit[0] !== bIdSplit[0]) {
    return parseInt(aIdSplit[0]) - parseInt(bIdSplit[0]);
  }
  return parseInt(aIdSplit[1]) - parseInt(bIdSplit[1]);
};
...
function checkThicknessMatch(shape, stock, required) {
  ...
  return isShape(shape) ? maths.equalTo(convertNumberFormat({ v: shape.t }), convertNumberFormat({ v: stock.t })) : shape.t === stock.t;
}
function checkLinearMatch(shape, stock, saw) {
  if ((saw == null ? void 0 : saw.stockType) !== "linear") return true;
  if (!isShape(shape) && !isInputShape(shape)) return true;
  return canRotate(shape, 0, stock) && maths.equalTo(convertNumberFormat({ v: shape.w }), convertNumberFormat({ v: stock.w })) || canRotate(shape, 1, stock) && maths.equalTo(convertNumberFormat({ v: shape.l }), convertNumberFormat({ v: stock.w }));
}
function stockMatch$1(shapes, stock, saw, index = 0) {
  const isInputs = isInputShape(shapes[0]);
  const stockType = saw.stockType;
  const stockLockSetManually = shapes.some((s) => valueSet(s.stockLock) && s.stockLock.length);
  if (stockLockSetManually) {
    return { stockList: stock, shapeList: shapes, unusableShapes: [], unusableStock: [], newIssues: [] };
  }
  stock = stock.filter((s) => isInputs || s.autoAdd === true || valueSet(s.q) && s.q > 0);
  ...
  const shapesWithoutFit = /* @__PURE__ */ new Set();
  const shapesWithoutWidth = /* @__PURE__ */ new Set();
  const shapesWithoutValidStock = /* @__PURE__ */ new Set();
  const newIssues = [];
  let shapeIndex = index;
  for (const shape of shapes) {
    const stockEvaluations = stock.map((stockItem, stockIndex) => {
      const fit = isValidShape(shape) && willItFit(shape, stockItem, void 0, saw);
      const material = checkMaterialMatch(shape, stockItem, someStockMaterialSet);
      const thickness = checkThicknessMatch(shape, stockItem, someStockThicknessSet);
      const width = checkLinearMatch(shape, stockItem, saw);
      return {
        stockItem,
        stockIndex,
        fit,
        ...
        satisfiesAll: fit && material && thickness && (stockType !== "linear" || width)
      };
    });
    shape.stockMatch = {
      fit: stockEvaluations.some((e) => e.fit),
      material: !someStockMaterialSet || stockEvaluations.some((e) => e.material),
      thickness: !someStockThicknessSet || stockEvaluations.some((e) => e.thickness),
      width: stockType !== "linear" || stockEvaluations.some((e) => e.width)
    };
    const validStock = stockEvaluations.filter((e) => e.satisfiesAll);
    const hasValidStock = validStock.length > 0;
    if (!isInputs && hasValidStock) {
      const stockParentIds = validStock.map((e) => e.stockItem.getParentID());
      shape.stockLock = stockParentIds;
      stockParentIds.forEach((id) => allocatedStock.add(id));
    }
    if (!shape.stockMatch.fit) {
      shapesWithoutFit.add(shape);
      newIssues.push(new Issue({
        category: ["part", "stock"],
        item: shape,
        field: [["l"], ["w"]],
        index: [shapeIndex],
      ...
      if (someStockMaterialSet && !shape.stockMatch.material) {
        shapesWithoutValidStock.add(shape);
        newIssues.push(new Issue({
          category: ["part", "stock"],
          item: shape,
          field: [["material"]],
      ...
      if (someStockThicknessSet && !shape.stockMatch.thickness) {
        shapesWithoutValidStock.add(shape);
        newIssues.push(new Issue({
          category: ["part", "stock"],
          item: shape,
      ...
      if (shape.stockMatch.material && shape.stockMatch.thickness && (stockType !== "linear" || shape.stockMatch.width)) {
        shapesWithoutValidStock.add(shape);
        newIssues.push(new Issue({
          category: ["part", "stock"],
          item: shape,
  ...
  shapes.forEach((shape) => shape.stockMatch = null);
  let unusableShapes, unusableStock;
  if (!isInputs) {
    unusableShapes = shapes.filter((s) => shapesWithoutFit.has(s) || shapesWithoutWidth.has(s) || shapesWithoutValidStock.has(s) || !s.stockLock || !s.stockLock.length).sort(sorting.ID);
    ...
    shapes = shapes.filter((s) => {
      var _a;
      return !shapesWithoutFit.has(s) && !shapesWithoutWidth.has(s) && !shapesWithoutValidStock.has(s) && ((_a = s == null ? void 0 : s.stockLock) == null ? void 0 : _a.length);
    });
  } else {
    unusableShapes = shapes.filter((s) => shapesWithoutFit.has(s) || shapesWithoutWidth.has(s) || shapesWithoutValidStock.has(s)).sort(sorting.ID);
    unusableStock = [];
  }
  return {
    stockList: stock,
...
class Issue {
  constructor({
    ...
    this.message = shouldTranslate ? t$2(message) : message;
    this.field = field.map((f) => [...f]);
    this.index = index ? [...index] : [];
    this.listId = listId ? [...listId] : [];
    this.type = type;
    this.category = category;
    this.identifier = this.determineIdentifier(item, this.index);
    this.addToItemIssues(item);
    if (Array.isArray(issues)) {
      issues.push(this);
    }
    const errorMessage = `issue created for ${getItemType(item)}: ${this.identifier || "N/A"} - ${this.field.map((f) => f.join(".")).join(", ")}`;
    if (throwError) {
      throw new Error(errorMessage);
    }
  }
  determineIdentifier(item, index) {
    var _a, _b, _c;
    if (!item) return "";
    const identifiableItem = item;
    if ((_a = identifiableItem.name) == null ? void 0 : _a.length) {
      return identifiableItem.name.toLocaleUpperCase();
    }
    if ((_b = identifiableItem.id) == null ? void 0 : _b.length) {
      return identifiableItem.id;
    }
    if ((_c = identifiableItem.parentID) == null ? void 0 : _c.length) {
      return identifiableItem.parentID;
    }
  ...
  addToItemIssues(item) {
    if (!item) return;
    const itemWithIssues = item;
    if ("issues" in itemWithIssues && Array.isArray(itemWithIssues.issues)) {
      itemWithIssues.issues.push(this);
    }
  }
  getHumanReadableIndexes() {
    if (!this.index.length) return "";
    return this.index.map((i) => {
      const num = typeof i === "number" ? i : parseInt(String(i), 10);
      return isNaN(num) ? "" : String(num + 1);
    }).filter(Boolean).join(",");
  }
  isMatch(singleFieldPath, singleIndex) {
    const fieldsMatch = this.field.some((issueFieldPath) => isEqual(issueFieldPath, singleFieldPath));
    const indexesMatch = this.index.includes(singleIndex);
    return fieldsMatch && indexesMatch;
  }
}
const fieldMap = {
...
function isItemWithIssues(item) {
  return hasProperty(item, "issues") && Array.isArray(item.issues);
}
function shouldShowInputIssue(item, field, warning = false) {
  var _a;
  if (!isItemWithIssues(item) || !((_a = item.issues) == null ? void 0 : _a.length)) {
    return false;
  }
  const targetType = warning ? "warning" : "error";
  const relevantIssues = item.issues.filter((issue) => issue.type === targetType);
  return relevantIssues.some((issue) => {
    var _a2;
    if (!((_a2 = issue.field) == null ? void 0 : _a2.length)) {
      return false;
    }
    return issue.field.some((issueField) => issueField.every((val, index) => val === getMappedField(field[index])));
  });
}
const convertAndValidate = ({
  ...
  try {
    val = convertNumberFormat({ v: val });
    if (required && (val === null || val === "")) {
      new Issue({
        item,
        message: t$2("errors.validation.not_set", {
          0: userFriendlyFieldMap[field.join(".")]
        }),
    ...
    if (!allowZero && val === 0) {
      new Issue({
        item,
        message: t$2("errors.validation.greater_than", {
          0: userFriendlyFieldMap[field.join(".")],
          1: 0
        }),
        shouldTranslate: false,
  ...
  handleMinValue({ item, field, value: val, index, issues: newIssues, min, isWarning: isWarning ?? false });
  handleMaxValue({ item, field, value: val, index, issues: newIssues, max, isWarning: isWarning ?? false });
  return val;
};
const handleConversionError = ({
  ...
  new Issue({
    item,
    message: t$2("errors.validation.not_understood", {
      0: field.join("."),
      1: value
    }),
    shouldTranslate: false,
...
const handleMinValue = ({
  ...
  if (value < min) {
    new Issue({
      item,
      message: t$2("errors.validation.greater_than_or_equal", {
        0: userFriendlyFieldMap[field.join(".")],
        1: min
      }),
      shouldTranslate: false,
...
const handleMaxValue = ({
  ...
  if (value > max) {
    new Issue({
      item,
      message: t$2("errors.validation.less_than_or_equal", {
        0: userFriendlyFieldMap[field.join(".")],
        1: max
      }),
      shouldTranslate: false,
...
const validateStringProperty = (item, propertyName, validValues, index, isWarning, issues) => {
  const value = get(item, propertyName);
  if (value === void 0 || value === null || value === "") return;
  if (typeof value !== "string") {
    new Issue({
      item,
      message: t$2("errors.validation.must_be_string", {
        0: userFriendlyFieldMap[propertyName]
      }),
      shouldTranslate: false,
      field: [[propertyName]],
      index: [index],
  ...
  if (!validValues.includes(normalizedValue)) {
    new Issue({
      item,
      message: t$2("errors.validation.must_be_values", {
        0: userFriendlyFieldMap[propertyName],
        1: validValues.join(", ")
      }),
      shouldTranslate: false,
...
const x = ({ item, index, max, isWarning = false, category = [] }) => {
  const newIssues = [];
  convertAndValidate({
    item,
    field: ["x"],
...
const y = ({ item, index, max, isWarning = false, category = [] }) => {
  const newIssues = [];
  convertAndValidate({
    item,
    field: ["y"],
...
const l = ({ item, index, max, isWarning = false, category = [] }) => {
  const newIssues = [];
  convertAndValidate({
    item,
    field: ["l"],
...
const w = ({ item, index, max, isWarning = false, category = [] }) => {
  const newIssues = [];
  convertAndValidate({
    item,
    field: ["w"],
...
const t = ({ item, index, max, isWarning = false, saw, category = [] }) => {
  const newIssues = [];
  if ((saw == null ? void 0 : saw.cutType) === "beam") {
    const val = get(item, "t");
    if (!val) {
      new Issue({
        item,
        message: t$2("errors.saw.thickness_required_for_beam_saw"),
        shouldTranslate: false,
        field: [["t"]],
        index: [index],
        type: "error",
...
const q = ({ item, index, isWarning = false, category = [] }) => {
  const newIssues = [];
  const val = get(item, "q");
  if (val === void 0 || val === null) return newIssues;
  try {
    const convertedVal = convertNumberFormat({ v: val });
    const hasAutoAdd = get(item, "autoAdd");
    if (convertedVal <= 0 && hasAutoAdd !== true) {
      new Issue({
        item,
        message: t$2("errors.validation.greater_than_or_equal", {
          0: userFriendlyFieldMap["q"],
          1: 0
        }),
        shouldTranslate: false,
        field: [["q"]],
...
const orientationLock = ({ item, index, isWarning = false }) => {
  const newIssues = [];
  validateStringProperty(item, "orientationLock", ["l", "w"], index, isWarning, newIssues);
  return newIssues;
};
const grain = ({ item, index, isWarning = false }) => {
  const newIssues = [];
  validateStringProperty(item, "grain", ["l", "w"], index, isWarning, newIssues);
  return newIssues;
};
const banding = ({ item, index, isWarning = false }) => {
  const newIssues = [];
  const bandingValue = get(item, "banding");
  if (bandingValue !== void 0 && bandingValue !== null) {
    if (typeof bandingValue !== "object" || bandingValue === null) {
      new Issue({
        item,
        message: t$2("errors.validation.must_be_object", { 0: "banding" }),
        shouldTranslate: false,
        field: [["banding"]],
        index: [index],
        type: isWarning ? "warning" : "error",
...
const customData = ({ item, index, isWarning = false, category = [] }) => {
  const newIssues = [];
  const data = get(item, "customData");
  if (data === void 0 || data === null) return newIssues;
  if (typeof data !== "object" || data === null) {
    new Issue({
      item,
      message: t$2("errors.validation.must_be_object", {
        0: userFriendlyFieldMap["customData"]
      }),
      shouldTranslate: false,
      field: [["customData"]],
      index: [index],
  ...
  for (const [, value] of Object.entries(data)) {
    if (value !== void 0 && value !== null) {
      ...
      if (!["string", "number", "boolean"].includes(valueType)) {
        new Issue({
          item,
          message: t$2("errors.validation.must_be_string_number_boolean", {
            0: userFriendlyFieldMap["customData"]
          }),
          shouldTranslate: false,
          field: [["customData"]],
...
const partTrim = ({
  ...
  const newIssues = [];
  if (!trimValue) return newIssues;
  const l2 = get(item, "l");
  const w2 = get(item, "w");
  if (!l2 || !w2) return newIssues;
  try {
    const trimValueNum = convertNumberFormat({ v: trimValue });
    const lNum = convertNumberFormat({ v: l2 });
    const wNum = convertNumberFormat({ v: w2 });
    const trimmedL = lNum - trimValueNum * 2;
    const trimmedW = wNum - trimValueNum * 2;
    if (trimmedL <= 0 || trimmedW <= 0) {
      new Issue({
        item,
        message: t$2("errors.trim.too_much", {
          0: "part",
          1: trimValueNum,
          z: `${trimmedL}x${trimmedW}`
        }),
        shouldTranslate: false,
        field: [["l"], ["w"], ["trim"]],
        index: [index],
...
const trim = ({
  ...
  const l2 = get(item, "l");
  const w2 = get(item, "w");
  const trimObj = get(item, "trim");
  if (!l2 || !w2 || !trimObj) return newIssues;
  const shouldValidateTrim = !isStock(item) || isStock(item) && !("trimmed" in item && item.trimmed);
  if (shouldValidateTrim && typeof trimObj === "object" && trimObj !== null) {
    for (const key of Object.keys(trimObj)) {
      convertAndValidate({
        item,
        field: ["trim", key],
        index,
      ...
      try {
        ...
        const safeConvert = (value) => {
          ...
          if (typeof value === "number" || typeof value === "string") {
            try {
              return convertNumberFormat({ v: value }) || 0;
            } catch {
              return 0;
            }
          }
        ...
        const trimValues = {
          x1: safeConvert(get(trimObj, "x1")),
          x2: safeConvert(get(trimObj, "x2")),
          y1: safeConvert(get(trimObj, "y1")),
          y2: safeConvert(get(trimObj, "y2"))
        };
        const totalX = trimValues.x1 + trimValues.x2;
        const totalY = trimValues.y1 + trimValues.y2;
        if (totalX >= lNum) {
          new Issue({
            item,
            message: t$2("errors.trim.too_much", {
              0: `${userFriendlyFieldMap["x1"].toUpperCase()} + ${userFriendlyFieldMap["x2"].toUpperCase()}`,
              1: userFriendlyFieldMap.l,
              2: lNum
            }),
            shouldTranslate: false,
        ...
        if (totalY >= wNum) {
          new Issue({
            item,
            message: t$2("errors.trim.too_much", {
              0: `${userFriendlyFieldMap["y1"].toUpperCase()} + ${userFriendlyFieldMap["y2"].toUpperCase()}`,
              1: userFriendlyFieldMap.w,
              2: wNum
            }),
            shouldTranslate: false,
...
const stockMatch = ({
  ...
  const l2 = get(item, "l");
  const w2 = get(item, "w");
  if (!q2 || !l2 || !w2) return newIssues;
  if ("applyPartTrim" in item && typeof item.applyPartTrim === "function") {
    item.applyPartTrim(partTrim2, stockType);
  }
  if (isItemWithIssues(item) && ((_a = item.issues) == null ? void 0 : _a.length)) {
    return newIssues;
  }
  const matchResult = stockMatch$1([item], inputStockList, saw, index);
  matchResult.newIssues.forEach((issue) => {
    newIssues.push(issue);
  });
  return newIssues;
};
const machining = ({ item, index }) => {
  const machiningObj = get(item, "machining");
  if (machiningObj && "validateEverything" in machiningObj) {
    machiningObj.validateEverything(item, index);
  }
};
...
function getValidStockTypes() {
  return SawSchema.stockTypes;
}
...
function createIssue(item, fields, translationKey, interpolation = {}) {
  ...
  if (!isSaw(item)) {
    console.error(t$2(translationKey, interpolation));
    return;
  }
  new Issue({
    category: ["saw"],
    ...
    message: t$2(translationKey, interpolation),
    shouldTranslate: false
  });
}
class Saw {
  constructor(data, stockType) {
    ...
    this.issues = [];
    stockType = stockType ?? (data == null ? void 0 : data.stockType) ?? getValidStockTypes()[0];
    ...
    this.stockType = stockType ?? (data == null ? void 0 : data.stockType) ?? getValidStockTypes()[0];
    if (!isValidStockTypeInput(this.stockType)) {
      this.stockType = getValidStockTypes()[0];
    }
    ...
    this.options.minSpacing = convertNumberFormat({ v: this.options.minSpacing }) ?? 0;
    this.options.minSpacingDimension.dimension = convertNumberFormat({ v: this.options.minSpacingDimension.dimension }) ?? 0;
    this.options.minSpacingDimension.minSpacing = convertNumberFormat({ v: this.options.minSpacingDimension.minSpacing }) ?? 0;
  }
  clone() {
  ...
  get minSpacing() {
    if (this.cutType !== "efficiency") return 0;
    return this.options.minSpacing;
  }
}
function validateSaw(saw, data, stockType) {
  ...
  if ((data == null ? void 0 : data.cutType) === "efficiency") {
    if ((_a = data == null ? void 0 : data.options) == null ? void 0 : _a.minSpacing) {
      data.options.minSpacing = typeof data.options.minSpacing === "string" ? convertNumberFormat({ v: data.options.minSpacing }) : data.options.minSpacing;
      if (!valueSet(data == null ? void 0 : data.bladeWidth) || data.bladeWidth <= 0) {
        createIssue(
          saw,
          "bladeWidth",
          "saw.validation.required.bladeWidthMinSpacing",
          { minSpacing: data.options.minSpacing }
        );
      }
      if (isNaN$1(data.options.minSpacing) || data.options.minSpacing < 0) {
        createIssue(
          saw,
          "options.minSpacing",
          "saw.validation.minSpacing.invalid",
          { minSpacing: data.options.minSpacing ?? "none" }
        );
      }
    }
    if ((_b = data == null ? void 0 : data.options) == null ? void 0 : _b.minSpacingDimension) {
      if (valueSet((_d = (_c = data == null ? void 0 : data.options) == null ? void 0 : _c.minSpacingDimension) == null ? void 0 : _d.dimension)) {
        data.options.minSpacingDimension.dimension = typeof data.options.minSpacingDimension.dimension === "string" ? convertNumberFormat({ v: data.options.minSpacingDimension.dimension }) : data.options.minSpacingDimension.dimension;
        if (isNaN$1(data.options.minSpacingDimension.dimension) || data.options.minSpacingDimension.dimension < 0) {
          createIssue(
            saw,
            "options.minSpacingDimension.dimension",
            "saw.validation.minSpacing.dimension.invalid",
            { minSpacingDimension: data.options.minSpacingDimension.dimension ?? "none" }
          );
        }
      }
      if ((_f = (_e = data == null ? void 0 : data.options) == null ? void 0 : _e.minSpacingDimension) == null ? void 0 : _f.minSpacing) {
        data.options.minSpacingDimension.minSpacing = typeof data.options.minSpacingDimension.minSpacing === "string" ? convertNumberFormat({ v: data.options.minSpacingDimension.minSpacing }) : data.options.minSpacingDimension.minSpacing;
        if (isNaN$1(data.options.minSpacingDimension.minSpacing) || data.options.minSpacingDimension.minSpacing < 0) {
          createIssue(
            saw,
            "options.minSpacingDimension.minSpacing",
            "saw.validation.minSpacing.invalid",
            { minSpacingDimension: data.options.minSpacingDimension.minSpacing ?? "none" }
          );
        }
      }
      if (((_h = (_g = data == null ? void 0 : data.options) == null ? void 0 : _g.minSpacingDimension) == null ? void 0 : _h.dimension) && ((_j = (_i = data == null ? void 0 : data.options) == null ? void 0 : _i.minSpacingDimension) == null ? void 0 : _j.minSpacing)) {
        if (!valueSet(data == null ? void 0 : data.bladeWidth) || data.bladeWidth <= 0) {
          createIssue(
            saw,
            "bladeWidth",
            "saw.validation.required.bladeWidthMinSpacing",
            {
              dimension: data.options.minSpacingDimension.dimension,
              minSpacing: data.options.minSpacingDimension.minSpacing
            }
          );
        }
      }
...
function getConvertedDimensions(item, caterForTrim = false) {
  var _a, _b, _c, _d;
  const l2 = typeof item.l === "string" ? convertNumberFormat({ v: item.l }) : item.l;
  const w2 = typeof item.w === "string" ? convertNumberFormat({ v: item.w }) : item.w;
  if (!caterForTrim || !isTrimmable(item) || isTrimmed(item) || isRectangle(item) && !(item == null ? void 0 : item.hasTrim)) {
    return { l: l2, w: w2 };
  }
  const trimX = convertNumberFormat({ v: ((_a = item == null ? void 0 : item.trim) == null ? void 0 : _a.x1) ?? 0 }) + convertNumberFormat({ v: ((_b = item == null ? void 0 : item.trim) == null ? void 0 : _b.x2) ?? 0 });
  const trimY = convertNumberFormat({ v: ((_c = item == null ? void 0 : item.trim) == null ? void 0 : _c.y1) ?? 0 }) + convertNumberFormat({ v: ((_d = item == null ? void 0 : item.trim) == null ? void 0 : _d.y2) ?? 0 });
  return {
    l: l2 - (typeof trimX === "string" ? convertNumberFormat({ v: trimX }) : trimX),
    w: w2 - (typeof trimY === "string" ? convertNumberFormat({ v: trimY }) : trimY)
  };
}
function getTrimmedDimensions(item, dims) {
  var _a, _b, _c, _d;
  if (isTrimmable(item) && !isTrimmed(item)) {
    dims.l = dims.l - (convertNumberFormat({ v: ((_a = item == null ? void 0 : item.trim) == null ? void 0 : _a.x1) ?? 0 }) + convertNumberFormat({ v: ((_b = item == null ? void 0 : item.trim) == null ? void 0 : _b.x2) ?? 0 }));
    dims.w = dims.w - (convertNumberFormat({ v: ((_c = item == null ? void 0 : item.trim) == null ? void 0 : _c.y1) ?? 0 }) + convertNumberFormat({ v: ((_d = item == null ? void 0 : item.trim) == null ? void 0 : _d.y2) ?? 0 }));
  }
  return dims;
}
function getRotatedDimensions(item, rot, trim2 = false) {
  let dims = {
    l: item.l,
    w: item.w
  };
  if (isInputStock(item) || isInputShape(item) || isUserGroup(item)) {
    dims = {
      l: convertNumberFormat({ v: item.l }),
      w: convertNumberFormat({ v: item.w })
    };
  }
  const currentRotation = (item == null ? void 0 : item.rot) ?? 0;
  if (trim2) {
    dims = getTrimmedDimensions(item, dims);
  }
...
function willItFit(item, container, rotation = null, saw) {
  var _a, _b;
  if (!container || !item) {
    throw new Error("Container and shape are required");
  }
  let minSpacing = 0;
  if (saw && isSaw(saw)) minSpacing = saw.minSpacing;
  else if (saw && ((_a = saw == null ? void 0 : saw.options) == null ? void 0 : _a.minSpacing)) minSpacing = convertNumberFormat({ v: saw.options.minSpacing });
  else if (isContainer(container)) minSpacing = (_b = container == null ? void 0 : container.saw) == null ? void 0 : _b.minSpacing;
  const containerDims = getConvertedDimensions(container, true);
  const itemDims = getConvertedDimensions(item, true);
  if (itemDims.l * itemDims.w > containerDims.l * containerDims.w) {
    return false;
  }
  function fitsDimension(shapeDim, containerDim) {
    return maths.equalTo(shapeDim, containerDim) || maths.lessThanOrEqualTo(shapeDim, containerDim - minSpacing * 2);
  }
  function fitsInOrientation(dims) {
    return fitsDimension(dims.l, containerDims.l) && fitsDimension(dims.w, containerDims.w);
  }
  const requiredOrientation = getNecessaryOrientation(item, container);
  if (item.orientationLock || rotation !== null) {
    const targetRotation = rotation ?? (requiredOrientation === "w" ? 1 : 0);
    const rotatedDims = getRotatedDimensions(item, targetRotation, true);
    return fitsInOrientation(rotatedDims);
  }
  const dims0 = getRotatedDimensions(item, 0, true);
  if (fitsInOrientation(dims0)) return true;
  const dims1 = getRotatedDimensions(item, 1, true);
  return fitsInOrientation(dims1);
}
function getOrientation(item) {
  let orientation = null;
  if (isGroup(item) || isUserGroup(item)) {
...
function convertShapeGrainToOrientationLock(item, container) {
  ...
  if (!stock) return orientation;
  if (!valueSet(stock == null ? void 0 : stock.grain)) return orientation;
  if (orientation === (stock == null ? void 0 : stock.grain)) return "l";
  return "w";
}
...
function getFurthestShape(shapes, axis) {
  const dimension = "l";
  const otherAxis = getReverseAxis();
  if (!(shapes == null ? void 0 : shapes.length)) return null;
  const shape = shapes.reduce((prev, current) => {
    return prev[axis] + prev[dimension] > current[axis] + current[dimension] ? prev : current;
  });
  const relevantShapes = shapes.filter((s) => s[axis] === shape[axis] && s[dimension] === shape[dimension]).sort((a, b) => a[otherAxis] - b[otherAxis]);
  return relevantShapes[0];
}
class Line {
  constructor(data) {
...
try {
  if (typeof config$1 !== "undefined" && config$1) {
    config$1.showDiff = true;
  } else {
  }
} catch (e) {
  console.warn("Error accessing chaiConfig, skipping configuration:", e);
}
createDebug("tests");
createDebug("timers");
let safeExpect;
if (typeof expect === "function") {
  ...
  const dummyChainer = new Proxy({}, { get: () => () => dummyChainer });
  safeExpect = () => dummyChainer;
}
function isDev() {
...
class Cut extends Line {
  ...
  constructor(data) {
    ...
    __publicField(this, "isGuillotine");
    __publicField(this, "guillotineData");
    __publicField(this, "ptxData");
    ...
    this.isGuillotine = data.isGuillotine;
    this.guillotineData = valueSet(data.guillotineData) ? data.guillotineData : {};
    this.ptxData = valueSet(data.ptxData) ? data.ptxData : {};
    this.isHead = valueSet(data.isHead) ? data.isHead : false;
...
function convertRaycastCollisionPointToShapePositions(shape, point, container) {
  let points = [];
  const minSpacing = shape.getMinSpacing(container.saw);
    ...
    allShapes.forEach((s, i) => {
      if (!s.isSquare() && !["l", "w"].includes(s.orientationLock)) {
        new Issue({
          ...
          message: t$2("errors.groups.part_needs_orientation_lock", { 0: i + 1 }),
          shouldTranslate: false
        });
      }
    });
    ...
    allShapes.forEach((s, i) => {
      ...
      if (!maths.equalTo(shapeDimension, referenceDimension)) {
        new Issue({
          category: ["group"],
          item: this,
          message: t$2("errors.groups.dimension_not_correct", {
            0: i + 1,
            1: joinDimension === "l" ? "length" : "width",
            2: referenceDimension,
            3: shapeDimension
          }),
          shouldTranslate: false
        });
...
function validateUserGroups(userGroups, shapeList, validateGroups = true) {
  ...
  for (const listId in tally) {
    ...
    if (!(inputShape == null ? void 0 : inputShape.q) || tallyQuantity > inputShape.q) {
      new Issue({
        category: ["group"],
        message: t$2("errors.groups.not_enough_of_part", {
          0: (inputShape == null ? void 0 : inputShape.name) ? inputShape.name : inputShapeIndex + 1,
          1: tallyQuantity,
          2: (inputShape == null ? void 0 : inputShape.q) ?? 0
        }),
        shouldTranslate: false,
        issues
      });
...
function recreateStockList({
  ...
  return stockList.filter((s) => s).map((s) => {
    if (isStock(s)) return s;
    if (preventAutoRotation || s.preventAutoRotation) s.preventAutoRotation = true;
    if (preventGrainRotation) s.preventGrainRotation = true;
    if (skipValidation) {
      s.skipValidation = true;
    }
    const stock = new Stock(s, saw);
    if (!skipValidation && stock.issues.length) {
      throw new Error(
...
function recreateShapeList({
  ...
  return shapeList.filter((s) => s).map((s) => {
    ...
    if (isGroupData(s) && ((_a = s == null ? void 0 : s.shapes) == null ? void 0 : _a.length)) {
      if (skipValidation) {
        s.shapes = s.shapes.map((shapeData) => {
          shapeData.skipValidation = true;
    ...
    if (!skipValidation && shape.issues.length) {
...
function recreateSegmentList({
  ...
  if (!(segmentList == null ? void 0 : segmentList.length)) return [];
  return segmentList.map((segmentObject) => {
    ...
    segmentObject.skipValidation = true;
...
class InputStock {
  constructor(data, numberFormat = "decimal", parseLocale = false) {
    ...
    this.id = data.id;
    this.index = data == null ? void 0 : data.index;
    this.listId = (data == null ? void 0 : data.listId) || Date.now().toString() + v4();
    if (data.skipValidation) {
      this.l = typeof data.l === "number" ? data.l : data.l ? Number(data.l) : null;
      this.w = typeof data.w === "number" ? data.w : data.w ? Number(data.w) : null;
      this.t = typeof data.t === "number" ? data.t : data.t ? Number(data.t) : null;
    } else {
      const keys = ["l", "w", "t"];
      keys.forEach((key) => this[key] = processValue(data, key, numberFormat, parseLocale));
    }
    this.q = typeof data.q === "number" ? data.q : data.q ? Number(data.q) : null;
    this.autoAdd = data.autoAdd || false;
    this.name = ((_a = data.name) == null ? void 0 : _a.length) ? (_b = sanitiseStringAnyLanguage(data == null ? void 0 : data.name)) == null ? void 0 : _b.toUpperCase() : null;
    this.material = data.material ? data.material.trim().toUpperCase() : "";
    this.trim = {
      x1: null,
      x2: null,
      y1: null,
    ...
    if (data.trim) {
      ...
      if (data.skipValidation) {
        trimKeys.forEach((key) => {
          this.trim[key] = typeof data.trim[key] === "number" ? data.trim[key] : data.trim[key] ? Number(data.trim[key]) : null;
        });
      } else {
        trimKeys.forEach((key) => {
    ...
    this.cost = typeof data.cost === "number" ? data.cost : data.cost ? Number(data.cost) : null;
    let grain2 = (_c = data == null ? void 0 : data.grain) == null ? void 0 : _c.toLowerCase();
    if (grain2 === " ") grain2 = "";
    this.grain = grain2 || "";
    this.multiEdit = data.multiEdit;
    this.allowExactFitShapes = data.allowExactFitShapes || false;
    this.preventGrainRotation = true;
    this.notes = typeof ((_d = data == null ? void 0 : data.notes) == null ? void 0 : _d.replace) === "function" ? data.notes.replace(/,/g, " ") : "";
  }
  ...
  getTrimmedDimensions() {
    const long = this.l > this.w ? this.l : this.w;
    const short = this.l < this.w ? this.l : this.w;
    const dimensions = { l: convertNumberFormat({ v: long }), w: convertNumberFormat({ v: short }) };
    return {
      name: this.name,
      id: null,
      listId: this.listId,
  ...
  validate(saw, index = null) {
    this.issues = [];
    ["l", "w", "t", "grain"].forEach((key) => validationFunctions[key]({ item: this, saw, index: index ?? this.index, category: "stock" }));
    validationFunctions.trim({ item: this, index, category: ["stock"] });
    ["q"].forEach((key) => validationFunctions[key]({ item: this, index: index ?? this.index, isWarning: true, category: "stock" }));
...
class InputShape {
  constructor(data, numberFormat = "decimal", parseLocale = false) {
    ...
    __publicField(this, "upDirection", null);
    //objects
    ...
    this.material = data.material ? data.material.trim().toUpperCase() : "";
    this.multiEdit = data.multiEdit;
    this.notes = typeof ((_c = data == null ? void 0 : data.notes) == null ? void 0 : _c.replace) === "function" ? data.notes.replace(/,/g, " ") : "";
    this.stockLock = (data == null ? void 0 : data.stockLock) || [];
    this.upDirection = (data == null ? void 0 : data.upDirection) || null;
    for (const key of Object.keys(this.trim)) {
      if (data.skipValidation) {
        this.trim[key] = typeof ((_d = data.trim) == null ? void 0 : _d[key]) === "number" ? data.trim[key] : ((_e = data.trim) == null ? void 0 : _e[key]) ? Number(data.trim[key]) : null;
      } else {
        this.trim[key] = processValue(data.trim, key, numberFormat, parseLocale);
      }
    }
    for (const key of Object.keys(this.banding)) {
      this.banding[key] = ((_f = data == null ? void 0 : data.banding) == null ? void 0 : _f[key]) || false;
    }
    for (const key of Object.keys(this.bandingOptions)) {
      this.bandingOptions[key] = ((_g = data == null ? void 0 : data.bandingOptions) == null ? void 0 : _g[key]) || {};
    }
    for (const key of Object.keys(this.finish)) {
      this.finish[key] = ((_h = data == null ? void 0 : data.finish) == null ? void 0 : _h[key]) || "";
    }
    for (const key of Object.keys(this.finishOptions)) {
      this.finishOptions[key] = ((_i = data == null ? void 0 : data.finishOptions) == null ? void 0 : _i[key]) || {};
    }
    this.orientationLock = data.orientationLock && ["l", "w"].includes(data.orientationLock.toLowerCase()) ? data.orientationLock.toLowerCase() : "";
  ...
  validate({
    ...
    this.issues = [];
    ["l", "w", "t"].forEach((key) => validationFunctions[key]({ item: this, index: index ?? this.index, saw, category: ["part"] }));
    partTrim2 = convertNumberFormat({ v: partTrim2 });
    validationFunctions.partTrim({ item: this, partTrim: partTrim2, index: index ?? this.index });
    validationFunctions.trim({ item: this, index: index ?? this.index, category: ["part"] });
    validationFunctions.machining({ item: this, index: index ?? this.index });
    ["q"].forEach((key) => {
      validationFunctions[key]({ item: this, index: index ?? this.index, isWarning: true, category: ["part"] });
    });
    if (inputStockList.length && !useInventory) {
      const tempSaw = new Saw(saw);
      validationFunctions.stockMatch({ item: this, inputStockList, saw: tempSaw, partTrim: partTrim2, index: index ?? this.index, isWarning: true });
    }
    this.issues = this.issues.filter((i) => i);
    return this.issues;
  }
...
class Rectangle {
  constructor(data) {
    ...
    __publicField(this, "identicalTo");
    __publicField(this, "hasTrim");
  ...
  validateRectangle(data) {
    ...
    this.issues = [];
    const newIssues = [];
    let toValidate = ["x", "y", "t", "w"];
    if (isGroup(this)) toValidate = ["x", "y", "t"];
    if (!(data == null ? void 0 : data.infiniteLength)) toValidate.push("l");
    toValidate.forEach((key) => newIssues.push(...validationFunctions[key]({ item: data, index: this.index })));
    this.issues.push(...validationFunctions.customData({ item: data, index: this.index }));
  ...
  initRectangle(data, update = false) {
    ...
    if (!update) {
      ...
      this.id = ((_a = data.id) == null ? void 0 : _a.toString()) || null;
      this.setParentID();
      this.q = typeof data.q === "number" ? data.q : data.q ? Number(data.q) : 0;
      this.duplicate = data.duplicate || false;
      this.offcut = data.offcut || false;
      this.infiniteLength = data.infiniteLength || false;
      if (data.skipValidation) {
        this.name = data.name || null;
        this.material = data.material || null;
        this.cost = typeof data.cost === "number" ? data.cost : data.cost ? Number(data.cost) : 0;
        this.grain = data.grain || null;
        this.notes = data.notes || "";
      } else {
        this.name = valueSet(data.name) && ((_b = data == null ? void 0 : data.name) == null ? void 0 : _b.length) ? (_c = truncateString(sanitiseStringAnyLanguage(data == null ? void 0 : data.name))) == null ? void 0 : _c.toUpperCase() : null;
        this.material = valueSet(data.material) ? data.material.trim().toLowerCase() : null;
        if (valueSet(data == null ? void 0 : data.cost)) {
          this.cost = typeof data.cost === "string" ? parseFloat(data.cost) : data.cost;
        } else {
          this.cost = 0;
        }
      ...
      this.customData = (data == null ? void 0 : data.customData) || {};
      this.proximity = { rectangle: null, distance: null };
      try {
        this.trim = (data == null ? void 0 : data.trim) || (data == null ? void 0 : data._trim);
      } catch (error) {
        if ((_d = error == null ? void 0 : error.cause) == null ? void 0 : _d.issues) this.issues.push(...error.cause.issues);
        else throw new Error(`error when attempting to set trim ${JSON.stringify(error)}`);
      }
      this.trimmed = data.trimmed || false;
      this.hasTrim = [this.trim.x1, this.trim.x2, this.trim.y1, this.trim.y2].some((value) => typeof value === "number" && value !== 0);
    }
    this.identicalTo = (data == null ? void 0 : data.identicalTo) || [];
    const unitBasedValues = [
      { key: "x", default: 0, required: false },
      { key: "y", default: 0, required: false },
      { key: "l", default: null, required: true },
      { key: "w", default: 1, required: true },
      { key: "t", default: null, required: false }
    ];
    ...
    if (!data.skipValidation && !(data == null ? void 0 : data.infiniteLength) && !(data == null ? void 0 : data.preventAutoRotation) && !data.trimmed && this.w > this.l) {
  ...
  isIdentical(rectangle, matchParentId = false) {
    ...
    if (this.t !== rectangle.t || this.orientationLock !== rectangle.orientationLock || this.material !== rectangle.material) {
      return false;
    }
    if (isShape(this) && ((_a = this.identicalTo) == null ? void 0 : _a.length)) {
      if (this.parentID === rectangle.parentID) return true;
      if (this.identicalTo.includes(rectangle.parentID)) return true;
    }
    if (!isGroup(this)) {
    ...
    if (!(w1 === w2 && l1 === l2) && !(w1 === l2 && l1 === w2)) return false;
...
class Stock extends Container {
  constructor(data, saw) {
    var _a;
    data = sanitiseData(data);
    data.preventAutoRotation = data.preventAutoRotation || ((_a = data == null ? void 0 : data.saw) == null ? void 0 : _a.stockType) === "roll";
    ...
    this.stack = valueSet(data == null ? void 0 : data.stack) ? data.stack : 1;
  ...
  validateStock(data) {
    ...
    const newIssues = [];
    if (!data.autoAdd) {
      ["q"].forEach((key) => newIssues.push(...validationFunctions[key]({ item: data, index: data == null ? void 0 : data.index })));
    }
    ["grain"].forEach((key) => newIssues.push(...validationFunctions[key]({ item: data, index: data == null ? void 0 : data.index })));
    this.issues.push(...newIssues.filter((i) => i));
  }
  /**
   * compress for saving / transfer
  ...
  getCroppedLength(shapes = [], bladeWidth = 0) {
    if (!(shapes == null ? void 0 : shapes.length)) return;
    const furthestShape = getFurthestShape(shapes.filter((s) => s.added && s.stock.id === this.id), "x");
    const furthestShapePosition = furthestShape.x + furthestShape.l;
    if (furthestShapePosition > this.l) throw new Error("Furthest shape position exceeds stock length");
    if (maths.equalTo(furthestShapePosition, this.l)) {
      return furthestShapePosition;
    }
    return furthestShapePosition + bladeWidth;
  }
}
class Offcut extends Rectangle {
  ...
  getCost() {
    ...
    if ((_a = this.stock) == null ? void 0 : _a.isStock())
      return this.stock ? parseFloat((this.area / this.stock.area * this.stock.cost).toFixed(2)) : 0;
    return 0;
  }
}
function recreateOffcuts({
  ...
  return offcuts.map((offcutObject) => {
    offcutObject.skipValidation = true;
    const stock = stockList.find((stock2) => {
      var _a;
...
class Shape extends Rectangle {
  ...
  constructor(data) {
    ...
    //objects
    __publicField(this, "machining");
    __publicField(this, "fitsStock");
    __publicField(this, "upDirection");
  ...
  initShape(data, update = false) {
    ...
    if (!update) {
      ...
      if (data.skipValidation) {
        this.orientationLock = data.orientationLock || null;
        this.stockLock = Array.isArray(data.stockLock) ? data.stockLock : [];
      } else {
      ...
      this.machining = data.machining ? new Machining$1(data.machining) : null;
      this.fitsStock = data.fitsStock || null;
      this.upDirection = data.upDirection || null;
    }
    this.added = data.added || false;
    this.initGuillotineData(data);
    this.inGroup = data.inGroup || this.inGroup || false;
    this.inUserGroup = data.inUserGroup || this.inUserGroup || false;
    this.groupID = data.groupID || this.groupID || null;
    this.addedAsGroup = data.addedAsGroup || this.addedAsGroup || false;
    this.score = data.score || this.score || null;
    ...
    this.placementOrder = data.placementOrder || this.placementOrder || null;
    this.groupPlacementOrder = data.groupPlacementOrder || this.groupPlacementOrder || null;
    this.minSpacing = data.minSpacing ?? (this.minSpacing || 0);
    this.priority = data.priority || {};
  }
  initGuillotineData(data) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p;
    this.guillotineData = {
      firstShape: ((_a = data == null ? void 0 : data.guillotineData) == null ? void 0 : _a.firstShape) || ((_b = this == null ? void 0 : this.guillotineData) == null ? void 0 : _b.firstShape) || false,
      myPhase: ((_c = data == null ? void 0 : data.guillotineData) == null ? void 0 : _c.myPhase) || ((_d = this == null ? void 0 : this.guillotineData) == null ? void 0 : _d.myPhase) || null,
      myStripParent: ((_e = data == null ? void 0 : data.guillotineData) == null ? void 0 : _e.myStripParent) || ((_f = this == null ? void 0 : this.guillotineData) == null ? void 0 : _f.myStripParent) || null,
      myStripDirection: ((_g = data == null ? void 0 : data.guillotineData) == null ? void 0 : _g.myStripDirection) || ((_h = this == null ? void 0 : this.guillotineData) == null ? void 0 : _h.myStripDirection) || null,
      stripShapeBatches: {
        subsetUsed: ((_j = (_i = data == null ? void 0 : data.guillotineData) == null ? void 0 : _i.stripShapeBatches) == null ? void 0 : _j.subsetUsed) || ((_l = (_k = this == null ? void 0 : this.guillotineData) == null ? void 0 : _k.stripShapeBatches) == null ? void 0 : _l.subsetUsed) || false,
        groups: ((_n = (_m = data == null ? void 0 : data.guillotineData) == null ? void 0 : _m.stripShapeBatches) == null ? void 0 : _n.groups) || ((_p = (_o = this == null ? void 0 : this.guillotineData) == null ? void 0 : _o.stripShapeBatches) == null ? void 0 : _p.groups) || {}
      }
    };
  }
  cloneGuillotineData() {
  ...
  getMinSpacing(saw, removeBlade = false) {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    const bladeWidth = saw.bladeWidth;
    if (saw.cutType !== "efficiency") {
      if (removeBlade) return 0;
      return bladeWidth;
    }
    if (this.minSpacing > 0) return this.minSpacing;
    let minSpacing = (saw == null ? void 0 : saw.minSpacing) || 0;
    if (bladeWidth > minSpacing) minSpacing = bladeWidth;
    if (((_b = (_a = saw.options) == null ? void 0 : _a.minSpacingDimension) == null ? void 0 : _b.dimension) && ((_d = (_c = saw.options) == null ? void 0 : _c.minSpacingDimension) == null ? void 0 : _d.minSpacing)) {
      const minDimension = (_f = (_e = saw.options) == null ? void 0 : _e.minSpacingDimension) == null ? void 0 : _f.dimension;
      if (this.l <= minDimension || this.w <= minDimension) {
        minSpacing = ((_h = (_g = saw.options) == null ? void 0 : _g.minSpacingDimension) == null ? void 0 : _h.minSpacing) || minSpacing;
      }
    }
    if (removeBlade) {
  ...
  validateShape(data) {
    ...
    const newIssues = [];
    ["q", "orientationLock", "banding"].forEach((key) => newIssues.push(...validationFunctions[key]({ item: data, index: data == null ? void 0 : data.index })));
    this.issues.push(...newIssues.filter((i) => i));
    if (this.machining) {
  ...
  addToStock(stock) {
    ...
    test([
      () => safeExpect(this.isInsideStock(stock), `shape ${this.id} is not inside stock ${stock.id}`).to.be.true
    ]);
  }
  removeFromStock() {
  ...
  getPerimeterCutVectors(offset2 = null) {
    var _a;
    if (offset2 === null) {
      offset2 = ((_a = this.stock) == null ? void 0 : _a.isStock()) ? this.stock.getBladeWidth() / 2 : 0;
    }
    const vectors = [
      //bottom
      {
  ...
  willItFit(container, rotation = null) {
    var _a, _b, _c;
    if (isStock(container) && typeof ((_a = this.fitsStock) == null ? void 0 : _a[container.parentID]) !== "undefined") {
      return ((_c = (_b = this.fitsStock) == null ? void 0 : _b[container.parentID]) == null ? void 0 : _c[rotation ?? "any"]) === true;
    }
...
class Segment extends Container {
  constructor(data) {
    ...
    __publicField(this, "hasHeadCut");
    __publicField(this, "isInitial");
    this.validateSegment(data);
    delete this.trim;
    delete this.trimmed;
    this.parentID = data.parentID || null;
    this.shapes = data.shapes || [];
    this.firstShape = data.firstShape || null;
    this.cuts = [];
    ...
    this.placementOrder = null;
    this.cutDirection = data.cutDirection || null;
    this.hasBeamTrim = data.hasBeamTrim || false;
    this.hasHeadCut = data.hasHeadCut || false;
  ...
  save() {
    ...
    this.children = this.children.map((c) => {
      ...
      return {
        id: c.id,
        parentID: (_a2 = c.parent) == null ? void 0 : _a2.id,
        x: c.x,
        y: c.y,
        l: c.l,
        w: c.w,
        ...
        hasHeadCut: c.hasHeadCut,
        cutDirection: c.cutDirection,
        phase: c.phase
      };
    });
    this.stockId = (this == null ? void 0 : this.stockId) ?? ((_a = this == null ? void 0 : this.stock) == null ? void 0 : _a.id);
    this.parentID = (_b = this == null ? void 0 : this.parent) == null ? void 0 : _b.id;
    delete this.stock;
    delete this.shapes;
    delete this.saw;
...
class Group extends Shape {
  ...
  constructor(data) {
    ...
    __publicField(this, "groupLength", 0);
    // Total length of all shapes along the grouping direction
    __publicField(this, "groupWidth", 0);
    this.q = 1;
    ...
    this.groupLength = data.groupLength || 0;
    this.groupWidth = data.groupWidth || 0;
    this.initGroup();
  }
  // Static utility method to update group dimensions
  static updateGroupDimensions(group) {
    const groupAxis = getAxisFromDimension(group.direction);
    if (groupAxis === "x") {
      group.l = group.groupLength;
      group.w = group.groupWidth;
    } else {
      group.l = group.groupWidth;
      group.w = group.groupLength;
    }
  }
  initGroup() {
    var _a;
    if (!((_a = this == null ? void 0 : this.shapes) == null ? void 0 : _a.length)) return;
    this.shapes = this.shapes.filter((s) => s);
    this.setShapePositions();
    if (this.container) {
      this.efficiency = this.groupLength / this.container[this.direction];
    }
  }
  setShapePositions() {
    ...
    for (const s of this.shapes) {
      ...
      s.inGroup = true;
      currentPosition += i === this.shapes.length - 1 ? s[this.direction] : s[this.direction] + s.getMinSpacing(this.container.saw);
      i++;
    }
    this.groupLength = currentPosition;
    const secondaryDimension = getReverseDimension(this.direction);
    const largestShapeInOtherDirection = this.shapes.reduce(
      (max, shape) => shape[secondaryDimension] > max ? shape[secondaryDimension] : max,
      0
    );
    this.groupWidth = largestShapeInOtherDirection;
    Group.updateGroupDimensions(this);
    if (isDev()) {
      const totalSpacing = this.shapes.slice(0, -1).reduce((total, shape) => total + shape.getMinSpacing(this.container.saw), 0);
      ...
      test([
        () => safeExpect(
          maths.equalTo(totalInDirection, this.groupLength),
  ...
  destroy() {
    super.reset(false, true, false);
    for (const s of this.shapes) s.reset(false, true, false);
  }
  reset(keepScores = false, keepGuillotineBatchData = true, keepGroupData = false) {
    super.reset(keepScores, keepGuillotineBatchData, keepGroupData);
    for (const s of this.shapes) s.reset(keepScores, keepGuillotineBatchData, keepGroupData);
  }
  /**
  ...
  placeMyShapes(stock) {
    ...
    for (let i = 0; i < this.shapes.length; i++) {
      ...
      if (i === 0 && this.x === 0 && this.y === 0) s.isFirstShape = true;
  ...
  compress() {
    ...
    clone.l = this.l;
    clone.w = this.w;
    clone.groupLength = this.groupLength;
    clone.groupWidth = this.groupWidth;
    return clone;
  }
}
...
function isTrimmable(s) {
  return isShape(s) || isStock(s) || isInputShape(s) || isInputStock(s);
}
function isTrimmed(s) {
  if (isInputShape(s) || isInputStock(s)) return false;
  if (isShape(s) || isStock(s)) {
    return s.trimmed;
  }
  return false;
}
...
const validateInputs = (options = {}) => {
  ...
  issues.push(...validateInputShapes({
    ...
    inputShapesOverride: normalizedOptions.inputShapes
  }));
  const errors = getErrors(issues);
  if (errors.length > 0) {
    console.warn("[Validation] errors:", JSON.parse(JSON.stringify(errors)));
    const additional = errors.map((e) => {
      var _a;
      let message = "";
      if ((_a = e == null ? void 0 : e.index) == null ? void 0 : _a.length) {
        message += e.getHumanReadableIndexes() + ": ";
      }
      message += t2(e.message);
      return message;
    });
    addNotice({
      type: "error",
      message: t2("errors.validation.inputs_issue_generic"),
      additional
    });
  }
  return issues;
};
const validateMaterials = (materialStore, shapesToValidate, useInventory = false) => {
  var _a;
  if (!useInventory) return [];
  const issues = [];
  for (let i = shapesToValidate.length - 1; i >= 0; i--) {
    const shape = shapesToValidate[i];
    if (!shape) continue;
    ...
    if ((_a = material == null ? void 0 : material.t) == null ? void 0 : _a.length) {
      if (!shape.t) {
        issues.push(new Issue({
          item: shape,
          category: ["part"],
...
const cleanEmptyShapes = (shapes) => {
  return shapes.filter((shape) => (shape == null ? void 0 : shape.l) || (shape == null ? void 0 : shape.w));
};
async function validateAndPrepare(rawOptions) {
  var _a, _b;
  const options = normaliseOptions(rawOptions);
  const t2 = options.t;
  if (options.inputShapes) {
    options.inputShapes = cleanEmptyShapes(options.inputShapes);
  }
  let issues = [];
  try {
    issues = validateInputs(options);
    if ((issues == null ? void 0 : issues.length) && issues.some((i) => i.type === "error")) {
      return { valid: false, issues };
    }
    const shapesToValidate = options.inputShapes ?? inputs.inputShapes.value;
    ...
    if (!options.useInventory) {
      ...
      if (stockErrors.length > 0) {
        addNotice({
          type: "error",
          message: t2("errors.validation.inputs_issue", { 0: "stock" }),
          additional: stockErrors.map((i) => t2(i.message))
        });
        return { valid: false, issues };
      }
    } else {
      const materialIssues = validateMaterials(options.materialStore, shapesToValidate, true);
      const materialErrors = getErrors(materialIssues);
      if (materialErrors.length > 0) {
        addNotice({
          type: "error",
          message: t2("errors.validation.inputs_issue", { 0: "material" }),
    ...
    if (sawErrors.length > 0) {
      addNotice({
        type: "error",
        message: t2("errors.validation.inputs_issue", { 0: "saw" }),
    ...
    if (!(stockList == null ? void 0 : stockList.length)) {
      addNotice({
        type: "error",
        message: t2("errors.validation.no_stock")
      });
      return { valid: false, issues };
    }
    const { shapeList, issues: shapeListIssues } = await createShapeList({
      orientationModel: options.orientationModel,
      trim: options.partTrim,
      inputShapesOverride: shapesToValidate
    ...
    if (shapeListErrors.length > 0) {
      addNotice({
        type: "error",
        message: t2("errors.validation.inputs_issue", { 0: "part" }),
    ...
    if (!(shapeList == null ? void 0 : shapeList.length)) {
      addNotice({
        type: "error",
        message: t2("errors.validation.no_parts_list")
      });
      return { valid: false, issues };
    }
    if (((_b = (_a = inputs.userGroups) == null ? void 0 : _a.value) == null ? void 0 : _b.length) > 0) {
      inputs.userGroups.value.forEach((group) => group.populateParentID(shapesToValidate));
      ...
      if (userGroupErrors.length > 0) {
        addNotice({
          type: "error",
          message: t2("errors.validation.inputs_issue", { 0: "group" }),
    ...
    addNotice({
      type: "error",
      message: t2("errors.general.unexpected"),
...
const _hoisted_2$c = ["onMousedown"];
const _hoisted_3$b = { class: "id" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$k, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(props.stockList, (stock, index) => {
          return openBlock(), createElementBlock("button", {
            type: "button",
            key: index,
            class: normalizeClass(["c-btn nav-button", { selected: stock.id === props.activeStockId }]),
            ...
            createBaseVNode("div", _hoisted_3$b, toDisplayString(index + 1), 1),
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$j, [
    ...
    $props.showNumber ? (openBlock(), createElementBlock("div", _hoisted_3$a, toDisplayString($props.number), 1)) : createCommentVNode("", true)
  ]);
}
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        type: "button",
        id: _ctx.id,
        class: normalizeClass(["c-btn orientation-button", { rot: shouldRotate.value, square: isSquare2.value, disabled: _ctx.disabled, [icon.value]: true }]),
        tabindex: "0",
        "aria-label": "Part orientation",
        onClick: click
      }, [
        icon.value === "delete" ? (openBlock(), createElementBlock("svg", _hoisted_2$a, _cache[0] || (_cache[0] = [
          createBaseVNode("path", { d: "M144 0L128 32H0V96H448V32H320L304 0H144zM416 128H32L56 512H392l24-384z" }, null, -1)
        ]))) : createCommentVNode("", true),
        icon.value === "freeRotation" ? (openBlock(), createElementBlock("svg", _hoisted_3$9, _cache[1] || (_cache[1] = [
        ...
        icon.value === "leftRight" ? (openBlock(), createElementBlock("svg", _hoisted_4$9, _cache[2] || (_cache[2] = [
          createBaseVNode("g", null, [
        ...
        icon.value === "topBottom" ? (openBlock(), createElementBlock("svg", _hoisted_5$7, _cache[3] || (_cache[3] = [
          createBaseVNode("g", null, [
        ...
        icon.value === "grainLeftRight" ? (openBlock(), createElementBlock("svg", _hoisted_6$5, _cache[4] || (_cache[4] = [
          createBaseVNode("g", null, [
        ...
        icon.value === "grainTopBottom" ? (openBlock(), createElementBlock("svg", _hoisted_7$3, _cache[5] || (_cache[5] = [
          createBaseVNode("g", null, [
...
const validateTypingInput = (value, type, numberFormat) => {
  if (type === "unitDependent") {
    if (numberFormat === "fraction") {
      if (/\/0$/.test(value)) {
        return {
          value,
          valid: false,
      ...
      const isValidPartial = /^-?\d*(\s+\d*)?(\/\d*)?$/.test(value);
      const isValidComplete = detectFraction(value);
      return {
        value,
        valid: isValidPartial || isValidComplete
      };
    } else {
      const regex = /^-?\d*\.?\d*$/;
      const isValid = regex.test(value);
      if (isValid && value !== "" && value !== "-" && value !== "." && !value.endsWith(".")) {
...
function useTextInputProcessor({
  ...
  const processValue2 = (inputValue, isTyping = false) => {
    if (inputValue === void 0 || inputValue === null || inputValue === "") {
      const shouldValidateRequired = props.required && !props.disableRequiredValidation;
      return validateNumericInput(inputValue, "decimal", shouldValidateRequired);
    }
    ...
    switch (props.type) {
      ...
      case "unitDependent":
        if (isTyping) {
          return validateTypingInput(stringValue, props.type, props.numberFormat);
        }
        try {
          const converted = convertNumberFormat({
            v: inputValue,
            nf: props.numberFormat,
            dp: props.decimalPlaces,
            fr: props.fractionRoundTo
          });
          if (typeof converted === "number") {
            let result = converted;
            let valid = true;
            let message;
            if (props.allowZero === false && result === 0) {
              return {
                value: null,
                valid: false,
                message: "zero_not_allowed"
            ...
            return { value: result, valid, message };
          }
      ...
      case "float":
        if (isTyping) {
          return validateTypingInput(stringValue, props.type);
        }
        try {
          const targetFormat = "decimal";
          const converted = convertNumberFormat({
            v: inputValue,
            nf: targetFormat
          });
          ...
          if (props.allowZero === false && num === 0) {
            return {
              value: null,
              valid: false,
              message: "zero_not_allowed"
          ...
          return { value: num, valid, message };
        } catch {
          return {
            value: null,
            valid: false,
  ...
  const shouldEmitValue = (result, isTyping = false) => {
    if (isTyping && props.type === "unitDependent" && props.numberFormat === "fraction") {
      return false;
    }
    if (isTyping && (props.type === "integer" || props.type === "float" || props.type === "unitDependent" && props.numberFormat === "decimal")) {
      return typeof result.value === "number" && result.valid;
    }
    if (result.valid) return true;
    if (result.message === "below_min" || result.message === "above_max") return true;
    if (result.message === "field_required" && !props.disableRequiredValidation) return true;
    return false;
  };
  const handlers = {
    ...
    handleMouseDown: () => {
      ...
      state.value.isMouseDown = true;
    },
    //Handler to reset the flag on mouse up
    handleMouseUp: () => {
      if (!isMounted.value) return;
      state.value.isMouseDown = false;
    },
    handleInput: (event) => {
      if (!isMounted.value) return;
      const target = event.target;
      if (state.value.isMouseDown) {
        const processedValue2 = processValue2(target.value, false);
        if (shouldEmitValue(processedValue2, false)) {
          emit("update:value", processedValue2.value);
          emit("validation", processedValue2, props.id);
        }
        state.value.isMouseDown = false;
        return;
      }
      state.value.isTyping = true;
      const processedValue = processValue2(target.value, true);
      emit("validation", processedValue, props.id);
      emit("input", target.value);
      if (shouldEmitValue(processedValue, true)) {
    ...
    handleBlur: (event) => {
      ...
      emit("validation", processedValue, props.id);
      if (shouldEmitValue(processedValue)) {
        emit("update:value", processedValue.value);
        state.value.lastValidValue = String(processedValue.value ?? "");
      }
      emit("blur", event);
    },
    handleFocus: (event) => {
    ...
    handlePaste: (event) => {
      ...
      if (props.type === "unitDependent" && props.numberFormat === "fraction") {
        const cleanedText = pastedText.replace(/[""'']/g, "").replace(/\s+/g, " ");
        if (!detectFraction(cleanedText)) {
          event.preventDefault();
          emit("validation", {
            value: cleanedText,
            valid: false,
            message: `Pasted text "${pastedText}" is not a valid fraction format`
          }, props.id);
          return;
        }
        if (cleanedText !== pastedText) {
          ...
          const cleanedValidation = processValue2(cleanedText, true);
          emit("validation", cleanedValidation, props.id);
...
function useSelectInputProcessor({
  ...
  const processValue2 = (inputValue) => {
    if (!(props == null ? void 0 : props.output) || props.output === "string") {
      return {
        value: inputValue,
        valid: true
      };
    ...
    if (props.options && props.options.length > 0) {
      ...
      const validOption = props.options.some((option) => option.value === processedValue);
      if (!validOption) {
        return {
  ...
  return {
    ...
    handleSelectChange: (event) => {
      ...
      const processedValue = processValue2(target.value);
      emit("validation", processedValue, props.id);
...
const _hoisted_1$g = ["id", "name", "value", "inputmode", "type", "placeholder", "disabled", "default", "readonly", "min", "max", "aria-label", "aria-invalid", "aria-describedby"];
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    decimalPlaces: {},
    fractionRoundTo: {},
    disableRequiredValidation: { type: Boolean, default: false }
  },
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("input", mergeProps(_ctx.$attrs, {
        ...
        onMouseup: _cache[8] || (_cache[8] = //@ts-ignore
...
const _hoisted_2$9 = ["disabled", "selected"];
const _hoisted_3$8 = {
  key: 0,
  value: " "
};
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("select", mergeProps(_ctx.$attrs, {
        ...
        }, toDisplayString(((_b = (_a = props.text) == null ? void 0 : _a.select) == null ? void 0 : _b.toUpperCase()) ?? "SELECT"), 9, _hoisted_2$9),
...
const _hoisted_3$7 = ["disabled", "selected"];
const _hoisted_4$7 = {
  key: 0,
  value: " "
};
const _hoisted_5$6 = ["hidden", "value", "disabled"];
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const textInputProps = computed(() => ({
      ...
      default: props.default,
      disableRequiredValidation: props.disableRequiredValidation
    }));
    ...
    watch(() => props.numberFormat, (newFormat, oldFormat) => {
      ...
      if (props.type === "unitDependent" && newFormat !== oldFormat && props.value !== null && props.value !== void 0 && props.value !== "") {
        try {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.type === "checkbox" ? (openBlock(), createElementBlock("div", _hoisted_2$7, [
          ...
          _ctx.type === "checkbox" ? (openBlock(), createBlock(_sfc_main$h, mergeProps({
            key: 1,
            ref: setInputRef,
            type: "checkbox"
          ...
          }), null, 16, ["checked"])) : createCommentVNode("", true),
          ...
          isTextualInput.value ? (openBlock(), createBlock(_sfc_main$i, mergeProps({
            ...
            "disable-required-validation": _ctx.disableRequiredValidation,
            onValidation: handleValidation,
            "onUpdate:value": handleValueUpdate
          }), null, 16, ["input-type", "input-mode", "value", "disable-required-validation"])) : _ctx.type === "select" ? (openBlock(), createBlock(_sfc_main$g, mergeProps({
            key: 2,
            ref: setInputRef
            ...
            default: withCtx(() => {
              ...
              return [
                createBaseVNode("option", {
                  ...
                  selected: !_ctx.value
                }, toDisplayString(((_b = (_a = _ctx.text) == null ? void 0 : _a.select) == null ? void 0 : _b.toUpperCase()) ?? "SELECT"), 9, _hoisted_3$7),
                _ctx.multiEdit ? (openBlock(), createElementBlock("option", _hoisted_4$7, toDisplayString(((_d = (_c = _ctx.text) == null ? void 0 : _c.delete) == null ? void 0 : _d.toUpperCase()) ?? "DELETE"), 1)) : createCommentVNode("", true),
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const columnsStyle = computed(() => {
      ...
      return `repeat(${cols - 1}, max-content) 1fr`;
    });
    ...
    return (_ctx, _cache) => {
      ...
      return !preFlightIssues.value ? (openBlock(), createElementBlock("div", {
        ...
        _ctx.allOptions.length === 1 && _ctx.allOptions[0].length === 1 ? (openBlock(), createElementBlock("div", _hoisted_1$b, [
          createBaseVNode("div", _hoisted_2$6, toDisplayString((_b = (_a = _ctx.allOptions) == null ? void 0 : _a[0]) == null ? void 0 : _b[0]), 1),
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.extraKeys, (key) => {
            ...
            return openBlock(), createElementBlock("div", { key }, [
              ((_a2 = _ctx.labels) == null ? void 0 : _a2[0]) && ((_c2 = (_b2 = _ctx.shape) == null ? void 0 : _b2[extraOptionsKey.value]) == null ? void 0 : _c2[key]) && _ctx.labels[0] in _ctx.shape[extraOptionsKey.value][key] ? (openBlock(), createBlock(_sfc_main$e, {
                ...
                type: "checkbox",
                output: "string",
                label: unref(t$1)(((_d2 = _ctx.userFriendlyFieldMap) == null ? void 0 : _d2[key]) || key),
          ...
          ((_h = _ctx.shape) == null ? void 0 : _h[extraOptionsKey.value]) && "all" in _ctx.shape[extraOptionsKey.value] ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            createBaseVNode("div", _hoisted_3$6, toDisplayString(unref(t$1)("general.all")), 1),
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.extraKeys, (option) => {
            ...
            return openBlock(), createElementBlock(Fragment, { key: option }, [
              ((_a2 = _ctx.shape) == null ? void 0 : _a2[extraOptionsKey.value]) && option in _ctx.shape[extraOptionsKey.value] ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                createBaseVNode("div", _hoisted_4$6, toDisplayString(unref(t$1)(((_b2 = _ctx.userFriendlyFieldMap) == null ? void 0 : _b2[option]) || option)), 1),
              ...
              createBaseVNode("button", {
                ...
                createVNode(_component_FontAwesomeIcon, { icon: ["fass", "trash"] })
              ], 8, _hoisted_5$5),
              createBaseVNode("div", _hoisted_6$4, toDisplayString(getPrice(option) || unref(t$1)("general.na").toUpperCase()), 1)
            ], 64);
          }), 128))
        ], 4)),
        createBaseVNode("button", {
          type: "button",
          class: "c-btn c-btn--delete",
          "aria-label": `${unref(t$1)("actions.delete")} ${unref(lowerCase)(unref(t$1)("woodwork." + _ctx.extraLabel))}`,
          onClick: _cache[1] || (_cache[1] = () => unref(removeExtras)(_ctx.shape, _ctx.extraType, true))
        }, [
          createVNode(_component_FontAwesomeIcon, { icon: ["fass", "trash"] }),
          createTextVNode(" " + toDisplayString(`${unref(t$1)("actions.delete")} ${unref(lowerCase)(unref(t$1)("woodwork." + _ctx.extraLabel))}`), 1)
        ], 8, _hoisted_7$2)
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("button", {
        id: _ctx.id,
        class: normalizeClass(["c-btn finish-button", {
        ...
        createVNode(_component_FontAwesomeIcon, { icon: ["fass", "spray-can"] })
      ], 10, _hoisted_1$a);
    };
  }
});
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("button", {
    id: _ctx.id,
    class: normalizeClass(["c-btn machining-button", { "selected": _ctx.hasMachining }]),
    type: "button",
    disabled: _ctx.disabled,
    onClick: _cache[0] || (_cache[0] = (...args) => _ctx.openMachining && _ctx.openMachining(...args))
  }, [
    createVNode(_component_FontAwesomeIcon, { icon: ["fass", "hammer"] })
  ], 10, _hoisted_1$9);
}
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$8, [
        ...
        createBaseVNode("button", {
          ...
          createVNode(_component_FontAwesomeIcon, { icon: ["fass", "files"] })
        ]),
...
const ImageUpload = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-766ba983"]]);
function addShapeAxes(shape) {
  ...
  const shapeAxisSpacing = 8;
  if (this.axes.shapeXAxis) {
    this.axes.shapeXAxis.attr("transform", `translate(0, ${this.state.h - this.state.padding + shapeAxisSpacing})`).call(axisBottom(xScale).tickValues(xScale.domain()).tickSize(4).tickFormat(this.formatNumber));
  } else {
    this.axes.shapeXAxis = this.selections.axisGroup.append("g").attr("transform", `translate(0, ${this.state.h - this.state.padding + shapeAxisSpacing})`).attr("class", "axis shape x").call(axisBottom(xScale).tickValues(xScale.domain()).tickSize(4).tickFormat(this.formatNumber));
  }
  if (((_b = (_a = shape == null ? void 0 : shape.stock) == null ? void 0 : _a.saw) == null ? void 0 : _b.stockType) !== "linear") {
    if (this.axes.shapeYAxis) {
      this.axes.shapeYAxis.attr("transform", `translate(${this.state.padding - shapeAxisSpacing}, 0)`).call(axisLeft(yScale).tickValues(yScale.domain()).tickSize(4).tickFormat(this.formatNumber));
    } else {
      this.axes.shapeYAxis = this.selections.axisGroup.append("g").attr("transform", `translate(${this.state.padding - shapeAxisSpacing}, 0)`).attr("class", "axis shape y").call(axisLeft(yScale).tickValues(yScale.domain()).tickSize(4).tickFormat(this.formatNumber));
    }
...
function createShapeLabels() {
  this.selections.shapeIDText = this.selections.shapeWrappers.selectAll("text.shape-text.id").data((d) => [d]).join(
    ...
    (update) => update.text((shape) => getShapeIdText.call(this, shape)).attr("x", (s) => this.getRectangleCoordinate(s, "x", "center")).attr("y", (s) => this.getRectangleCoordinate(s, "y", "center")).attr("dy", 1)
  );
  this.selections.shapeNameText = this.selections.shapeWrappers.selectAll("text.shape-text.name").data((d) => [d]).join(
    ...
    (update) => update.text((shape) => getShapeNameText.call(this, shape)).call(this.trimNameToFit, this).classed("hidden", (shape, b, c) => this.isNameHidden(shape, b, c)).attr("x", (s) => this.getRectangleCoordinate(s, "x", "center")).attr("y", (s, b, c) => {
      const node = c[b];
      return this.getRectangleCoordinate(
        s,
        "y",
  ...
  this.selections.shapeWidthText = this.selections.shapeWrappers.selectAll("text.shape-text.width").data((d) => [d]).join(
    ...
    (update) => update.text((shape) => getShapeWidthText.call(this, shape)).classed("hidden", (shape, b, c) => this.isWidthHidden(shape, b, c)).attr("transform", (s, b, c) => {
      const node = c[b];
      const x2 = this.getRectangleCoordinate(
        s,
        "x",
...
function getShapeLengthText(shape) {
  if (this.state.env === "development" && this.state.debug === "guillotine") return "";
...
function setupShapes() {
  ...
  drawBanding.call(this, this.props.shapes.value);
...
function createShapeRectangles(selection) {
  const newRectangles = selection.selectAll("rect.shape").data((d) => [d]).join("rect").attr("class", "shape").attr("x", (s) => this.getRectangleCoordinate(s, "x")).attr("y", (s) => this.getRectangleCoordinate(s, "y")).attr("width", (s) => this.getWidthAttribute(s)).attr("height", (s) => this.getHeightAttribute(s)).style("fill", (s) => {
    return getShapeColor.call(this, s);
  });
...
function setupHoverEvents(selection) {
  ...
  selection.on("mouseover", (event) => {
    ...
    if (!target.classed("selected")) {
      target.style("fill", this.config.colors.partSelected.toString());
    }
  }, { passive: true }).on("mouseout", (event, shape) => {
    const target = select(event.target);
    target.classed("hover", false);
    if (!target.classed("selected")) {
      target.style("fill", getShapeColor.call(this, shape));
    }
  }, { passive: true });
}
  ...
  if (shape) {
    ...
    switch (this.state.debug) {
      ...
      case "score":
        ...
        break;
      default:
        logProperties = ["id", "placementOrder", "priority", "addedAsGroup", "bestScore.score", "upDirection"];
    }
    console.table(getShapeProperties(shape, logProperties));
    console.log(shape.bestScore.score);
  }
}
...
function handleAppModeClick(event, shape) {
  ...
  if (this.settings.app || this.settings.embed) {
    const eventData = {
      ...
      color: getShapeColor.call(this, shape),
      notes: shape == null ? void 0 : shape.notes
    };
    if (typeof this.callbacks.onPartClick === "function") {
      this.callbacks.onPartClick(eventData);
    }
...
function getShapeColor(shape) {
  var _a;
  const fallbackRgb = rgb(204, 204, 204);
  if (this.state.env === "development") {
    switch (this.state.debug) {
      case "guillotine":
      ...
      case "priorityShapes":
        ...
        break;
      case "score": {
        const scoreColorResult = this.scales.scoreColorScale(shape.bestScore.total);
        if (scoreColorResult != null && typeof scoreColorResult.toString === "function") {
          return scoreColorResult;
        } else if (scoreColorResult != null && typeof scoreColorResult.r === "number" && typeof scoreColorResult.g === "number" && typeof scoreColorResult.b === "number") {
          console.warn("Detected corrupted score color object from scale:", scoreColorResult, "for shape:", shape);
          return rgb(scoreColorResult.r, scoreColorResult.g, scoreColorResult.b, scoreColorResult.opacity ?? 1);
        } else {
          console.warn("Score color scale returned null, undefined, or unexpected value:", scoreColorResult, "for shape:", shape);
          return fallbackRgb;
        }
      }
    }
  ...
  const parentId = parseInt(shape.parentID);
  let scaleResult;
  if (this.scales.shapeColorScale && typeof this.scales.shapeColorScale === "function") {
    scaleResult = this.scales.shapeColorScale(parentId);
  } else {
    console.error("shapeColorScale is not initialized or is not a function!", this.scales.shapeColorScale);
    scaleResult = null;
  }
  if (scaleResult != null && typeof scaleResult.toString === "function") {
    return scaleResult;
  }
  if (scaleResult != null && typeof scaleResult.r === "number" && typeof scaleResult.g === "number" && typeof scaleResult.b === "number") {
    return rgb(scaleResult.r, scaleResult.g, scaleResult.b, scaleResult.opacity ?? 1);
  }
  console.warn("Shape color scale returned null, undefined, or unexpected non-color value for shape:", shape, scaleResult);
  return fallbackRgb;
}
function createBandingData(shapes) {
  const bandingData = [];
  for (const shape of shapes) {
    if (shape.added && (shape == null ? void 0 : shape._banding)) {
...
function drawBanding(shapes) {
  ...
  if (bandingData.length === 0) {
    this.selections.bandingGroup.selectAll("line").remove();
    this.selections.bandingWrappers = null;
    return;
  }
  this.selections.bandingWrappers = this.selections.bandingGroup.selectAll("line").data(bandingData, (d, i) => i).join(
...
const stockHash = (stock) => stock.id;
...
function drawSegments({ parent, near, far }) {
  if (!this.props.containerWidth)
    return false;
  const segments = [parent, near, far].filter((segment) => segment);
  ...
  if (this.state.env === "development") {
    addSegmentLabels.call(this, segments);
  }
...
function applySegmentAttributes(selection) {
  return selection.classed("offcut", (segment) => segment.offcut).classed("near", (segment) => segment.segmentType === "near").classed("far", (segment) => segment.segmentType === "far").classed("parent", (s, index) => s.id !== "root" && index === 0).attr("x", (segment) => this.getRectangleCoordinate(segment, "x")).attr("y", (segment) => this.getRectangleCoordinate(segment, "y")).attr("width", (segment) => this.getWidthAttribute(segment)).attr("height", (segment) => this.getHeightAttribute(segment));
}
...
function applyLabelAttributes(selection) {
  return selection.attr("x", (segment) => this.getRectangleCoordinate(segment, "x", "center")).attr("y", (segment) => this.getRectangleCoordinate(segment, "y", "center")).attr("text-anchor", "middle").attr("dominant-baseline", "middle");
}
function setupSegmentDebugEvents() {
  this.selections.segmentRectangles.on("mousedown", function(event, segment) {
    console.log("segment", `[${(segment == null ? void 0 : segment.parentID) || "-"}]->[${segment.id}] {P${segment.phase}} ${segment.l}x${segment.w} ${segment.cutDirection} ${segment.hasHeadCut ? "HEAD" : "NORM"}`);
  });
}
function getCutSegments(cut) {
  ...
  let parent;
  if (parentSegmentID) {
    parent = this.props.segments.value.find((s) => s.id === parentSegmentID);
  } else {
    parent = this.props.segments.value.find((s) => s.segmentType === "root");
  }
...
const { currentCutIndex } = useResults();
function drawCuts() {
  if (!this.props.containerWidth) return;
  this.selections.cutLines = this.selections.cutGroup.selectAll("line").data(this.props.cuts.value, (d, i) => i).join(
...
function applyLineAttributes(selection) {
  ...
  }).attr("x1", (cut) => this.scales.xPositionScale(cut.getVisCoords("x1"))).attr("x2", (cut) => this.scales.xPositionScale(cut.getVisCoords("x2"))).attr("y1", (cut) => this.scales.yPositionScale(cut.getVisCoords("y1"))).attr("y2", (cut) => this.scales.yPositionScale(cut.getVisCoords("y2"))).classed("trim", (cut) => cut.isTrim).classed("head", (cut) => cut.isHead);
}
...
function handleGuillotineCutVisibility(cut, parentSegmentID, orderKey, sorting2) {
  ...
  const inCutMode = currentCutIndex.value !== null;
  if (inCutMode && this.selections.cutLabels) {
    this.selections.cutLabels.style("visibility", (c) => {
      if (typeof cut.guillotineData[orderKey] === "number" && c.guillotineData[orderKey] <= cut.guillotineData[orderKey]) {
        return "visible";
      }
      return "hidden";
    });
    if (this.selections.cutBackgrounds) {
      this.selections.cutBackgrounds.style("visibility", (c) => {
        if (typeof cut.guillotineData[orderKey] === "number" && c.guillotineData[orderKey] <= cut.guillotineData[orderKey]) {
          return "visible";
        }
        return "hidden";
  ...
  this.selections.cutLines.classed("ptx-dummy", (c) => {
    var _a;
    return (_a = c == null ? void 0 : c.ptxData) == null ? void 0 : _a.isDummy;
  });
  if (!sorting2) {
...
function handleStandardCutVisibility(cut, index, trim2, axis, halfBladeWidth) {
  ...
  if (this.state.env === "development" && this.selections.cutLabels) {
    this.selections.cutLabels.style("visibility", (c, thisIndex) => thisIndex <= index ? "visible" : "hidden");
    if (this.selections.cutBackgrounds) {
      this.selections.cutBackgrounds.style("visibility", (c, thisIndex) => thisIndex <= index ? "visible" : "hidden");
    }
  }
  let measurements;
...
function resetCuts() {
  ...
  if ((_a = this.selections) == null ? void 0 : _a.cutLabels) {
    this.selections.cutLabels.style("visibility", "hidden");
  }
  if ((_b = this.selections) == null ? void 0 : _b.cutBackgrounds) {
    this.selections.cutBackgrounds.style("visibility", "hidden");
  }
...
function handleSegmentBasedCutVisibility(cut, parentSegmentID) {
  ...
  const result = getCutSegments.call(this, cut);
  if (result === false) return;
  const { parent, children } = result;
  const { near } = getRelevantSegments(cut, children);
  if (!near) return;
  let measurements = [];
  let values;
  ...
  if ((cut == null ? void 0 : cut.dimension) === "l") {
    ...
    values = [(_b = cut == null ? void 0 : cut.distances) == null ? void 0 : _b.bottom, cut == null ? void 0 : cut.distances.top];
  } else if ((cut == null ? void 0 : cut.dimension) === "w") {
    measurements = [
      [
        near.x,
    ...
    values = [(_c = cut == null ? void 0 : cut.distances) == null ? void 0 : _c.left, (_d = cut == null ? void 0 : cut.distances) == null ? void 0 : _d.right];
  }
...
function showCut(index = null, sorting2 = "") {
  ...
  if (this.props.stock.value.saw.cutType === "guillotine") {
    const trimCuts = this.props.cuts.value.filter((c) => c.isTrim);
    index = index + trimCuts.length;
    if (index - trimCuts.length >= this.props.cuts.value.length - trimCuts.length) {
      currentCutIndex.value = this.props.cuts.value.length - trimCuts.length - 1;
    }
  }
  ...
  resetShapeAxes.call(this);
  resetCutMeasurementAxes.call(this);
  if (index !== null && index >= 0 && index < this.selections.cutLines.size()) {
    const parentElement = this.selections.cutLines.nodes()[index].parentElement;
    if (!parentElement) return;
    select(parentElement).raise();
  }
  ...
  if (!((_d = cut == null ? void 0 : cut.guillotineData) == null ? void 0 : _d.parentSegmentID)) {
    return drawSegments.call(this, { parent });
  }
  const { near, far } = getRelevantSegments(cut, children);
  drawSegments.call(this, { parent, near, far });
}
function getRelevantSegments(cut, children) {
  const relevantAxis = cut.dimension === "l" ? "y" : "x";
  const relevantDimension = cut.dimension === "l" ? "w" : "l";
  const near = children.find((c) => c.segmentType === "near" && c[relevantAxis] + c[relevantDimension] === cut[relevantAxis + "1"] - cut.halfBladeWidth());
  const far = children.find((c) => c.segmentType === "far" && c[relevantAxis] === cut[relevantAxis + "1"] + cut.halfBladeWidth());
  return { near, far };
}
function updateCutStrokeWidth(cut, index, parentSegmentID) {
  this.selections.cutLines.attr("stroke-width", (c, cutIndex) => {
    var _a;
    const scaledWidth = this.scales.measurementScale(this.getBladeWidth(c.stock));
    let width = Math.max(1, Math.ceil(scaledWidth));
    const segmentCutOrder = (_a = cut == null ? void 0 : cut.guillotineData) == null ? void 0 : _a.segmentCutOrder;
...
class Diagram {
  constructor(config2) {
    ...
    __publicField(this, "formatNumber", (v) => {
      const conversion = convertNumberFormat({
        v,
        o: this.numberConfig
      });
      if (conversion !== null) return conversion.toString();
    });
    this.config = config2;
    this.selections = {};
  ...
  setAspectRatio() {
    ...
    const stock = this.props.stock.value;
    const containerWidth = this.props.containerWidth.value;
    if (containerWidth <= 0) return;
    const availableWidth = containerWidth - 2 * this.state.padding;
    if (availableWidth <= 0) return;
    this.scales.xScale.domain([0, stock.l]);
    this.scales.yScale.domain([0, stock.w]);
    this.scales.yAxisScale.domain(this.settings.flipY ? [0, stock.w] : [stock.w, 0]);
    this.scales.xPositionScale.domain([0, stock.l]);
    this.scales.yPositionScale.domain([0, stock.w]);
    this.scales.measurementScale.domain([0, stock.l]);
    const requiredHeight = stock.l > 0 ? availableWidth * stock.w / stock.l : 0;
    this.state.w = availableWidth + 2 * this.state.padding;
    this.state.h = requiredHeight + 2 * this.state.padding;
    const aspectRatio = stock.l > 0 ? stock.w / stock.l : 0;
    this.state.stretched = false;
    if (this.requiresStretch(stock, aspectRatio) && this.options.enableStretch) {
      this.state.h = containerWidth * 0.15 + this.state.padding * 2;
      this.state.stretched = true;
    }
    this.scales.xScale.range([this.state.padding, this.state.w - this.state.padding]);
    this.scales.yScale.range([this.state.padding, this.state.h - this.state.padding]);
    this.scales.yAxisScale.range([this.state.padding, this.state.h - this.state.padding]);
    this.scales.xPositionScale.range(
    ...
    this.scales.measurementScale.range([0, this.state.w - this.state.padding * 2]);
    if (this.state.w > 0 && this.state.h > 0) {
      this.selections.el.style("height", this.state.h + "px");
      this.props.containerHeight.value = this.state.h;
      this.selections.svgCanvas.attr("width", this.state.w).attr("height", this.state.h).attr("viewBox", `0 0 ${this.state.w} ${this.state.h}`);
    } else {
      this.selections.el.style("height", null);
      this.props.containerHeight.value = 0;
      this.selections.svgCanvas.attr("width", null).attr("height", null).attr("viewBox", null);
    }
  }
  //--------------------------------------------------------
  // FIND
  ...
  selectShape(shapeEl) {
    ...
    if (shapeEL) {
      ...
      this.callbacks.onShapeSelect(shape, shapeEl);
    }
  }
  //--------------------------------------------------------
  // DRAWING
  ...
  toggleShapes(show = false) {
    if (!this.selections.shapeGroup) return;
    if (show) {
  ...
  toggleSegments(show = true) {
    if (!this.selections.segmentGroup) return;
  ...
  toggleCuts(show = true) {
    if (!this.selections.cutGroup) return;
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const {
      ...
      activeCuts,
      activeSegments,
      currentCutIndex: currentCutIndex2,
      getStock,
      getShapes,
      getSegments,
      getCuts
    ...
    const props = __props;
    const emit = __emit;
    const onPartClick = (data) => {
      emit("part-click", data);
    };
    const onShapeColourUpdate = (newColours) => {
      emit("shape-colour-update", newColours);
    };
    const onShapeSelect = (shape, shapeEl) => {
      if (!(shape == null ? void 0 : shape.id)) return;
      emit("shape-select", shape.id.toString(), shapeEl);
    };
    ...
    watchThrottled(
      ...
      (newWidth) => {
        ...
        diagram.drawAll();
        if (currentCutIndex2.value !== null) {
          diagram.toggleSegments(true);
          diagram.showCut(currentCutIndex2.value);
        }
      },
      { throttle: 100 }
    );
    let isStockChange = false;
    watch(() => relevantStock.value, (newStock) => {
      if (!newStock) return;
      if (containerWidth.value <= 0) return;
      isStockChange = true;
      diagram.setDevice();
      diagram.resetCuts();
      diagram.removeSegments();
      diagram.drawStock();
      diagram.drawShapes();
      diagram.drawCuts();
      nextTick(() => {
    ...
    watch(() => relevantShapes.value, (newShapes) => {
      if (isStockChange) return;
      if (!newShapes) return;
      if (containerWidth.value <= 0) return;
      diagram.setDevice();
      diagram.drawShapes();
    ...
    if (props.main) {
      watch(() => relevantCuts.value, () => {
        if (isStockChange) return;
        if (containerWidth.value <= 0) return;
        diagram.drawCuts();
      }, { immediate: false, deep: true });
      watch(currentCutIndex2, () => {
        if (currentCutIndex2.value === null) return;
        if (containerWidth.value <= 0) return;
        diagram.toggleSegments(true);
        diagram.showCut(currentCutIndex2.value);
      }, { immediate: false });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        class: normalizeClass([{ "app": _ctx.app }, "diagram-container"])
...
const _hoisted_5$3 = ["id", "disabled", "onClick"];
const _hoisted_6$3 = {
  key: 0,
  class: "cell"
};
const _hoisted_7$1 = ["onClick"];
const _hoisted_8$1 = { class: "cell" };
const _hoisted_9$1 = ["disabled", "aria-label", "onClick"];
const _hoisted_10$1 = { class: "button-wrapper main" };
const _hoisted_11$1 = ["aria-label"];
const _hoisted_12$1 = ["aria-label", "disabled"];
const _hoisted_13$1 = ["aria-label"];
const _hoisted_14$1 = { id: "part-count" };
const _hoisted_15$1 = {
  key: 3,
  id: "messages"
};
...
const _hoisted_19 = { id: "diagram-wrapper" };
const _hoisted_20 = {
  key: 0,
  id: "stack"
};
const showDevInfo$2 = false;
const GRID_ROW_PADDING = 5;
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ObjectViewer2 = defineAsyncComponent(() => Promise.resolve().then(() => ObjectViewer$1));
    const { inputs: inputs2, totalInputShapes: totalInputShapes2, getShapeGrainSummary, updateNumberFormat, validateInputStock: validateInputStock2, removeShape: removeShape2 } = useInputs();
    const { r, updateFromResult, stackedStock, uniqueAddedShapes, uniqueUsedStock, activeStockId, activeStock, setActiveStockId } = useResults();
      ...
      callbacks: {
        onResult(resultData) {
          ...
          if (!((_a = result.shapeList) == null ? void 0 : _a.length) || !((_b = result.stockList) == null ? void 0 : _b.length)) {
            ...
            addNotice2({
              type: "error",
              message: t$1("errors.calculation.no_result"),
              additional: [t$1("errors.validation.check_inputs")]
            });
          ...
          if ((_e = (_d = (_c = r == null ? void 0 : r.metadata) == null ? void 0 : _c.value) == null ? void 0 : _d.unplacedParts) == null ? void 0 : _e.length) {
            ...
            addNotice2({
              type: "warning",
              message: t$1("woodwork.parts_not_fit") + ": " + parts
            });
          }
        ...
        onConnectError(error) {
          addNotice2({
            type: "error",
            message: t$1("errors.network.cannot_connect"),
            additional: [error]
          });
        },
        onError(error) {
          addNotice2({
            type: "error",
            message: t$1("errors.general.error_occurred"),
            additional: [error]
          });
        }
      }
    ...
    const fieldDefinitions = computed(() => {
      ...
      const fieldDefinitions2 = [
        ...
        },
        {
          ...
          w: "minmax(20px, max-content)",
          type: "select",
          output: options.numberFormat === "decimal" ? "number" : "string",
        ...
        },
        {
          ...
          min: (options == null ? void 0 : options.minDimension) ?? 0,
    ...
    const partColumns = computed(() => {
      let number = relevantFieldDefinitions.value.length + 2;
      number++;
      return number;
    });
    const partColumnsStyle = computed(() => {
      const baseWidthValues = {
        id: 34,
        del: 32,
        info: 32
      };
      const widthValues = {
        id: `${baseWidthValues.id + GRID_ROW_PADDING}px`,
        del: `${baseWidthValues.del + GRID_ROW_PADDING}px`,
        info: `${baseWidthValues.info}px`
      };
      const widths = [];
    ...
    const buttonStyles = computed(() => ({
      "--btn-color": options.colors.buttonText,
      "--btn-bg": options.colors.button,
      "--btn-hover-bg": adjustColor(options.colors.button, -8),
      "--btn-focus-ring": options.colors.button
    }));
    ...
    const optionHandlers = {
      ...
      cutPreference: (cutPreference) => {
        ...
        if (allowedCutPreferences.includes(cutPreference)) {
          ...
          console.warn(`SmartCut - cut preference ${cutPreference || "N/A"} is not one of ${allowedCutPreferences.join("|")}`);
        }
      },
      guillotineOptions: (guillotineOptions) => {
        sawData.guillotineOptions = guillotineOptions;
      },
    ...
    const handleFieldValidation = (el, result, item, key) => {
      if (result.valid) {
        ...
        updateTip({
          referenceEl: el,
          show: true,
          content: t$1(`errors.field_validation.${result.message}`),
          type: "error"
        });
      }
    };
    ...
    const openMachining = (shape = null) => {
      ...
      if (shape && shape.l && shape.w) {
        showMachining.value = true;
      } else {
        alert(t$1("machining.enter_dimensions_first"));
      }
    };
    const closeMachining = () => {
      showMachining.value = false;
    };
    ...
    const getShapeThicknesses = (shape) => {
      ...
      for (let i = 0; i < thicknessesList.length; i++) {
        const t2 = thicknessesList[i];
        const bonded = getBondedThicknesses(t2);
        const bondedIndexes = [];
        if (bonded.length) {
    ...
    const getShapeThicknessOptions = (shape) => {
      ...
      return thicknesses2.map((t2) => ({
        label: t2 == null ? void 0 : t2.toString(),
        value: t2
      }));
    };
    ...
    const addBondedThicknesses = (bonded, material = null) => {
      ...
      const bondexIndexes = [];
      for (let bondedThickness of bonded) {
    ...
    const getBondedThicknesses = (t2, cu = false) => {
    ...
    const isCreditVisible = () => {
      ...
      let visible = true;
      const link = document.querySelector("#smartcut-checkout a#credit");
      if (!link) return visible = false;
      ...
      if (style.position !== "absolute") return visible = false;
    ...
    const initExtrasOptions = (shape, extraType) => {
      ...
      if (shape == null ? void 0 : shape[extraOptionsKey]) {
        for (const option in shape[extraOptionsKey]) {
          ...
          if (price === false && option && shape[extraType][option]) {
            new Issue({
              item: shape,
              field: [[extraType, option]],
              type: "error",
              category: ["part"],
              message: t$1("option_not_available", { x: shape[extraType][option], y: t$1(extraType) })
            });
          }
    ...
    const updatePartQuantitiesBasedOnThickness = (inputShapes) => {
      if (!thicknesses.value.length) return;
      for (const s of inputShapes) {
        if (!s.t) return;
        const thicknessIndex = thicknesses.value.findIndex(
          (t2) => convertNumberFormat({ v: t2 }) === s.t
        );
        const bondedIndexes = bondedThicknesses.value.find((bonded) => bonded.includes(thicknessIndex));
        if (!bondedIndexes) return;
        const smallestThickness = Math.min(
          ...bondedIndexes.map((i) => thicknesses.value[i])
        );
        if (convertNumberFormat({ v: s.t }) > smallestThickness) {
          s.q = s.q * (convertNumberFormat({ v: s.t }) / smallestThickness);
          s.notes = `Bond to form ${s.t.valueOf()}`;
    ...
    const calculate = async () => {
      ...
      thinking.value = true;
      success.value = false;
      const inputShapes = inputs2.inputShapes.value.map((s) => new InputShape(s));
      updatePartQuantitiesBasedOnThickness(inputShapes);
      const { valid, saw, stockList, shapeList } = await validateAndPrepare({
        ...
        onLimit: () => {
          addNotice2({
            type: "error",
            message: t$1("limits.max_parts") + " " + options.maxParts
          });
        }
      });
      if (!valid) {
    ...
    const parseInputs = (detail) => {
      ...
      if (errors.length) {
        addNotice2({
          type: "error",
          message: t$1("errors.general.issues_found")
        });
      }
    ...
    watch(() => props.stock, (stock) => {
      ...
      if (inputs2.inputStock.value.length) {
        ...
        if (inputStockIssues.length) {
          ...
          addNotice2({
            type: "error",
            message: t$1("errors.validation.stock_issue"),
            additional: inputStockIssues.map((i) => i.message)
          });
        }
      }
    }, { immediate: true });
    ...
    onMounted(async () => {
      ...
      if (currentURL.value !== newURL) clear();
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        !loaded.value ? (openBlock(), createBlock(Spinner, {
          key: 0,
          size: 50,
          "show-number": false
        })) : createCommentVNode("", true),
        ...
        ((_a = currentInputShape.value) == null ? void 0 : _a.machining) && showMachining.value ? (openBlock(), createBlock(unref(Machining$12), {
          key: 1,
        ...
        unref(env) === "development" && showDevInfo$2 ? (openBlock(), createElementBlock("div", _hoisted_1$6, [
          ...
          createBaseVNode("div", null, toDisplayString(options.enable.focus), 1),
          createVNode(unref(ObjectViewer2), {
            data: [unref(inputs2).inputShapes.value[0]],
            paths: ["inputs.inputShapes"]
          }, null, 8, ["data"])
        ])) : createCommentVNode("", true),
        loaded.value ? (openBlock(), createElementBlock("section", {
          key: 3,
          id: "smartcut-checkout",
          class: normalizeClass(["smartcut-content", { fullscreen: isFullScreen.value }])
        }, [
          canGoFullScreen.value && !__props.readonly ? (openBlock(), createElementBlock("button", {
            key: 0,
            ...
            createVNode(_component_FontAwesomeIcon, { icon: ["fass", "expand"] }),
            createTextVNode(" " + toDisplayString(unref(t$1)("general.full_screen")), 1)
          ], 4)) : createCommentVNode("", true),
          showCredit.value ? (openBlock(), createElementBlock("a", {
            key: 1,
            id: "credit",
            style: creditStyles,
          ...
          }, toDisplayString(unref(upperCase)(unref(t$1)("general.powered_by"))), 1)) : createCommentVNode("", true),
          createBaseVNode("div", {
            id: "part-input",
            class: "inputs no-margin-top grid-table",
            style: normalizeStyle({ "grid-template-columns": partColumnsStyle.value })
          }, [
            unref(inputs2).inputShapes.value.length ? (openBlock(), createElementBlock("div", _hoisted_2$4, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(relevantFieldDefinitions.value, (f) => {
                ...
                }, toDisplayString(unref(t$1)(f.label)), 3);
              }), 128)),
              unref(env) === "development" ? (openBlock(), createElementBlock("div", _hoisted_3$4, " Info ")) : createCommentVNode("", true),
              _cache[7] || (_cache[7] = createBaseVNode("div", { class: "cell del" }, null, -1))
            ])) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(inputs2).inputShapes.value, (shape, shapeIndex) => {
              return openBlock(), createElementBlock("div", {
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(relevantFieldDefinitions.value, (f) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    !["orientationLock", "banding", "finish", "machining", "imageUpload"].includes(f.id) ? (openBlock(), createBlock(_sfc_main$e, {
                      ...
                      type: f.type,
                      output: f.output,
                      label: (f == null ? void 0 : f.label) ? unref(t$1)(f.label) : null,
                      placeholder: (f == null ? void 0 : f.placeholder) ? unref(t$1)(f.placeholder) : null,
                      "enable-label": false,
                      ...
                      text: {
                        delete: unref(capitalise)(unref(t$1)("actions.delete")),
                        select: unref(capitalise)(unref(t$1)("actions.select"))
                      },
                    ...
                    }, null, 8, ["id", "rectangle", "disabled", "stock-grain", "style", "orientation-model", "onUpdateOrientation"])) : f.id === "banding" ? (openBlock(), createBlock(_sfc_main$j, {
                      key: 2,
                    ...
                    }, null, 8, ["id", "input-shape", "disabled", "style", "open", "onClicked"])) : f.fieldMap === "machining" && canGoFullScreen.value ? (openBlock(), createBlock(MachiningButton, {
                      key: 4,
                    ...
                    }, null, 8, ["id", "disabled", "style", "input-shape", "onOpen"])) : f.fieldMap === "imageUpload" ? (openBlock(), createElementBlock("button", {
                      key: 5,
                      ...
                      createVNode(_component_FontAwesomeIcon, { icon: ["fass", "image"] })
                    ], 10, _hoisted_5$3)) : createCommentVNode("", true)
                  ]);
                }), 128)),
                unref(env) === "development" ? (openBlock(), createElementBlock("div", _hoisted_6$3, [
                  createBaseVNode("button", {
                    class: normalizeClass(["c-btn", { selected: extrasIndex.info === shapeIndex }]),
                    style: normalizeStyle(buttonStyles.value),
                    type: "button",
                ...
                createBaseVNode("div", _hoisted_8$1, [
                  createBaseVNode("button", {
                    disabled: unref(inputs2).inputShapes.value.length <= 1,
                    type: "button",
                    class: "delete",
                    "aria-label": `${unref(t$1)("actions.remove")} ${unref(lowerCase)(unref(t$1)("woodwork.part"))}`,
                    onClick: ($event) => unref(removeShape2)(shape.listId)
                  }, [
                    createVNode(_component_FontAwesomeIcon, { icon: ["fass", "trash"] })
                  ], 8, _hoisted_9$1)
                ]),
          ...
          createBaseVNode("div", _hoisted_10$1, [
            !__props.readonly ? (openBlock(), createElementBlock("button", {
              ...
              class: "add c-btn",
              type: "button",
              "aria-label": `${unref(t$1)("actions.add")} ${unref(t$1)("woodwork.part")}`,
              ...
              createVNode(_component_FontAwesomeIcon, { icon: ["fass", "plus-large"] }),
              createTextVNode(" " + toDisplayString(`${unref(t$1)("actions.add")} ${unref(t$1)("woodwork.part")}`), 1)
            ], 12, _hoisted_11$1)) : createCommentVNode("", true),
            createBaseVNode("button", {
              id: "calculate-button",
              class: "c-btn calculate",
              type: "button",
              "aria-label": unref(t$1)("actions.calculate"),
              style: normalizeStyle(buttonStyles.value),
              disabled: !((_b = unref(inputs2).inputStock.value) == null ? void 0 : _b.length) || thinking.value,
              onClick: _cache[3] || (_cache[3] = ($event) => calculate())
            }, [
              createVNode(_component_FontAwesomeIcon, { icon: ["fass", "calculator"] }),
              createTextVNode(toDisplayString(unref(t$1)("actions.calculate")), 1)
            ], 12, _hoisted_12$1),
            !__props.readonly ? (openBlock(), createElementBlock("button", {
              key: 1,
              class: "c-btn c-btn--delete",
              type: "button",
              "aria-label": unref(t$1)("actions.clear"),
              onClick: _cache[4] || (_cache[4] = ($event) => clear())
            }, [
              createVNode(_component_FontAwesomeIcon, { icon: ["fass", "trash"] })
            ], 8, _hoisted_13$1)) : createCommentVNode("", true),
            createBaseVNode("div", _hoisted_14$1, toDisplayString(unref(totalInputShapes2)) + toDisplayString((options == null ? void 0 : options.maxParts) ? "/" + options.maxParts : ""), 1)
          ]),
          ...
          messageVisible.value ? (openBlock(), createElementBlock("div", _hoisted_15$1, [
            messageHeading.value ? (openBlock(), createElementBlock("div", _hoisted_16$1, toDisplayString(messageHeading.value), 1)) : createCommentVNode("", true),
            createBaseVNode("pre", _hoisted_17, toDisplayString(messageContent.value), 1)
          ])) : createCommentVNode("", true),
          (options.enable.diagram ? thinking.value && !unref(progress).complete : thinking.value || unref(progress).complete) ? (openBlock(), createElementBlock("div", _hoisted_18, [
            createVNode(Spinner, {
              size: 50,
          ...
          withDirectives(createBaseVNode("div", _hoisted_19, [
            ((_d = (_c = unref(activeStock)) == null ? void 0 : _c.saw) == null ? void 0 : _d.stockType) !== "roll" ? (openBlock(), createElementBlock("div", _hoisted_20, toDisplayString(((_e = unref(activeStock)) == null ? void 0 : _e.stack) ? (_f = unref(activeStock)) == null ? void 0 : _f.stack : 1), 1)) : createCommentVNode("", true),
...
const CheckoutCalculator = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-6c39d4e1"]]);
const _sfc_main$7 = {
  name: "ObjectViewer",
  props: {
    data: {
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const checkVisibility = () => {
      ...
      const computedStyle = window.getComputedStyle(props.referenceEl);
      ...
      const isNotClipped = !isElementClipped(props.referenceEl);
      isReferenceVisible.value = isDisplayed && isVisible && isOpaque && hasDimensions && isInViewport && isNotClipped;
    };
    const isElementClipped = (element) => {
    ...
    const setupObservers = () => {
      if (!props.referenceEl) return;
      intersectionObserver = new IntersectionObserver(
        (entries) => {
          entries.forEach((entry) => {
            if (entry.target === props.referenceEl) {
              checkVisibility();
            }
          });
        },
      ...
      intersectionObserver.observe(props.referenceEl);
      mutationObserver = new MutationObserver((mutations) => {
        mutations.forEach((mutation) => {
          if (mutation.type === "attributes" && (mutation.attributeName === "style" || mutation.attributeName === "class" || mutation.attributeName === "hidden")) {
            checkVisibility();
          }
        });
      });
      mutationObserver.observe(props.referenceEl, {
        attributes: true,
        attributeFilter: ["style", "class", "hidden"]
      });
      let parent = props.referenceEl.parentElement;
      while (parent && parent !== document.body) {
    ...
    watch([() => props.referenceEl, () => props.show], ([newRef, newShow], [oldRef]) => {
      if (oldRef !== newRef) {
        cleanupObservers();
      }
      if (newShow && newRef) {
    ...
    const handleWindowEvents = () => {
      if (props.show && props.referenceEl) {
        checkVisibility();
      }
    };
    onMounted(() => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        createVNode(Transition, { name: "fade" }, {
          default: withCtx(() => [
            _ctx.show && _ctx.referenceEl && isReferenceVisible.value ? (openBlock(), createElementBlock("div", {
              key: 0,
              ref_key: "floatingRef",
              ref: floatingRef,
              class: normalizeClass(["smartcut-tooltip", _ctx.type]),
...
class Vis {
  constructor({
    ...
    __publicField(this, "edgePadding", 15);
    // For left and bottom when axes shown
    __publicField(this, "axisPadding", 30);
    // For top and right when axes shown
    __publicField(this, "minSizeForAxes", 400);
  ...
  init() {
    ...
    if (!this.svgCanvas) {
      ...
      if (this.svgCanvas === null) {
        const svg = this.el.append("svg").attr("class", "vis").attr("width", "100%").attr("height", "100%");
        if (svg === null) return;
        this.svgCanvas = svg;
      } else {
        this.svgCanvas = d3.select(this.svgCanvas);
      }
    }
    this.loaded = true;
  }
  create() {
    if (!this.shape) return false;
    const showAxes = this.shouldShowAxes();
    const paddingLeft = showAxes ? this.edgePadding : 0;
    const paddingBottom = showAxes ? this.edgePadding : 0;
    const paddingRight = showAxes ? this.axisPadding : 0;
    const paddingTop = showAxes ? this.axisPadding : 0;
    if (!this.shape.l || !this.shape.w || !this.w || !this.h || this.w - (paddingLeft + paddingRight) < 0 || this.h - (paddingTop + paddingBottom) < 0)
      return false;
    ...
    this.createBanding();
    if (showAxes) {
      this.xAxis = this.svgCanvas.append("g").attr("transform", `translate(0, ${paddingTop})`).attr("class", "axis x");
      this.xAxis.call(
        d3.axisTop(this.xScale).ticks(10).tickSize(-this.h + (paddingTop + paddingBottom))
      );
      this.svgCanvas.selectAll(".axis.x .tick").each(function(d, i, nodes) {
        if (i === 0 || i === nodes.length - 1) {
          d3.select(this).select("line").style("display", "none");
        }
      });
      this.svgCanvas.selectAll(".axis.x text").attr("dy", "-5px");
      this.yAxis = this.svgCanvas.append("g").attr("transform", `translate(${this.w - paddingRight}, 0)`).attr("class", "axis y");
      this.yAxis.call(
        d3.axisRight(this.yScale).ticks(Math.ceil(this.shapeW / this.shapeL * 10)).tickSize(-this.w + (paddingLeft + paddingRight))
      );
      this.svgCanvas.selectAll(".axis.y .tick").each(function(d, i, nodes) {
        if (i === 0 || i === nodes.length - 1) {
          d3.select(this).select("line").style("display", "none");
        }
      });
      this.svgCanvas.selectAll(".axis.y text").attr("dx", "5px");
      console.log("Axes created:", { xAxis: !!this.xAxis, yAxis: !!this.yAxis });
    }
  ...
  createShape() {
    ...
    const paddingRight = showAxes ? this.axisPadding : 0;
    const paddingTop = showAxes ? this.axisPadding : 0;
    this.shapeGroup.append("rect").attr("class", "shape-background-fill").attr("x", paddingLeft).attr("y", paddingTop).attr("width", this.w - (paddingLeft + paddingRight)).attr("height", this.h - (paddingTop + paddingBottom));
    this.shapeGroup.append("rect").attr("class", "shape-background").attr("x", paddingLeft).attr("y", paddingTop).attr("width", this.w - (paddingLeft + paddingRight)).attr("height", this.h - (paddingTop + paddingBottom)).style("fill", "url(#stripes)");
    const path2 = d3.path();
  ...
  createHoles() {
    ...
    this.holeGroup.selectAll("circle").data(
      ...
      const scaledYposition = this.getYScale()(drawYPosition);
  ...
  createHingeHoles() {
    ...
    this.hingeHoleGroup.selectAll("circle").data(visibleHingeHoles).join("circle").attr("class", "hole").classed("invalid", (h) => h.valid === false).classed("partial", (h) => !h.isThroughShape(this.shape)).attr("cx", (h) => this.xScale(h.x)).attr("cy", (h) => this.getYScale()(h.getYDrawPosition(this.shape, this.currentSide))).attr("r", (h) => this.measurementScale(h.diameter / 2));
  }
  createBanding() {
    ...
    for (const side of mainSides) {
      ...
      switch (side) {
        case "x1":
          bandingData.push({
            x1: paddingLeft - offset2,
            x2: paddingLeft - offset2,
        ...
        case "x2":
          bandingData.push({
            x1: this.w - paddingRight + offset2,
            x2: this.w - paddingRight + offset2,
        ...
        case "y1":
          bandingData.push({
            x1: paddingLeft + this.getCornerBandingSize(0),
            x2: this.w - paddingRight - this.getCornerBandingSize(1),
        ...
        case "y2":
          bandingData.push({
            x1: paddingLeft + this.getCornerBandingSize(3),
            x2: this.w - paddingRight - this.getCornerBandingSize(2),
    ...
    this.bandingGroup.selectAll("line").data(bandingData).join("line").attr("class", "banding").attr("x1", (d) => d.x1).attr("x2", (d) => d.x2).attr("y1", (d) => d.y1).attr("y2", (d) => d.y2).attr("stroke-width", this.bandingStrokeWidth);
    const path2 = d3.path();
  ...
  flip() {
    ...
    const paddingLeft = showAxes ? this.edgePadding : 0;
    const paddingRight = showAxes ? this.axisPadding : 0;
    if (showAxes && this.yAxis) {
      const currentYScale = this.currentSide === 0 ? this.yScale : this.yScaleFlipped;
      this.yAxis.call(
        d3.axisRight(currentYScale).ticks(Math.ceil(this.shapeW / this.shapeL * 10)).tickSize(-this.w + (paddingLeft + paddingRight))
      );
      this.svgCanvas.selectAll(".axis.y .tick").each(function(d, i, nodes) {
        if (i === 0 || i === nodes.length - 1) {
          d3.select(this).select("line").style("display", "none");
  ...
  updateSize() {
    ...
    const paddingRight = showAxes ? this.axisPadding : 0;
    const paddingTop = showAxes ? this.axisPadding : 0;
    if (this.w - (paddingLeft + paddingRight) < 0) return;
    let availableHeight = window.innerHeight - (paddingTop + paddingBottom) - 20;
    if (availableHeight > 600) availableHeight = 600;
    this.xScale.domain([0, this.shapeL]).range([paddingLeft, this.w - paddingRight]);
    if (aspectRatio > 0.3) {
      this.h = this.xScale(this.shape.getShortSide()) + paddingTop;
    } else {
      aspectRatio = 0.3;
    ...
    this.yScale.domain([this.shapeW, 0]).range([paddingTop, this.h - paddingBottom]);
    this.yScaleFlipped.domain([0, this.shapeW]).range([paddingTop, this.h - paddingBottom]);
    this.measurementScale.domain([0, this.shapeL]).range([0, this.w - (paddingLeft + paddingRight)]);
    this.HTMLElement.style.height = this.h + "px";
    this.HTMLElement.style.width = this.w + "px";
    if (this.svgCanvas) {
      this.svgCanvas.attr("width", this.w).attr("height", this.h).attr("viewBox", `0 0 ${this.w} ${this.h}`);
    }
    this.create();
  }
}
const _hoisted_1$3 = { id: "machining" };
const _hoisted_2$2 = { class: "inputs" };
const _hoisted_3$2 = {
  key: 0,
  class: "debug"
};
...
const _hoisted_9 = { class: "grid-table" };
const _hoisted_10 = { class: "row table-heading" };
const _hoisted_11 = {
  key: 0,
  class: "cell id"
};
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    let vis = null;
    const initVis = () => {
      if (!shape.value || !diagramRef.value) {
        console.warn("Missing shape or diagram ref for vis initialization");
        return;
      }
      console.log("Initializing vis with diagramRef:", diagramRef.value);
      vis = new Vis({
        HTMLElement: diagramRef.value,
        shape: shape.value,
        vueComponent: null
      });
      vis.init();
    ...
    const createHole = () => {
      shape.value.machining.createHole(
        ...
        props.options.holes.defaultDepth ?? convertNumberFormat({ v: props.shape.t }) ?? 0,
        currentFace.value
      );
      vis.createHoles();
    };
    ...
    const fieldDefinitions = reactive({
      ...
      hingeHoles: {
        ...
        hingeLength: {
          ...
          required: true,
          type: "unitDependent",
          label: t$1("machining.hinge_length"),
          min: 0
        },
        outerSpacing: {
          enabled: true,
          required: true,
          type: "unitDependent",
          label: t$1("machining.outer_spacing"),
          min: 0
        },
        distanceFromEdge: {
          enabled: true,
          required: true,
          type: "unitDependent",
          label: t$1("machining.distance_from_edge"),
          min: 0
        },
        ...
        createBaseVNode("section", {
          ...
          createBaseVNode("div", _hoisted_1$3, [
            createBaseVNode("div", _hoisted_2$2, [
              unref(env) === "development" && showDevInfo$1 ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
                createVNode(unref(ObjectViewer2), {
              ...
              _ctx.options.faces.enabled ? (openBlock(), createElementBlock("div", _hoisted_6$1, [
                ...
                _cache[6] || (_cache[6] = createBaseVNode("div", { class: "text" }, " [Click to flip] ", -1))
              ])) : createCommentVNode("", true),
              ...
              createBaseVNode("div", _hoisted_7, [
                _ctx.options.holes.enabled ? (openBlock(), createElementBlock("div", {
                  ...
                  onClick: _cache[1] || (_cache[1] = ($event) => currentType.value = "holes")
                ...
                _ctx.options.hingeHoles.enabled ? (openBlock(), createElementBlock("div", {
                  ...
                  onClick: _cache[2] || (_cache[2] = ($event) => currentType.value = "hingeHoles")
                ...
                _ctx.options.corners.enabled ? (openBlock(), createElementBlock("div", {
                  ...
                  onClick: _cache[3] || (_cache[3] = ($event) => currentType.value = "corners")
                ...
                _ctx.options.banding.enabled ? (openBlock(), createElementBlock("div", {
                  ...
                  onClick: _cache[4] || (_cache[4] = ($event) => currentType.value = "banding")
                }, " Banding ", 2)) : createCommentVNode("", true)
              ]),
              currentType.value === "holes" || currentType.value === "hingeHoles" || currentType.value && currentType.value !== "banding" ? (openBlock(), createElementBlock("div", _hoisted_8, [
              ...
              currentType.value !== "banding" && currentShapeFields.value.length ? (openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", _hoisted_10, [
                  shouldShowId() ? (openBlock(), createElementBlock("div", _hoisted_11)) : createCommentVNode("", true),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(currentFields.value, (value, key) => {
                  ...
                  _cache[7] || (_cache[7] = createBaseVNode("div", { class: "cell" }, null, -1))
                ]),
                (openBlock(true), createElementBlock(Fragment, null, renderList(currentShapeFields.value, (shapeField, shapeFieldIndex) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    shouldShowId() ? (openBlock(), createElementBlock("div", _hoisted_12, [
                      createBaseVNode("div", _hoisted_13, toDisplayString(getIndex(shapeFieldIndex)), 1)
                    ])) : createCommentVNode("", true),
                    (openBlock(true), createElementBlock(Fragment, null, renderList(currentFieldKeys.value, (key, fieldIndex) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        createVNode(_sfc_main$e, {
                          type: currentFields.value[key].type,
                          id: key + "-" + fieldIndex,
                          ...
                          value: unref(getNestedProperty$1)(shapeField, key),
                          output: currentFields.value[key].output,
                          options: currentFields.value[key].options,
                          "onUpdate:value": (value) => unref(setNestedProperty)(shapeField, key, value)
              ...
              ], 6)) : !currentType.value ? (openBlock(), createElementBlock("div", _hoisted_16, "Please select from the menu above")) : createCommentVNode("", true)
            ]),
            createBaseVNode("div", {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const validate = (key, value) => {
      ...
      return key in validation ? validation[key](value) : null;
    };
    ...
    const predictHeadingType = (header) => {
      const strings = {
        l: ["length", "l", "len", "lng", "long", "lgth", "lg", t$1("l"), t$1("length")],
        w: ["width", "w", "wd", "wide", "height", "h", "ht", "high", t$1("w"), t$1("width")],
        t: ["thickness", "t", "th", "depth", "dp", "dpth", "thk", "thick", t$1("t"), t$1("thickness")],
        name: ["name", "nom", "n", "nm", "nme", "label", "lbl", "description", "desc", t$1("name")],
        q: ["quantity", "qty", "q", "quant", "qnty", "qnt", t$1("quantity"), t$1("q"), "count"],
        material: ["material", "mat", "m", "matl", "mtl", "mtrl", "mtr", t$1("quantity")],
        orientationLock: ["rotation", "rot", "ro", "r", "o", "orientation", "orient", "or", "direction", "dir", t$1("orientation")],
        banding: ["b", "banding", "band", "ba", "bnd", "edging", "edge", "edn", t$1("banding")],
        finish: ["finish", "paint"]
      };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createVNode(Drop, {
          label: unref(t$1)("Drop CSV file here"),
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const createFields = () => {
      fieldsArray.value = Object.values(specification.value.inputs).map((i) => ({
        value: i.default ?? null
      }));
      console.log(fieldsArray.value);
    };
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createBaseVNode("div", _hoisted_2$1, [
          ...
          hardwareResult.value ? (openBlock(), createElementBlock("div", _hoisted_3$1, [
            createBaseVNode("div", _hoisted_4$1, toDisplayString(unref(t$1)("Hardware")), 1),
            ...
            createBaseVNode("div", _hoisted_5, toDisplayString(unref(t$1)("Hardware total")) + " = " + toDisplayString(__props.formatPrice(harwareTotal.value)), 1)
          ])) : createCommentVNode("", true),
          createBaseVNode("div", _hoisted_6, toDisplayString(unref(t$1)("Panels")), 1)
        ])
      ], 64);
    };
  }
            ...
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(notices), (notice) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  !notice.persistent ? (openBlock(), createBlock(_component_FontAwesomeIcon, {
                    key: 0,
                    icon: ["fass", "trash"],
                    class: "dismiss",
...
export {
  ...
  Saw as h,
  recreateStockList as i,
  recreateShapeList as j,
  recreateSegmentList as k,
  recreateCutList as l,
  mapOrientation as m,
  recreateOffcuts as n,
  sorting as o,
  ...
  faces as v,
  getNestedProperty$1 as w,
  checkObjectHasPropery as x,
  objectValuesPresent as y,
  t$1 as z
};
//# sourceMappingURL=components-DNQps9NE.js.map
