import { d as i, r as s, R as f, c as a, q as y, a as d, x as _, A as k, i as v, N as c, o as r } from "./vendor-vue-ChIbPezZ.js";
import { bu as h } from "./components-Bf39GJww.js";
const C = {
  key: 1,
  class: "error-message"
}, x = /* @__PURE__ */ i({
  ...
  setup(p, { expose: l }) {
    const m = s(!1), o = s(null), u = f({
      wordpress: c(() => import("./WordPress-Dn5Cu9EN.js")),
      vanilla: c(() => import("./Vanilla-BpbZtu7v.js"))
    }), e = p, t = a(() => {
