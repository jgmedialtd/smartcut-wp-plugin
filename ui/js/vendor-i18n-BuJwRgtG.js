...
}, ne = (r) => r == null ? "" : "" + r, Pe = (r, e, t) => {
  r.forEach((s) => {
    e[s] && (t[s] = e[s]);
  });
}, Re = /###/g, re = (r) => r && r.indexOf("###") > -1 ? r.replace(Re, ".") : r, ae = (r) => !r || d(r), M = (r, e, t) => {
...
const je = (r) => d(r) ? r.replace(/[&<>"'\/]/g, (e) => Ee[e]) : r;
class De {
  constructor(e) {
...
const Ie = [" ", ",", "?", "!", ";"], Te = new De(20), Ae = (r, e, t) => {
  ...
  const i = Te.getRegExp(`(${s.map((a) => a === "?" ? "\\?" : a).join("|")})`);
  let n = !i.test(r);
  if (!n) {
    const a = r.indexOf(t);
...
class le extends Y {
  ...
  getResource(e, t, s, i = {}) {
    ...
    return !l && !t && !s && e.indexOf(".") > -1 && (e = o[0], t = o[1], s = o.slice(2).join(".")), l || !a || !d(s) ? l : G(this.data?.[e]?.[t], s, n);
  }
...
function Ve() {
  ...
  let t;
  return e.get = (s, i) => (t?.revoke?.(), i === Oe ? r : (r.push(i), t = Proxy.revocable(s, e), t.proxy)), Proxy.revocable(/* @__PURE__ */ Object.create(null), e).proxy;
}
function X(r, e) {
  const {
    [Oe]: t
...
const ue = {}, q = (r) => !d(r) && typeof r != "boolean" && typeof r != "number";
class W extends Y {
  constructor(e, t = {}) {
    super(), Pe(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = t, this.options.keySeparator === void 0 && (this.options.keySeparator = "."), this.logger = $.create("translator");
  }
  changeLanguage(e) {
    e && (this.language = e);
  }
  ...
  extractFromKey(e, t) {
    ...
    const a = s && e.indexOf(s) > -1, o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !Ae(e, s, i);
    if (a && !o) {
  ...
  translate(e, t, s) {
    ...
    let h = g?.res;
    const m = g?.usedKey || o, S = g?.exactUsedKey || o, L = ["[object Number]", "[object Function]", "[object RegExp]"], x = i.joinArrays !== void 0 ? i.joinArrays : this.options.joinArrays, F = !this.i18nFormat || this.i18nFormat.handleAsObject, w = i.count !== void 0 && !d(i.count), R = W.hasDefaultValue(i), j = w ? this.pluralResolver.getSuffix(f, i.count, i) : "", D = i.ordinal && w ? this.pluralResolver.getSuffix(f, i.count, {
      ordinal: !1
    }) : "", ee = w && !i.ordinal && i.count === 0, N = ee && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${j}`] || i[`defaultValue${D}`] || i.defaultValue;
    let v = h;
    F && !h && R && (v = N);
    const Ce = q(v), $e = Object.prototype.toString.apply(v);
    if (F && v && Ce && L.indexOf($e) < 0 && !(d(x) && Array.isArray(v))) {
      if (!i.returnObjects && !this.options.returnObjects) {
        ...
        return n ? (g.res = k, g.usedParams = this.getUsedParamsDetails(i), g) : k;
      }
      if (a) {
        const k = Array.isArray(v), O = k ? [] : {}, te = k ? S : m;
        for (const C in v)
          if (Object.prototype.hasOwnProperty.call(v, C)) {
            const P = `${te}${a}${C}`;
            R && !h ? O[C] = this.translate(P, {
              ...i,
      ...
      h = h.join(x), h && (h = this.extendTranslation(h, e, i, s));
    else {
      let k = !1, O = !1;
      !this.isValidLookup(h) && R && (k = !0, h = N), this.isValidLookup(h) || (O = !0, h = o);
      const C = (i.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && O ? void 0 : h, P = R && N !== h && this.options.updateMissing;
      if (O || k || P) {
        if (this.logger.log(P ? "updateKey" : "missingKey", f, u, o, P ? N : h), a) {
        ...
        const se = (b, E, V) => {
          const ie = R && V !== h ? V : C;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(b, u, E, ie, P, i) : this.backendConnector?.saveMissing && this.backendConnector.saveMissing(b, u, E, ie, P, i), this.emit("missingKey", b, u, E, h);
        };
        this.options.saveMissing && (this.options.saveMissingPlurals && w ? K.forEach((b) => {
          const E = this.pluralResolver.getSuffixes(b, i);
          ee && i[`defaultValue${this.options.pluralSeparator}zero`] && E.indexOf(`${this.options.pluralSeparator}zero`) < 0 && E.push(`${this.options.pluralSeparator}zero`), E.forEach((V) => {
            se([b], o + V, i[`defaultValue${V}`] || N);
          });
        }) : se(K, o, N));
      }
      h = this.extendTranslation(h, e, i, g, s), O && h === o && this.options.appendNamespaceToMissingKey && (h = `${u}${c}${o}`), (O || k) && this.options.parseMissingKeyHandler && (h = this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${u}${c}${o}` : o, k ? h : void 0, i));
    }
  ...
  extendTranslation(e, t, s, i, n) {
    ...
    return e != null && o?.length && s.applyPostProcessor !== !1 && (e = Le.handle(o, e, t, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...i,
  ...
  resolve(e, t = {}) {
    ...
    return d(e) && (e = [e]), e.forEach((l) => {
      ...
      f.forEach((S) => {
        this.isValidLookup(s) || (o = S, !ue[`${m[0]}-${S}`] && this.utils?.hasLoadedNamespace && !this.utils?.hasLoadedNamespace(o) && (ue[`${m[0]}-${S}`] = !0, this.logger.warn(`key "${i}" for languages "${m.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), m.forEach((L) => {
          if (this.isValidLookup(s)) return;
          a = L;
          const x = [c];
          if (this.i18nFormat?.addLookupKeys)
            this.i18nFormat.addLookupKeys(x, c, L, S, t);
          else {
            let w;
            p && (w = this.pluralResolver.getSuffix(L, t.count, t));
            ...
            if (p && (t.ordinal && w.indexOf(j) === 0 && x.push(c + w.replace(j, this.options.pluralSeparator)), x.push(c + w), g && x.push(c + R)), h) {
              ...
              x.push(D), p && (t.ordinal && w.indexOf(j) === 0 && x.push(D + w.replace(j, this.options.pluralSeparator)), x.push(D + w), g && x.push(D + R));
            }
          }
          let F;
          for (; F = x.pop(); )
            this.isValidLookup(s) || (n = F, s = this.getResource(L, S, F, t));
        }));
      });
    }), {
      res: s,
...
const de = (r, e, t, s = ".", i = !0) => {
  let n = Fe(r, e, t);
  return !n && i && d(t) && (n = G(r, t, s), n === void 0 && (n = G(e, t, s))), n;
}, Z = (r) => r.replace(/\$/g, "$$$$");
class Me {
  constructor(e = {}) {
  ...
  interpolate(e, t, s, i) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, u = (g) => {
      if (g.indexOf(this.formatSeparator) < 0) {
        const L = de(t, l, g, this.options.keySeparator, this.options.ignoreJSONStructure);
      ...
      const h = g.split(this.formatSeparator), m = h.shift().trim(), S = h.join(this.formatSeparator).trim();
      return this.format(de(t, l, m, this.options.keySeparator, this.options.ignoreJSONStructure), S, s, {
        ...i,
        ...t,
        interpolationkey: m
      });
    ...
    return [{
      ...
      for (o = 0; n = g.regex.exec(e); ) {
        ...
        else !d(a) && !this.useRawValueToEscape && (a = ne(a));
        const m = g.safeValue(a);
        if (e = e.replace(n[0], m), f ? (g.regex.lastIndex += a.length, g.regex.lastIndex -= n[0].length) : g.regex.lastIndex = 0, o++, o >= this.maxReplaces)
          break;
      }
    }), e;
  }
  nest(e, t, s = {}) {
    ...
    for (; i = this.nestingRegexp.exec(e); ) {
      ...
      d(n) || (n = ne(n)), n || (this.logger.warn(`missed to resolve ${i[1]} for nesting ${e}`), n = ""), l.length && (n = l.reduce((c, f) => this.format(c, f, s.lng, {
        ...s,
...
class Be {
  ...
  init(e, t = {
    ...
    const s = t.cacheInBuiltFormats ? ge : ze;
    this.formats = {
      number: s((i, n) => {
...
class Qe extends Y {
  ...
  loaded(e, t, s) {
    ...
    this.queue.forEach((l) => {
      Ne(l.loaded, [n], a), Je(l, e), t && l.errors.push(t), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((u) => {
        o[u] || (o[u] = {});
        const c = l.loaded[u];
...
}), me = (r) => (d(r.ns) && (r.ns = [r.ns]), d(r.fallbackLng) && (r.fallbackLng = [r.fallbackLng]), d(r.fallbackNS) && (r.fallbackNS = [r.fallbackNS]), r.supportedLngs?.indexOf?.("cimode") < 0 && (r.supportedLngs = r.supportedLngs.concat(["cimode"])), typeof r.initImmediate == "boolean" && (r.initAsync = r.initImmediate), r), J = () => {
}, _e = (r) => {
...
class z extends Y {
  ...
  dir(e) {
    ...
    const t = ["ar", "shu", "sqr", "ssh", "xaa", "yhd", "yud", "aao", "abh", "abv", "acm", "acq", "acw", "acx", "acy", "adf", "ads", "aeb", "aec", "afb", "ajp", "apc", "apd", "arb", "arq", "ars", "ary", "arz", "auz", "avl", "ayh", "ayl", "ayn", "ayp", "bbz", "pga", "he", "iw", "ps", "pbt", "pbu", "pst", "prp", "prd", "ug", "ur", "ydd", "yds", "yih", "ji", "yi", "hbo", "men", "xmn", "fa", "jpr", "peo", "pes", "prs", "dv", "sam", "ckb"], s = this.services?.languageUtils || new fe(pe());
  ...
  cloneInstance(e = {}, t = J) {
    ...
    return n.translator = new W(n.services, i), n.translator.on("*", (o, ...l) => {
      n.emit(o, ...l);
...
const y = z.createInstance();
y.createInstance = z.createInstance;
y.createInstance;
y.dir;
y.init;
y.loadResources;
...
function qe(r) {
  return Ye.call(We.call(arguments, 1), (e) => {
    if (e)
      for (const t in e)
        r[t] === void 0 && (r[t] = e[t]);
  }), r;
...
const xe = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, Ge = function(r, e) {
  ...
  create(r, e, t, s) {
    ...
    t && (i.expires = /* @__PURE__ */ new Date(), i.expires.setTime(i.expires.getTime() + t * 60 * 1e3)), s && (i.domain = s), document.cookie = Ge(r, e, i);
  },
  read(r) {
  ...
  lookup(r) {
    ...
    if (typeof window < "u") {
      ...
      for (let a = 0; a < n.length; a++) {
        const o = n[a].indexOf("=");
        o > 0 && n[a].substring(0, o) === e && (t = n[a].substring(o + 1));
      }
    }
    return t;
  }
...
class ut {
  ...
  detect() {
    ...
    }), t = t.filter((s) => s != null && !Ze(s)).map((s) => this.options.convertDetectedLanguage(s)), this.services && this.services.languageUtils && this.services.languageUtils.getBestMatchFromCodes ? t : t.length > 0 ? t[0] : null;
  }
  cacheUserLanguage(e) {
