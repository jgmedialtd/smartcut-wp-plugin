import { u as Pe, w as te, x as Ue, L as Ne, I as fe, y as me } from "./EcommerceCalculator-CTmE4c2O.js";
import { a as Ee } from "./vendor-axios-DZng9m6S.js";
import { x as c, s as k, d as De, k as $, z as Fe, o as d, c as h, t as O, F as K, u as m, a as T, i as Re, b as U, g as he, j as ne, q as Be, w as pe, n as Ae, h as Ve, E as ze, f as ge, m as ke, I as je } from "./vendor-vue-CrNGqS0k.js";
import { f as We } from "./bandingAxesCache-DMR2pLrK.js";
import { _ as qe } from "./Launch-9LoYYNsk.js";
const L = k(null), ae = k([]), se = k(null), oe = k(!1), be = k(""), ye = k(!1), we = k(null), H = k(!1);
let xe = !1;
function Ge() {
  ...
  async function I(f, x = 1) {
    oe.value = !0, be.value = f || "";
    try {
      const u = { page: x, limit: 50 };
      f && (u.search = f);
      const b = await R.get("ecommerce/admin/organisations", { params: u });
      b.data?.success && (ae.value = b.data.data || [], se.value = b.data.pagination || null);
    } catch (u) {
...
function et(e) {
  ...
  }), x = c(() => S.value ? 1 : 0), u = c(() => x.value + C.value.length), b = c(() => u.value + (s.value ? 1 : 0)), M = c(() => {
    const r = n.value;
  ...
  }), V = c(() => C.value.map((r, o) => te(M.value, x.value + o, F.value).sort())), N = c(() => s.value ? te(M.value, u.value, F.value).map(Number).sort((r, o) => r - o) : []), E = c(() => _.value ? te(M.value, b.value, F.value).map(Number).sort((r, o) => r - o) : []), z = c(() => V.value.map((r) => r.map((o) => ({ value: o, label: o || "(default)" })))), j = c(() => E.value.map((r) => ({ value: r, label: `${r} mm` }))), W = c(() => {
...
const tt = { class: "catalogue-banding-picker levels-picker" }, at = {
...
}, gt = ["aria-selected", "onMousedown", "onMouseenter"], kt = ["src"], bt = {
  key: 1,
  class: "cbp-decor-thumb cbp-decor-thumb--empty"
  ...
  setup(e, { emit: n }) {
    const t = e, p = n, I = c(() => t.payload?.definedFieldLabels?.decor?.trim() || t.decorLabel), C = c(() => t.payload?.definedFieldLabels?.thickness?.trim() || t.thicknessLabel), S = c(() => t.payload), s = k({ ...t.modelValue }), _ = k(""), g = k(!1), D = k(0), f = c(() => t.suggestedDecor), x = k(), u = k(), b = k(), { floatingStyles: M, teleportTarget: F, syncFloatingFont: V } = Ue(
      x,
      u,
      {
            ...
            g.value ? (d(), h("div", {
              ...
              T("div", ht, [
                ...
                (d(!0), h(K, null, ge(m(r).slice(0, 200), (i, v) => (d(), h("div", {
                  ...
                  }, null, 40, kt)) : (d(), h("span", bt, O(i.name.slice(0, 2).toUpperCase()), 1)),
                  T("div", yt, [
                    T("div", wt, [
...
}), Tt = /* @__PURE__ */ qe(Ot, [["__scopeId", "data-v-0a6eb006"]]), Et = /* @__PURE__ */ De({
  ...
  setup(e, { emit: n }) {
    ...
    })), C = k(!1), S = k(""), s = k(null), _ = c(() => s.value && me(s.value, I.value)?.value || ""), g = k(!1);
    function D() {
      g.value = !0;
    }
    $(() => t.initialCode, (u) => {
    ...
    return $(
      ...
      }), b || console.log("[CatalogueBandingPicker] no auto-hydration", { stockIdentity: I.value });
    }), (u, b) => (d(), ne(Tt, {
      payload: s.value,
      loading: C.value,
      error: S.value,
      ...
      debug: e.debug,
      onEngage: D,
      "onUpdate:modelValue": b[0] || (b[0] = (M) => p("update:modelValue", M)),
      "onUpdate:resolvedCode": b[1] || (b[1] = (M) => p("update:resolvedCode", M))
