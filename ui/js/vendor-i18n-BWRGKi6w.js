const p = (r) => typeof r == "string", K = () => {
  let r, e;
  const t = new Promise((s, i) => {
    r = s, e = i;
  });
  return t.resolve = r, t.reject = e, t;
}, ie = (r) => r == null ? "" : "" + r, $e = (r, e, t) => {
  r.forEach((s) => {
    e[s] && (t[s] = e[s]);
  });
}, Re = /###/g, ne = (r) => r && r.indexOf("###") > -1 ? r.replace(Re, ".") : r, re = (r) => !r || p(r), M = (r, e, t) => {
...
const je = [" ", ",", "?", "!", ";"], Ie = new De(20), Te = (r, e, t) => {
  ...
  return i;
}, H = (r) => r == null ? void 0 : r.replace("_", "-"), Ae = {
  type: "logger",
  log(r) {
    this.output("log", r);
  },
...
class oe extends q {
  ...
  getResource(e, t, s, i = {}) {
    ...
    return !l && !t && !s && e.indexOf(".") > -1 && (e = o[0], t = o[1], s = o.slice(2).join(".")), l || !a || !p(s) ? l : Z((h = (u = this.data) == null ? void 0 : u[e]) == null ? void 0 : h[t], s, n);
  }
  addResource(e, t, s, i, n = {
    ...
    let o = [e, t];
    s && (o = o.concat(a ? s.split(a) : s)), e.indexOf(".") > -1 && (o = e.split("."), i = t, t = o[1]), this.addNamespaces(t), ae(this.data, o, i), n.silent || this.emit("added", e, t, s, i);
  }
  ...
  addResourceBundle(e, t, s, i, n, a = {
    ...
    a.skipCopy || (s = JSON.parse(JSON.stringify(s))), i ? we(l, s, n) : l = {
      ...l,
      ...s
    }, ae(this.data, o, l), a.silent || this.emit("added", e, t, s);
  }
...
const le = {}, ue = (r) => !p(r) && typeof r != "boolean" && typeof r != "number";
class Y extends q {
  constructor(e, t = {}) {
  ...
  translate(e, t, s) {
    ...
    const m = (d == null ? void 0 : d.usedKey) || o, x = (d == null ? void 0 : d.exactUsedKey) || o, v = ["[object Number]", "[object Function]", "[object RegExp]"], O = i.joinArrays !== void 0 ? i.joinArrays : this.options.joinArrays, E = !this.i18nFormat || this.i18nFormat.handleAsObject, b = i.count !== void 0 && !p(i.count), P = Y.hasDefaultValue(i), B = b ? this.pluralResolver.getSuffix(f, i.count, i) : "", N = i.ordinal && b ? this.pluralResolver.getSuffix(f, i.count, {
      ordinal: !1
    }) : "", A = b && !i.ordinal && i.count === 0, w = A && i[`defaultValue${this.options.pluralSeparator}zero`] || i[`defaultValue${B}`] || i[`defaultValue${N}`] || i.defaultValue;
    let y = c;
    E && !c && P && (y = w);
    const ke = ue(y), Ce = Object.prototype.toString.apply(y);
    if (E && y && ke && v.indexOf(Ce) < 0 && !(p(O) && Array.isArray(y))) {
      ...
      if (k || C || F) {
        ...
        const ee = (L, D, U) => {
          var se;
          const te = P && U !== c ? U : $;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(L, u, D, te, F, i) : (se = this.backendConnector) != null && se.saveMissing && this.backendConnector.saveMissing(L, u, D, te, F, i), this.emit("missingKey", L, u, D, c);
        };
        this.options.saveMissing && (this.options.saveMissingPlurals && b ? V.forEach((L) => {
          const D = this.pluralResolver.getSuffixes(L, i);
          A && i[`defaultValue${this.options.pluralSeparator}zero`] && D.indexOf(`${this.options.pluralSeparator}zero`) < 0 && D.push(`${this.options.pluralSeparator}zero`), D.forEach((U) => {
            ee([L], o + U, i[`defaultValue${U}`] || w);
          });
        }) : ee(V, o, w));
      }
  ...
  resolve(e, t = {}) {
    ...
    return p(e) && (e = [e]), e.forEach((l) => {
      ...
      f.forEach((x) => {
        var v, O;
        this.isValidLookup(s) || (o = x, !le[`${m[0]}-${x}`] && ((v = this.utils) != null && v.hasLoadedNamespace) && !((O = this.utils) != null && O.hasLoadedNamespace(o)) && (le[`${m[0]}-${x}`] = !0, this.logger.warn(`key "${i}" for languages "${m.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), m.forEach((E) => {
          var B;
          if (this.isValidLookup(s)) return;
          a = E;
          const b = [h];
          if ((B = this.i18nFormat) != null && B.addLookupKeys)
            ...
            const A = `${this.options.pluralSeparator}zero`, w = `${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;
            if (g && (b.push(h + N), t.ordinal && N.indexOf(w) === 0 && b.push(h + N.replace(w, this.options.pluralSeparator)), d && b.push(h + A)), c) {
              const y = `${h}${this.options.contextSeparator}${t.context}`;
              b.push(y), g && (b.push(y + N), t.ordinal && N.indexOf(w) === 0 && b.push(y + N.replace(w, this.options.pluralSeparator)), d && b.push(y + A));
            }
          }
          let P;
          for (; P = b.pop(); )
...
const de = (r, e, t, s = ".", i = !0) => {
  let n = Ne(r, e, t);
  return !n && i && p(t) && (n = Z(r, t, s), n === void 0 && (n = Z(e, t, s))), n;
}, G = (r) => r.replace(/\$/g, "$$$$");
class Ue {
  constructor(e = {}) {
    var t;
  ...
  interpolate(e, t, s, i) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, u = (c) => {
      if (c.indexOf(this.formatSeparator) < 0) {
        const O = de(t, l, c, this.options.keySeparator, this.options.ignoreJSONStructure);
    ...
    return [{
      ...
      for (o = 0; n = c.regex.exec(e); ) {
        ...
        else !p(a) && !this.useRawValueToEscape && (a = ie(a));
  ...
  nest(e, t, s = {}) {
    ...
    for (; i = this.nestingRegexp.exec(e); ) {
      ...
      p(n) || (n = ie(n)), n || (this.logger.warn(`missed to resolve ${i[1]} for nesting ${e}`), n = ""), u && (n = l.reduce((h, f) => this.format(h, f, s.lng, {
        ...s,
...
class He {
  ...
  init(e, t = {
    ...
    const s = t.cacheInBuiltFormats ? ge : Me;
    this.formats = {
      number: s((i, n) => {
...
class Be extends q {
  ...
  loaded(e, t, s) {
    ...
    this.queue.forEach((l) => {
      Pe(l.loaded, [n], a), ze(l, e), t && l.errors.push(t), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach((u) => {
        o[u] || (o[u] = {});
        const h = l.loaded[u];
...
class z extends q {
  ...
  init(e = {}, t) {
    ...
    if (!this.options.isClone) {
      ...
      }, f.backendConnector = new Be(i(this.modules.backend), f.resourceStore, f, this.options), f.backendConnector.on("*", (g, ...d) => {
        this.emit(g, ...d);
  ...
  cloneInstance(e = {}, t = W) {
    ...
    if ((e.debug !== void 0 || e.prefix !== void 0) && (n.logger = n.logger.clone(e)), ["store", "services", "language"].forEach((o) => {
      ...
      n.store = new oe(o, i), n.services.resourceStore = n.store;
    }
...
function _e(r) {
  return Qe.call(We.call(arguments, 1), (e) => {
    if (e)
      for (const t in e)
        r[t] === void 0 && (r[t] = e[t]);
  }), r;
...
const xe = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, qe = function(r, e) {
  ...
  create(r, e, t, s) {
    ...
    t && (i.expires = /* @__PURE__ */ new Date(), i.expires.setTime(i.expires.getTime() + t * 60 * 1e3)), s && (i.domain = s), document.cookie = qe(r, encodeURIComponent(e), i);
  },
  read(r) {
...
class at {
  ...
  init() {
    ...
    this.services = e, this.options = _e(t, this.options || {}, rt()), typeof this.options.convertDetectedLanguage == "string" && this.options.convertDetectedLanguage.indexOf("15897") > -1 && (this.options.convertDetectedLanguage = (i) => i.replace("-", "_")), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = s, this.addDetector(Ge), this.addDetector(Ze), this.addDetector(Xe), this.addDetector(et), this.addDetector(tt), this.addDetector(st), this.addDetector(it), this.addDetector(nt);
  }
  addDetector(e) {
  ...
  detect() {
    ...
    }), t = t.filter((s) => s != null && !Ye(s)).map((s) => this.options.convertDetectedLanguage(s)), this.services && this.services.languageUtils && this.services.languageUtils.getBestMatchFromCodes ? t : t.length > 0 ? t[0] : null;
  }
  cacheUserLanguage(e) {
