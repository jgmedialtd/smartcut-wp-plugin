import { F as ue, I as ne } from "./EcommerceCalculator-xTmaI3ss.js";
import { o as k, q as K, u as T, i as Oe, h as A, t as qe, n as je, v as fe, k as pe, w as Fe } from "./vendor-C76etQCp.js";
import { d as He, O as Xe, k as L, l as Ke, o as F, c as N, a as re, m as oe, u as Ze, b as V, j as ye, F as J, f as we, B as Qe, x as D, s as q, H as Ye, g as ae, t as ie, q as et } from "./vendor-vue-DcIxm_xE.js";
import { _ as tt } from "./Launch-CoGHL0vS.js";
function nt(n, e) {
  const r = {};
...
const R = pe(["x", "y", "z"]), B = pe(["top", "bottom", "left", "right", "front", "back"]), rt = k({
  ...
  w: R,
  t: R
}), w = T([je(), A()]), ot = k({ my: B, their: B }), at = k({ center: R }), it = k({ axis: R, offset: w }), st = ot.transform((n) => ({ kind: "edge", ...n })), ct = at.transform((n) => ({ kind: "center", ...n })), ut = it.transform((n) => ({ kind: "offset", ...n })), lt = T([
  st,
  ct,
  ut
]);
...
const Pe = k({
  ...
  ...de,
  repeat: Re
}), bt = vt.transform((n) => ({ kind: "root", ...n })), kt = xt.transform((n) => ({ kind: "joined", ...n })), St = yt.transform((n) => ({ kind: "mirrored", ...n })), At = wt.transform((n) => ({ kind: "repeated", ...n })), Ce = T([
  bt,
  kt,
  St,
  At
...
const Ae = 32;
function Ft(n, e = {}) {
  if (!n.instances.some(H))
    return n;
  const o = n.templates ?? {};
  let t = n.instances;
  for (let a = 0; a < Ae && t.some(H); a++) {
    const u = [];
    for (const l of t)
      if (H(l)) {
        const i = Pt(l, o, e);
    ...
    for (const t of Object.keys(n)) {
      ...
      if (typeof a == "string")
        ...
        for (let s = 0; s < a.length; s++)
          typeof a[s] == "string" ? a[s] = $e(t, a[s], e, r, o) : le(a[s], e, r, o);
      else typeof a == "object" && le(a, e, r, o);
    }
}
function $e(n, e, r, o, t) {
  let a = e;
  return n === "to" || n === "mirrorOf" ? a = Te(a, r, o) : Nt(a) && (a = _t(a, r, o)), a.startsWith("=") && (a = Ct(a, t)), a;
}
function Te(n, e, r) {
...
class It {
  ...
  solveJoinPosition(e, r, o) {
    const t = C[e.myFace], a = C[e.theirFace];
    if (t.axis !== a.axis)
  ...
  axisOfRule(e) {
    ...
    const r = C[e.my].axis, o = C[e.their].axis;
    if (r !== o)
  ...
  applyAlignRule(e, r, o, t) {
    ...
    if (!be(e))
      throw new b("Unknown AlignRule variant");
    const a = C[e.my].sign, s = C[e.their].sign;
  ...
  repeatBetween(e, r, o, t) {
    ...
    for (const _ of ["x", "y", "z"]) {
      if (_ === i)
        continue;
      const U = P?.[_];
      U !== void 0 && (z[_] = this.evalNumber(U));
    }
    const E = e.shift !== void 0 ? this.evalNumber(e.shift) : 0;
    for (let _ = 1; _ <= r; _++) {
      const U = { ...z };
      U[i] = u.coord + h * _ + E, v.push(U);
    }
    return v;
  }
  repeatAxis(e, r, o) {
...
const Tt = {
  key: 0,
  class: "debug"
}, Et = { id: "sc-configurator" }, Ut = { class: "configurator__group-legend" }, Bt = /* @__PURE__ */ He({
  __name: "Configurator",
  props: {
    currency: {
      type: String,
  ...
  setup(n, { expose: e, emit: r }) {
    const o = Qe(() => import("./ObjectViewer-BvG3JkRw.js")), t = n, a = r, s = Xe("calculator"), u = D(() => s());
    let l = null;
    const i = q(null), d = q([]), h = q(!1), v = q(""), z = D(() => {
      ...
      for (; f < c.length; ) {
        ...
        const $ = m?.groupLabel ?? g, S = m?.groupLayout === "row" ? "row" : "column", O = [];
        for (; f < c.length; ) {
          const [W, j] = c[f];
          if (j?.display === "visualizer" || j?.group !== g) break;
          O.push({ input: j, key: W, index: f }), f++;
        }
        p.push({ kind: "group", label: $, key: g, items: O, layout: S });
      }
      return p;
    }), P = D(() => {
    ...
    function _(c) {
      ...
      for (const [m, y] of Object.entries(c)) {
        ...
        if (g)
          try {
            const $ = g.replace(/^=\s*/, "");
            if (!l.evaluateExpression($, x)) continue;
          } catch {
    ...
    L(Ee, (c) => {
      ...
      for (const [y, g] of Object.entries(P.value)) {
        ...
        const S = p(g), O = f.get(S), j = (m[y] || {}).materialGroup, De = j ? t.materialPickMeta?.[j]?.code : void 0, Ge = j ? t.materialPicks?.[j] : void 0, te = De || Ge || g.material || "", xe = {
          ...g,
    ...
    function ve(c) {
      ...
      for (let f = 0; f < p.length; f++) {
        ...
        const y = c?.[m.group], g = typeof y?.selectedThickness == "number" ? y.selectedThickness : null, $ = Array.isArray(y?.availableThicknesses) && y.availableThicknesses.length > 0 ? Math.min(...y.availableThicknesses) : null;
        let S = g ?? $;
        if (S === null) continue;
