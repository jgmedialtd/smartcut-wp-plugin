import { d as _, B as i, r as p, c as l, j as y, a as f, e as d, C as k, t as v, h as u, b as m } from "./vendor-vue-BYiwvu61.js";
const h = {
  key: 1,
  class: "error-message"
}, C = /* @__PURE__ */ _({
  ...
  setup(t, { expose: s }) {
    const o = p(!1), n = p(null), a = i({
      wordpress: u(() => import("./WordPress-BReklCT8.js")),
      vanilla: u(() => import("./Vanilla-CUnG7ss8.js").then((c) => c.V))
    }), e = t, r = l(() => {
