const { initializeZodTranslations: i } = await import("./zod-error-map-B45HhBgy.js");
i();
const { initializeStaticRegistry: l } = await import("./static-class-registry-DparBkbx.js");
l();
const { shouldClearStorage: u } = await import("./version-utils-Ds2b9_6L.js"), n = "checkout-app-version", o = "4.0.5";
{
...
const w = await import("./Launch-CtrX8dRv.js"), d = w.default;
let s = null, c = !1;
const h = async () => {
  if (!c) {
    c = !0;
