const { initializeZodTranslations: i } = await import("./zod-error-map-DLOt7qJM.js");
i();
const { initializeStaticRegistry: l } = await import("./static-class-registry-c3j9u8l3.js");
l();
const { shouldClearStorage: m } = await import("./version-utils-Ds2b9_6L.js"), n = "checkout-app-version", o = "4.0.20";
{
...
const w = await import("./Launch-BhfRjGvc.js"), d = w.default;
let s = null, c = !1;
const h = async () => {
  if (!c) {
    c = !0;
