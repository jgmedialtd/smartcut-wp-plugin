import { d as defineComponent, g as ref, j as onMounted, c as createElementBlock, o as openBlock, z as createVNode, e as createCommentVNode, s as createBlock, u as unref, B as defineAsyncComponent, b as createBaseVNode, F as Fragment, k as nextTick, O as markRaw, U as provide, E as shallowRef, V as onBeforeMount, h as computed, W as resolveDynamicComponent, t as toDisplayString, X as createApp, Y as FontAwesomeIcon } from "./vendor-vue-Dk_GuyMk.js";
import { q as mainSides, v as faces, w as getNestedProperty, C as CheckoutCalculator, p as convertNumberFormat, x as checkObjectHasPropery, y as objectValuesPresent, z as t, A as truncateString, B as sanitiseString, D as mapLegacyInitData, _ as _export_sfc, E as i18nextReady } from "./components-DNQps9NE.js";
import { J as JSZip, D as library$1, E as faXmark, G as faExpand, H as faExpand$1, I as faPlusLarge, K as faPlusLarge$1, L as faArrowsLeftRight, M as faArrowsUpDown, N as faHammer, O as faSprayCan, Q as faImage, S as faFiles, T as faTrash, U as faCalculator } from "./vendor-Bl85u5aa.js";
import { E, a as autoTable } from "./vendor-pdf-5e6yqo4d.js";
import { u as useInputs, f as useProductPricing } from "./composables-_fF_hxOz.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "WordPress",
  setup(__props) {
    const FormulaPricing = defineAsyncComponent(() => import("./components-DNQps9NE.js").then((n) => n.F));
    const ObjectViewer = defineAsyncComponent(() => import("./components-DNQps9NE.js").then((n) => n.O));
    const Notices = defineAsyncComponent(() => import("./components-DNQps9NE.js").then((n) => n.N));
    ...
    onMounted(() => {
      var _a;
      console.log("💥 Powered by https://smartcut.dev", (_a = window == null ? void 0 : window.smartcutConfig) == null ? void 0 : _a.version);
...
const Launch = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-afc067af"]]);
library$1.add(
  faXmark,
  faExpand,
  faExpand$1,
