import { d as defineComponent, y as useTranslation, g as ref, U as provide, j as onMounted, o as openBlock, c as createElementBlock, A as createVNode, u as unref, b as createBaseVNode, t as toDisplayString, f as createCommentVNode, q as createBlock, F as Fragment, k as nextTick, O as markRaw, C as defineAsyncComponent, G as shallowRef, V as onBeforeMount, h as computed, W as resolveDynamicComponent, X as createApp, Y as install, Z as FontAwesomeIcon } from "./vendor-vue-DYb4rgTA.js";
import { i as instance, B as Browser } from "./vendor-i18n-CwRLCSuJ.js";
import { q as capitalise, d as sentenceCase, v as setI18nInstance, w as mainSides, x as faces, y as getNestedProperty, C as CheckoutCalculator, z as checkObjectHasPropery, A as objectValuesPresent, p as convertNumberFormat, B as truncateString, D as sanitiseString, E as mapLegacyInitData, _ as _export_sfc } from "./components-5Ywb82Gq.js";
...
import { u as useInputs, f as useProductPricing } from "./composables-BBn_9UTw.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const FormulaPricing = defineAsyncComponent(() => import("./components-5Ywb82Gq.js").then((n) => n.F));
    const ObjectViewer = defineAsyncComponent(() => import("./components-5Ywb82Gq.js").then((n) => n.O));
    const Notices = defineAsyncComponent(() => import("./components-5Ywb82Gq.js").then((n) => n.N));
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        unref(env) === "development" && showDevInfo ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
          ...
          createBaseVNode("div", null, "Stock thickness: " + toDisplayString(stock.value[0].t), 1),
          createBaseVNode("div", null, "Shape thickness: " + toDisplayString(unref(inputShapes)[0].t), 1)
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    onBeforeMount(() => {
      console.log(`💥 Powered by https://smartcut.dev V${currentVersion}`);
