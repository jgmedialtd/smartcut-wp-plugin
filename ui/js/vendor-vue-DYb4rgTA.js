import { A as parse$1, B as icon, C as isNode, D as getNodeName, E as computePosition, G as arrow$1 } from "./vendor-CklyHjfV.js";
/**
* @vue/shared v3.5.13
...
function useTranslation(ns, options) {
  ...
  let t;
  {
    t = i18next.getFixedT(null, ns != null ? ns : null, void 0);
  }
  return {
    i18next,
...
var TranslationComponent = /* @__PURE__ */ defineComponent({
  props: {
    translation: {
      type: String,
      required: true
...
//# sourceMappingURL=vendor-vue-DYb4rgTA.js.map
