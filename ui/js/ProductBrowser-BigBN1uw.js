import { L as se } from "./EcommerceCalculator-xTmaI3ss.js";
import { d as R, o as n, c as u, N as z, w as D, g as T, P as N, a as b, b as p, t as P, n as re, s as m, x as I, k as O, j as E, u as r, F as Q, f as A, m as ne, p as K } from "./vendor-vue-DcIxm_xE.js";
import { _ as G } from "./Launch-CoGHL0vS.js";
import { C as ce, a as ue } from "./CatalogueSort-BmB374sp.js";
...
function Se(l) {
  ...
  function F(a) {
    if (!i.value) return "";
    const { apiUrl: c, orgSlug: f, isCustomDomain: x } = i.value;
    return x ? `${c}ecommerce/${a}` : `${c}ecommerce/${f}/${a}`;
  }
  async function U() {
    if (i.value) {
      ...
      r(e).isLoading.value ? (n(), u("div", Fe, [
        ...
        (n(!0), u(Q, null, A(r(e).items.value, (t) => (n(), E($e, {
          ...
          badges: K(() => [
            ...
            t.category && typeof t.category == "object" ? (n(), u("span", xe, P(t.category.name), 1)) : p("", !0)
          ]),
          meta: K(() => [
