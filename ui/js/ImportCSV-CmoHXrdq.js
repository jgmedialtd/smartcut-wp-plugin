import { E as ce, o as M, c as P, a as de, t as z, w as I, g as ue, d as fe, l as me, m as pe, u as K, b as he, s as g, x as Y } from "./vendor-vue-DcIxm_xE.js";
import { P as ge } from "./vendor-C76etQCp.js";
import { j as x } from "./InputUserGroup-BS7MVA1o.js";
import { _ as be } from "./Launch-CoGHL0vS.js";
import { u as ye } from "./EcommerceCalculator-xTmaI3ss.js";
...
const ke = /* @__PURE__ */ be(ve, [["render", we]]), De = { id: "import-file" }, qe = /* @__PURE__ */ fe({
  __name: "ImportCSV",
  props: {
    numberFormat: {
      type: String,
  ...
  emits: ["error", "import"],
  setup(f, { emit: p }) {
    const { addNotice: d } = ye(), o = f, v = p, b = g([]), y = g([]), F = g([]), E = g([]), w = g({}), S = g([]), B = g(!1), $ = g(null), N = g(null), q = g({}), A = [
      "l",
      "w",
      "t",
      "q",
      ...
      finish: ["", "", "matt,gloss", ""],
      cost: ["", "", "", ""]
    }, ee = ["banding", "finish", "planing", "machining"], V = A.filter((e) => !ee.includes(e)), te = () => {
...
`);
      ...
      B.value = !1, E.value = Object.values(w.value).map((t) => !t || t === "N" ? null : A.includes(t) ? t : (B.value = !0, null));
      const e = E.value.filter((t, n) => E.value.indexOf(t) !== n);
      S.value = e.map((t) => E.value.reduce(
