...
y();
const { initializeStaticRegistry: S } = await import("./static-class-registry-8xGXNzVH.js");
S();
const { clearStorageOnceAboveThreshold: A, createLocalStorageAdapter: E } = await import("./version-utils-DJMibzAZ.js"), L = "version/checkout/current", _ = "version/checkout/last-clear", R = "4.0.58", P = "4.1.6";
{
  const a = E();
  A(
    P,
...
}, v = await import("./Launch-DrD-8UqN.js").then((a) => a.L), C = v.default;
let r = null, n = !1;
const F = async () => {
  if (!n) {
    n = !0;
