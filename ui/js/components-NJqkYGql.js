...
var hr = (i, t, e) => t in i ? cr(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e;
var c = (i, t, e) => hr(i, typeof t != "symbol" ? t + "" : t, e);
...
const zt = 1e-10, Yr = 10, Xr = Number.MAX_SAFE_INTEGER, Kr = 4294967295, qe = (i) => typeof i == "number" && Number.isFinite(i), Ai = (i) => Array.isArray(i) && i.length > 0;
...
function Jr(i) {
  return qe(i) ? Number.isInteger(i) ? i : Number(i.toFixed(Yr)) : !1;
}
function Qr(i) {
  if (!qe(i) || i < 0 || i > Xr)
    throw new Error("Invalid length parameter");
  return Math.floor(crypto.getRandomValues(new Uint32Array(1))[0] / (Kr + 1) * i);
}
function eo(i, t) {
  if (!Ai(i))
...
const ce = {
  ...
  getRandom: Qr,
  getRandomSample: eo,
  calculateStandardDeviation: xi.calculateStandardDeviation.bind(xi),
  calculateCoefficientOfVariation: xi.calculateCoefficientOfVariation.bind(xi)
}, Rs = 10, to = 0;
...
function x(i) {
  ...
  if (typeof i.v == "number" && (i.nf === "decimal" || !i.nf && !((l = i.o) != null && l.numberFormat))) {
    if (i.dp === void 0 && ((a = i.o) == null ? void 0 : a.decimalPlaces) === void 0)
      return i.v;
    const f = i.dp ?? ((u = i.o) == null ? void 0 : u.decimalPlaces) ?? Rs, p = Math.pow(10, f);
    return Math.round(i.v * p) / p;
  }
  const t = i.o ?? {}, e = i.nf ?? t.numberFormat ?? "decimal", s = i.dp ?? t.decimalPlaces ?? Rs, n = i.pl ?? t.parseLocale ?? !1, r = i.fr ?? t.fractionRoundTo ?? to;
  try {
    const f = lo(i.v, n);
    return f ? e === "decimal" ? so(f, i.v, s) : no(f, r) : e === "decimal" ? 0 : "0";
  } catch (f) {
    throw new ps(
...
function so(i, t, e) {
  ...
  if (typeof i == "string" && !i.includes("/")) {
    ...
    return ki(Math.round(l * a) / a);
  }
  const n = new ai(i).valueOf();
  if (typeof t == "string" && t.includes("/")) {
    if (typeof e == "number") {
      const l = Math.pow(10, e);
      return ki(Math.round(n * l) / l);
    }
    return n;
  }
  const r = io(String(t)), o = Math.pow(10, r);
  return ki(Math.round(n * o) / o);
}
function no(i, t) {
...
function Ei(i) {
  ...
  try {
    ...
    throw new ps(`Failed to parse number: ${i}`);
  }
}
function oo(i) {
  if (!i) return !1;
...
const ve = (i, t, e) => t in i ? i[t] : (console.warn(_i.missingProperty(String(t), e)), null), Ci = (i, t) => (e, s) => {
  const n = i(e, s);
  return n !== 0 ? n : t(e, s);
}, jt = (i, t) => {
  if (!Fs(i) || !Fs(t))
    return console.warn(_i.missingArea), 0;
...
const qi = {
  ...
  aspect(i, t) {
    return !_s(i) || !_s(t) ? (console.warn(_i.missingAspect), 0) : t.getAspect() - i.getAspect();
  },
  fillThenArea(i) {
    return (t, e) => !qs(t) || !qs(e) ? (console.warn(_i.missingLongSide), 0) : e[i] === t[i] ? -jt(t, e) : parseFloat(String(e[i])) - parseFloat(String(t[i]));
  }
};
function ao(i, t, e, s = !1, n = !1) {
  return t.filter((r, o) => {
    const l = {
      fit: uo(i) && ji(i, r, void 0, e),
      material: co(i, r, s),
      thickness: ho(i, r, n),
      width: fo(i, r)
    };
...
function fo(i, t) {
  var e;
  return ((e = t == null ? void 0 : t.saw) == null ? void 0 : e.stockType) !== "linear" || !Je(i) ? !0 : ss(i, 0, t) && ce.equalTo(i.w, t.w) || ss(i, 1, t) && ce.equalTo(i.l, t.w);
}
const Bs = (i) => i.some((t) => t === !0), po = (i, t) => i.some((e, s) => e && t[s]);
function go(i, t, e) {
  ...
  for (const p of i) {
    ...
    const I = ao(p, t, e, o, l);
    p.stockMatch.fit = Bs(p.stockMatch.fit);
    const d = po(
      p.stockMatch.material,
      p.stockMatch.thickness
    );
    if (p.stockMatch.width = Bs(p.stockMatch.width), !s && I.length) {
  ...
  let u, f;
  return s || (u = i.filter((p) => !p.stockLock || !p.stockLock.length).sort(qi.ID), f = t.filter((p) => !a.has(p.parentID)).sort(qi.ID), t = t.filter((p) => dt(p)).filter((p) => a.has(p.parentID)), (o || l) && (i = i.filter((p) => {
    var I;
...
class re {
  constructor({
    ...
    const f = `issue created for ${yl(t)}: ${this.identifier || "N/A"} - ${this.message} for field ${this.field || "N/A"}`;
...
const Qt = ({ item: i, field: t, index: e, newIssues: s, min: n = null, max: r = null, required: o = !1, allowZero: l = !0, isWarning: a = !1 }) => {
  ...
  return yo({ item: i, field: t, value: u, index: e, issues: s, min: n, isWarning: a }), bo({ item: i, field: t, value: u, index: e, issues: s, max: r, isWarning: a }), u;
}, vo = ({ item: i, field: t, value: e, index: s, issues: n, isWarning: r }) => {
  new re({
    item: i,
...
}, yo = ({ item: i, field: t, value: e, index: s, issues: n, min: r, isWarning: o }) => {
...
}, bo = ({ item: i, field: t, value: e, index: s, issues: n, max: r, isWarning: o }) => {
  typeof e == "number" && typeof r == "number" && e > r && new re({
    item: i,
...
}, Io = ({ item: i, index: t, max: e, isWarning: s, saw: n }) => {
  const r = [];
...
function yn(i, t) {
  return Mo(i).includes(t);
}
function bn(i, t, e) {
  return Ro(i, t).includes(e);
}
function Ii(i, t, e, s = {}) {
  for (const n in s)
...
class Dt {
  constructor(t, e) {
    ...
    c(this, "issues");
    t = qt(t), this.issues = [], e = e ?? (t == null ? void 0 : t.stockType) ?? Ye.stockTypes[0], qo(this, t, e), !this.issues.length && (this.bladeWidth = x({ v: t == null ? void 0 : t.bladeWidth }) ?? Ye.defaults.bladeWidth, this.stockType = e ?? (t == null ? void 0 : t.stockType) ?? Ye.stockTypes[0], vn(this.stockType) || (this.stockType = Ye.stockTypes[0]), this.cutType = t == null ? void 0 : t.cutType, yn(this.stockType, this.cutType) || (this.cutType = Fo(this.stockType)[0]), this.cutPreference = t == null ? void 0 : t.cutPreference, bn(this.stockType, this.cutType, this.cutPreference) || (this.cutPreference = _o(this.stockType, this.cutType)[0]), this.stackHeight = (t == null ? void 0 : t.stackHeight) ?? Ye.defaults.stackHeight, this.guillotineOptions = Di({}, t == null ? void 0 : t.guillotineOptions, Ye.defaults.guillotine), this.efficiencyOptions = Di({}, t == null ? void 0 : t.efficiencyOptions, Ye.defaults.efficiency), this.options = Di({}, t == null ? void 0 : t.options, Ye.defaults.options), this.options.minSpacing = x({ v: this.options.minSpacing }) ?? 0, this.options.minSpacingDimension.dimension = x({ v: this.options.minSpacingDimension.dimension }) ?? 0, this.options.minSpacingDimension.minSpacing = x({ v: this.options.minSpacingDimension.minSpacing }) ?? 0);
  }
  clone() {
...
function qo(i, t, e) {
  if (k(t == null ? void 0 : t.bladeWidth) && (t.bladeWidth = typeof t.bladeWidth == "string" ? x({ v: t.bladeWidth }) : t.bladeWidth), (fi(t.bladeWidth) || t.bladeWidth < 0) && Ii(
    i,
    "bladeWidth",
  ...
  t.cutType && !yn(e, t.cutType) && Ii(
    i,
    "cutType",
    "saw.validation.cutType.invalid",
    { cutType: t.cutType, stockType: e }
  ), t.cutType && t.cutPreference && !bn(e, t.cutType, t.cutPreference) && Ii(
    i,
...
function es(i, t, e = !1) {
  ...
  return e && (s = Bo(i, s)), n === t || ([s.l, s.w] = [s.w, s.l]), s;
}
function wn(i) {
...
function ji(i, t, e, s) {
  ...
  let n = 0;
  s && gs(s) ? n = s.getMinSpacing() : s && ((I = s == null ? void 0 : s.options) != null && I.minSpacing) ? n = x({ v: s.options.minSpacing }) : Ss(t) && (n = (d = t == null ? void 0 : t.saw) == null ? void 0 : d.getMinSpacing());
  const r = is(t, !0), o = is(i, !0);
  if (o.l * o.w > r.l * r.w)
    return !1;
  function l(m, w) {
...
function ms(i, t) {
  const e = Sn(i);
  return k(e) ? !t || At(i) ? e : Ss(t) ? Go(i, t) : e : null;
}
function Go(i, t) {
  if (!t) throw new Error("container not supplied to convertShapeGrainToOrientationLock");
  if (!Ss(t)) throw new Error("container is not a container");
  const e = Sn(i);
  if (At(i)) return e;
  if (!k(e)) return null;
  const s = t.getStock();
...
function ss(i, t = null, e = null) {
  ...
  if (t === !0 && (t = 1), t === !1 && (t = 0), xn(i) && t || e && !ji(i, e, t))
    return !1;
  const s = ms(i, e);
  return !(s === "l" && t === 1 || s === "w" && t === 0);
}
function ns(i, t = null, e = null) {
  return t === null && (t = i.rot === 0 ? 1 : 0), ss(i, t, e) ? (i.rot === t || Ho(i), !0) : !1;
}
function Zt(i, t = null, e = null) {
  return t ? t = 1 : t = 0, e && t && !ji(i, e, t) ? !1 : ns(i, t, e);
}
function Wo(i, t) {
  if (!t)
...
class Yt {
  constructor(t) {
    ...
    c(this, "origin");
    c(this, "type");
    this.x1 = t.x1, this.x2 = t.x2, this.y1 = t.y1, this.y2 = t.y2, this.dimension = jo(this), this.direction = zo(this), this.type = t != null && t.type ? t.type : null, this.origin = t != null && t.origin ? t.origin : null;
  }
  getCoordinates() {
    return {
      x1: this.x1,
...
function Cn(i = [], t = null) {
  i != null && i.length && kn() && Yo.runTests;
}
Xe.colors = [
  2,
  3,
...
class zi extends Yt {
  ...
  constructor(e) {
    ...
    c(this, "type", null);
    c(this, "remove");
    k(e == null ? void 0 : e.stock) && (((n = (s = e.stock) == null ? void 0 : s.constructor) == null ? void 0 : n.name) === "Stock" ? this.stock = e.stock : this.stock = new Gt(e.stock), this.stockId = this.stock.id), this.stockId = (r = e == null ? void 0 : e.stock) == null ? void 0 : r.id, this.type = e.type ?? null, this.guillotine = e.guillotine, this.guillotineData = k(e.guillotineData) ? e.guillotineData : {}, this.guillotineData.ptxDummyCut = (e == null ? void 0 : e.ptxDummyCut) || ((o = e == null ? void 0 : e.guillotineData) == null ? void 0 : o.ptxDummyCut) || !1, this.isTrim = k(e.isTrim) ? e.isTrim : !1, this.isHead = k(e.isHead) ? e.isHead : !1, this.distances = k(e.distances) ? e.distances : {}, this.beamTrimX1 = e.beamTrimX1, this.beamTrimY1 = e.beamTrimY1;
  }
...
class Ee {
  ...
  getAvailableShapePositions(t) {
    ...
    return (t == null ? void 0 : t.cutType) !== "efficiency" ? (Li[this.corner] && (this.grid ? Li[this.corner][this.grid] && Li[this.corner][this.grid].forEach((s) => e.add(s)) : Li[this.corner].default.forEach((s) => e.add(s))), e) : (Pi[this.corner] && (this.grid ? Pi[this.corner][this.grid] && Pi[this.corner][this.grid].forEach((s) => e.add(s)) : Pi[this.corner].default.forEach((s) => e.add(s))), e);
  }
}
class Ht {
  constructor(t = []) {
...
function Qo(i, t, e) {
  ...
  if (n.forEach((I) => {
    ...
    let j = s.toArray();
    for (let ee = j.length; ee--; ) {
      const z = j[ee];
      (ce.lessThan(z.x, d) || ce.lessThan(z.y, m) || ce.greaterThan(z.x, w) || ce.greaterThan(z.y, R)) && j.splice(ee, 1);
    }
...
function sl(i, t) {
  ...
  return s.filter(({ shape: l }) => l.id === o.id).forEach(({ shape: l, rays: a }) => {
    ...
    for (const f of u) {
      ...
      r === f.direction && (Ln(p, l, null, f.direction, "edge"), e.addPoint(p));
    }
  }), e = rl(e), e;
}
function Pn(i, t) {
...
function $i(i, t, e, s, n) {
  ...
  if (i[`${l}1`] >= e[l] && i[`${l}1`] <= e[l] + e[a]) {
    ...
    if (u || f || p || I) {
      ...
      Ln(R, t, e, i.direction, "shape", j), s.addPoint(R);
    }
  }
}
function rl(i) {
...
class rs {
  ...
  getDistanceToEdge(t) {
    const e = this.x, s = this.y, n = this.diameter / 2, r = x({ v: t.getLongSide() }), o = x({ v: t.getShortSide() }), l = t.machining.corners.map((m) => m.type ? m.size : 0), a = [
      ...
      const R = w === 0 || w === 3, j = w < 2, ee = R ? e : r - e;
      let z = null;
      this.face === 0 ? z = j ? s : o - s : this.face === 1 && (z = j ? o - s : s);
      const J = Math.sqrt(ee * ee + z * z);
      return {
        c: m,
        distance: J
      };
    ...
    if (d && d.type === "radius") {
      ...
      const ee = e - m, z = I < 2;
      let J;
      this.face === 0 ? J = z ? s : o - s : this.face === 1 && (J = z ? o - s : s);
      const ae = J - w, W = Math.sqrt(ee * ee + ae * ae), V = l[I] - W - n;
      let v = !1;
      return d.index === 0 ? v = e <= m && J <= w : d.index === 1 ? v = e >= m && J <= w : d.index === 2 ? v = e >= m && J >= w : d.index === 3 && (v = e <= m && J >= w), v && V < f ? V : f;
      ...
      const j = d.index === 0 ? 1 : -1, ee = (m * e + w * s + R) / Math.sqrt(m * m + w * w) * j - n;
      return ee < f ? ee : f;
    } else
      return f;
  }
  validate(t, e, s = null) {
    ...
    }), s && Bi(this, s, n, e), n.length ? this.valid = !1 : this.valid = !0, n;
  }
}
class Gs {
  constructor({
...
let On = class {
  ...
  constructor({
    ...
    c(this, "corners", []);
    c(this, "hingeHoles", []);
    s && s.length === 4 ? this.corners = s.map((n) => new Ws(n)) : [0, 1, 2, 3].forEach((n) => {
      this.corners.push(new Ws({
        type: null,
        size: null,
        index: n
      }));
    }), t && (this.holes = t.map((n) => new rs(n))), e && (this.hingeHoles = e.map((n) => new Gs(n)));
  }
...
class ys {
  ...
  createGroup(t = 0, e = 0, s = [], n = null) {
    ...
    r.forEach((f) => {
      ...
      s.splice(p, 1), No(f), f.inUserGroup = !0;
    });
    let l = 0, a = 0;
...
function lh(i, t = []) {
  ...
  const e = i.map((s) => new ys(s));
  return t.length && cl(e, t), e;
}
function cl(i = [], t = []) {
...
function uh({
  ...
  return !i || !(i != null && i.length) ? [] : i.filter((s) => s).map((s) => {
    ...
    let n;
    if (gl(s) && ((o = s == null ? void 0 : s.shapes) != null && o.length)) {
...
class bs {
  constructor(t, e = "decimal", s = !1) {
    ...
    c(this, "notes", "");
    var o, l;
    t = qt(t), this.readonly = t.readonly, this.id = t.id, this.listId = t != null && t.listId ? t.listId : Date.now().toString() + as(), ["l", "w", "t"].forEach((a) => {
      this[a] = Hi(t, a, e, s);
    }), this.q = k(t == null ? void 0 : t.q) ? fi(Mi(t.q)) ? null : Mi(t.q) : null, this.autoAdd = k(t.autoAdd) ? t.autoAdd : !1, this.name = k(t.name) ? Ui(t.name).toUpperCase() : "", this.material = k(t.material) ? t.material.trim().toUpperCase() : "";
    const r = ["x1", "x2", "y1", "y2"];
    this.trim = {
      x1: null,
      x2: null,
...
class Vi {
  constructor(t, e = "decimal", s = !1) {
    ...
    c(this, "rot", 0);
    var r, o, l, a, u;
    t = t = qt(t), this.readonly = t.readonly, this.id = t.id, this.listId = t != null && t.listId ? t.listId : Date.now().toString() + as(), ["l", "w", "t"].forEach((f) => {
      this[f] = Hi(t, f, e, s);
    }), this.q = k(t == null ? void 0 : t.q) ? fi(Mi(t.q)) ? null : Mi(t.q) : null, this.name = k(t.name) ? Ui(t.name).toUpperCase() : "", this.material = k(t.material) ? t.material.trim().toUpperCase() : "", this.multiEdit = t.multiEdit, typeof ((r = t == null ? void 0 : t.notes) == null ? void 0 : r.replace) == "function" ? this.notes = t.notes.replace(/,/g, " ") : this.notes = "", this.stockLock = (t == null ? void 0 : t.stockLock) ?? [];
    for (const f of Object.keys(this.trim))
      this.trim[f] = Hi(t.trim, f, e, s);
    ...
    this.orientationLock = k(t.orientationLock) && ["l", "w"].includes(t.orientationLock.toLowerCase()) ? t.orientationLock.toLowerCase() : "", this.machining = new On(t.machining ?? {
      holes: [],
      hingeHoles: [],
      corners: []
  ...
  validate({
    ...
    if (this.issues = [], ["l", "w", "t"].forEach((o) => Ne[o]({ item: this, index: e, saw: r })), s = x({ v: s }), Ne.partTrim({ item: this, partTrim: s, index: e }), Ne.trim({ item: this, index: e }), Ne.machining({ item: this, index: e }), ["q"].forEach((o) => {
  ...
  setSaw(e, s) {
    ...
    if (!(!e && !s)) {
      if (!s)
        if (k(e == null ? void 0 : e.saw)) {
          if (!((r = e == null ? void 0 : e.saw) != null && r.cutType)) {
            const { cutType: a, cutPreference: u } = ts(e.saw.cutPreference);
            e.saw.cutType = a, e.saw.cutPreference = u;
          }
        } else {
          e.saw = {};
          const { cutType: a, cutPreference: u } = ts(e.cutPreference);
      ...
      try {
        ...
        a && (gs(a) ? this.saw = a : this.saw = new Dt(a)), (l = (o = this.saw) == null ? void 0 : o.issues) != null && l.length && this.issues.push(...this.saw.issues);
      } catch (a) {
...
class Ot extends ei {
  ...
  initShape(e, s = !1) {
    var n;
    s || (this.validateShape(e), e.orientationLock = (n = e == null ? void 0 : e.orientationLock) == null ? void 0 : n.toLowerCase(), (e == null ? void 0 : e.orientationLock) === " " && (e.orientationLock = ""), this.orientationLock = k(e == null ? void 0 : e.orientationLock) && this.l !== this.w ? e.orientationLock : null, k(e == null ? void 0 : e.stockLock) ? Array.isArray(e == null ? void 0 : e.stockLock) && (this.stockLock = e.stockLock.map((r) => r.toString())) : this.stockLock = [], this.banding = (e == null ? void 0 : e.banding) || (e == null ? void 0 : e._banding), this.finish = (e == null ? void 0 : e.finish) || (e == null ? void 0 : e._finish), this.machining = k(e == null ? void 0 : e.machining) ? new On(e.machining) : null), this.added = k(e == null ? void 0 : e.added) ? e.added : !1, this.initGuillotineData(e), this.inGroup = k(e == null ? void 0 : e.inGroup) ? e.inGroup : this.inGroup || !1, this.inUserGroup = k(e == null ? void 0 : e.inUserGroup) ? e.inUserGroup : this.inUserGroup || !1, this.groupID = k(e == null ? void 0 : e.groupID) ? e.groupID : this.groupID || null, this.addedAsGroup = k(e == null ? void 0 : e.addedAsGroup) ? e.addedAsGroup : this.addedAsGroup || !1, this.score = k(e == null ? void 0 : e.score) ? e.score : this.score || null, this.bestScore = k(e == null ? void 0 : e.bestScore) ? e.bestScore : this.bestScore || {
      x: 0,
      y: 0,
      rot: null,
      total: null,
  ...
  save() {
    ...
    }) && (this._finish = null), ul(this), (n = this.guillotineData) == null || delete n.myStripParent, delete this.score, delete this.inGroup, delete this.groupID, delete this.addedAsGroup;
  }
  isExactFit(e) {
  ...
  addToStock(e) {
    this.stock = e, this.stockId = e.id, this.added = !0, this.inGroup = !1, e.used = !0, this.grain = e.grain, e != null && e.grain && this.rot && (this.grain = ui(e.grain)), Cn([
      () => Oi(this.isInsideStock(e), `shape ${this.id} is not inside stock`).to.be.true
    ]);
  }
  removeFromStock() {
  ...
  getBandingLength(e) {
    return !fl(e) || !this.banding[e] ? 0 : e === "x1" || e === "x2" ? this.getShortSide() : e === "y1" || e === "y2" ? this.getLongSide() : An(e) ? Dn(this, e) : 0;
  }
  getPriority(e) {
    var n;
    if (!e) return 0;
  ...
  compress() {
    ...
    return e.myStripParent = ml(this.guillotineData.myStripParent) ? this.guillotineData.myStripParent.id : this.guillotineData.myStripParent, {
      id: this.id,
...
class ws extends Yi {
  constructor(e) {
    var t = (...xh) => (super(...xh), c(this, "cuts"), c(this, "phase"), c(this, "cutDirection"), c(this, "firstShape"), c(this, "merged"), c(this, "children"), c(this, "siblings"), //used by vis only
  ...
  save() {
    var e, s;
    this.children = this.children.map((n) => n ? {
      id: n.id,
      x: n.x,
      y: n.y,
      l: n.l,
    ...
    } : null), this.stockId = (this == null ? void 0 : this.stockId) ?? ((e = this == null ? void 0 : this.stock) == null ? void 0 : e.id), this.parentID = (s = this == null ? void 0 : this.parent) == null ? void 0 : s.id, delete this.stock, delete this.shapes, delete this.saw, delete this.siblings, delete this.parent, delete this.trim, this.algoBenchmark = null;
  }
  getBladeWidth() {
    return this.stock.getBladeWidth();
  }
...
class ht extends Ot {
  ...
  orientateShapes(e) {
    this.shapes.forEach((s) => {
      ...
      if (!ns(s, n.rot, e)) throw new Error("orientateShapes - unable to rotate shape in group");
    });
  }
  /**
  ...
  placeMyShapes(e) {
    ...
    for (let s = 0; s < this.shapes.length; s++) {
      ...
      if (n.x = this.x + r.x, n.y = this.y + r.y, !ns(n, r.rot, e)) throw new Error("placeMyShapes - unable to rotate shape in group");
...
function yl(i) {
  return i instanceof ht ? i.type === "user" ? "userGroup" : i.type === "strip" ? "stripGroup" : "group" : i instanceof ys ? "inputUserGroup" : i instanceof bs ? "inputStock" : i instanceof Vi ? "inputShape" : i instanceof Gt ? "stock" : i instanceof Yi ? "container" : i instanceof Ot && !(i instanceof ht) ? "shape" : i instanceof ws ? "segment" : i instanceof En ? "offcut" : i instanceof Dt ? "saw" : i instanceof ei ? "rectangle" : null;
}
function Ns(i, t) {
  return fr(i, t);
}
...
function os(i = 0, t, e = null, s = null, n = null) {
...
function Us(i, t, e = null, s = null, n = null) {
  if (!we(e) || s === "shape") return !1;
  let r;
  return i === 0 || i === 1 ? os(i, t, e, s, n) ? "cc" : !1 : i === 2 ? t === "w" ? e.l < e.w ? "c" : "cc" : !1 : r;
}
function xl(i) {
  i.banding && (i.banding = Gi(i.banding, "cc")), i.trim && (i.trim = Gi(i.trim, "cc"));
}
function mh(i, t = 0) {
  return Je(i) || we(i) || !t || (i.preventAutoRotation = !0, t === 2 && i.l < i.w && xl(i)), i;
}
function Gi(i, t = "cc", e = {
  x1: "y1",
  x2: "y2",
  y1: "x1",
  y2: "x2"
...
const { addNotice: ut } = fs(), {
  ...
  if ((i = Ie == null ? void 0 : Ie.inputStock) != null && i.value) {
    for (let e = Ie.inputStock.value.length - 1; e >= 0; e--) {
      ...
      !(s != null && s.l) && !(s != null && s.w) && (e === 0 && Ie.inputStock.value.length > 1 || e !== 0) && zs(s.listId);
    }
    if ((t = Ie == null ? void 0 : Ie.inputShapes) != null && t.value)
      for (let e = Ie.inputShapes.value.length - 1; e >= 0; e--) {
        ...
        !(s != null && s.l) && !(s != null && s.w) && (e === 0 && Ie.inputShapes.value.length > 1 || e !== 0) && js(s.listId);
      }
  }
}, Dl = (i, t = !1) => {
  var s, n;
  ...
  Tl();
  const s = [];
  t.useInventory || s.push(..._n(i == null ? void 0 : i.sawData)), s.push(...Pl({
    saw: t.sawData,
...
async function Al(i) {
  ...
  try {
    if (!Ol(t))
      return { valid: !1 };
    if (t.maxShapes !== 1 / 0 && t.maxShapes && !t.isAdmin && !t.shared && (kl.value > t.maxShapes || Cl.value > t.maxStock))
      return t.onLimit(), { valid: !1 };
    if (t.useInventory) {
      const d = Dl(t.materialStore, !0), m = Pt(d);
      if (m.length > 0)
        return ut({
          type: "error",
    ...
    const { stockList: l, issues: a } = await Il(r), u = Pt(a);
    if (u.length > 0)
      return ut({
        type: "error",
        message: e("inputs_issue", { x: "stock" }),
...
function Rl(i, t, e = !0) {
  if (!xs(i, t, "Options")) return;
  const s = i[t], n = Object.keys(s);
  for (const r of n)
    Cs(i, t, r, e);
  e && Bn(i, t, "all");
}
function Cs(i, t, e, s = !0) {
  s && Bn(i, t, e), e !== "all" && xs(i, t) && (i[t][e] = !1);
}
function Bn(i, t, e) {
  if (!xs(i, t, "Options")) return;
...
function Hn(i, t, e, s, n = [], r) {
  ...
  for (const p of l)
    p !== "all" && (n.includes(p) || (Is(i, t, p, e, s, r), Array.isArray(f) || ci(i, t, p, !1), ci(i, t, p, !!qe(a))));
}
function ci(i, t, e, s) {
  var o;
  if (e === "all") return;
  const n = ks(t), r = El((o = i == null ? void 0 : i[n]) == null ? void 0 : o[e]);
  s ? i[t][e] = r || !0 : i[t][e] = !1;
}
function Wi(i, t, e, s) {
  var a;
  ...
  if (!Array.isArray(o) || !s || typeof s != "function")
    return !1;
  const l = s(t, o);
  return t === "banding" && An(e) && qe(l) ? al(i, e, l) / 1e3 : l;
}
function vh(i) {
  i != null && i.type && delete i.type, Fl.call(this, i);
}
function Fl(i) {
...
const ql = { id: "mini-stock-nav" }, Bl = ["onMousedown"], Hl = { class: "id" }, Gl = /* @__PURE__ */ Oe({
  ...
  setup(i, { emit: t }) {
    ...
    return (r, o) => (y(), C("div", ql, [
      (y(!0), C(Se, null, De(e.stockList, (l, a) => (y(), C("button", {
        ...
        M("div", Hl, te(a + 1), 1),
        us(M("div", { class: "stack legibility" }, te(l.stack), 513), [
          [cs, typeof l.stack == "number" && l.stack > 1]
        ])
      ], 46, Bl))), 128))
    ]));
  }
...
}, Nl = { id: "spinner" }, Ul = ["width", "height"], jl = {
  key: 2,
  id: "spinner-number",
  class: "stock-number"
};
function zl(i, t, e, s, n, r) {
  return y(), C("div", Nl, [
    e.complete ? G("", !0) : (y(), C("svg", {
      ...
      Sr('<rect class="square s1" x="0" y="0"></rect><rect class="square s2" x="100" y="0"></rect><rect class="square s3" x="200" y="0"></rect><rect class="square s4" x="0" y="100"></rect><rect class="square s5" x="200" y="100"></rect><rect class="square s6" x="0" y="200"></rect><rect class="square s7" x="100" y="200"></rect>', 7)
    ]), 12, Ul)),
    e.complete ? (y(), C("svg", {
      key: 1,
      class: "complete",
    ...
    e.showNumber ? (y(), C("div", jl, te(e.number), 1)) : G("", !0)
  ]);
}
const Vs = /* @__PURE__ */ ti(Wl, [["render", zl]]);
function Vl(i, t, e, s, n = !0) {
  var o;
...
const Kl = ["id"], Zl = {
  ...
  setup(i, { emit: t }) {
    const e = i, s = t, n = H(0), r = H(!1), o = (v, T, X, P) => {
      if (!we(X) || T === 0)
        return v;
      const F = l();
      ...
      switch (T.orientationModel) {
        case 0:
          ...
          break;
        case 1:
          T.stockGrain === "y" || T.stockGrain === "n" ? X = T.rectangle.l >= T.rectangle.w ? "l" : "w" : T.rectangle.l >= T.rectangle.w ? X = T.stockGrain : X = X = T.stockGrain === "l" ? "w" : "l";
          break;
        case 2:
          X = T.rectangle.l >= T.rectangle.w ? "l" : "w";
          break;
      }
      return X;
    }, a = () => {
      ...
      const T = j.value.findIndex((X) => X === v);
      return T === -1 ? 0 : T;
    }, f = () => {
      let v = 0;
      ...
      v.forEach((A) => {
        ...
        return U[A.Dimensions] - U[q.Dimensions];
      }), console.table(se);
    }, j = Z(() => {
      if (!e.rectangle) return ["l", "w"];
      if (_t(e.rectangle)) return ["l", "w"];
      let v = ["", "l", "w"];
      return e.rectangle.multiEdit && (v = [" ", "", "l", "w"]), ee.value && (v = v.filter((T) => T !== "w")), v;
    }), ee = Z(() => {
      var v, T, X, P;
      return we(e.rectangle) || it(e.rectangle) ? e.rectangle.isSquare() : e.rectangleType && ((v = e.rectangle) != null && v.l) && ((T = e.rectangle) != null && T.w) ? ((X = e.rectangle) == null ? void 0 : X.l) === ((P = e.rectangle) == null ? void 0 : P.w) : !1;
    }), z = Z(() => {
      let v = "";
    ...
    }), J = Z(() => _t(e.rectangle) || !e.rectangle ? {
      l: null,
      w: null
    } : {
      l: e.rectangle.l,
      w: e.rectangle.w
    }), ae = Z(() => !J.value.l && !J.value.w), W = Z(() => os(
      e.orientationModel,
      e.stockGrain,
      e.rectangle,
      e.rectangleType,
      ...
      let X = "default";
      return we(e.rectangle) || e.rectangleType === "shape" ? X = d() : _t(e.rectangle) && (X = e.rectangle.direction || "default"), ((P = v[T]) == null ? void 0 : P[X]) || v[T].default;
    });
    return Le(n, (v, T) => {
      r.value && T !== void 0 && I(j.value[v]);
    }, { immediate: !1 }), Le(J, (v, T) => {
      ...
      id: v.id,
      class: Ce(["orientation-button", { rot: W.value, square: ee.value, disabled: v.disabled, [V.value]: !0 }]),
      tabindex: "0",
      ...
      V.value === "grainLeftRight" ? (y(), C("svg", {
        key: 4,
        class: "grain",
        style: ke({
          stroke: v.iconColor ? v.iconColor : "#ffffff"
      ...
      V.value === "grainTopBottom" ? (y(), C("svg", {
        key: 5,
        class: "grain",
        style: ke({
          stroke: v.iconColor ? v.iconColor : "#ffffff"
...
const ra = ["id", "name", "value", "inputmode", "type", "placeholder", "disabled", "default", "readonly", "min", "max", "aria-label", "aria-invalid", "aria-describedby"], oa = /* @__PURE__ */ Oe({
  __name: "TextInput",
  props: {
    type: {},
    inputType: {},
...
}), la = ["id", "checked", "disabled", "required", "aria-label", "aria-invalid", "aria-describedby"], aa = /* @__PURE__ */ Oe({
...
}), ua = ["id", "value", "disabled", "required", "aria-label", "aria-invalid", "aria-describedby"], ca = ["disabled", "selected"], ha = {
  key: 0,
  value: " "
}, da = ["hidden", "value", "disabled"], fa = /* @__PURE__ */ Oe({
  __name: "SelectInput",
  props: {
    options: {},
    ...
    return (f, p) => {
      ...
      return y(), C("select", oi(f.$attrs, {
        ...
        M("option", {
          ...
          selected: !e.value
        }, te(((d = (I = e.text) == null ? void 0 : I.select) == null ? void 0 : d.toUpperCase()) ?? "SELECT"), 9, ca),
        e.multiEdit ? (y(), C("option", ha, te(((w = (m = e.text) == null ? void 0 : m.delete) == null ? void 0 : w.toUpperCase()) ?? "DELETE"), 1)) : G("", !0),
  ...
  setup(i) {
    return (t, e) => (y(), C("label", {
      ...
      Xt(te(t.label) + " ", 1),
      t.required ? (y(), C("span", ga, "*")) : G("", !0)
    ], 8, pa));
  }
}), ma = ["data-field-id"], va = ["disabled", "selected"], ya = {
  key: 0,
  value: " "
}, ba = ["hidden", "value", "disabled"], ct = /* @__PURE__ */ Oe({
  inheritAttrs: !1,
  __name: "InputField",
  props: {
    value: { default: null },
  ...
  setup(i, { emit: t }) {
    const e = t, s = i, n = H(null), r = H(null), o = H(!0), l = H(s.numberFormat), a = Z(() => s.custom ? "custom-" + s.id : s.id), u = Z(() => `${a.value}-error`), f = Z(() => s.label || s.placeholder), p = Z(() => V(s.type, s.numberFormat)), I = Z(() => v(s.type, s.numberFormat)), d = Z(() => ["string", "integer", "float", "unitDependent"].includes(s.type)), m = Z(() => {
      let P = s.value;
      ...
      r.value = P;
    }, W = (P) => s.label && s.enableLabel && s.labelPosition === P, V = (P, F) => {
      if (P === "unitDependent")
    ...
    return Le(() => s.numberFormat, (P, F) => {
      ...
      d.value ? (y(), ge(oa, oi({
        ...
        onValidation: X,
        "onUpdate:value": T
      }), null, 16, ["input-type", "input-mode", "value"])) : P.type === "checkbox" ? (y(), ge(aa, oi({
        key: 2,
        ref: ae,
        type: "checkbox"
      }, z.value, {
      ...
      }), null, 16, ["checked"])) : P.type === "select" ? (y(), ge(fa, oi({
        key: 3,
        ref: ae
      }, J.value, {
        ...
        default: ds(() => {
          ...
          return [
            M("option", {
              ...
              selected: !P.value
            }, te(((se = (le = P.text) == null ? void 0 : le.select) == null ? void 0 : se.toUpperCase()) ?? "SELECT"), 9, va),
            P.multiEdit ? (y(), C("option", ya, te(((q = (A = P.text) == null ? void 0 : A.delete) == null ? void 0 : q.toUpperCase()) ?? "DELETE"), 1)) : G("", !0),
            (y(!0), C(Se, null, De(w.value, (U) => (y(), C("option", {
              key: U.value,
              hidden: U.hidden,
              value: U.value,
              disabled: U.disabled
  ...
  key: 0,
  class: "inputs"
}, Sa = { class: "label" }, xa = { class: "label" }, ka = { class: "label" }, Ca = ["onClick"], Ia = { class: "price" }, La = ["aria-label"], ls = /* @__PURE__ */ Oe({
  __name: "ExtrasInputs",
  props: {
  ...
  setup(i, { emit: t }) {
    const e = i, s = t, { t: n } = Ni(["main", "errors"]), r = H(!1), o = Z(() => e.extraType + "Options"), l = Z(() => {
      var w;
      ...
      var ae;
      if (!d) return [];
      const ee = (ae = m == null ? void 0 : m[w]) == null ? void 0 : ae[R];
      if (!ee)
        return console.error(`ExtrasInputs: cannot find pricing options for ${w} > ${R}`), [];
      const z = Object.values(ee);
      if (!z.length)
        return console.error(`ExtrasInputs: cannot find pricing options for ${w} > ${R}`), [];
      const J = z.filter((W) => typeof W == "string");
    ...
    return ft(() => I()), (d, m) => {
      ...
      return r.value ? G("", !0) : (y(), C("div", {
        ...
        d.allOptions.length === 1 && d.allOptions[0].length === 1 ? (y(), C("div", wa, [
          M("div", Sa, te((j = (R = d.allOptions) == null ? void 0 : R[0]) == null ? void 0 : j[0]), 1),
          M("div", null, [
            (ee = d.shape) != null && ee[o.value] && "all" in d.shape[o.value] ? (y(), ge(ct, {
              key: 0,
              id: `${d.extraType}-all-${d.shapeIndex}`,
              type: "checkbox",
              output: "string",
              label: S(Vt)(S(n)("all")),
              "true-value": (J = (z = d.allOptions) == null ? void 0 : z[0]) == null ? void 0 : J[0],
              "false-value": "",
              value: (W = d.shape[o.value].all) == null ? void 0 : W[(ae = d.labels) == null ? void 0 : ae[0]],
              "onUpdate:value": m[0] || (m[0] = (v) => {
                var T, X;
                u("all", (T = d.labels) == null ? void 0 : T[0], v), a((X = d.labels) == null ? void 0 : X[0], v);
              })
            }, null, 8, ["id", "label", "true-value", "value"])) : G("", !0)
          ]),
          (y(!0), C(Se, null, De(d.extraKeys, (v) => {
            var T, X, P, F, le, se;
            return y(), C("div", { key: v }, [
              (T = d.labels) != null && T[0] && ((P = (X = d.shape) == null ? void 0 : X[o.value]) != null && P[v]) && d.labels[0] in d.shape[o.value][v] ? (y(), ge(ct, {
                key: 0,
          ...
          (V = d.shape) != null && V[o.value] && "all" in d.shape[o.value] ? (y(), C(Se, { key: 0 }, [
            M("div", xa, te(S(Vt)(S(n)("all"))), 1),
            (y(!0), C(Se, null, De(d.allOptions, (v, T) => {
              var X, P;
              return y(), ge(ct, {
                ...
                value: (P = d.shape[o.value].all) == null ? void 0 : P[(X = d.labels) == null ? void 0 : X[T]],
                "onUpdate:value": (F) => {
                  var le, se;
          ...
          (y(!0), C(Se, null, De(d.extraKeys, (v) => {
            ...
            return y(), C(Se, { key: v }, [
              (T = d.shape) != null && T[o.value] && v in d.shape[o.value] ? (y(), C(Se, { key: 0 }, [
                M("div", ka, te(S(Vt)(S(n)(((X = d.userFriendlyFieldMap) == null ? void 0 : X[v]) || v))), 1),
                (y(!0), C(Se, null, De(d.allOptions, (P, F) => {
                  var le;
                  return y(), ge(ct, {
              ...
              M("div", {
                class: "delete",
                onClick: () => S(Cs)(d.shape, d.extraType, v)
              }, [
                pe(w, { icon: ["fass", "trash"] })
              ], 8, Ca),
              M("div", Ia, te(p(v) || S(n)("na").toUpperCase()), 1)
            ], 64);
          }), 128))
        ], 4)),
        M("button", {
          ...
          onClick: m[1] || (m[1] = () => S(Rl)(d.shape, d.extraType, !0))
        }, [
          pe(w, { icon: ["fass", "trash"] }),
...
}), Pa = ["id", "disabled"], $a = { class: "icon" }, Ta = /* @__PURE__ */ Oe({
  __name: "FinishButton",
  props: {
    inputShape: { default: null },
    open: { type: Boolean, default: !1 },
...
const Ea = /* @__PURE__ */ ti(Da, [["render", Aa]]), Ma = { id: "uploader" }, Ra = {
  key: 0,
  class: "debug"
}, Fa = {
  key: 1,
  class: "selected-files"
}, _a = ["src"], qa = ["onClick"], Ba = !0, Ha = /* @__PURE__ */ Oe({
  __name: "ImageUpload",
  props: {
    shapeId: {
      type: String,
...
Only JPG and PNG files are allowed.`), m.value = "";
      ...
      const J = [...ee, ...R], ae = f(J), W = J.map((v, T) => ({
        originalName: v.name,
    ...
    return kr(() => {
      ...
      const w = Bt("font-awesome-icon");
      return y(), C("div", Ma, [
        i.env === "development" && Ba ? (y(), C("div", Ra, [
          pe(S(e), {
            data: [n.value],
            paths: ["imageData"]
          }, null, 8, ["data"])
        ...
        (R = n.value.files) != null && R.length ? (y(), C("div", Fa, [
          (y(!0), C(Se, null, De(n.value.files, (j, ee) => (y(), C("div", {
            key: ee,
            class: "selected-file"
          }, [
            M("img", {
...
}), Ga = /* @__PURE__ */ ti(Ha, [["__scopeId", "data-v-0836e586"]]);
function Wa(i) {
  var l, a;
  ...
  this.axes.shapeXAxis ? this.axes.shapeXAxis.call(Ri(s).tickValues(s.domain()).tickSize(4).tickFormat(this.formatNumber)) : this.axes.shapeXAxis = this.selections.axisGroup.append("g").attr("transform", `translate(0, ${this.state.h - this.state.padding + this.state.axisSpacing})`).attr("class", "axis shape x").call(Ri(s).tickValues(s.domain()).tickSize(4).tickFormat(this.formatNumber)), ((a = (l = i == null ? void 0 : i.stock) == null ? void 0 : l.saw) == null ? void 0 : a.stockType) !== "linear" ? this.axes.shapeYAxis ? this.axes.shapeYAxis.call(Fi(o).tickValues(o.domain()).tickSize(4).tickFormat(this.formatNumber)) : this.axes.shapeYAxis = this.selections.axisGroup.append("g").attr("transform", `translate(${this.state.padding - this.state.axisSpacing}, 0)`).attr("class", "axis shape y").call(Fi(o).tickValues(o.domain()).tickSize(4).tickFormat(this.formatNumber)) : this.axes.shapeYAxis && (this.axes.shapeYAxis.remove(), this.axes.shapeYAxis = null);
}
function Na() {
...
function Gn(i, t, e) {
  !e || !(i != null && i.length) || i.forEach((s, n) => {
    const [r, o] = s;
    e === "x" ? Ua.call(this, r, o, t[n]) : ja.call(this, r, o, t[n]);
  });
}
function Ua(i, t, e) {
  ...
  ]), n = Wn(s.domain()), r = this.selections.axisGroup.append("g").attr(
    "transform",
    `translate(0, ${this.state.h - this.state.padding + this.state.axisSpacing})`
  ).attr("class", "axis measurement x").call(Ri(s).tickValues([n]).tickSize(4).tickFormat(() => this.formatNumber(e)));
...
function ja(i, t, e) {
  ...
  ).attr("class", "axis measurement y").call(Fi(s).tickValues([n]).tickSize(4).tickFormat(() => this.formatNumber(e)));
...
function Ya() {
  this.selections.shapeIDText = this.selections.shapeWrappers.selectAll("text.shape-text.id").data((i) => [i]).join(
    (i) => i.append("text").attr("class", "shape-text id").text((t) => Xa.call(this, t)).classed("hidden", (t, e, s) => this.isTextHidden(t, e, s)).attr("dominant-baseline", "middle").attr("fill", this.config.colors.text.toString()).attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t) => this.getRectangleCoordinate(t, "y", "center")).attr("dy", 1),
    ...
    (i) => i.append("text").attr("class", "shape-text name").text((t) => Ka.call(this, t)).call(this.trimNameToFit, this).classed("hidden", (t, e, s) => this.isNameHidden(t, e, s)).attr("dominant-baseline", "middle").attr("fill", this.config.colors.text.toString()).attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t, e, s) => {
      const n = s[e];
    ...
    (i) => i.append("text").attr("class", "shape-text length").text((t) => Xs.call(this, t)).classed("hidden", (t, e, s) => this.isLengthHidden(t, e, s)).attr("dominant-baseline", "middle").attr("fill", this.config.colors.text.toString()).attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t, e, s) => {
      const r = s[e].getBBox().height;
      return this.getRectangleCoordinate(t, "y", "top", -(r / 2 + 2));
    }),
    (i) => i.text((t) => Xs.call(this, t)).classed("hidden", (t, e, s) => this.isLengthHidden(t, e, s)).attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t, e, s) => {
      const r = s[e].getBBox().height;
      return this.getRectangleCoordinate(t, "y", "top", -(r / 2 + 2));
    })
  ), this.selections.shapeWidthText = this.selections.shapeWrappers.selectAll("text.shape-text.width").data((i) => [i]).join(
    (i) => i.append("text").attr("class", "shape-text width").text((t) => Za.call(this, t)).classed("hidden", (t, e, s) => this.isWidthHidden(t, e, s)).attr("dominant-baseline", "middle").attr("fill", this.config.colors.text.toString()).attr("transform", (t, e, s) => {
...
function Ja(i) {
  ...
  if (this.props.stock.value.cutType === "efficiency") {
    if (this.state.env === "development") {
      ...
      const a = Pn(this.props.shapes.value, this.props.stock.value).flatMap((u) => Object.values(u.rays));
  ...
  if (s) {
    const r = s.toArray();
    for (const o of r) {
      const l = el(i, o, this.props.stock.value);
  ...
  return Qa.call(this, t, i), eu.call(this, t, i), !!(t != null && t.length);
}
function Qa(i, t) {
  function e(n) {
    return `${n.x}-${n.y}`;
...
function iu() {
  ...
  this.scales.shapeColorScale.domain([1, i]), this.state.env === "development" && nu.call(this), su.call(this);
}
function su() {
  return this.selections.shapeWrappers = this.selections.shapeGroup.selectAll("g.shape-group").data(this.props.shapes.value, tu).join(
    (i) => {
      const t = i.append("g").attr("class", "shape-group");
      return Ks.call(this, t), Zs.call(this, t), t.on("mousedown", Js.bind(this)), t;
    },
    (i) => (Ks.call(this, i), Zs.call(this, i), i.on("mousedown", Js.bind(this)), i),
    (i) => i.remove()
  ), this.props.shapes.value.length > 0 && hu.call(this, this.props.shapes.value), this.settings.main && requestAnimationFrame(() => Ya.call(this)), this.selections.shapeWrappers.size() > 0;
}
function nu() {
  var n;
  let i = 1 / 0, t = -1 / 0;
...
function Js(i, t) {
  ...
  this.state.env === "development" && ou.call(this, i, t), (this.settings.app || this.settings.embed) && uu.call(this, i, t), this.state.device === "desktop" && (Xi.call(this), Wa.call(this, t)), this.props.moveMode.value ? this.callbacks.onAddToPartsBin(t) : this.findShape.call(this, t.id);
}
function ou(i, t) {
  if (console.clear(), t) {
    let e;
...
function hu(i) {
  ...
  const t = cu.call(this, i), e = (s) => `${s.x1}-${s.y1}-${s.x2}-${s.y2}-${s.type}`;
  this.selections.bandingWrappers = this.selections.bandingGroup.selectAll("line").data(t, e).join(
    (s) => s.append("line").call((n) => Qs.call(this, n)),
    (s) => s.call((n) => Qs.call(this, n)),
    (s) => s.remove()
  );
}
function Ti(i, t) {
...
function pu() {
  if (!this.props.stock.value || !this.props.stock.value.w || !this.props.stock.value.l || !this.props.containerWidth.value)
    return !1;
  this.setAspectRatio(), Na.call(this), this.selections.stockGroup.selectAll("rect.background.stock").data([this.props.stock.value], en).join(
...
function nn({ parent: i, near: t, far: e }) {
  if (!this.props.containerWidth)
    return !1;
  const s = [i, t, e];
  this.selections.segmentRectangles = this.selections.segmentGroup.selectAll("rect").data(s, Nn).join(
    (n) => n.append("rect").attr("class", "segment").call((r) => rn.call(this, r)),
    (n) => n.call((r) => rn.call(this, r)),
    (n) => n.remove()
  ), gu.call(this, this.selections.segmentRectangles), !this.settings.app && this.state.env === "development" && vu.call(this);
}
function rn(i) {
  return i.classed("offcut", (t) => t.offcut).classed("near", (t) => t.segmentType === "near").classed("far", (t) => t.segmentType === "far").classed("parent", (t, e) => e === 0).attr("x", (t) => this.getRectangleCoordinate(t, "x")).attr("y", (t) => this.getRectangleCoordinate(t, "y")).attr("width", (t) => this.getWidthAttribute(t)).attr("height", (t) => this.getHeightAttribute(t));
}
function gu(i) {
  this.selections.segmentGroup.selectAll("text").data(i, Nn).join(
...
function vu() {
  this.selections.segmentRectangles.on("mousedown", function(i, t) {
    console.log("segment", `[${(t == null ? void 0 : t.parentID) || "-"}]->[${t.id}] ${t.l}x${t.w}`);
  });
}
function Un(i) {
  var n;
...
function bu() {
  this.props.containerWidth && (this.selections.cutLabelGroup && this.selections.cutLabelGroup.remove(), this.selections.cutLines = this.selections.cutGroup.selectAll("line").data(this.props.cuts.value, yu).join(
    (i) => i.append("line").attr("class", "cut").call((t) => ln.call(this, t)),
    (i) => i.call((t) => ln.call(this, t)),
    (i) => i.remove()
  ), this.selections.cutLabelGroup = this.selections.cutGroup.append("g").attr("class", "label-group"));
}
function ln(i) {
...
function xu(i, t) {
  ...
  if (e == null) return;
  this.selections.cutLines.classed("completed", (w) => jn(w, t, e)), this.selections.cutLines.classed("inside-segment", (w) => zn(w, t));
  const s = Un.call(this, i);
  if (s === !1) return;
  const { parent: n, children: r } = s, { near: o } = Vn(i, r);
  let l = [], a;
  ...
  ], a = [(d = i == null ? void 0 : i.distances) == null ? void 0 : d.left, (m = i == null ? void 0 : i.distances) == null ? void 0 : m.right]), this.state.device === "desktop" && !i.isTrim && a && Gn.call(this, l, a, f);
}
function ku(i = null, t = "") {
  var d, m, w, R;
  if (i === null || this.selections.cutLines.empty()) return;
  const e = this.props.cuts.value[i];
  hi.call(this), Xi.call(this), Me(this.selections.cutLines.nodes()[i].parentElement).raise();
  ...
  if (!((R = e == null ? void 0 : e.guillotineData) != null && R.parentSegmentID))
    return nn.call(this, { parent: u });
  const { near: p, far: I } = Vn(e, f);
  nn.call(this, { parent: u, near: p, far: I });
}
function Vn(i, t) {
...
class $u {
  ...
  initColors(t) {
    const e = {
      ...
      stock: "#ffd166",
      text: "#ffffff"
    }, s = (n, r) => Ft("#" + (Lu(n == null ? void 0 : n.replace("#", "")) ? n.replace("#", "") : r.replace("#", "")));
  ...
  removeStock() {
    this.selections.stockGroup && this.selections.stockGroup.selectAll("*").remove(), this.selections.axisGroup && this.selections.axisGroup.selectAll("*").remove(), Va.call(this);
  }
  removeCuts() {
...
const Tu = ["id"], Du = /* @__PURE__ */ Oe({
  ...
  setup(i, { expose: t, emit: e }) {
    ...
    }, z = H(0), J = H(0), ae = H(null);
    let W, V = H(!1);
    ft(() => le());
    const v = Z(() => ({
      format: d.numberFormat,
      decimals: d.decimalPlaces
    })), T = Z(() => d.stockId ? u(d.stockId) : n.value), X = Z(() => d.stockId ? f(d.stockId) : r.value), P = Z(() => d.main ? d.stockId ? I(d.stockId) : o.value : []), F = Z(() => d.main ? d.stockId ? p(d.stockId) : l.value : []);
    Cr(ae, (ne) => {
      ...
      z,
      (ne) => {
        W && (ne <= 0 || (W.setDevice(), W.resetShapeAxes(), W.drawAll(), a.value !== null && (W.toggleSegments(!0), W.showCut(a.value))));
      },
      { throttle: 100 }
    ), Le(n, (ne) => {
      ne && (z.value <= 0 || (W.setDevice(), W.drawStock()));
    }), Le(r, (ne) => {
      ne && (z.value <= 0 || (W.setDevice(), W.drawShapes()));
    }), Le(o, () => {
      z.value <= 0 || W.drawCuts();
    }), Le(a, () => {
      a.value !== null && (z.value <= 0 || (W.toggleSegments(!0), W.showCut(a.value)));
    }), Le(v, (ne) => {
  ...
  key: 1,
  class: "cell delete"
}, Fu = { class: "cell" }, _u = ["id", "disabled", "onClick"], qu = {
  key: 0,
  class: "cell center"
}, Bu = ["onClick"], Hu = {
  key: 1,
  class: "cell"
}, Gu = ["aria-label", "onClick"], Wu = { class: "button-wrapper main" }, Nu = ["aria-label"], Uu = ["aria-label", "disabled"], ju = ["aria-label"], zu = { id: "part-count" }, Vu = {
  key: 3,
  id: "messages"
}, Yu = {
  key: 0,
  ...
  setup(i, { expose: t, emit: e }) {
    const s = $t(() => Promise.resolve().then(() => cc)), n = $t(() => Promise.resolve().then(() => dc)), r = $t(() => Promise.resolve().then(() => Ac)), o = $t(() => Promise.resolve().then(() => qc)), l = $t(() => Promise.resolve().then(() => Ki)), { t: a } = Ni(["main", "errors"]), { inputs: u, totalInputShapes: f, getShapeGrainSummary: p, updateNumberFormat: I, validateInputStock: d } = hn(), { r: m, updateFromResult: w, stackedStock: R, uniqueAddedShapes: j, uniqueUsedStock: ee, activeStockId: z, setActiveStockId: J } = dn(), { progress: ae, reset: W } = qr(), { addNotice: V } = fs(), { tip: v, update: T, hide: X } = Fr(), P = i, F = e, le = "production", se = H((navigator == null ? void 0 : navigator.language) || "en-US"), A = Lr(null), q = window.location.hostname, U = H(!1), ie = H(!0), oe = Pr("Checkout/currentURL", window.location.href), ye = as(), de = H([]), We = H(!1), st = H(!1), E = H(!1), pt = H(!1), ne = H(!1), nt = H(Sl()), rt = H(!1), { socket: ot } = _r({
      refs: {
        connected: U,
        thinking: E
      },
      callbacks: {
        onResult(h) {
          ...
          if ((D = (Q = (O = m == null ? void 0 : m.metadata) == null ? void 0 : O.value) == null ? void 0 : Q.unplacedParts) != null && D.length) {
      ...
      return [...[
        ...
        },
        {
          ...
          w: "minmax(20px, max-content)",
          type: "select",
          output: Y.numberFormat === "decimal" ? "float" : "string",
          label: "thickness",
          allowZero: !1
        },
        {
      ...
      stockType: (h) => {
        ...
        g.includes(h) || console.warn(`${h} is not a valid stockType, expected ${g.join("|")}`), K.stockType = h, h === "linear" && (K.cutType = null, K.cutPreference = null);
      },
      stockSelection: (h) => {
        const g = ["efficiency", "smallest"];
        h && !g.includes(h) ? console.warn(`${h} is not a valid stockSelection, expected ${g.join("|")}`) : K.options.stockSelection = h;
      },
      minSpacing: (h) => {
        K.options.minSpacing = h;
      },
      stackHeight: (h) => {
        K.stackHeight = h;
      },
      cutPreference: (h) => {
        ...
        if (g.includes(h)) {
          const { cutType: b, cutPreference: L } = ts(h);
          K.cutType = b, K.cutPreference = L;
        } else
          console.warn(`SmartCut - cut preference ${h || "N/A"} is not one of ${g.join("|")}`);
      },
      guillotineOptions: (h) => {
        K.guillotineOptions = h;
      },
      bladeWidth: (h) => {
        h >= 0 ? K.bladeWidth = h : console.warn(`SmartCut - you provided an incorrect blade width of: ${h}`);
      },
      maxParts: (h) => {
        Y.maxParts = h;
      },
      ...
      customFields: (h) => {
        ...
        for (const b of u.inputShapes.value)
          b.customData = h.reduce((L, B) => {
            const O = si(B.id);
            return L[O] = b.customData[O] || B.default || "", L;
          }, {});
      }
    }, ze = (h) => {
      if (P.debug && F("log", ["checkout init...", h]), h != null && h.options) {
        ...
        _l(b), [
          ...
          O in b || F("error", `${O} is a required option`);
        });
        const B = ["enable", "colors"];
        for (const O in b)
          B.includes(O) || (Y[O] = b[O]), O in me && me[O](b[O]);
      }
      h.colors && "colors" in me && me.colors(h.colors), As("banding", h), As("finish", h), Qe(h), Kn(h), st.value = !0, P.debug && F("log", ["init complete"]);
      ...
      Vl(ii, "parts", K.stockType, h, g);
    }, si = (h) => h ? Ui(h).toLowerCase() : null, Ge = (h, g, b, L) => {
      if (g.valid) {
        if (X(), b && L) {
          const B = b.issues.findIndex((O) => O.field.some((Q) => Q.length === L.length && Q.every((D, _) => D === L[_])));
      ...
      if (Mt(Y, ["enable", "machining"]) && h != null && h.machining) {
        for (const Q in je)
          h.machining[Q] && (je[Q] = h.machining[Q]);
        if (["holes", "hingeHoles"].forEach((Q) => {
          var D, _;
          (D = h == null ? void 0 : h.machining) != null && D[Q] && (je[Q].enabled = (_ = h == null ? void 0 : h.machining) == null ? void 0 : _[Q].enabled);
        }), (L = (b = (g = h == null ? void 0 : h.machining) == null ? void 0 : g.corners) == null ? void 0 : b.types) != null && L.length && (je.corners.enabled = !0, je.corners.types = h.machining.corners.types), h.banding && ((O = (B = h == null ? void 0 : h.options) == null ? void 0 : B.enable) != null && O.banding)) {
          if (!be) return;
          je.banding = {
            enabled: !0
      ...
      Ke.value = h, h && h.l && h.w ? Nt.value = !0 : alert("Please enter dimensions first");
    }, St = () => {
      ...
      if ((g = h == null ? void 0 : h.stock) != null && g.some((L) => L == null ? void 0 : L.material)) {
        ...
        for (const B of h.stock) {
          ...
          const O = B.material.toUpperCase();
          L.has(O) || L.set(O, /* @__PURE__ */ new Set()), B.t != null && ((b = L.get(O)) == null || b.add(x({ v: B.t })));
        }
        Be.value = Array.from(L.entries()).map(([B, O]) => ({
          name: B,
          thicknesses: Array.from(O).sort((D, _) => D - _)
      ...
      const b = [];
      for (let L of h)
        Y.numberFormat === "decimal" && (L = parseFloat(L)), _e.value.push(L), g && g.thicknesses.push(L), b.push(_e.value.length - 1);
      Et.value.push(b);
    }, Ls = (h, g = !1) => {
      ...
      return [g, b].forEach((O, Q) => {
        if (!O) return h = !1;
        const D = window.getComputedStyle(O);
        if (D.display === "none" || D.display === "hidden" || D.opacity === "0" || D.color === "transparent" || D.position !== "relative" || Q === 1 && D.color !== "#4e4e4e" && D.color !== "rgb(78, 78, 78)")
          return h = !1;
      }), ie.value = h, h;
    }, Ps = (h, g, b, L, B) => {
      Is(
      ...
      const g = [], b = Object.keys(h), L = Ts(h);
      for (let B = L; B--; ) g.push(/* @__PURE__ */ new Set());
      for (const B of b)
        B.split("|").forEach((Q, D) => g[D].add(Q));
      for (let B = 0; B < L; B++)
        g[B] = Array.from(g[B]);
      return g;
    }, bi = (h, g = [], b) => {
      ...
      l: null,
      w: K.stockType === "linear" ? ((g) => (g = u.inputStock.value[0]) == null ? void 0 : g.w)() : null,
      ...
      const L = new Vi(h, Y.numberFormat);
      return (B = be == null ? void 0 : be.labels) != null && B.length && yi(L, "banding"), (O = Ae == null ? void 0 : Ae.labels) != null && O.length && yi(L, "finish"), L;
    }, rr = () => {
      ...
      W(), J(null), m.stockList.value = [], m.shapeList.value = [], m.cutList.value = [];
    }, Ji = () => {
      u.inputShapes.value.length = 0, P.inputType !== "formula" && Ze(() => Zi(1));
    }, or = async () => {
      if (F("calculating"), E.value) return !1;
      E.value = !0, pt.value = !1;
      const { valid: h, saw: g, stockList: b, shapeList: L } = await Al({
        t: a,
        partTrim: Y.partTrim,
        ...
        onLimit: () => {
          V({
            type: "error",
            message: a("max_parts") + " " + Y.maxParts
          });
        }
      });
      if (!h) {
      ...
      var kt;
      if (Ve(h, !1), !h || !g || !(g != null && g[h]) || !Mt(Y, ["enable", h])) return;
      const b = [h, "pricing"];
      if (!Ns(g, b)) {
      ...
      const B = Object.keys(L), O = Object.values(L);
      if (!B.length) {
      ...
      if (O.some((Ct) => isNaN(Ct))) {
        F("error", `${b} values must be a number`);
        return;
      }
      const D = Ts(L), _ = [h, "labels"];
      let xe = [];
      if (Ns(g, _))
        xe = Mt(g, _);
      else {
      ...
      if (xe.length !== D) {
        F("error", `${_.join(".")} length (${xe.length}) must match the number of levels in ${b.join(".")} (${D})`);
        return;
      }
      switch (h) {
        case "banding":
          be.labels = xe, be.pricing = L, be.options = Ds(L);
          break;
        case "finish":
          Ae.labels = xe, Ae.pricing = L, Ae.options = Ds(L);
          break;
      }
      ...
      if (!g) return;
      h !== "info" && Object.keys(Pe).forEach((L) => {
        L !== h && L !== "info" && (Pe[L] = null);
      });
      const b = u.inputShapes.value.indexOf(g);
      Pe[h] === b ? (Ke.value = null, Pe[h] = null) : (Ke.value = g, Pe[h] = b);
    }, Es = (h) => {
      ...
      let g = 0;
      for (const Q of h.inputs.parts) {
        const D = ni(Q);
        D ? (u.inputShapes.value.push(D), (O = D.issues) != null && O.length && F("log", [`SmartCut - issues found while importing part at index ${g}`, D.issues])) : F("log", [`SmartCut - error loading part at index ${g}`, Q]), g++;
      }
      u.inputShapes.value.flatMap((Q) => Pt(Q.issues)).length && V({
        type: "error",
    ...
    Le(() => P.stock, (h) => {
    ...
    }, { immediate: !0 }), Le(u.inputShapes, (h) => {
      F("inputs-changed"), h.forEach((g) => {
        var L;
        K.stockType === "linear" && (g.w = (L = u.inputShapes.value[0]) == null ? void 0 : L.w);
      ...
      oe.value !== b && Ji(), oe.value = b, se.value = Y.locale, await ot.connect(), ot.emit("getUserFromDomain"), window.addEventListener("smartcut/load", Es), We.value = !0, P.debug && F("log", [
        "ready...",
        "fields:",
        bt.value.map((L) => L.id)
      ]);
    ...
    return hs(() => {
      window.removeEventListener("smartcut/load", Es), ur(), delete window.smartcutCheckout;
    }), t({
      init: ze,
      clear: Ji,
      ...
      return y(), C(Se, null, [
        ...
        S(le) === "development" && Zu ? (y(), C("div", Ou, [
          g[5] || (g[5] = M("div", null, "Developer information", -1)),
          M("div", null, te(Y.enable.focus), 1),
          pe(S(l), {
            data: [K],
            paths: ["sawData"]
          }, null, 8, ["data"]),
        ...
        Nt.value && ((L = Ke.value) != null && L.machining) ? (y(), ge(S(r), {
          key: 1,
          shape: Ke.value,
          "onUpdate:shape": g[0] || (g[0] = (O) => Ke.value = O),
          translate: !0,
          options: je,
        ...
        st.value ? (y(), C("div", {
          ...
          M("div", {
            ...
            S(u).inputShapes.value.length ? (y(), C("div", Eu, [
              g[6] || (g[6] = M("div", { class: "cell id" }, null, -1)),
              (y(!0), C(Se, null, De(bt.value, (O) => (y(), C("div", {
                key: O.id,
                class: Ce(["cell", { center: ["orientationLock", "banding", "finish", "machining", "imageUpload"].includes(O.id) || O.type === "checkbox" }])
              }, te(S(Te)(S(a)(O.label))), 3))), 128)),
              S(le) === "development" ? (y(), C("div", Mu, " Info ")) : G("", !0),
              S(u).inputShapes.value.length > 1 ? (y(), C("div", Ru)) : G("", !0)
            ])) : G("", !0),
            (y(!0), C(Se, null, De(S(u).inputShapes.value, (O, Q) => (y(), C("div", {
              key: Q,
              class: "row inputs"
            }, [
              M("div", Fu, [
              ...
              (y(!0), C(Se, null, De(bt.value, (D) => (y(), C("div", {
                key: D.fieldMap,
                class: Ce(["cell", [`${D.id}`, { center: ["orientationLock", "banding", "finish", "machining", "imageUpload"].includes(D.id) || D.type === "checkbox" }]])
              }, [
                ["orientationLock", "banding", "finish", "machining", "imageUpload"].includes(D.id) ? D.id === "orientationLock" ? (y(), ge(Jl, {
                  key: 1,
                  id: "orientation-" + Q,
                  rectangle: O,
                  disabled: i.readonly,
                  ...
                  onUpdateOrientation: (_) => He(O, _)
                }, null, 8, ["id", "rectangle", "disabled", "stock-grain", "button-background", "icon-color", "orientation-model", "onUpdateOrientation"])) : D.id === "banding" ? (y(), ge(ea, {
                  key: 2,
                  id: "banding-" + Q,
                  "input-shape": O,
                  disabled: i.readonly,
                  ...
                  open: Pe.banding === Q,
                  "orientation-model": Y.orientationModel,
                  onClicked: (_) => Si("banding", O)
                }, null, 8, ["id", "input-shape", "disabled", "stock-grain", "open", "orientation-model", "onClicked"])) : D.id === "finish" ? (y(), ge(Ta, {
                  key: 3,
                  id: "finish-" + Q,
                  "input-shape": O,
                  disabled: i.readonly,
                  open: Pe.finish === Q,
                  onClicked: (_) => Si("finish", O)
                }, null, 8, ["id", "input-shape", "disabled", "open", "onClicked"])) : D.fieldMap === "machining" && nt.value ? (y(), ge(Ea, {
                  key: 4,
                  id: "machining-" + Q,
                  disabled: i.readonly,
                  "input-shape": O,
                  onOpen: (_) => he(O)
                }, null, 8, ["id", "disabled", "input-shape", "onOpen"])) : D.fieldMap === "imageUpload" ? (y(), C("button", {
                  key: 5,
                  id: "image-upload-" + Q,
                  type: "button",
                  disabled: i.readonly,
                  class: Ce({ selected: Pe.info === Q }),
                  onClick: (_) => Si("imageUpload", O)
                }, [
                  pe(b, { icon: ["fass", "image"] })
                ], 10, _u)) : G("", !0) : (y(), ge(ct, {
                  key: 0,
                  id: D.id + "-" + Q,
                  focus: !i.readonly && Y.enable.focus && Q === S(u).inputShapes.value.length - 1 && D.id === "l",
                  issue: S(Hs)(O, [D.fieldMap]),
                  warning: S(Hs)(O, [D.fieldMap], !0),
                  type: D.type,
                  output: D.output,
                  label: D != null && D.label ? S(Te)(S(a)(D.label)) : null,
                  placeholder: D != null && D.placeholder ? S(Te)(S(a)(D.placeholder)) : null,
                  "enable-label": !1,
                  "number-format": Y.numberFormat,
                  "should-update-number-format": !1,
                  readonly: i.readonly,
                  required: (D == null ? void 0 : D.required) ?? !1,
                  "allow-zero": (D == null ? void 0 : D.allowZero) ?? !0,
                  options: D.id === "t" ? Xn(O) : D == null ? void 0 : D.options,
                  ...
                  value: S(Mt)(O, D == null ? void 0 : D.fieldMap),
                  text: {
                    delete: S(Vt)(S(a)("delete")),
                    select: S(Vt)(S(a)("select"))
                  },
                  onValidation: (_, xe) => Ge(_, xe, O, [D.fieldMap]),
                  "onUpdate:value": (_) => {
                    D.fieldMap && S(bl)(O, D.fieldMap, _);
                  }
              ...
              S(u).inputShapes.value.length > 1 ? (y(), C("div", Hu, [
                M("button", {
                  type: "button",
                  class: "delete",
              ...
              Pe.banding === Q && be.options.length > 0 ? (y(), ge(ls, {
                key: 2,
                shape: O,
                "shape-index": Q,
                "extra-type": "banding",
              ...
              Pe.finish === Q && Ae.options.length > 0 ? (y(), ge(ls, {
                key: 3,
                shape: O,
                "shape-index": Q,
                "extra-type": "finish",
          ...
          M("div", Wu, [
            i.readonly ? G("", !0) : (y(), C("button", {
              ...
              style: ke({ background: Y.colors.button, color: Y.colors.buttonText }),
              class: "add c-btn icon-left",
              onClick: g[2] || (g[2] = (O) => Zi(1))
            }, [
            ...
            i.readonly ? G("", !0) : (y(), C("button", {
              ...
              onClick: g[4] || (g[4] = (O) => Ji())
            }, [
              pe(b, { icon: ["fass", "trash"] })
            ], 8, ju)),
            M("div", zu, te(S(f)) + te(Y != null && Y.maxParts ? "/" + Y.maxParts : ""), 1)
          ]),
          ...
          Ue.value ? (y(), C("div", Vu, [
            Wt.value ? (y(), C("div", Yu, te(Wt.value), 1)) : G("", !0),
            M("pre", Xu, te($e.value), 1)
          ])) : G("", !0),
          (Y.enable.diagram ? E.value && !S(ae).complete : E.value || S(ae).complete) ? (y(), C("div", Ku, [
            pe(Vs, {
              size: 50,
          ...
          us(pe(Du, {
            ...
            [cs, Y.enable.diagram && S(ae).complete]
          ]),
          Y.enable.diagram && S(R).length > 1 && S(ae).complete ? (y(), ge(Gl, {
            key: 5,
            ref: "stockNavigation",
            "active-stock-id": S(z),
            "stock-list": S(R),
...
}, ec = { class: "smartcut-object-viewer" }, tc = ["onClick"], ic = { class: "toggle-icon" }, sc = { class: "path-label" }, nc = {
  key: 0,
  ...
  return y(), C("div", ec, [
    (y(!0), C(Se, null, De(e.data, (o, l) => (y(), C("div", {
      ...
      M("div", {
        ...
        M("div", ic, te(n.expanded[l] ? "▼" : "▶"), 1),
        M("div", sc, te(e.paths[l] || l), 1)
      ], 8, tc),
      n.expanded[l] ? (y(), C("div", nc, [
...
const lc = /* @__PURE__ */ ti(Qu, [["render", oc]]), Ki = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: lc }, Symbol.toStringTag, { value: "Module" })), ac = ["data-placement"], uc = /* @__PURE__ */ Oe({
  __name: "ToolTip",
  props: {
    show: { type: Boolean },
    content: {},
  ...
  setup(i) {
    const t = i, e = H(null), s = H(null), n = Z(() => ({
      ...
      Dr({ element: s })
    ], { floatingStyles: o, middlewareData: l, placement: a } = $r(
      n,
      e,
      {
        placement: "top",
        middleware: r,
        whileElementsMounted: (p, I, d) => gr(
          p,
          I,
          d,
          {
...
}), cc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: uc }, Symbol.toStringTag, { value: "Module" })), hc = /* @__PURE__ */ Oe({
  __name: "InputIssues",
  props: {
    item: {
      type: Object,
...
}), dc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: hc }, Symbol.toStringTag, { value: "Module" })), et = {
  precisionFixed: jr,
  format: Ur,
  select: Me,
  selectAll: gn,
...
const gc = { id: "machining" }, mc = {
  key: 0,
  class: "debug"
}, vc = { class: "inputs" }, yc = {
  key: 0,
  class: "shape-name"
}, bc = { class: "shape-dimensions" }, wc = {
  key: 1,
  class: "sides-wrapper"
}, Sc = { class: "menu" }, xc = { class: "button-wrapper" }, kc = { class: "row table-heading" }, Cc = {
  key: 0,
  class: "cell id"
}, Ic = {
  key: 0,
  class: "cell"
}, Lc = { class: "id" }, Pc = ["onClick"], $c = { class: "remove" }, Tc = { key: 5 }, Dc = !1, Oc = /* @__PURE__ */ Oe({
  __name: "Machining",
  props: /* @__PURE__ */ Ms({
  ...
  emits: /* @__PURE__ */ Ms(["update:shape", "close"], ["update:shape"]),
  setup(i, { emit: t }) {
    var Be, _e, Et, Nt, je, be, Ae, ii, Ut, mi, bt, wt, vi;
    const e = $t(() => Promise.resolve().then(() => Ki)), s = i, n = t, r = Z(() => vs(E.value)), o = Z(() => pc.call({ options: s.options }, ["units"])), l = Z(() => {
      var N;
      if (!((N = f.value) != null && N.length)) return 0;
      if (K.value === "banding") return 1;
      let $ = Object.values(u.value).filter((ue) => ue.enabled).length;
      return $ += 2, $;
    }), a = Z(() => {
      if (!f.value.length || K.value === "banding") return;
      const $ = {
        id: "34px",
        del: "30px"
      }, N = [];
    ...
    }), u = Z(() => !K.value || K.value === "banding" ? null : Wt[K.value]), f = Z(() => !K.value || K.value === "banding" ? [] : Object.keys(Wt[K.value]).filter(($) => Wt[K.value][$].enabled)), p = Z(() => K.value ? z() : []), I = Z(() => {
      var N, ue, me, ze;
      ...
      if (!K.value) return [];
      if (K.value === "banding") return [];
      const $ = E.value.machining[K.value];
    ...
    const ae = () => {
      ...
      }), J.init(), rt.value = !0, setTimeout(() => {
        J.updateSize();
      }, 100));
    }, W = () => {
      Y.value = Y.value === 0 ? 1 : 0, J.flip();
    }, V = () => {
      switch (K.value) {
        case "holes":
          v();
      ...
      n("close");
    }, de = ($) => $ && typeof $.disabled == "function" ? $.disabled : !1, We = ($, N, ue, me, ze) => {
      Is($, N, ue, me, ze, s.findExtrasPrice);
    }, st = ($, N, ue, me) => {
      Hn(
        $,
        N,
    ...
    const pt = H(null), ne = H(null), nt = H(!1), rt = H(!1), ot = H(!1), yt = H(!1), Y = H(0), K = H(null), Ke = H(0), Ue = H([]), Wt = gt({
      holes: {
        x: {
          enabled: !0,
          type: "unitDependent",
        ...
        diameter: {
          ...
          options: (Nt = s.options.holes.diameters) != null && Nt.length ? ee(s.options.holes.diameters) : void 0,
          required: !0
        },
        depth: {
          ...
          options: (Ae = s.options.holes.depths) != null && Ae.length ? ee(s.options.holes.depths) : void 0
        },
        face: {
          required: !0,
      ...
      hingeHoles: {
        ...
        depth: {
          ...
          options: (mi = s.options.holes.depths) != null && mi.length ? ee(s.options.holes.depths) : void 0
        },
        //[] separate option for hinges
        diameter: {
          enabled: !0,
          ...
          options: (vi = s.options.holes.diameters) != null && vi.length ? ee(s.options.holes.diameters) : void 0
        },
        numHoles: {
          enabled: !0,
          required: !0,
    ...
    return Le(() => {
      ...
      if (Pe()) {
        ...
        d(), Ue.value = E.value.machining.validate(
          ...
          Bi(N, $e == null ? void 0 : $e.holes, Ue.value, ue);
        }), d(!1);
      }
    }, { deep: !0, immediate: !0 }), Le(() => {
      var $, N;
      ...
      Pe() && (d(), Ue.value = E.value.machining.validate(
        E.value,
        "holes",
      ...
      Pe() && (d(), E.value.machining.updateHingeHoles(E.value), Ue.value = E.value.machining.validate(
        E.value,
        "hingeHoles",
        $e == null ? void 0 : $e.hingeHoles
      ), E.value.machining.hingeHoles.forEach(($, N) => {
        Bi($, $e == null ? void 0 : $e.holes, Ue.value, N);
      ...
      if (Pe()) {
        ...
        for (const $ of E.value.machining.corners)
          $.isPresent() || Cs(E.value, "banding", $.getCorner(), !0);
        J.createBanding(), d(!1);
      }
    }, { deep: !0, immediate: !0 }), Le(() => {
      var $;
      ...
      return y(), C("div", gc, [
        ...
        M("div", null, [
          M("div", vc, [
            ...
            (me = E.value) != null && me.name ? (y(), C("div", yc, te(E.value.name), 1)) : G("", !0),
            M("div", bc, te((ze = E.value) == null ? void 0 : ze.l) + " x " + te((He = E.value) == null ? void 0 : He.w) + " " + te((Ve = E.value) != null && Ve.t ? "x " + ((si = E.value) == null ? void 0 : si.t) : null), 1),
            $.options.faces.enabled ? (y(), C("div", wc, [
              M("div", {
                ref: "sides",
                class: Ce(["sides", { flipped: Y.value === 1 }]),
                onClick: W
              }, N[4] || (N[4] = [
            ...
            M("div", Sc, [
              $.options.holes.enabled ? (y(), C("div", {
                key: 0,
                class: Ce({ selected: K.value === "holes" }),
                onClick: N[0] || (N[0] = (Ge) => K.value = "holes")
              }, " Holes ", 2)) : G("", !0),
              $.options.hingeHoles.enabled ? (y(), C("div", {
                key: 1,
                class: Ce({ selected: K.value === "hingeHoles" }),
                onClick: N[1] || (N[1] = (Ge) => K.value = "hingeHoles")
              }, " Hinge holes ", 2)) : G("", !0),
              $.options.corners.enabled ? (y(), C("div", {
                key: 2,
                class: Ce({ selected: K.value === "corners" }),
                onClick: N[2] || (N[2] = (Ge) => K.value = "corners")
              }, " Corners ", 2)) : G("", !0),
              $.options.banding.enabled ? (y(), C("div", {
                key: 3,
                class: Ce({ selected: K.value === "banding" }),
                onClick: N[3] || (N[3] = (Ge) => K.value = "banding")
              }, " Banding ", 2)) : G("", !0)
            ]),
            M("div", xc, [
              K.value === "holes" || K.value === "hingeHoles" ? (y(), C("button", {
                key: 0,
                type: "button",
                onClick: V
              }, " Create ")) : G("", !0),
              K.value && K.value !== "banding" ? (y(), C("button", {
                key: 1,
                type: "button",
                onClick: A
              }, " Delete all ")) : G("", !0)
            ]),
            K.value === "banding" && E.value ? (y(), ge(ls, {
              key: 3,
              shape: E.value,
              env: $.env,
              "extra-type": "banding",
            ...
            K.value !== "banding" && p.value.length ? (y(), C("div", {
              key: 4,
              class: Ce(["grid-table", K.value]),
              style: ke({ "grid-template-columns": a.value })
            }, [
              M("div", kc, [
                j() ? (y(), C("div", Cc)) : G("", !0),
                (y(!0), C(Se, null, De(u.value, (Ge, Qe, he) => us((y(), C("div", {
                  key: he,
                  class: "cell"
                }, te(Ge.label ?? Qe), 1)), [
                  [cs, Ge.enabled]
              ...
              (y(!0), C(Se, null, De(p.value, (Ge, Qe) => (y(), C("div", {
                ...
                (y(!0), C(Se, null, De(U(Qe), (he, St) => (y(), C("div", {
                  key: St,
                  class: "group validation",
                  style: ke({ "grid-column-end": "span " + l.value })
                }, te(he), 5))), 128))
              ]))), 128))
            ], 6)) : K.value !== "banding" ? (y(), C("div", Tc, " Please select from the menu above ")) : G("", !0)
          ]),
          M("div", {
            id: "machining-diagram",
            class: Ce(["diagram", { flipped: Y.value === 1 }])
          }, null, 2)
        ])
      ]);
    };
  }
}), Ac = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: Oc }, Symbol.toStringTag, { value: "Module" })), Ec = {
  name: "Drop",
  props: {
    requiredType: {
      type: String,
...
function Mc(i, t, e, s, n, r) {
  return y(), C("div", {
    id: "drop",
    class: Ce({ thinking: e.thinking, [n.dropClass]: !0 }),
    onDrop: t[0] || (t[0] = Er((...o) => r.onDrop && r.onDrop(...o), ["prevent"]))
  }, [
    M("div", null, te(e.thinking ? "Loading, please wait..." : e.label), 1)
  ], 34);
}
const Rc = /* @__PURE__ */ ti(Ec, [["render", Mc]]), Fc = { id: "import-file" }, _c = /* @__PURE__ */ Oe({
  __name: "ImportCSV",
  props: {
    numberFormat: {
      type: String,
  ...
  emits: ["error", "import"],
  setup(i, { emit: t }) {
    const e = i, s = t, { t: n } = Ni(["main", "errors"]), r = H([]), o = H([]), l = H([]), a = H([]), u = H({}), f = H([]), p = H(!1), I = H(null), d = H(null), m = [
      "l",
      "w",
      "t",
      "q",
    ...
    }), R = Z(() => e.customFields.map((A) => A.label)), j = (A, q) => {
      if (q) {
        const U = Object.keys(q), ie = [[]];
        U.forEach((ye) => {
          const de = q[ye], We = [];
          ie.forEach((st) => {
      ...
      if (!oe) {
        ...
        console.log(`Valid ${U} choices...`), console.table(Array.from(q)), console.log(`The following ${U} choices are invalid`, ye);
      }
      return oe;
    }, J = (A, q) => {
      const U = {
      ...
      return ie.forEach((de, We) => {
        ye[de] = {}, Object.keys(q).forEach((st, E) => {
          var pt;
          ye[de][U[E]] = ((pt = oe[We]) == null ? void 0 : pt.split("|")[E]) || "";
        });
      }), ye;
    }, W = () => r.value.map((A, q) => ({
      l: e.numberFormat === "decimal" ? Ei(A.l) : A.l,
      w: e.numberFormat === "decimal" ? Ei(A.w) : A.w,
      t: e.numberFormat === "decimal" ? Ei(A.t) : A.t,
      q: A.q,
      orientationLock: A.orientationLock,
      name: A.name,
      material: A.material,
      bandingOptions: w.value[q].banding ? J("bandingOptions", A.banding) : null,
      finishOptions: w.value[q].finish ? J("finishOptions", A.finish) : null,
      numberFormat: e.numberFormat,
      customData: le(A)
    })), V = (A) => {
      var U;
      const q = (U = A == null ? void 0 : A[0]) == null ? void 0 : U.data;
      q && br.parse(q, {
        header: !1,
        dynamicTyping: !1,
        worker: !0,
      ...
      o.value = A.data.filter((q) => q.some((U) => U)), l.value = o.value[0], u.value = {};
      for (let q = l.value.length; q--; ) {
        const U = l.value[q], ie = T(U);
        ie ? u.value[q] = ie : (u.value[q] = null, R.value.includes(U) && (u.value[q] = "customData." + e.customFields.find((oe) => oe.label === U).id));
      }
      X(), o.value.shift(), F(), se();
    }, T = (A) => {
      const q = {
      ...
      const A = a.value.filter((q, U) => a.value.indexOf(q) !== U);
      f.value = A.map((q) => a.value.reduce(
        (U, ie, oe) => (ie && ie === q && U.push(oe), U),
        []
      ));
...
}), qc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: _c }, Symbol.toStringTag, { value: "Module" }));
...
const Bc = {
  key: 0,
  class: "debug"
}, Hc = { id: "formula-pricing" }, Gc = {
  key: 1,
  class: "extras"
}, Wc = { class: "heading" }, Nc = { id: "hardware-total" }, Uc = { class: "heading panels" }, jc = !1, zc = /* @__PURE__ */ Oe({
  ...
  setup(i, { emit: t }) {
    const e = $t(() => Promise.resolve().then(() => Ki)), s = i, { t: n } = Ni(["main", "errors"]), r = t, o = Mr("calculator"), l = Z(() => o()), a = H("production");
    let u = null;
    const f = H(null), p = H([]), I = H(!1), d = H(""), m = Z(() => {
      if (!I.value || !p.value.length || p.value.every((v) => v.value === null)) return null;
      const V = J();
      return Ze(() => r("panel-result", V)), V;
    }), w = Z(() => {
      if (!l.value || !I.value || !p.value.length || p.value.every((v) => v.value === null)) return;
      const V = ae();
      return Ze(() => r("hardware-result", V, R.value)), V;
    }), R = Z(() => {
      if (w.value)
        return Object.values(w.value).reduce((V, v) => V + v.totalCost, 0);
    });
    Le(m, (V) => {
      var P, F, le;
      if (!I.value || !V || !l.value || !((P = l.value) != null && P.inputShapes)) return;
      ...
      for (const se of Object.values(m.value)) {
        ...
        const A = v(se), q = T.get(A), U = {
          ...
          notes: d.value,
          readonly: !0
        }, ie = q || l.value.createInputShape(U);
        if (q) {
          Object.assign(q, U);
    ...
    const j = (V) => {
      s.debug && console.log(V);
    }, ee = () => {
      p.value = Object.values(f.value.inputs).map((V) => ({
        value: V.default ?? null
      })), console.log(p.value);
    }, z = (V, v) => {
      p.value[V] && (p.value[V].value = v);
    }, J = () => {
      try {
        return u.calculatePanelsFromFields(p.value);
      } catch (V) {
        return l.value.inputShapes.length = 0, console.error(V), null;
      }
    }, ae = () => {
      try {
      ...
      s.url ? (j(`SmartCut - Formula calculator init from url: ${s.url}`), u = new an({ url: s.url }), f.value = await u.getSpec()) : s.spec && (j("SmartCut - Formula calculator init with JSON"), u = new an({ spec: s.spec }), f.value = await u.getSpec()), ee(), I.value = !0;
    };
    return (V, v) => {
      var T, X;
      return y(), C(Se, null, [
        a.value === "development" && jc ? (y(), C("div", Bc, [
        ...
        M("div", Hc, [
          ...
          (y(!0), C(Se, null, De((X = f.value) == null ? void 0 : X.inputs, (P, F, le) => {
            var se;
            return y(), ge(ct, {
              id: "formula-field-" + le,
              key: le,
          ...
          w.value ? (y(), C("div", Gc, [
            M("div", Wc, te(S(n)("Hardware")), 1),
            (y(!0), C(Se, null, De(w.value, (P, F) => (y(), C("div", { key: F }, te(P.name) + " x" + te(P.q) + " = " + te(i.formatPrice(P.totalCost)), 1))), 128)),
            M("div", Nc, te(S(n)("Hardware total")) + " = " + te(i.formatPrice(R.value)), 1)
          ])) : G("", !0),
          M("div", Uc, te(S(n)("Panels")), 1)
        ])
      ], 64);
    };
  }
}), bh = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: zc }, Symbol.toStringTag, { value: "Module" })), Vc = { id: "smartcut-notices" }, Yc = { class: "content" }, Xc = ["onClick"], Kc = ["innerHTML"], Zc = /* @__PURE__ */ Oe({
  __name: "Notices",
  props: {
    position: { default: "top-left" }
  },
  setup(i) {
    const t = i, { notices: e, dismissNotice: s } = fs(), n = H({}), r = Z(() => t.position.includes("right") ? "notice-right" : "notice-left");
    return (o, l) => {
      ...
      return y(), ge(cn, { to: "body" }, [
        M("div", Vc, [
          pe(Rr, {
            ...
            default: ds(() => [
              (y(!0), C(Se, null, De(S(e), (u) => (y(), C("div", {
                key: u.id,
                ref_for: !0,
                ref: (f) => {
                  f && (n.value[u.id] = f);
...
}), wh = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: Zc }, Symbol.toStringTag, { value: "Module" }));
export {
  Jt as A,
  Vr as B,
  yh as C,
