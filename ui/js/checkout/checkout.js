...
import { q as Ve, v as He, w as v, C as Ke, p as St, x as U, y as xt, z as Ft, A as Pt, B as Et, D as zt, _ as Tt, E as qt } from "./components-BZTl60Hm.js";
...
import { u as Qt, f as Wt } from "./composables-BuS83uIC.js";
...
const Kt = (l, k, j, y = (u) => u.toString()) => {
  ...
  __name: "WordPress",
  setup(l) {
    const k = oe(() => import("./components-BZTl60Hm.js").then((e) => e.F)), j = oe(() => import("./components-BZTl60Hm.js").then((e) => e.O)), y = oe(() => import("./components-BZTl60Hm.js").then((e) => e.N)), { inputShapes: u } = Qt(), d = "production", f = {}, F = {}, P = b(null);
    let q, c, t;
    const S = {
      banding: null,
      finish: null
  ...
  setup(l, { expose: k, emit: j }) {
    const y = oe(() => import("./components-BZTl60Hm.js").then((o) => o.F)), u = oe(() => import("./components-BZTl60Hm.js").then((o) => o.N)), d = j, f = b(!1), F = b([]), P = b({
      banding: null,
      finish: null,
      machining: null
