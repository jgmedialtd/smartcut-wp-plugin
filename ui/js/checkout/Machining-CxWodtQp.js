...
import { B as et, Q as Ye, C as E, R as tt, r as Y, f as ze, w as M, o as st, n as se, G as at, j as c, k as g, I as ae, u as Te, A as x, t as b, v as P, p as O, H as j, q as Ae, F as q, l as N, x as it, y as nt, L as lt } from "./main-8EuuSrTZ.js";
import { e as z, f as S, h as Ee, v as V, i as rt, j as ht, k as Be, r as ot, u as dt, l as ut, I as ie, s as ct, n as pt } from "./Launch-C3lsAxQE.js";
class gt {
  constructor({
    HTMLElement: a,
    vueComponent: n,
...
const vt = { id: "machining" }, mt = {
  ...
  setup(T, { emit: a }) {
    ...
    const n = lt(() => import("./ObjectViewer-BL5zQO-E.js")), t = T, v = a, o = E(() => rt(s.value)), L = E(() => ht.call({ options: t.options }, ["units"])), f = E(() => {
      var i;
