import { bv as ze, bw as me, bx as ie, by as tt, bz as v, bA as nt, F as at, I as it, bB as rt, bC as st, bD as Ee, bE as ot, t as lt } from "./components-Bf39GJww.js";
import { J as ct } from "./vendor-jszip-BLbRTMPM.js";
import { m as ut } from "./composables-BGwYkZJE.js";
import { E as dt, a as O } from "./vendor-jspdf-CG28Yq1x.js";
import { d as pt, r as z, L as ft, c as mt, k as _t, a as Te, o as re, E as _e, x as ge, q as qe, s as Q, N as he, g as gt, F as ht, n as bt, _ as yt, R as wt } from "./vendor-vue-ChIbPezZ.js";
const I = 5, W = 10, $ = ",", A = {
  fillColor: [7, 59, 76],
  fontStyle: "normal"
}, D = {
...
const kt = (r, w, j, _ = (l) => l.toString()) => {
  ...
  let p = 10;
  l.setFontSize(20), l.text(r("pdf.order_summary"), 10, p), p += 15, l.setFontSize(14), l.text(`${r("general.your")} ${r("woodwork.part")}`, 10, p), p += I, R = [
    r("woodwork.length"),
    r("woodwork.width"),
    ...
    r("woodwork.quantity"),
    r("woodwork.name"),
    `${r("woodwork.banding")} (${ze.join($)})`,
    `${r("woodwork.finish")} (${me.join($)})`
  ];
  const m = w.parts.map((u) => {
    let h, t;
    if ("extras" in u && u.extras)
      h = ze.map((o) => ie(u.extras?.banding?.sides?.[o], "-")).join($), t = me.map((o) => ie(u.extras?.finish?.faces?.[o], "-")).join($);
    else {
      const o = u;
      h = ["y1", "y2", "x1", "x2"].map((S) => ie(o.banding?.[S], "-")).join($), t = me.map((S) => ie(o.finish?.faces?.[S], "-")).join($);
    }
    return [
      _(u.l),
      _(u.w),
  ...
  O(l, {
    ...
    headStyles: A,
    styles: D
  }), p = l.lastAutoTable.finalY + W, l.setFontSize(14), l.text(r("pdf.stock_requirements"), 10, p), p += I, R = [
    r("woodwork.length"),
    r("woodwork.width"),
    r("woodwork.thickness"),
    r("woodwork.material"),
  ...
  if (O(l, {
    ...
    l.setFontSize(14), l.text(r("pdf.roll_requirements"), 10, p), p += I, R = [
      r("woodwork.name"),
      r("woodwork.material"),
      r("woodwork.length")
    ];
  ...
  __name: "WordPress",
  setup(r) {
    const w = he(() => import("./components-Bf39GJww.js").then((e) => e.bJ)), j = he(() => import("./components-Bf39GJww.js").then((e) => e.bI)), _ = he(() => import("./components-Bf39GJww.js").then((e) => e.bK)), { inputShapes: l } = tt(), p = "production", m = {}, F = {}, B = z(null);
    let u, h, t;
    const E = {
      banding: null,
      finish: null
    ...
    const K = z(!1), T = z("manual"), J = z(""), P = ft([]), je = mt(() => P.value), H = z(null), C = z(!0), be = z(null), L = z(!1), G = z(null);
    yt("calculator", () => G.value);
    const k = (e) => {
      K.value && console.log("SmartCut -", ...e);
    }, g = (e) => {
      console.error(`SmartCut - ${e}`);
    }, Z = (e = !0) => {
      L.value = !0, ["checkout", "intro_text", "offcuts", "banding_key"].forEach((a) => U(a, "block")), Qe() && U("pricing_table", "table"), e ? X(!0) : oe(), q();
    }, N = (e = !0, n = !0) => {
      L.value = !1, ["checkout", "intro_text", "offcuts", "banding_key", "pricing_table"].forEach((i) => U(i, "none")), n === !0 ? ye() : n === !1 && q(), X ? X() : e === !1 && oe();
    }, X = (e = !1) => {
      U("quantity", "inline-block"), m.quantity.readOnly = e;
    }, oe = () => {
      L.value !== !1 && (le(1), U("quantity", "none"), m.quantity.readOnly = !0);
    }, ye = () => {
      if (!m.cart_button) {
      ...
      C.value = xe(), C.value ? X(!0) : oe(), o.type === "variable" ? N(!1, !1) : Z(C.value);
      const Y = {
        type: o.type,
      ...
      Y.type === "variable" && (k(["setting variable product form listeners"]), jQuery(function(b) {
        b(".variations_form").on("reset_data", () => N(!1, !1)).on("found_variation", (Xe, et) => Je(Xe, et));
      }));
      const ae = {
        product: o,
        selectedVariation: H,
      ...
      T.value = v(window, ["smartcutConfig", "settings", "enable_formula"]) === !0 ? "formula" : "manual", J.value = v(window, ["smartcutConfig", "settings", "formula_url"]), k([`Input type: ${T.value}`]), x = {
      ...
      return n;
    }, Ue = (e) => (se.holes ?? 0) * (e.metadata.numHoles ?? 0) + (se.corners ?? 0) * (e.metadata.numCorners ?? 0), U = (e, n) => {
      ...
      if (o.selected_thickness = a, l.value.forEach((i) => {
        ...
        if (Array.isArray(i) ? Z(C.value) : ne(i) ? N(!0, !0) : Z(C.value), S?.length) {
          let d;
          const c = a;
      ...
      const a = kt(lt, e, be.value, He).split(",")[1], i = new ct();
    ...
    return _t(() => {
      console.log("💥 Powered by https://smartcut.dev", window?.smartcutConfig?.version), k(["Launching WordPress checkout..."]), E.banding = v(window, ["smartcutConfig", "banding_data"]), E.finish = v(window, ["smartcutConfig", "finish_data"]), se = v(window, ["smartcutConfig", "machining_pricing"]), S = v(window, ["smartcutConfig", "variations"]), Ve(), Ke(), Ae(window.smartcutConfig), De(window.smartcutConfig), $e(), Be(), [
      ...
      T.value === "formula" && J.value ? (re(), qe(Q(w), {
        key: 1,
        ref: "formulapricing",
        "format-price": ee,
        url: J.value,
      ...
      T.value === "manual" || T.value === "formula" && J.value ? (re(), qe(nt, {
        key: 2,
        ref_key: "calculator",
        ref: G,
