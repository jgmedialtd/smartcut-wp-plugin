import { d as _, G as i, x as p, j as y, H as f, c as d, t as k, b as v, s as l, C as u, o as m } from "./vendor-vue-CrNGqS0k.js";
const h = {
  key: 1,
  class: "error-message"
}, C = /* @__PURE__ */ _({
  ...
  setup(t, { expose: c }) {
    const o = l(!1), n = l(null), a = i({
      wordpress: u(() => import("./WordPress-B5yy_z3U.js")),
      vanilla: u(() => import("./Vanilla-DBUwCeJZ.js").then((s) => s.V))
    }), e = t, r = p(() => {
