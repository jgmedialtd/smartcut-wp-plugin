import { d as qt, h as Ut, W as _t, _ as Vt, w as B, n as Zt, o as Jt, e as Qt, y as Kt, g as $, R as te, c as L } from "./vendor-vue-QD0FJS8o.js";
import { f as xt, i as ee, j as se, r as ie } from "./EcommerceCalculator-ClNeqZHE.js";
import { f as ne, d as ae, l as P, e as U, c as _, i as y, r as C, g as j, h as le } from "./vendor-d3-DC0ueG10.js";
import { ay as R, aB as V, aq as oe, cF as E } from "./result.zod-B0BoTcpc.js";
import { g as re, p as ce, a as he, P as ue, d as de, b as pe } from "./coordinates-BSLhhBFy.js";
import "./vendor-i18next-DIDhOEvY.js";
import { a as fe } from "./vendor-lodash-CLVv-kqQ.js";
function ge(e) {
  const t = e.x, s = e.x + e.l, i = P().domain([t, s]).range([this.scales.xPositionScale(t), this.scales.xPositionScale(s)]), n = e.y, a = e.y + e.w, l = P().domain([n, a]).range([this.scales.yPositionScale(n), this.scales.yPositionScale(a)]), o = 8;
  this.axes.shapeXAxis ? this.axes.shapeXAxis.attr("transform", `translate(0, ${this.state.h - this.state.padding + o})`).call(U(i).tickValues(i.domain()).tickSize(4).tickFormat(this.formatNumber)) : this.axes.shapeXAxis = this.selections.axisGroup.append("g").attr("transform", `translate(0, ${this.state.h - this.state.padding + o})`).attr("class", "axis shape x").call(U(i).tickValues(i.domain()).tickSize(4).tickFormat(this.formatNumber)), e?.stock?.saw?.stockType !== "linear" ? this.axes.shapeYAxis ? this.axes.shapeYAxis.attr("transform", `translate(${this.state.padding - o}, 0)`).call(_(l).tickValues(l.domain()).tickSize(4).tickFormat(this.formatNumber)) : this.axes.shapeYAxis = this.selections.axisGroup.append("g").attr("transform", `translate(${this.state.padding - o}, 0)`).attr("class", "axis shape y").call(_(l).tickValues(l.domain()).tickSize(4).tickFormat(this.formatNumber)) : this.axes.shapeYAxis && (this.axes.shapeYAxis.remove(), this.axes.shapeYAxis = null);
}
function me() {
...
function vt(e, t, s) {
  !s || !e?.length || e.forEach((i, n) => {
    const [a, l] = i;
    s === "x" ? ye.call(this, a, l, t[n]) : xe.call(this, a, l, t[n]);
  });
}
function ye(e, t, s) {
  ...
  ).attr("class", "axis measurement x").call(U(i).tickValues([n]).tickSize(4).tickFormat(() => this.formatNumber(s)));
...
function q({ parent: e, near: t, far: s, offcuts: i = [] }) {
  if (!this.props.containerWidth)
    return !1;
  const n = [e, t, s, ...i].filter((a) => a);
  this.selections.segmentRectangles = this.selections.segmentGroup.selectAll("rect").data(n, Z).join(
    (a) => a.append("rect").attr("class", "segment").call((l) => st.call(this, l)),
    (a) => a.call((l) => st.call(this, l)),
    (a) => a.remove()
...
function ke(e) {
  this.selections.segmentGroup.selectAll("text").data(e, Z).join(
...
function Ae() {
  ...
  this.selections.segmentRectangles = this.selections.segmentGroup.selectAll("rect").data(e, Z).join(
...
function Be(e, t, s, i, n) {
  this.selections.cutLines.style("visibility", (l, o) => o <= t ? "visible" : "hidden"), this.state.env === "development" && this.selections.cutLabels && (this.selections.cutLabels.style("visibility", (l, o) => o <= t ? "visible" : "hidden"), this.selections.cutBackgrounds && this.selections.cutBackgrounds.style("visibility", (l, o) => o <= t ? "visible" : "hidden"));
  let a;
  if (e?.dimension === "l" ? a = [
    [0 + (s.l1 ?? 0), e.y1 - n],
    ...
    this.state.device === "desktop" && !e.isTrim && vt.call(this, a, l, i);
  }
  this.selections.cutLines.classed("offcut-cut", !1), this.selections.cutLines.classed("highlight", (l, o) => o === t);
}
function Ct() {
...
function Te(e, t) {
  ...
  if (s == null) return;
  this.selections.cutLines.classed("completed", (p) => wt(p, t, s)), this.selections.cutLines.classed("inside-segment", (p) => At(p, t));
  const i = bt.call(this, e);
  if (i === !1) return;
  const { parent: n, children: a } = i, { near: l } = Pt(e, a);
  if (!l) return;
  let o = [], r;
  const f = this.getHalfBladeWidth(e.stock), h = e.dimension === "l" ? "y" : "x";
  e?.dimension === "l" ? (o = [
    [
      l.y,
      l.y + l.w
  ...
  ], r = [e?.distances?.bottom, e?.distances.top]) : e?.dimension === "w" && (o = [
    [
      l.x,
      l.x + l.l
    ],
  ...
  ], r = [e?.distances?.left, e?.distances?.right]), this.state.device === "desktop" && !e.isTrim && r && vt.call(this, o, r, h);
}
function Re(e = null, t = "") {
  ...
  const i = s.guillotineState?.parentSegmentID, n = this.getHalfBladeWidth(s.stock), a = s.dimension === "l" ? "y" : "x", l = s?.stock?.trim, o = t === "ptx" ? "ptxOrder" : "order";
  if (s.isTrim && ["guillotine", "beam"].includes(s?.stock?.cutType)) {
    Ge.call(this, s, e, o), at.call(this, s, e, i), this.removeSegments();
    return;
  }
  if (["guillotine", "beam"].includes(s?.stock?.cutType) && i !== null && typeof i < "u" ? Ie.call(this, s, i, o, t) : Be.call(this, s, e, l, a, n), at.call(this, s, e, i), t === "ptx") {
    this.removeSegments();
    return;
  }
  ...
  if (r === !1)
    return;
  const { parent: f, children: h } = r;
  if (!s?.guillotineState?.parentSegmentID)
    return q.call(this, { parent: f });
  if (s.stock?.cutType === "beam" && f.phase === 0) {
    const k = this.props.segments.value.find((v) => v.stock?.autoId === s.stock?.autoId)?.children || h, M = k.find((v) => v.offcut === !0 && v.y === 0 && v.isTrimOffcut === !0), m = k.find((v) => v.offcut === !0 && v !== M && v.y + v.w >= s.stock.w - (s.stock.trim?.l2 || 0)), b = k.filter((v) => !v.offcut), S = b.find((v) => v.type === "near"), w = b.find((v) => v.type === "far"), x = [M, m].filter(Boolean);
    return q.call(this, { parent: f, near: S, far: w, offcuts: x });
  }
  const { near: p, far: g, offcuts: A } = Pt(s, h);
  q.call(this, { parent: f, near: p, far: g, offcuts: A });
}
function Pt(e, t) {
  const s = e.dimension === "l" ? "y" : "x", i = e.dimension === "l" ? "w" : "l", n = e.stock?.cutType === "beam";
  let a, l;
  if (n)
    a = t.find((r) => r.type === "near" && !r.offcut), l = t.find((r) => r.type === "far" && !r.offcut);
  else {
    const f = e[s + "1"], h = e.stock.halfBladeWidth;
    a = t.find((p) => p.type === "near" && Math.abs(p[s] + p[i] - (f - h)) < 1e-6), l = t.find((p) => p.type === "far" && Math.abs(p[s] - (f + h)) < 1e-6);
  }
  const o = t.filter((r) => r.offcut === !0 && r !== a && r !== l);
...
function at(e, t, s) {
  this.selections.cutLines.attr("stroke-width", (i, n) => {
    ...
    const o = e?.guillotineState?.segmentCutOrder;
    return (wt(i, s, o) || At(i, s)) && (l += 1), n === t && Math.ceil(this.scales.measurementScale(this.getBladeWidth(i.stock))) < 5 && (l = 5), l;
  });
}
function We() {
  ...
  e.contours.forEach((n, a) => {
    const l = n.leadIn.length > 0 ? n.leadIn[0] : n.contour[0];
    if (!l) return;
    i && a > 0 && this.selections.cuttingPathGroup.append("line").attr("x1", t(i.x)).attr("y1", s(i.y)).attr("x2", t(l.x)).attr("y2", s(l.y)).attr("stroke", "#000").attr("stroke-width", 0.5).attr("stroke-dasharray", "2,3").attr("fill", "none"), i = n.leadOut.length > 0 ? n.leadOut[n.leadOut.length - 1] : n.contour.length > 0 ? n.contour[n.contour.length - 1] : l;
    ...
    const l = a.map(
      (o, r) => `${r === 0 ? "M" : "L"} ${t(o.x)} ${s(o.y)}`
    ).join(" ");
    this.selections.cuttingPathGroup.append("path").attr("d", l).attr("stroke", "#ff00ff").attr("stroke-width", 1).attr("fill", "none");
  });
}
function Me(e) {
...
function $e(e, t, s) {
  ...
  const o = (r, f, h) => {
    const p = r - a, g = f - l;
    n += Math.sqrt(p * p + g * g), i.push({ sx: r, sy: f, type: h, cumDist: n }), a = r, l = f;
  };
  return i.push({ sx: a, sy: l, type: "rapid", cumDist: 0 }), e.contours.forEach((r, f) => {
    const h = r.leadIn.length > 0 ? r.leadIn[0] : r.contour[0];
    if (!h) return;
    o(t(h.x), s(h.y), "rapid");
    const p = [
      ...r.leadIn,
...
function Le(e, t) {
  ...
  for (let i = 1; i < e.length; i++)
    if (e[i].cumDist >= t) {
      const n = e[i - 1], a = e[i], l = a.cumDist - n.cumDist;
      if (l === 0) return { sx: a.sx, sy: a.sy, type: a.type };
      const o = (t - n.cumDist) / l;
      return {
        sx: n.sx + (a.sx - n.sx) * o,
        sy: n.sy + (a.sy - n.sy) * o,
        type: a.type
...
function Oe() {
  ...
  if (!t || !t.waypoints.length) {
    const a = this.scales.xPositionScale, l = this.scales.yPositionScale, o = $e(e, a, l);
    if (o.length < 2) return;
    const r = o[o.length - 1].cumDist;
    t = {
      waypoints: o,
      totalDistance: r,
      progress: 0,
  ...
  const i = this, n = (a) => {
    ...
    const l = (a - t.lastTime) / 1e3;
    t.lastTime = a, t.progress += t.speed * l, t.progress >= 1 && (t.progress = 1, t.playing = !1);
    const o = t.progress * t.totalDistance, r = Le(t.waypoints, o);
    ...
    for (let A = 0; A < t.waypoints.length; A++) {
      const d = t.waypoints[A];
      if (d.cumDist > o) break;
      d.type === "cutting" ? ((!g || g.type !== "cutting") && (h += ` M ${g ? g.sx : d.sx} ${g ? g.sy : d.sy}`), h += ` L ${d.sx} ${d.sy}`) : ((!g || g.type !== "rapid") && (p += ` M ${g ? g.sx : d.sx} ${g ? g.sy : d.sy}`), p += ` L ${d.sx} ${d.sy}`), g = d;
    }
    t.progress < 1 && g && (r.type === "cutting" ? h += ` L ${r.sx} ${r.sy}` : p += ` L ${r.sx} ${r.sy}`), i.selections.cuttingPathGroup.select(".cutting-path-trail-cut").attr("d", h), i.selections.cuttingPathGroup.select(".cutting-path-trail-rapid").attr("d", p), t.playing && (t.rafId = requestAnimationFrame(n));
  };
...
function Fe(e) {
  ...
  if (this.props.stock.value.cutType === "efficiency") {
    if (this.state.env === "development") {
      let l = function(h) {
        ...
        h.attr("class", "ray").attr("x1", (p) => this.scales.xPositionScale(p.x1)).attr("x2", (p) => this.scales.xPositionScale(p.x2)).attr("y1", (p) => this.scales.yPositionScale(p.y1)).attr("y2", (p) => this.scales.yPositionScale(p.y2));
      };
      if (this.state.env !== "development") return;
      const f = ce(this.props.shapes.value, this.props.stock.value).flatMap((h) => Object.values(h.rays));
      this.selections.ghostShapeGroup.selectAll("line").data(f, l).join(
        (h) => h.append("line").call((p) => o.call(this, p)),
        (h) => h.call((p) => o.call(this, p)),
        (h) => h.remove()
      );
    }
    n = he(
  ...
  for (const l of i.toArray()) {
    const o = de(e, l, this.props.stock.value);
    o && a.addPoints(o.toArray());
  }
  if (n) {
    const l = n.toArray();
    for (const o of l) {
      const r = pe(e, o, this.props.stock.value);
  ...
  if (this.props.stock.value.cutType === "efficiency") {
    ...
    ].forEach((o) => a.add(o)), t = a.toArray();
  } else {
    const l = this.props.stock.value;
    a.add(new R(l.trim.w1 ?? 0, l.trim.l1 ?? 0)), t = a.toArray();
  }
...
function je(e, t) {
  ...
  function i(n, a) {
    n.attr("data-id", (l, o) => o).attr("class", "shape ghost").attr("x", (l) => (a.x = l.x, this.getRectangleCoordinate(a, "x"))).attr("y", (l) => (a.y = l.y, this.getRectangleCoordinate(a, "y"))).attr("width", this.getWidthAttribute(a)).attr("height", this.getHeightAttribute(a)).on("mousedown", (l, o) => {
...
function Xe(e, t) {
  ...
  function i(n) {
    n.attr("class", "dot").attr("cx", (a) => this.scales.xPositionScale(a.x)).attr("cy", (a) => this.scales.yPositionScale(a.y)).attr("r", 6).on("mousedown", (a, l) => {
      this.callbacks.onMoveShape(t, l);
    });
  }
  this.selections.dotGroup.selectAll("circle").data(e, s).join(
    ...
    function(n) {
      ...
      const a = y(this).attr("data-id"), l = y(`.ghost[data-id="${a}"]`);
...
function ze() {
  this.selections.shapeIDText = this.selections.shapeWrappers.selectAll("text.shape-text.id").data((e) => Y(e) ? [] : [e]).join(
    (e) => e.append("text").attr("class", "shape-text id").text((t) => lt.call(this, t)).classed("hidden", (t, s, i) => this.isTextHidden(t, s, i)).attr("dominant-baseline", "middle").style("fill", (t) => I.call(this, t)).attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t) => this.getRectangleCoordinate(t, "y", "center")).attr("dy", 1),
    (e) => e.classed("hidden", !1).text((t) => lt.call(this, t)).classed("hidden", (t, s, i) => this.isTextHidden(t, s, i)).style("fill", (t) => I.call(this, t)).attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t) => this.getRectangleCoordinate(t, "y", "center")).attr("dy", 1)
  ), this.selections.shapeNameText = this.selections.shapeWrappers.selectAll("text.shape-text.name").data((e) => Y(e) ? [] : [e]).join(
    (e) => e.append("text").attr("class", "shape-text name").text((t) => ot.call(this, t)).call(this.trimNameToFit, this).classed("hidden", (t, s, i) => this.isNameHidden(t, s, i)).attr("dominant-baseline", "middle").style("fill", (t) => I.call(this, t)).attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t, s, i) => {
      const n = i[s];
    ...
    (e) => e.classed("hidden", !1).text((t) => ot.call(this, t)).call(this.trimNameToFit, this).classed("hidden", (t, s, i) => this.isNameHidden(t, s, i)).style("fill", (t) => I.call(this, t)).attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t, s, i) => {
      const n = i[s];
      return this.getRectangleCoordinate(
        t,
        "y",
    ...
    (e) => e.append("text").attr("class", "shape-text width").text((t) => ct.call(this, t)).classed("hidden", (t, s, i) => this.isWidthHidden(t, s, i)).attr("dominant-baseline", "middle").style("fill", (t) => I.call(this, t)).attr("transform", (t, s, i) => {
      ...
      ), l = this.getRectangleCoordinate(t, "y", "center"), o = this.state.device === "mobile" ? 90 : -90;
...
function qe() {
  ...
  for (const i of e) {
    ...
    const l = typeof n == "string" ? n : n.autoId || n.id;
    l && (t.has(l) || t.set(l, []), t.get(l).push(i));
  }
  if (t.size === 0) {
    this.removeGroups();
    return;
  ...
  const s = [];
  for (const [, i] of t) {
    const n = Math.min(...i.map((r) => r.x)), a = Math.min(...i.map((r) => r.y)), l = Math.max(...i.map((r) => r.x + r.l)) - n, o = Math.max(...i.map((r) => r.y + r.w)) - a;
    s.push({ x: n, y: a, l, w: o, shapes: i });
  }
  this.initGroups(s);
}
const Ue = (e) => e.id;
function _e() {
  ...
  this.scales.shapeColorScale.domain([1, e]), this.state.env === "development" && Ze.call(this), Ve.call(this), qe.call(this);
}
function Ve() {
  return this.selections.shapeWrappers = this.selections.shapeGroup.selectAll("g.shape-group").data(this.props.shapes.value, Ue).join(
    (e) => {
...
function Ze() {
  ...
  const s = this.props.shapes.value.reduce((n, a) => {
    ...
    return l === 0 || l === null || l === void 0 ? n : l < n ? l : n;
  }, e), i = this.props.shapes.value.reduce((n, a) => {
    const l = a?.bestScore?.total;
    return l == null ? n : l > n ? l : n;
  }, t);
...
function Qe(e, t) {
  ...
  const f = Math.cos(i), h = Math.sin(i), p = (m) => m.map((b) => {
    if (i === 0) return { x: b.x, y: b.y };
    const S = b.x - o, w = b.y - r;
    return {
      x: f * S - h * w + o,
      y: h * S + f * w + r
    };
  }), g = l.map(p), A = n === s ? t.holes?.length ? p(s) : g[0] : p(n);
  let d = 1 / 0, k = 1 / 0;
  for (const m of A)
    m.x < d && (d = m.x), m.y < k && (k = m.y);
  return g.map((m) => m.map((S) => ({
    x: e.scales.xPositionScale(S.x - d + (t.x || 0)),
    ...
    switch (this.state.debug) {
      case "guillotine":
        ...
        if (typeof e.guillotineState.myPhase == "number") {
          ...
          return `rgb(${n.map((o, r) => Math.round(o + e.guillotineState.myPhase / 5 * (a[r] - o))).join(",")})`;
        }
        break;
      case "groups":
        if (e.group.addedAsGroup)
      ...
      case "priorityShapes":
        ...
        break;
      case "placementOrder": {
        const n = this.props.shapes.value.reduce((a, l) => {
          const o = l.placementOrder ?? 0;
          return o > a ? o : a;
        }, 0);
        if (n > 0 && typeof e.placementOrder == "number") {
          const a = [0, 115, 255], l = [255, 50, 50], o = e.placementOrder / n;
          return `rgb(${a.map((f, h) => Math.round(f + o * (l[h] - f))).join(",")})`;
        }
        break;
      }
      case "score": {
...
function is(e) {
  ...
  for (const s of e) {
    ...
    if (s.added && i?.sides) {
      ...
      for (const [a, l] of Object.entries(i.sides)) {
        if (!l || ["a", "b", "c", "d"].includes(a)) continue;
        let o = a;
        if (s.rot) {
          const f = ie({ [a]: !0 }, "cc");
          o = Object.keys(f)[0];
        }
        const r = as.call(this, s, o);
        r && t.push({ ...r, stroke: n });
      }
    }
  }
...
class hs {
  ...
  trimNameToFit(t, s) {
    function i(n, a, l) {
      ...
      for (; p > g && f.length > 0; )
        f = f.slice(0, -1), r.text(f.length ? f + "..." : ""), p = r.node().getComputedTextLength();
    }
    t.each(i.bind(s));
  }
  setDevice() {
  ...
  debounce(t, s, i = !1) {
    ...
    return (...a) => new Promise((l) => {
      const o = () => {
        n = null, i || l(t.apply(this, a));
      };
      clearTimeout(n), i && !n && l(t.apply(this, a)), n = setTimeout(o, s);
    });
  }
  ...
  getRectangleCoordinate(t, s, i, n) {
    let a;
    const l = t.x ?? 0, o = t.y ?? 0, r = t.l ?? 0, f = t.w ?? 0;
    if (s === "x") {
      let h;
      switch (i) {
        case "center":
          h = this.scales.xPositionScale(l + r / 2), n && (h += n);
          break;
        case "right":
          h = this.scales.xPositionScale(l + r), n && (h -= n);
          break;
        default:
          h = this.scales.xPositionScale(this.settings.flipX ? l - r : l), n && (h -= n);
      }
      a = h;
    } else if (s === "y") {
      let h;
      switch (i) {
        case "center":
          h = this.scales.yPositionScale(o + f / 2), n && (h += n);
          break;
        case "bottom":
          h = this.scales.yPositionScale(this.settings.flipY ? o + f : o), n && (h += n);
          break;
        default:
          h = this.scales.yPositionScale(this.settings.flipY ? o : o + f), n && (h -= n);
      }
      a = h;
    }
    return a;
  ...
  getBladeWidth(t = null) {
    return oe(t) && t !== null ? t.bladeWidth : 0;
  }
  ...
  isTextHidden(t, s, i) {
    ...
    if (a.width === 0 && a.height === 0)
      return !1;
    const l = this.scales.measurementScale(t.l), o = this.scales.yScale(t.w);
  ...
  isNameHidden(t, s, i) {
    ...
    const l = this.scales.measurementScale(t.l), o = this.scales.measurementScale(t.w);
...
const us = ["id"], Cs = /* @__PURE__ */ qt({
  ...
  setup(e, { expose: t, emit: s }) {
    const {
      ...
      k("shape-colour-update", u);
    }, b = (u, T) => {
      u?.autoId && k("shape-select", u.autoId, T);
    }, S = (u) => {
      u && k("add-to-parts-bin", u);
    }, w = (u, T) => {
      u && k("move-shape", u, T);
    }, x = $(0), v = $(0), J = $(null);
    let c, Q = $(!1);
    ...
    })), K = L(() => d.stockAutoId ? f(d.stockAutoId) : n.value), tt = L(() => d.stockAutoId ? h(d.stockAutoId) : a.value), et = L(() => d.main ? d.stockAutoId ? g(d.stockAutoId) : l.value : []), Bt = L(() => d.main ? d.stockAutoId ? p(d.stockAutoId) : o.value : []);
    _t(J, (u) => {
      const T = u[0], { width: z, height: zt } = T.contentRect;
      z > 0 && (x.value = z), k("resize", { width: z, height: zt });
    }), Vt(
      x,
      (u) => {
        c && (u <= 0 || (c.setDevice(), c.resetShapeAxes(), c.removeCuttingPath(), c.drawAll(), H(), r.value !== null && (c.toggleSegments(!0), c.showCut(r.value))));
      },
      { throttle: 100 }
    );
    let N = !1;
    B(() => K.value, (u) => {
      u && (x.value <= 0 || (N = !0, c.setDevice(), c.resetCuts(), c.removeSegments(), c.resetShapeAxes(), c.removeCuttingPath(), c.drawAll(), H(), Zt(() => N = !1)));
    }, { immediate: !1 }), B(() => tt.value, (u) => {
      N || u && (x.value <= 0 || (c.setDevice(), c.drawShapes()));
    }, { immediate: !1, deep: !0 }), d.main && (B(() => et.value, () => {
      N || x.value <= 0 || c.drawCuts();
    }, { immediate: !1, deep: !0 }), B(r, () => {
      r.value !== null && (x.value <= 0 || (c.toggleSegments(!0), c.showCut(r.value)));
    }, { immediate: !1 }), B(It, (u) => {
      c.updateNumberFormat(u.format, u.decimals, null);
    }, { immediate: !1 }));
    const Tt = () => {
      const u = {
        // STATIC
      ...
      c = new hs(u), D.debug = c.state.debug, Q.value = !0;
    }, Rt = (u = !1) => {
      c && c.toggleShapes(u);
    }, Wt = (u = !1) => {
      c && c.toggleCuts(u);
    }, Mt = (u = !1) => {
      c && c.toggleSegments(u);
    }, Dt = () => {
      c && c.drawShapes();
    }, $t = () => {
      c && (c.drawStock(), H());
      ...
      c && (c.toggleSegments(!0), c.showCut(u));
    }, Ht = (u) => c ? c.drawPositions(u) : !1, Nt = () => {
      c && c.removePositions();
    }, Et = (u) => {
      c && c.findShape(u);
    }, Yt = () => {
      c && c.clearSelection();
    }, Ft = (u) => c ? c.requiresStretch(u) : !1, jt = (u) => {
      c?.options && (c.options.enableStretch = u, c.setAspectRatio(), c.drawAll(), H());
    }, Xt = () => c?.options?.enableStretch ?? !0;
    return B(() => d.flipY, (u) => {
      c?.settings && (c.settings.flipY = u, c.setAspectRatio(), c.drawAll());
    }), B(() => D.debug, (u) => {
      c?.state && (c.state.debug = u);
    }), t({
      loaded: Q,
      toggleShapes: Rt,
      toggleCuts: Wt,
      ...
      setCuttingPathAnimationSpeed: (u) => {
        c && c.setCuttingPathAnimationSpeed(u);
      },
      state: D,
      get stretched() {
        return D.stretched;
      ...
      set moving(u) {
        c?.state && (c.state.moving = u);
      }
    }), (u, T) => (Jt(), Qt("div", {
      id: e.elementId,
      ref_key: "diagramContainerRef",
      ref: J,
      class: Kt([{ app: e.app }, "diagram-container"])
    }, null, 10, us));
  }
});
export {
