...
import { F as ai, g as Zt, d as Oi, i as pi, c as vr, a as fn, b as Ke, v as as, t as Ri, e as Ai, h as yr, s as br, f as wr, o as Sr, j as xr, k as kr, P as Cr } from "./vendor-D6Dp0Tf9.js";
import { i as Ir } from "./vendor-i18n-J0oHP3sq.js";
import { d as Oe, c as C, o as y, F as Se, r as De, n as ke, a as Ce, b as M, w as us, t as te, v as cs, e as W, f as Lr, g as H, h as Z, i as Le, j as ft, k as tt, l as hs, m as oi, u as k, p as Kt, q as pe, s as Pr, x as ds, y as Ui, z as Bt, A as ve, B as $r, C as $t, D as Tr, E as Dr, G as Or, H as Ar, I as gt, J as Er, T as Mr, K as pn, L as Rr, M as Fs, N as Fr, O as _r, P as qr, Q as Br, R as Hr } from "./vendor-vue-pers8-Kp.js";
import { u as gn, a as fs, b as ps, c as Gr, d as Wr, e as Nr } from "./composables-D2_K8XSj.js";
import { a as mn, b as vn, l as et, c as Fi, d as _i, s as Me, r as Ft, e as li, f as yn, g as Ur, h as jr, i as zr, p as Vr, S as Yr, j as Xr, k as Kr } from "./vendor-d3-B-JATA3m.js";
function gi(i) {
...
const Vt = 1e-10, Qr = 10, eo = Number.MAX_SAFE_INTEGER, to = 4294967295, qe = (i) => typeof i == "number" && Number.isFinite(i), Ei = (i) => Array.isArray(i) && i.length > 0;
function ri(i, t, e = Vt) {
  if (i === t) return 0;
...
const io = {
  greaterThan: (i, t, e = Vt) => !qe(i) || !qe(t) ? !1 : ri(i, t, e) > 0,
  greaterThanOrEqualTo: (i, t, e = Vt) => !qe(i) || !qe(t) ? !1 : ri(i, t, e) >= 0,
  lessThan: (i, t, e = Vt) => !qe(i) || !qe(t) ? !1 : ri(i, t, e) < 0,
  lessThanOrEqualTo: (i, t, e = Vt) => !qe(i) || !qe(t) ? !1 : ri(i, t, e) <= 0,
  equalTo: (i, t, e = Vt) => !qe(i) || !qe(t) ? !1 : ri(i, t, e) === 0
};
function so(i) {
...
function Mi(i) {
  ...
  try {
    ...
    throw new gs(`Failed to parse number: ${i}`);
  }
}
function ho(i) {
  if (!i) return !1;
...
const Bi = {
  ...
  fillThenArea(i) {
    return (t, e) => !Hs(t) || !Hs(e) ? (console.warn(qi.missingLongSide), 0) : e[i] === t[i] ? -zt(t, e) : parseFloat(String(e[i])) - parseFloat(String(t[i]));
  }
};
...
function vo(i, t, e) {
  return e ? !x(i.t) || !x(t.t) ? !1 : Xe(i) ? ce.equalTo(i.t, t.t) : i.t === t.t : !0;
}
function yo(i, t) {
  var e;
  return ((e = t == null ? void 0 : t.saw) == null ? void 0 : e.stockType) !== "linear" || !Xe(i) ? !0 : ss(i, 0, t) && ce.equalTo(i.w, t.w) || ss(i, 1, t) && ce.equalTo(i.l, t.w);
}
...
function wo(i, t, e) {
  ...
  let u, f;
  return s || (u = i.filter((p) => !p.stockLock || !p.stockLock.length).sort(Bi.ID), f = t.filter((p) => !a.has(p.parentID)).sort(Bi.ID), t = t.filter((p) => st(p)).filter((p) => a.has(p.parentID)), (o || l) && (i = i.filter((p) => {
    var I;
...
class re {
  constructor({
    ...
    const f = `issue created for ${Ll(t)}: ${this.identifier || "N/A"} - ${this.message} for field ${this.field || "N/A"}`;
...
const ei = ({ item: i, field: t, index: e, newIssues: s, min: n = null, max: r = null, required: o = !1, allowZero: l = !0, isWarning: a = !1 }) => {
  let u = Zt(i, t);
  if (o && (u == null || u === ""))
    return new re({
      item: i,
  ...
  const n = [];
  return "x" in i && ei({ item: i, field: ["x"], index: t, newIssues: n, min: 0, max: e, isWarning: s }), n;
}, Po = ({ item: i, index: t, max: e, isWarning: s }) => {
  const n = [];
  return "y" in i && ei({ item: i, field: ["y"], index: t, newIssues: n, min: 0, max: e, isWarning: s }), n;
}, $o = ({ item: i, index: t, max: e, isWarning: s }) => {
  const n = [];
  return "l" in i && ei({ item: i, field: ["l"], index: t, newIssues: n, required: !0, allowZero: !1, min: 0, max: e, isWarning: s }), n;
}, To = ({ item: i, index: t, max: e, isWarning: s }) => {
  const n = [];
  return "w" in i && ei({ item: i, field: ["w"], index: t, newIssues: n, required: !0, allowZero: !1, min: 0, max: e, isWarning: s }), n;
  ...
  return "t" in i && ((n == null ? void 0 : n.cutType) === "beam" && !i.t && new re({
    ...
    type: "error",
    issues: r
  }), ei({ item: i, field: ["t"], index: t, newIssues: r, allowZero: !1, min: 0, max: e, isWarning: s })), r;
  ...
  if (!st(i) || st(i) && !(i != null && i.trimmed)) {
    const o = ["l", "w"], [l, a] = o.map((u) => S(i[u]));
    for (const u in i.trim)
      ei({ item: i, field: ["trim", u], index: t, newIssues: r, min: e, max: s });
...
function No(i, t, e) {
  if (x(t == null ? void 0 : t.bladeWidth) && (t.bladeWidth = typeof t.bladeWidth == "string" ? S({ v: t.bladeWidth }) : t.bladeWidth), (pi(t.bladeWidth) || t.bladeWidth < 0) && Li(
    i,
    "bladeWidth",
...
function is(i, t = !1) {
  ...
  if (!t || !qn(i) || Bn(i) || kl(i) && !(i != null && i.hasTrim))
    return { l: e, w: s };
...
function zi(i, t, e = null, s) {
  ...
  let n = 0;
  s && ms(s) ? n = s.getMinSpacing() : s && ((I = s == null ? void 0 : s.options) != null && I.minSpacing) ? n = S({ v: s.options.minSpacing }) : xs(t) && (n = (h = t == null ? void 0 : t.saw) == null ? void 0 : h.getMinSpacing());
...
function Cn(i) {
  let t = null;
  return At(i) ? t = i.direction : (Xe(i) || we(i)) && (t = i.orientationLock), t;
}
function vs(i, t) {
  const e = Cn(i);
  return x(e) ? !t || At(i) ? e : xs(t) ? zo(i, t) : e : null;
}
function zo(i, t) {
  if (!t) throw new Error("container not supplied to convertShapeGrainToOrientationLock");
  if (!xs(t)) throw new Error("container is not a container");
  const e = Cn(i);
  if (At(i)) return e;
  if (!x(e)) return null;
  const s = t.getStock();
...
function ns(i, t = null, e = null) {
  return t === null && (t = i.rot === 0 ? 1 : 0), ss(i, t, e) ? (i.rot === t || jo(i), !0) : !1;
}
function Jt(i, t = null, e = null) {
  return t ? t = 1 : t = 0, e && t && !zi(i, e, t) ? !1 : ns(i, t, e);
}
function Vo(i, t) {
  if (!t)
...
class Xt {
  constructor(t) {
    ...
    c(this, "origin");
    c(this, "type");
    this.x1 = t.x1, this.x2 = t.x2, this.y1 = t.y1, this.y2 = t.y2, this.dimension = Jo(this), this.direction = Qo(this), this.type = t != null && t.type ? t.type : null, this.origin = t != null && t.origin ? t.origin : null;
  }
  getCoordinates() {
    return {
      x1: this.x1,
...
function Pn(i = [], t = null) {
  i != null && i.length && Ln() && tl.runTests;
}
Ke.colors = [
  2,
  3,
...
class Vi extends Xt {
  ...
  constructor(e) {
    ...
    c(this, "distances");
    c(this, "remove");
    x(e == null ? void 0 : e.stock) && (((n = (s = e.stock) == null ? void 0 : s.constructor) == null ? void 0 : n.name) === "Stock" ? this.stock = e.stock : this.stock = new Wt(e.stock), this.stockId = this.stock.id), this.stockId = (r = e == null ? void 0 : e.stock) == null ? void 0 : r.id, this.type = e.type ?? null, this.isGuillotine = e.isGuillotine, this.guillotineData = x(e.guillotineData) ? e.guillotineData : {}, this.ptxData = x(e.ptxData) ? e.ptxData : {}, this.isHead = x(e.isHead) ? e.isHead : !1, this.isTrim = x(e.isTrim) ? e.isTrim : !1, this.beamTrimX1 = e.beamTrimX1, this.beamTrimY1 = e.beamTrimY1, this.distances = x(e.distances) ? e.distances : {};
  }
...
function ol(i, t, e) {
  ...
  if (n.forEach((I) => {
    ...
    let h, m, w, q;
    ((o = t == null ? void 0 : t.constructor) == null ? void 0 : o.name) === "Stock" && (t != null && t.trimmed) || ((l = t == null ? void 0 : t.constructor) == null ? void 0 : l.name) === "Segment" ? (h = t.x, m = t.y, w = t.x + t.l, q = t.y + t.w) : (h = t.x + ((a = t == null ? void 0 : t.trim) == null ? void 0 : a.x1), m = t.y + ((u = t == null ? void 0 : t.trim) == null ? void 0 : u.y1), w = t.x + t.l - ((f = t == null ? void 0 : t.trim) == null ? void 0 : f.x2), q = t.y + t.w - ((p = t == null ? void 0 : t.trim) == null ? void 0 : p.y2));
    let N = s.toArray();
    for (let J = N.length; J--; ) {
      const V = N[J];
      (ce.lessThan(V.x, h) || ce.lessThan(V.y, m) || ce.greaterThan(V.x, w) || ce.greaterThan(V.y, q)) && N.splice(J, 1);
    }
...
function Ti(i, t, e, s, n) {
  ...
  if (i[`${l}1`] >= e[l] && i[`${l}1`] <= e[l] + e[a]) {
    ...
    if (u || f || p || I) {
      const m = r ? i[`${l}1`] : n, w = r ? n : i[`${l}1`], q = new Ee(m, w), N = i.origin;
      Tn(q, t, e, i.direction, "shape", N), s.addPoint(q);
    }
  }
}
function dl(i) {
...
class rs {
  ...
  getDistanceToEdge(t) {
    const e = this.x, s = this.y, n = this.diameter / 2, r = S({ v: t.getLongSide() }), o = S({ v: t.getShortSide() }), l = t.machining.corners.map((m) => m.type ? m.size : 0), a = [
      ...
      const q = w === 0 || w === 3, N = w < 2, J = q ? e : r - e;
      let V = null;
      this.face === 0 ? V = N ? s : o - s : this.face === 1 && (V = N ? o - s : s);
      const Q = Math.sqrt(J * J + V * V);
      return {
        c: m,
        distance: Q
      };
    ...
    if (h && h.type === "radius") {
      ...
      const q = I < 2;
      m += I === 0 || I === 3 ? l[I] : -l[I], w += q ? l[I] : -l[I];
      const J = e - m, V = I < 2;
      let Q;
      this.face === 0 ? Q = V ? s : o - s : this.face === 1 && (Q = V ? o - s : s);
      const ae = Q - w, G = Math.sqrt(J * J + ae * ae), X = l[I] - G - n;
      let v = !1;
      return h.index === 0 ? v = e <= m && Q <= w : h.index === 1 ? v = e >= m && Q <= w : h.index === 2 ? v = e >= m && Q >= w : h.index === 3 && (v = e <= m && Q >= w), v && X < f ? X : f;
    } else if (h && h.type === "bevel") {
      let m, w, q;
      h.index === 0 ? (m = 1, w = 1, q = -h.size) : h.index === 1 ? (m = 1, w = -1, q = -r + h.size) : h.index === 2 ? (m = 1, w = 1, q = -r - o + h.size) : h.index === 3 && (m = -1, w = 1, q = -o + h.size);
      const N = h.index === 0 ? 1 : -1, J = (m * e + w * s + q) / Math.sqrt(m * m + w * w) * N - n;
      return J < f ? J : f;
    } else
      return f;
  }
...
let Mn = class {
  ...
  constructor({
    ...
    }), t && (this.holes = t.map((n) => new rs(n))), e && (this.hingeHoles = e.map((n) => new Ns(n)));
  }
...
function fh(i, t = []) {
  ...
  const e = i.map((s) => new bs(s));
  return t.length && vl(e, t), e;
}
function vl(i = [], t = []) {
...
function gh({
  ...
  return !i || !(i != null && i.length) ? [] : i.filter((s) => s).map((s) => {
    ...
    let n;
    if (xl(s) && ((o = s == null ? void 0 : s.shapes) != null && o.length)) {
...
class ws {
  constructor(t, e = "decimal", s = !1) {
    ...
    t = qt(t), this.readonly = t.readonly, this.id = t.id, this.listId = t != null && t.listId ? t.listId : Date.now().toString() + as(), ["l", "w", "t"].forEach((a) => {
      this[a] = Gi(t, a, e, s);
    }), this.q = x(t == null ? void 0 : t.q) ? pi(Ri(t.q)) ? null : Ri(t.q) : null, this.autoAdd = x(t.autoAdd) ? t.autoAdd : !1, this.name = x(t.name) ? ji(t.name).toUpperCase() : "", this.material = x(t.material) ? t.material.trim().toUpperCase() : "";
    const r = ["x1", "x2", "y1", "y2"];
    this.trim = {
      x1: null,
      x2: null,
...
class ci {
  constructor(t, e = "decimal", s = !1) {
    ...
    this.orientationLock = x(t.orientationLock) && ["l", "w"].includes(t.orientationLock.toLowerCase()) ? t.orientationLock.toLowerCase() : "", this.machining = new Mn(t.machining ?? {
      holes: [],
      hingeHoles: [],
      corners: []
...
class Gt {
  ...
  validateRectangle(t) {
    this.issues = [];
    const e = [], s = ["x", "y", "t", "w"];
    t != null && t.infiniteLength || s.push("l"), s.forEach((n) => e.push(...Ne[n]({ item: t }))), this.issues.push(...Ne.customData({ item: t })), this.issues.push(...e.filter((n) => n));
  }
  initRectangle(t, e = !1) {
    var n, r, o;
    if (!e) {
    ...
    }), !(t != null && t.infiniteLength) && !(t != null && t.preventAutoRotation) && !t.trimmed && this.w > this.l && ([this.l, this.w] = [this.w, this.l], this.grain && !(t != null && t.preventGrainRotation) && (this.grain = ui(this.grain))), x(t == null ? void 0 : t.stock) && (st(t.stock) ? this.stock = t.stock : this.stock = new Wt(t.stock), this.stockId = this.stock.id);
  }
  updateRectangle(t) {
  ...
  isIdentical(t, e = !1) {
    ...
    if (this.constructor !== t.constructor || this.t !== t.t || this.orientationLock !== t.orientationLock || this.material !== t.material)
      return !1;
    if (Xe(this) && ((u = this.identicalTo) != null && u.length) && (this.parentID === t.parentID || this.identicalTo.includes(t.parentID)))
      return !0;
    if (At(this)) {
      if (t.id === this.id) return !0;
    } else {
      if (t.parentID === this.parentID) return !0;
      if (Xe(this) && e && this.parentID !== t.parentID) return !1;
    }
  ...
  setSaw(e, s) {
    ...
    if (!(!e && !s)) {
      ...
      try {
        ...
        a && (ms(a) ? this.saw = a : this.saw = new Dt(a)), (l = (o = this.saw) == null ? void 0 : o.issues) != null && l.length && this.issues.push(...this.saw.issues);
      } catch (a) {
...
class Wt extends Yi {
  constructor(e, s) {
    var n;
    e = qt(e), e.preventAutoRotation = e.preventAutoRotation || ((n = e == null ? void 0 : e.saw) == null ? void 0 : n.stockType) === "roll", e.autoAdd && !e.q && (e.q = 1);
    super(e, s);
    c(this, "_id");
    //used for mongo
    c(this, "autoAdd");
  ...
  getCroppedLength(e = [], s = 0) {
    ...
    const n = Zo(e.filter((o) => o.added && o.stock.id === this.id), "x"), r = n.x + n.l;
...
class Ot extends Gt {
  ...
  initShape(e, s = !1) {
    var n;
    s || (this.validateShape(e), e.orientationLock = (n = e == null ? void 0 : e.orientationLock) == null ? void 0 : n.toLowerCase(), (e == null ? void 0 : e.orientationLock) === " " && (e.orientationLock = ""), this.orientationLock = x(e == null ? void 0 : e.orientationLock) && this.l !== this.w ? e.orientationLock : null, x(e == null ? void 0 : e.stockLock) ? Array.isArray(e == null ? void 0 : e.stockLock) && (this.stockLock = e.stockLock.map((r) => r.toString())) : this.stockLock = [], this.banding = (e == null ? void 0 : e.banding) || (e == null ? void 0 : e._banding), this.finish = (e == null ? void 0 : e.finish) || (e == null ? void 0 : e._finish), this.machining = x(e == null ? void 0 : e.machining) ? new Mn(e.machining) : null, this.fitsStock = x(e == null ? void 0 : e.fitsStock) ? e.fitsStock : null, this.upDirection = x(e == null ? void 0 : e.upDirection) ? e.upDirection : null), this.added = x(e == null ? void 0 : e.added) ? e.added : !1, this.initGuillotineData(e), this.inGroup = x(e == null ? void 0 : e.inGroup) ? e.inGroup : this.inGroup || !1, this.inUserGroup = x(e == null ? void 0 : e.inUserGroup) ? e.inUserGroup : this.inUserGroup || !1, this.groupID = x(e == null ? void 0 : e.groupID) ? e.groupID : this.groupID || null, this.addedAsGroup = x(e == null ? void 0 : e.addedAsGroup) ? e.addedAsGroup : this.addedAsGroup || !1, this.score = x(e == null ? void 0 : e.score) ? e.score : this.score || null, this.bestScore = x(e == null ? void 0 : e.bestScore) ? e.bestScore : this.bestScore || {
      x: 0,
      y: 0,
      rot: null,
      total: null,
  ...
  cloneGuillotineData() {
    var e;
    return (e = this.guillotineData) != null && e.myStripParent && (Xe(this.guillotineData.myStripParent) || At(this.guillotineData.myStripParent)) && (this.guillotineData.myStripParent = this.guillotineData.myStripParent.compress()), structuredClone(this.guillotineData);
  }
  getCopyNumber() {
  ...
  getBandingLength(e) {
    return !wl(e) || !this.banding[e] ? 0 : e === "x1" || e === "x2" ? this.getShortSide() : e === "y1" || e === "y2" ? this.getLongSide() : Rn(e) ? En(this, e) : 0;
  }
  getPriority(e) {
    var n;
    if (!e) return 0;
  ...
  willItFit(e, s = null) {
    var n, r;
    return st(e) ? ((r = (n = this.fitsStock) == null ? void 0 : n[e.parentID]) == null ? void 0 : r[s ?? "any"]) === !0 : zi(this, e, s);
  }
  clone(e = null) {
    const s = this.id.split(".");
  ...
  compress() {
    ...
    return e.myStripParent = Cl(this.guillotineData.myStripParent) ? this.guillotineData.myStripParent.id : this.guillotineData.myStripParent, {
      id: this.id,
...
class Ss extends Yi {
  constructor(e) {
    var t = (...$h) => (super(...$h), c(this, "cuts"), c(this, "phase"), c(this, "cutDirection"), c(this, "firstShape"), c(this, "merged"), c(this, "children"), c(this, "siblings"), //used by vis only
...
function Xe(i) {
  return i instanceof Ot && !(i instanceof dt);
}
function Cl(i) {
  return i instanceof Ot || i instanceof dt;
}
...
function qn(i) {
  return Xe(i) || st(i) || we(i) || it(i);
}
function Bn(i) {
  return we(i) || it(i) ? !1 : Xe(i) || st(i) ? i.trimmed : !1;
}
function Ll(i) {
  return i instanceof dt ? i.type === "user" ? "userGroup" : i.type === "strip" ? "stripGroup" : "group" : i instanceof bs ? "inputUserGroup" : i instanceof ws ? "inputStock" : i instanceof ci ? "inputShape" : i instanceof Wt ? "stock" : i instanceof Yi ? "container" : i instanceof Ot && !(i instanceof dt) ? "shape" : i instanceof Ss ? "segment" : i instanceof Fn ? "offcut" : i instanceof Dt ? "saw" : i instanceof Gt ? "rectangle" : null;
}
function js(i, t) {
  return yr(i, t);
}
...
function wh(i) {
  return !i || !Array.isArray(i) ? 0 : i.reduce((t, e) => {
    let s = 0;
    return it(e) && e.autoAdd ? s = 1 : s = x(e.q) && typeof e.q == "string" ? parseInt(e.q) : e.q, !isNaN(s) && s > 0 ? t + s : t;
  }, 0);
}
function Sh(i) {
  if (!(i != null && i.length)) return [];
...
function xh(i, t = 0) {
  return Xe(i) || we(i) || !t || (i.preventAutoRotation = !0, t === 2 && i.l < i.w && Dl(i)), i;
}
...
const { addNotice: ct } = fs(), {
  inputs: Ie,
  totalInputShapes: Ol,
  totalInputStock: Al,
  createStockList: El,
  createShapeList: Ml,
  validateInputShapes: Rl,
  ...
  _l();
  const s = [];
  t.useInventory || s.push(...Hn(i == null ? void 0 : i.sawData)), s.push(...Rl({
    saw: t.sawData,
...
async function Hl(i) {
  ...
  try {
    if (!Bl(t))
      return { valid: !1 };
    if (t.maxShapes !== 1 / 0 && t.maxShapes && !t.isAdmin && !t.shared && (Ol.value > t.maxShapes || Al.value > t.maxStock))
      return t.onLimit(), { valid: !1 };
    if (t.useInventory) {
      const h = ql(t.materialStore, !0), m = Pt(h);
      if (m.length > 0)
        return ct({
          type: "error",
    ...
    const { stockList: l, issues: a } = await El(r), u = Pt(a);
    if (u.length > 0)
      return ct({
        type: "error",
        message: e("inputs_issue", { x: "stock" }),
    ...
    const { shapeList: f, issues: p } = await Ml({
...
function Nl(i, t, e = !0) {
  if (!ks(i, t, "Options")) return;
  const s = i[t], n = Object.keys(s);
  for (const r of n)
    Is(i, t, r, e);
  e && Wn(i, t, "all");
}
function Is(i, t, e, s = !0) {
  s && Wn(i, t, e), e !== "all" && ks(i, t) && (i[t][e] = !1);
}
function Wn(i, t, e) {
  if (!ks(i, t, "Options")) return;
...
function Nn(i, t, e, s, n = [], r) {
  ...
  for (const p of l)
    p !== "all" && (n.includes(p) || (Ls(i, t, p, e, s, r), Array.isArray(f) || hi(i, t, p, !1), hi(i, t, p, !!qe(a))));
}
function hi(i, t, e, s) {
  var o;
  if (e === "all") return;
  const n = Cs(t), r = Gl((o = i == null ? void 0 : i[n]) == null ? void 0 : o[e]);
  s ? i[t][e] = r || !0 : i[t][e] = !1;
}
function Ni(i, t, e, s) {
  var a;
  ...
  if (!Array.isArray(o) || !s || typeof s != "function")
    return !1;
  const l = s(t, o);
  return t === "banding" && Rn(e) && qe(l) ? gl(i, e, l) / 1e3 : l;
}
function kh(i) {
  i != null && i.type && delete i.type, Ul.call(this, i);
}
function Ul(i) {
...
const zl = { id: "mini-stock-nav" }, Vl = ["onMousedown"], Yl = { class: "id" }, Xl = /* @__PURE__ */ Oe({
...
}, Zl = { id: "spinner" }, Jl = ["width", "height"], Ql = {
  key: 2,
  id: "spinner-number",
  class: "stock-number"
};
function ea(i, t, e, s, n, r) {
  return y(), C("div", Zl, [
    ...
    e.showNumber ? (y(), C("div", Ql, te(e.number), 1)) : W("", !0)
  ]);
}
const Xs = /* @__PURE__ */ ti(Kl, [["render", ea]]);
function ta(i, t, e, s, n = !0) {
  var o;
...
const na = ["id"], ra = {
  ...
  setup(i, { emit: t }) {
    const e = i, s = t, n = H(0), r = H(!1), o = (v, T, K, P) => {
      ...
      let v = 0;
      return v = u(V.value) + 1, v > N.value.length - 1 && (v = 0), v;
    }, p = () => {
      let v = 0;
      if (V.value)
      ...
      l: e.rectangle.l,
      w: e.rectangle.w
    }), ae = Z(() => !Q.value.l && !Q.value.w), G = Z(() => os(
      e.orientationModel,
      e.stockGrain,
      e.rectangle,
      e.rectangleType,
      ...
      let K = "default";
      return we(e.rectangle) || e.rectangleType === "shape" ? K = h() : _t(e.rectangle) && (K = e.rectangle.direction || "default"), ((P = v[T]) == null ? void 0 : P[K]) || v[T].default;
    });
    return Le(n, (v, T) => {
      ...
      id: v.id,
      class: Ce(["orientation-button", { rot: G.value, square: J.value, disabled: v.disabled, [X.value]: !0 }]),
      tabindex: "0",
      ...
      X.value === "grainLeftRight" ? (y(), C("svg", {
        key: 4,
        class: "grain",
        style: ke({
          stroke: v.iconColor ? v.iconColor : "#ffffff"
      ...
      X.value === "grainTopBottom" ? (y(), C("svg", {
        key: 5,
        class: "grain",
        style: ke({
          stroke: v.iconColor ? v.iconColor : "#ffffff"
...
const fa = ["id", "name", "value", "inputmode", "type", "placeholder", "disabled", "default", "readonly", "min", "max", "aria-label", "aria-invalid", "aria-describedby"], pa = /* @__PURE__ */ Oe({
  __name: "TextInput",
  props: {
    type: {},
    inputType: {},
  ...
  setup(i, { emit: t }) {
    const e = i, s = t, n = H(!0), r = H(null), {
      ...
      const w = m.getBoundingClientRect(), q = window.getComputedStyle(m);
      return w.width > 0 && w.height > 0 && q.display !== "none" && q.visibility !== "hidden";
    };
    return ft(() => {
      (x(e.default) && e.value === void 0 || e.value === null) && s("update:value", e.default), e.focus && r.value && h(r.value) && tt(() => r.value.focus());
    }), hs(() => {
      n.value = !1;
...
}), ga = ["id", "checked", "disabled", "required", "aria-label", "aria-invalid", "aria-describedby"], ma = /* @__PURE__ */ Oe({
...
}), va = ["id", "value", "disabled", "required", "aria-label", "aria-invalid", "aria-describedby"], ya = ["disabled", "selected"], ba = {
  key: 0,
  value: " "
}, wa = ["hidden", "value", "disabled"], Sa = /* @__PURE__ */ Oe({
  __name: "SelectInput",
  props: {
    options: {},
  ...
  setup(i, { emit: t }) {
    const e = i, s = t, n = H(!0), r = H(null), o = Z(() => e.options.map((a) => {
      var u, f, p;
      return {
        value: a.value,
    ...
    return (a, u) => {
      ...
      return y(), C("select", oi(a.$attrs, {
        ...
        M("option", {
          ...
          selected: !e.value
        }, te(((p = (f = e.text) == null ? void 0 : f.select) == null ? void 0 : p.toUpperCase()) ?? "SELECT"), 9, ya),
        e.multiEdit ? (y(), C("option", ba, te(((h = (I = e.text) == null ? void 0 : I.delete) == null ? void 0 : h.toUpperCase()) ?? "DELETE"), 1)) : W("", !0),
        (y(!0), C(Se, null, De(o.value, (m) => (y(), C("option", {
          key: m.value,
          hidden: m.hidden,
          value: m.value,
          disabled: m.disabled
  ...
  setup(i) {
    return (t, e) => (y(), C("label", {
      ...
      Kt(te(t.label) + " ", 1),
      t.required ? (y(), C("span", ka, "*")) : W("", !0)
    ], 8, xa));
  }
}), Ca = ["data-field-id"], Ia = ["disabled", "selected"], La = {
  key: 0,
  value: " "
}, Pa = ["hidden", "value", "disabled"], ht = /* @__PURE__ */ Oe({
  inheritAttrs: !1,
  __name: "InputField",
  props: {
    value: { default: null },
  ...
  setup(i, { emit: t }) {
    const e = t, s = i, n = H(null), r = H(null), o = H(!0), l = H(s.numberFormat), a = Z(() => s.custom ? "custom-" + s.id : s.id), u = Z(() => `${a.value}-error`), f = Z(() => s.label || s.placeholder), p = Z(() => X(s.type, s.numberFormat)), I = Z(() => v(s.type, s.numberFormat)), h = Z(() => ["string", "integer", "float", "unitDependent"].includes(s.type)), m = Z(() => {
      let P = s.value;
      if (s.type !== "unitDependent" || !P) return P;
      try {
        return S({ v: P, nf: s.numberFormat });
      } catch {
      ...
      return {
        value: P.value,
        label: ((R = P.label) == null ? void 0 : R.toUpperCase()) || ((le = P.value) == null ? void 0 : le.toString().toUpperCase()),
        hidden: P.hidden || !1,
      ...
      r.value = P;
    }, G = (P) => s.label && s.enableLabel && s.labelPosition === P, X = (P, R) => {
      if (P === "unitDependent")
      ...
      P.valid === void 0 || P.valid === !0 ? (o.value = !0, e("validation", n.value, P)) : P.valid === !1 && P.message && (o.value = !1, console.warn(`Field validation error for field ${R} - ${P.message}`), e("validation", n.value, P));
    };
    return Le(() => s.numberFormat, (P, R) => {
      if (s.shouldConvertNumberFormat !== !1) {
        if (s.type === "unitDependent" && P !== R && s.value)
          try {
            const le = S({ v: s.value, nf: P });
            e("update:value", le);
          } catch {
      ...
      ref_key: "fieldRef",
      ref: n,
      class: Ce(["input-wrapper", q.value]),
      ...
      h.value ? (y(), pe(pa, oi({
        ...
        onValidation: K,
        "onUpdate:value": T
      }), null, 16, ["input-type", "input-mode", "value"])) : P.type === "checkbox" ? (y(), pe(ma, oi({
        key: 2,
        ref: ae,
        type: "checkbox"
      }, V.value, {
      ...
      }), null, 16, ["checked"])) : P.type === "select" ? (y(), pe(Sa, oi({
        key: 3,
        ref: ae
      }, Q.value, {
        ...
        default: ds(() => {
          ...
          return [
            M("option", {
              ...
              selected: !P.value
            }, te(((se = (le = P.text) == null ? void 0 : le.select) == null ? void 0 : se.toUpperCase()) ?? "SELECT"), 9, Ia),
            P.multiEdit ? (y(), C("option", La, te(((_ = (A = P.text) == null ? void 0 : A.delete) == null ? void 0 : _.toUpperCase()) ?? "DELETE"), 1)) : W("", !0),
            (y(!0), C(Se, null, De(w.value, (z) => (y(), C("option", {
              key: z.value,
              hidden: z.hidden,
              value: z.value,
              disabled: z.disabled
  ...
  key: 0,
  class: "inputs"
}, Ta = { class: "label" }, Da = { class: "label" }, Oa = { class: "label" }, Aa = ["onClick"], Ea = { class: "price" }, Ma = ["aria-label"], ls = /* @__PURE__ */ Oe({
  __name: "ExtrasInputs",
  props: {
  ...
  setup(i, { emit: t }) {
    const e = i, s = t, { t: n } = Ui(["main", "errors"]), r = H(!1), o = Z(() => e.extraType + "Options"), l = Z(() => {
      ...
      var ae;
      if (!h) return [];
      const J = (ae = m == null ? void 0 : m[w]) == null ? void 0 : ae[q];
      if (!J)
        return console.error(`ExtrasInputs: cannot find pricing options for ${w} > ${q}`), [];
      const V = Object.values(J);
      if (!V.length)
        return console.error(`ExtrasInputs: cannot find pricing options for ${w} > ${q}`), [];
      const Q = V.filter((G) => typeof G == "string");
    ...
    return ft(() => I()), (h, m) => {
      ...
      return r.value ? W("", !0) : (y(), C("div", {
        ...
        h.allOptions.length === 1 && h.allOptions[0].length === 1 ? (y(), C("div", $a, [
          M("div", Ta, te((N = (q = h.allOptions) == null ? void 0 : q[0]) == null ? void 0 : N[0]), 1),
          M("div", null, [
            (J = h.shape) != null && J[o.value] && "all" in h.shape[o.value] ? (y(), pe(ht, {
              key: 0,
              id: `${h.extraType}-all-${h.shapeIndex}`,
              type: "checkbox",
              output: "string",
              label: k(Yt)(k(n)("all")),
              "true-value": (Q = (V = h.allOptions) == null ? void 0 : V[0]) == null ? void 0 : Q[0],
              "false-value": "",
          ...
          (y(!0), C(Se, null, De(h.extraKeys, (v) => {
            ...
            return y(), C("div", { key: v }, [
              (T = h.labels) != null && T[0] && ((P = (K = h.shape) == null ? void 0 : K[o.value]) != null && P[v]) && h.labels[0] in h.shape[o.value][v] ? (y(), pe(ht, {
                key: 0,
                id: `${h.extraType}-${v}-${h.shapeIndex}`,
                type: "checkbox",
                output: "string",
                label: k(Yt)(k(n)(((R = h.userFriendlyFieldMap) == null ? void 0 : R[v]) || v)),
          ...
          (X = h.shape) != null && X[o.value] && "all" in h.shape[o.value] ? (y(), C(Se, { key: 0 }, [
            M("div", Da, te(k(Yt)(k(n)("all"))), 1),
            (y(!0), C(Se, null, De(h.allOptions, (v, T) => {
              ...
              return y(), pe(ht, {
                ...
                options: f(h.pricing, h.shape, o.value, "all", T).map((R) => ({ value: R, label: R })),
                text: { select: "✘" },
                "select-first-option-disabled": !1,
                value: (P = h.shape[o.value].all) == null ? void 0 : P[(K = h.labels) == null ? void 0 : K[T]],
                "onUpdate:value": (R) => {
                  var le, se;
                  u("all", (le = h.labels) == null ? void 0 : le[T], R), a((se = h.labels) == null ? void 0 : se[T], R);
                }
          ...
          (y(!0), C(Se, null, De(h.extraKeys, (v) => {
            ...
            return y(), C(Se, { key: v }, [
              (T = h.shape) != null && T[o.value] && v in h.shape[o.value] ? (y(), C(Se, { key: 0 }, [
                M("div", Oa, te(k(Yt)(k(n)(((K = h.userFriendlyFieldMap) == null ? void 0 : K[v]) || v))), 1),
                (y(!0), C(Se, null, De(h.allOptions, (P, R) => {
                  var le;
                  return y(), pe(ht, {
                    id: `${h.extraType}-${v}-${h.labels[R]}-${R}-${h.shapeIndex}`,
                    key: `${h.extraType}-${v}-${h.labels[R]}-${R}-${h.shapeIndex}`,
                    type: "select",
                    disabled: f(h.pricing, h.shape, o.value, v, R).length === 0,
                    options: f(h.pricing, h.shape, o.value, v, R).map((se) => ({
                      value: se,
                      label: se
                    })),
                    text: { select: "✘" },
                    "select-first-option-disabled": !1,
                    value: h.shape[o.value][v][(le = h.labels) == null ? void 0 : le[R]],
                    "onUpdate:value": (se) => {
                      var A;
                      return u(v, (A = h.labels) == null ? void 0 : A[R], se);
                    }
                  }, null, 8, ["id", "disabled", "options", "value", "onUpdate:value"]);
                }), 128))
              ], 64)) : W("", !0),
              M("div", {
                class: "delete",
                onClick: () => k(Is)(h.shape, h.extraType, v)
              }, [
                ve(w, { icon: ["fass", "trash"] })
              ], 8, Aa),
              M("div", Ea, te(p(v) || k(n)("na").toUpperCase()), 1)
            ], 64);
          }), 128))
        ], 4)),
        M("button", {
          ...
          onClick: m[1] || (m[1] = () => k(Nl)(h.shape, h.extraType, !0))
        }, [
          ve(w, { icon: ["fass", "trash"] }),
          Kt(" " + te(k(n)("action_item", { a: "delete", i: h.extraLabel })), 1)
        ], 8, Ma)
      ], 6));
    };
  }
}), Ra = ["id", "disabled"], Fa = { class: "icon" }, _a = /* @__PURE__ */ Oe({
  __name: "FinishButton",
  props: {
    inputShape: { default: null },
    open: { type: Boolean, default: !1 },
...
const Ga = /* @__PURE__ */ ti(qa, [["render", Ha]]), Wa = { id: "uploader" }, Na = {
  key: 0,
  class: "debug"
}, Ua = {
  key: 1,
  class: "selected-files"
}, ja = ["src"], za = ["onClick"], Va = !0, Ya = /* @__PURE__ */ Oe({
  __name: "ImageUpload",
  props: {
    shapeId: {
      type: String,
  ...
  setup(i, { emit: t }) {
    const e = $t(() => Promise.resolve().then(() => Ki)), s = H(null), n = H({
      ...
      if (!w) return;
      const q = Array.from(w), N = q.filter((v) => !l(v));
      if (N.length > 0) {
...
Only JPG and PNG files are allowed.`), m.value = "";
      ...
      if (J.length + q.length > r.maxImages) {
        alert(`Maximum ${r.maxImages} images allowed per shape.`), m.value = "";
        return;
      }
      const Q = [...J, ...q], ae = f(Q), G = Q.map((v, T) => ({
        originalName: v.name,
      ...
      const m = [...n.value.files], w = [...n.value.previewUrls], q = [...n.value.metadata];
      if (m.splice(h, 1), w.splice(h, 1), q.splice(h, 1), m.length === 0)
        n.value = {
          shapeId: r.shapeId,
          files: [],
          previewUrls: [],
    ...
    return $r(() => {
      ...
      const w = Bt("font-awesome-icon");
      return y(), C("div", Wa, [
        i.env === "development" && Va ? (y(), C("div", Na, [
          ve(k(e), {
            data: [n.value],
            paths: ["imageData"]
          }, null, 8, ["data"])
        ...
        (q = n.value.files) != null && q.length ? (y(), C("div", Ua, [
...
}), Xa = /* @__PURE__ */ ti(Ya, [["__scopeId", "data-v-0836e586"]]);
function Ka(i) {
  var l, a;
...
function Un(i, t, e) {
  !e || !(i != null && i.length) || i.forEach((s, n) => {
    const [r, o] = s;
    e === "x" ? Ja.call(this, r, o, t[n]) : Qa.call(this, r, o, t[n]);
  });
}
function Ja(i, t, e) {
...
function Qa(i, t, e) {
  ...
  eu(r), this.axes.cutMeasurementYAxes.push(r);
}
function jn(i) {
...
function iu() {
  this.selections.shapeIDText = this.selections.shapeWrappers.selectAll("text.shape-text.id").data((i) => [i]).join(
    (i) => i.append("text").attr("class", "shape-text id").text((t) => su.call(this, t)).classed("hidden", (t, e, s) => this.isTextHidden(t, e, s)).attr("dominant-baseline", "middle").attr("fill", this.config.colors.text.toString()).attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t) => this.getRectangleCoordinate(t, "y", "center")).attr("dy", 1),
    ...
    (i) => i.append("text").attr("class", "shape-text name").text((t) => nu.call(this, t)).call(this.trimNameToFit, this).classed("hidden", (t, e, s) => this.isNameHidden(t, e, s)).attr("dominant-baseline", "middle").attr("fill", this.config.colors.text.toString()).attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t, e, s) => {
      const n = s[e];
    ...
    (i) => i.append("text").attr("class", "shape-text width").text((t) => ru.call(this, t)).classed("hidden", (t, e, s) => this.isWidthHidden(t, e, s)).attr("dominant-baseline", "middle").attr("fill", this.config.colors.text.toString()).attr("transform", (t, e, s) => {
...
function ou(i) {
  ...
  return lu.call(this, t, i), au.call(this, t, i), !!(t != null && t.length);
}
function lu(i, t) {
  function e(n) {
    return `${n.x}-${n.y}`;
...
function cu() {
  ...
  this.scales.shapeColorScale.domain([1, i]), this.state.env === "development" && du.call(this), hu.call(this);
}
function hu() {
  return this.selections.shapeWrappers = this.selections.shapeGroup.selectAll("g.shape-group").data(this.props.shapes.value, uu).join(
    (i) => {
    ...
    (i) => i.remove()
  ), this.props.shapes.value.length > 0 && bu.call(this, this.props.shapes.value), this.settings.main && requestAnimationFrame(() => iu.call(this)), this.selections.shapeWrappers.size() > 0;
}
function du() {
  var n;
  let i = 1 / 0, t = -1 / 0;
...
function en(i, t) {
  ...
  this.state.env === "development" && pu.call(this, i, t), (this.settings.app || this.settings.embed) && vu.call(this, i, t), this.state.device === "desktop" && (Xi.call(this), Ka.call(this, t)), this.props.moveMode.value ? this.callbacks.onAddToPartsBin(t) : this.findShape.call(this, t.id);
}
function pu(i, t) {
  if (console.clear(), t) {
    let e;
    ...
    console.table(gu(t, e)), console.log(t.bestScore.score);
  }
}
function gu(i, t) {
  return t.reduce((e, s) => {
  ...
  for (const e of i)
    if (e != null && e._banding)
      for (const [s, n] of Object.entries(e._banding)) {
        ...
        let r = s;
        e.rot && (r = fu.call(this, s));
        const o = wu.call(this, e, r);
        o && t.push(o);
      }
  return t;
}
...
function bu(i) {
  ...
  const t = yu.call(this, i), e = (s) => `${s.x1}-${s.y1}-${s.x2}-${s.y2}-${s.type}`;
...
function xu() {
  if (!this.props.stock.value || !this.props.stock.value.w || !this.props.stock.value.l || !this.props.containerWidth.value)
    return !1;
  this.setAspectRatio(), Za.call(this), this.selections.stockGroup.selectAll("rect.background.stock").data([this.props.stock.value], sn).join(
...
function on({ parent: i, near: t, far: e }) {
  ...
  this.selections.segmentRectangles = this.selections.segmentGroup.selectAll("rect").data(s, zn).join(
    ...
    (n) => n.remove()
  ), this.state.env === "development" && ku.call(this, s), !this.settings.app && this.state.env === "development" && Iu.call(this);
}
function ln(i) {
...
function an(i) {
  return i.attr("x", (t) => this.getRectangleCoordinate(t, "x", "center")).attr("y", (t) => this.getRectangleCoordinate(t, "y", "center")).attr("text-anchor", "middle").text((t) => Cu.call(this, t)).attr("dominant-baseline", "middle");
}
function Cu(i) {
...
const { currentCutIndex: Yn } = ps();
function es(i) {
  return `${i.stock.saw.bladeWidth}-${i.x1}-${i.y1}-${i.x2}-${i.y2}`;
}
function Lu() {
  this.props.containerWidth && (this.selections.cutLabelGroup && this.selections.cutLabelGroup.remove(), this.selections.cutLines = this.selections.cutGroup.selectAll("line").data(this.props.cuts.value, es).join(
    (i) => i.append("line").attr("class", "cut").call((t) => un.call(this, t)),
    (i) => i.call((t) => un.call(this, t)),
    (i) => i.remove()
  ), this.selections.cutLabelGroup = this.selections.cutGroup.append("g").attr("class", "label-group"), this.selections.cutLabelGroup.selectAll("*").remove(), this.selections.cutBackgrounds = this.selections.cutLabelGroup.selectAll("circle.label-background").data(this.props.cuts.value, es).join(
    (i) => i.append("circle").attr("class", "label-background").call((t) => cn.call(this, t)),
    (i) => i.call((t) => cn.call(this, t)),
    (i) => i.remove()
  ), this.selections.cutLabels = this.selections.cutLabelGroup.selectAll("text.cut-label").data(this.props.cuts.value, es).join(
...
function Du(i = null, t = "") {
  ...
  if (["guillotine", "beam"].includes((w = e == null ? void 0 : e.stock) == null ? void 0 : w.cutType) && s !== null && typeof s < "u" ? Pu.call(this, e, s, l, t) : $u.call(this, e, i, o, r, n), Ou.call(this, e, i, s), t === "ptx") {
    this.removeSegments();
    return;
  }
...
class Mu {
  ...
  initColors(t) {
    const e = {
      ...
      stock: "#ffd166",
      text: "#ffffff"
    }, s = (n, r) => Ft("#" + (Au(n == null ? void 0 : n.replace("#", "")) ? n.replace("#", "") : r.replace("#", "")));
  ...
  removeStock() {
    this.selections.stockGroup && this.selections.stockGroup.selectAll("*").remove(), this.selections.axisGroup && this.selections.axisGroup.selectAll("*").remove(), tu.call(this);
  }
  removeCuts() {
...
const Ru = ["id"], Fu = /* @__PURE__ */ Oe({
  ...
  setup(i, { expose: t, emit: e }) {
    ...
    })), T = Z(() => h.stockId ? u(h.stockId) : n.value), K = Z(() => h.stockId ? f(h.stockId) : r.value), P = Z(() => h.main ? h.stockId ? I(h.stockId) : o.value : []), R = Z(() => h.main ? h.stockId ? p(h.stockId) : l.value : []);
    Tr(ae, (ne) => {
      const rt = ne[0], { width: ot } = rt.contentRect;
      ot > 0 && (V.value = ot);
    }), Dr(
      V,
      (ne) => {
      ...
      ne && (V.value <= 0 || (G.setDevice(), G.resetCuts(), G.removeSegments(), G.drawStock(), G.drawShapes(), G.drawCuts()));
    }, { immediate: !1 }), Le(r, (ne) => {
      ne && (V.value <= 0 || (G.setDevice(), G.drawShapes()));
    }, { immediate: !1 }), Le(o, () => {
      V.value <= 0 || G.drawCuts();
    }, { immediate: !1 }), Le(a, () => {
      a.value !== null && (V.value <= 0 || (G.toggleSegments(!0), G.showCut(a.value)));
    }, { immediate: !1 }), Le(v, (ne) => {
  ...
  key: 1,
  class: "cell delete"
}, Wu = { class: "cell" }, Nu = ["id", "disabled", "onClick"], Uu = {
  key: 0,
  class: "cell center"
}, ju = ["onClick"], zu = {
  key: 1,
  class: "cell"
}, Vu = ["aria-label", "onClick"], Yu = { class: "button-wrapper main" }, Xu = ["aria-label"], Ku = ["aria-label", "disabled"], Zu = ["aria-label"], Ju = { id: "part-count" }, Qu = {
  key: 3,
  id: "messages"
}, ec = {
  key: 0,
  ...
  setup(i, { expose: t, emit: e }) {
    const s = $t(() => Promise.resolve().then(() => mc)), n = $t(() => Promise.resolve().then(() => yc)), r = $t(() => Promise.resolve().then(() => qc)), o = $t(() => Promise.resolve().then(() => Uc)), l = $t(() => Promise.resolve().then(() => Ki)), { t: a } = Ui(["main", "errors"]), { inputs: u, totalInputShapes: f, getShapeGrainSummary: p, updateNumberFormat: I, validateInputStock: h } = gn(), { r: m, updateFromResult: w, stackedStock: q, uniqueAddedShapes: N, uniqueUsedStock: J, activeStockId: V, setActiveStockId: Q } = ps(), { progress: ae, reset: G } = Nr(), { addNotice: X } = fs(), { tip: v, update: T, hide: K } = Gr(), P = i, R = e, le = "production", se = H((navigator == null ? void 0 : navigator.language) || "en-US"), A = Or(null), _ = window.location.hostname, z = H(!1), ie = H(!0), oe = Ar("Checkout/currentURL", window.location.href), ye = as(), de = H([]), We = H(!1), nt = H(!1), E = H(!1), pt = H(!1), ne = H(!1), rt = H(Tl()), ot = H(!1), { socket: lt } = Wr({
      refs: {
        connected: z,
        thinking: E
      },
      callbacks: {
        onResult(d) {
          ...
          const b = {
            ...
            parts: N.value.map((F) => {
              ...
              return {
                ...
                q: (kt = (xe = m.metadata.value) == null ? void 0 : xe.addedPartTally) == null ? void 0 : kt[F.parentID],
                name: F.name,
                banding: F.banding,
                finish: F.finish,
                customData: F.customData,
                stockId: ((Ct = F == null ? void 0 : F.stock) == null ? void 0 : Ct.id) || (F == null ? void 0 : F.stockId)
              };
            }),
            stock: J.value.map((F) => {
              var xe, kt;
              return {
                ...
                t: F == null ? void 0 : F.t,
                material: F.material,
                q: (kt = (xe = m.metadata.value) == null ? void 0 : xe.usedStockTally) == null ? void 0 : kt[F.parentID],
          ...
          if ((O = (Y = (D = m == null ? void 0 : m.metadata) == null ? void 0 : D.value) == null ? void 0 : Y.unplacedParts) != null && O.length) {
            const F = m.metadata.value.unplacedParts.map((xe) => xe.id).join();
            X({
              type: "warning",
              message: Te(a("parts_not_fit")) + ": " + F
            });
          }
          R("result", b), E.value = !1;
        },
        onUser(d) {
          A.value = d;
        },
    ...
    }), Ze = H(null), Ue = H(!1), Nt = H(""), $e = H(""), Pe = gt({
      banding: null,
      finish: null,
      info: null,
      imageUpload: null
    }), Be = H([]), _e = H([]), Et = H([]), Ut = H(!1), je = gt({
      numberFormat: "decimal",
      faces: { enabled: !0 },
      holes: { enabled: !1 },
      corners: {
      ...
      cutPreference: (d) => {
        ...
        if (g.includes(d)) {
          const { cutType: b, cutPreference: L } = ts(d);
      ...
      customFields: (d) => {
        ...
        for (const b of u.inputShapes.value)
          b.customData = d.reduce((L, B) => {
            const D = si(B.id);
            return L[D] = b.customData[D] || B.default || "", L;
          }, {});
      }
    }, ze = (d) => {
      if (P.debug && R("log", ["checkout init...", d]), d != null && d.options) {
        const b = d.options;
        jl(b), [
          "stockType",
          "cutPreference",
          ...
          D in b || R("error", `${D} is a required option`);
        });
        const B = ["enable", "colors"];
        for (const D in b)
          B.includes(D) || (j[D] = b[D]), D in ge && ge[D](b[D]);
      }
      d.colors && "colors" in ge && ge.colors(d.colors), Ms("banding", d), Ms("finish", d), Je(d), tr(d), nt.value = !0, P.debug && R("log", ["init complete"]);
      ...
      ta(ii, "parts", ee.stockType, d, g);
    }, si = (d) => d ? ji(d).toLowerCase() : null, Ge = (d, g, b, L) => {
      if (g.valid) {
        if (K(), b && L) {
          const B = b.issues.findIndex((D) => D.field.some((Y) => Y.length === L.length && Y.every((O, F) => O === L[F])));
      ...
      var g, b, L, B, D;
      if (Mt(j, ["enable", "machining"]) && d != null && d.machining) {
        for (const Y in je)
          d.machining[Y] && (je[Y] = d.machining[Y]);
        if (["holes", "hingeHoles"].forEach((Y) => {
          var O, F;
          (O = d == null ? void 0 : d.machining) != null && O[Y] && (je[Y].enabled = (F = d == null ? void 0 : d.machining) == null ? void 0 : F[Y].enabled);
        }), (L = (b = (g = d == null ? void 0 : d.machining) == null ? void 0 : g.corners) == null ? void 0 : b.types) != null && L.length && (je.corners.enabled = !0, je.corners.types = d.machining.corners.types), d.banding && ((D = (B = d == null ? void 0 : d.options) == null ? void 0 : B.enable) != null && D.banding)) {
          if (!be) return;
          je.banding = {
            enabled: !0
          }, be.options.length && (je.banding.options = be.options), be.labels.length && (je.banding.labels = be.labels), Qt(be.pricing) && (je.banding.pricing = be.pricing);
        }
      }
    }, he = (d = null) => {
      Ze.value = d, d && d.l && d.w ? Ut.value = !0 : alert("Please enter dimensions first");
    }, St = () => {
      Ut.value = !1, document.exitFullscreen && document.exitFullscreen();
    }, xt = (d = []) => {
        ...
        for (const g of d)
          if (g != null && g.t)
            if (typeof g.t == "string" && g.t.includes(",")) {
              const b = Ps(g.t, !0);
              b.length === 2 ? (ir(b), Ve("t", !0), g.t = _e.value[0]) : R("error", "bonded thickness found which does not have 2 options");
      ...
      if ((g = d == null ? void 0 : d.stock) != null && g.some((L) => L == null ? void 0 : L.material)) {
        ...
        for (const B of d.stock) {
          ...
          L.has(D) || L.set(D, /* @__PURE__ */ new Set()), B.t != null && ((b = L.get(D)) == null || b.add(S({ v: B.t })));
        }
        Be.value = Array.from(L.entries()).map(([B, D]) => ({
          name: B,
          thicknesses: Array.from(D).sort((O, F) => O - F)
      ...
      const b = [];
      for (let L of d)
        j.numberFormat === "decimal" && (L = parseFloat(L)), _e.value.push(L), g && g.thicknesses.push(L), b.push(_e.value.length - 1);
      Et.value.push(b);
    }, Ps = (d, g = !1) => {
      ...
      document.getElementById("smartcut-checkout").requestFullscreen(), ot.value = !0;
    }, rr = () => {
      document.exitFullscreen && document.exitFullscreen(), ot.value = !1;
    }, or = () => {
      var L, B;
      ...
      return [g, b].forEach((D, Y) => {
        if (!D) return d = !1;
        const O = window.getComputedStyle(D);
        if (O.display === "none" || O.display === "hidden" || O.opacity === "0" || O.color === "transparent" || O.position !== "relative" || Y === 1 && O.color !== "#4e4e4e" && O.color !== "rgb(78, 78, 78)")
          return d = !1;
      }), ie.value = d, d;
    }, $s = (d, g, b, L, B) => {
      Ls(
      ...
      if (d != null && d[L])
        for (const B in d[L]) {
          const D = Ni(d, g, B, P.findExtrasPrice);
          D === !1 && B && d[g][B] && new re({
            item: d,
            field: [[g, B]],
            type: "error",
      ...
      const g = [], b = Object.keys(d), L = Ds(d);
      for (let B = L; B--; ) g.push(/* @__PURE__ */ new Set());
      for (const B of b)
        B.split("|").forEach((Y, O) => g[O].add(Y));
      for (let B = 0; B < L; B++)
        g[B] = Array.from(g[B]);
      return g;
    }, wi = (d, g = [], b) => {
      ...
      u.inputShapes.value.splice(d, 1), ((b = Ze.value) == null ? void 0 : b.listId) === g && (Ze.value = null), G();
    }, ni = (d = {
      l: null,
      ...
      const L = new ci(d, j.numberFormat);
      ...
      if (_e.value.length)
        for (const g of d) {
          ...
          const b = _e.value.findIndex(
            (D) => S({ v: D }) === g.t
          ), L = Et.value.find((D) => D.includes(b));
          if (!L) return;
          const B = Math.min(
            ...L.map((D) => _e.value[D])
          );
      ...
      if (R("calculating"), E.value) return !1;
      E.value = !0, pt.value = !1;
      const d = u.inputShapes.value.map((Y) => new ci(Y));
      cr(d);
      const { valid: g, saw: b, stockList: L, shapeList: B } = await Hl({
        t: a,
        partTrim: j.partTrim,
        ...
        onLimit: () => {
          X({
            type: "error",
            message: a("max_parts") + " " + j.maxParts
          });
        }
      });
      if (!g) {
        R("validation-error"), E.value = !1;
        return;
      }
      Es(), P.debug && console.log(
        "SmartCut - calculating",
        "stock",
        L.map((Y) => Y.dimensions),
        "parts",
        B.map((Y) => Y.dimensions)
      );
      const D = {
        inputs: {
          parts: d,
      ...
      await lt.connect(), lt.emit("calculate", D);
    }, Ms = (d, g) => {
      var kt;
      if (Ve(d, !1), !d || !g || !(g != null && g[d]) || !Mt(j, ["enable", d])) return;
      const b = [d, "pricing"];
      if (!js(g, b)) {
      ...
      const O = Ds(L), F = [d, "labels"];
      let xe = [];
      if (js(g, F))
        xe = Mt(g, F);
      else {
        R("error", `${F.join(".")} not found`);
        return;
      }
      if (!xe) {
        R("error", `${F.join(".")} data not provided`);
        return;
      }
      if (!Array.isArray(xe)) {
        R("error", `${F.join(".")} data must be an array`);
        return;
      }
      if (!(xe != null && xe.length)) {
        R("error", `if provided, ${F.join(".")} data must contain values`);
        return;
      }
      if (xe.length !== O) {
        R("error", `${F.join(".")} length (${xe.length}) must match the number of levels in ${b.join(".")} (${O})`);
        return;
      }
      switch (d) {
        case "banding":
          be.labels = xe, be.pricing = L, be.options = Os(L);
          break;
        case "finish":
          Ae.labels = xe, Ae.pricing = L, Ae.options = Os(L);
          break;
      }
      ...
      if (!g) return;
      d !== "info" && Object.keys(Pe).forEach((L) => {
        L !== d && L !== "info" && (Pe[L] = null);
      });
      const b = u.inputShapes.value.indexOf(g);
      Pe[d] === b ? (Ze.value = null, Pe[d] = null) : (Ze.value = g, Pe[d] = b);
    }, Rs = (d) => {
      if (R("log", ["load event received"]), !nt.value) {
      ...
      var L, B, D;
      if (R("log", ["loading parts..."]), !d || !((B = (L = d == null ? void 0 : d.inputs) == null ? void 0 : L.parts) != null && B.length)) {
        R("log", ["could not find any parts to import"]);
        return;
      }
      u.inputShapes.value.length = 0;
      let g = 0;
      for (const Y of d.inputs.parts) {
        const O = ni(Y);
        O ? (u.inputShapes.value.push(O), (D = O.issues) != null && D.length && R("log", [`SmartCut - issues found while importing part at index ${g}`, O.issues])) : R("log", [`SmartCut - error loading part at index ${g}`, Y]), g++;
      }
      u.inputShapes.value.flatMap((Y) => Pt(Y.issues)).length && X({
        type: "error",
        message: Te(a("issues_found"))
      }), R("log", [`loaded ${u.inputShapes.value.length} parts`]);
    }, fr = (d) => {
    ...
    Le(() => P.stock, (d) => {
      ...
      R("inputs-changed"), d.forEach((g) => {
        var L;
        ee.stockType === "linear" && (g.w = (L = u.inputShapes.value[0]) == null ? void 0 : L.w);
        const b = Be.value.find((B) => B.name === g.material);
        b && (b.thicknesses.includes(S({ v: g.t })) || (g.t = S({ v: b.thicknesses[0] })));
      });
    }, { deep: !0 }), Le(() => j.numberFormat, (d) => {
      I(d);
    }), ft(async () => {
      if (We.value) return;
      const d = new URL(window.location.href), g = d.searchParams.toString(), b = d.origin + d.pathname + (g ? `?${g}` : "");
      oe.value !== b && Zi(), oe.value = b, se.value = j.locale, await lt.connect(), lt.emit("getUserFromDomain"), window.addEventListener("smartcut/load", Rs), We.value = !0, P.debug && R("log", [
        "ready...",
        "fields:",
        bt.value.map((L) => L.id)
      ]);
    ...
    return hs(() => {
      ...
      return y(), C(Se, null, [
        ve(k(s), {
          ...
          type: k(v).type,
          show: k(v).show,
          "reference-el": k(v).referenceEl
        }, null, 8, ["content", "type", "show", "reference-el"]),
        k(le) === "development" && sc ? (y(), C("div", _u, [
          g[5] || (g[5] = M("div", null, "Developer information", -1)),
          M("div", null, te(j.enable.focus), 1),
          ve(k(l), {
            data: [j],
            paths: ["options"]
          }, null, 8, ["data"])
        ])) : W("", !0),
        Ut.value && ((L = Ze.value) != null && L.machining) ? (y(), pe(k(r), {
          key: 1,
          shape: Ze.value,
          "onUpdate:shape": g[0] || (g[0] = (D) => Ze.value = D),
          translate: !0,
          options: je,
        ...
        nt.value ? (y(), C("div", {
          ...
          class: Ce({ fullscreen: ot.value })
        }, [
          rt.value && !i.readonly ? (y(), C("div", {
            key: 0,
          ...
          M("div", {
            ...
            k(u).inputShapes.value.length ? (y(), C("div", Bu, [
              ...
              }, te(k(Te)(k(a)(D.label))), 3))), 128)),
              k(le) === "development" ? (y(), C("div", Hu, " Info ")) : W("", !0),
              k(u).inputShapes.value.length > 1 ? (y(), C("div", Gu)) : W("", !0)
            ])) : W("", !0),
            (y(!0), C(Se, null, De(k(u).inputShapes.value, (D, Y) => (y(), C("div", {
              key: Y,
              class: "row inputs"
            }, [
              M("div", Wu, [
              ...
              (y(!0), C(Se, null, De(bt.value, (O) => (y(), C("div", {
                ...
                ["orientationLock", "banding", "finish", "machining", "imageUpload"].includes(O.id) ? O.id === "orientationLock" ? (y(), pe(oa, {
                  key: 1,
                  id: "orientation-" + Y,
                  rectangle: D,
                  disabled: i.readonly,
                ...
                }, null, 8, ["id", "rectangle", "disabled", "stock-grain", "button-background", "icon-color", "orientation-model", "onUpdateOrientation"])) : O.id === "banding" ? (y(), pe(aa, {
                  key: 2,
                  id: "banding-" + Y,
                  "input-shape": D,
                  disabled: i.readonly,
                  ...
                  open: Pe.banding === Y,
                  "orientation-model": j.orientationModel,
                  onClicked: (F) => xi("banding", D)
                }, null, 8, ["id", "input-shape", "disabled", "stock-grain", "open", "orientation-model", "onClicked"])) : O.id === "finish" ? (y(), pe(_a, {
                  key: 3,
                  id: "finish-" + Y,
                  "input-shape": D,
                  disabled: i.readonly,
                  open: Pe.finish === Y,
                  onClicked: (F) => xi("finish", D)
                }, null, 8, ["id", "input-shape", "disabled", "open", "onClicked"])) : O.fieldMap === "machining" && rt.value ? (y(), pe(Ga, {
                  key: 4,
                  id: "machining-" + Y,
                  disabled: i.readonly,
                  "input-shape": D,
                  ...
                  type: "button",
                  disabled: i.readonly,
                  class: Ce({ selected: Pe.info === Y }),
                  onClick: (F) => xi("imageUpload", D)
                }, [
                  ve(b, { icon: ["fass", "image"] })
                ], 10, Nu)) : W("", !0) : (y(), pe(ht, {
                  key: 0,
                  id: O.id + "-" + Y,
                  focus: !i.readonly && j.enable.focus && Y === k(u).inputShapes.value.length - 1 && O.id === "l",
                  issue: k(Ws)(D, [O.fieldMap]),
                  warning: k(Ws)(D, [O.fieldMap], !0),
                  type: O.type,
                  output: O.output,
                  label: O != null && O.label ? k(Te)(k(a)(O.label)) : null,
                  placeholder: O != null && O.placeholder ? k(Te)(k(a)(O.placeholder)) : null,
                  "enable-label": !1,
                  ...
                  value: k(Mt)(D, O == null ? void 0 : O.fieldMap),
                  text: {
                    delete: k(Yt)(k(a)("delete")),
                    select: k(Yt)(k(a)("select"))
                  },
                  onValidation: (F, xe) => Ge(F, xe, D, [O.fieldMap]),
                  "onUpdate:value": (F) => {
                    O.fieldMap && k(Pl)(D, O.fieldMap, F);
                  }
              ...
              k(u).inputShapes.value.length > 1 ? (y(), C("div", zu, [
                M("button", {
                  type: "button",
                  class: "delete",
                  "aria-label": k(Te)(k(a)("action_item", { a: "remove", i: "part" })),
                  onClick: (O) => ur(Y)
                }, [
              ...
              Pe.banding === Y && be.options.length > 0 ? (y(), pe(ls, {
                key: 2,
                shape: D,
                "shape-index": Y,
                "extra-type": "banding",
              ...
              Pe.finish === Y && Ae.options.length > 0 ? (y(), pe(ls, {
                key: 3,
                shape: D,
                "shape-index": Y,
                "extra-type": "finish",
          ...
          M("div", Yu, [
            i.readonly ? W("", !0) : (y(), C("button", {
              ...
              onClick: g[2] || (g[2] = (D) => As(1))
            }, [
              ve(b, { icon: ["fass", "plus-large"] }),
              Kt(" " + te(k(Te)(k(a)("action_item", { a: k(a)("add"), i: k(a)("part") }))), 1)
            ], 12, Xu)),
            M("button", {
              id: "calculate-button",
              type: "button",
              class: "c-btn calculate icon-left",
              "aria-label": k(Te)(k(a)("calculate")),
              style: ke({
                background: j.colors.button,
                color: j.colors.buttonText
              }),
              disabled: !((B = k(u).inputStock.value) != null && B.length) || E.value,
              onClick: g[3] || (g[3] = (D) => hr())
            }, [
              ve(b, { icon: ["fass", "calculator"] }),
              Kt(te(k(Te)(k(a)("calculate"))), 1)
            ], 12, Ku),
            i.readonly ? W("", !0) : (y(), C("button", {
              key: 1,
              type: "button",
              class: "c-btn clear",
              "aria-label": k(Te)(k(a)("clear")),
              onClick: g[4] || (g[4] = (D) => Zi())
            }, [
              ve(b, { icon: ["fass", "trash"] })
            ], 8, Zu)),
            M("div", Ju, te(k(f)) + te(j != null && j.maxParts ? "/" + j.maxParts : ""), 1)
          ]),
          ne.value && !i.readonly ? (y(), pe(k(o), {
            key: 2,
            ref: "import",
            "number-format": j.numberFormat,
          ...
          Ue.value ? (y(), C("div", Qu, [
            Nt.value ? (y(), C("div", ec, te(Nt.value), 1)) : W("", !0),
            M("pre", tc, te($e.value), 1)
          ])) : W("", !0),
          (j.enable.diagram ? E.value && !k(ae).complete : E.value || k(ae).complete) ? (y(), C("div", ic, [
            ve(Xs, {
              size: 50,
              number: k(ae).shapeCount,
              complete: k(ae).complete,
          ...
          us(ve(Fu, {
            ...
            [cs, j.enable.diagram && k(ae).complete]
          ]),
          j.enable.diagram && k(q).length > 1 && k(ae).complete ? (y(), pe(Xl, {
            key: 5,
            ref: "stockNavigation",
            "active-stock-id": k(V),
            "stock-list": k(q),
...
}), Ch = /* @__PURE__ */ ti(nc, [["__scopeId", "data-v-80125cb5"]]), rc = {
  name: "ObjectViewer",
  props: {
    data: {
      type: Array,
...
}, oc = { class: "smartcut-object-viewer" }, lc = ["onClick"], ac = { class: "toggle-icon" }, uc = { class: "path-label" }, cc = {
  key: 0,
  ...
  return y(), C("div", oc, [
    (y(!0), C(Se, null, De(e.data, (o, l) => (y(), C("div", {
      ...
      M("div", {
        ...
        M("div", ac, te(n.expanded[l] ? "▼" : "▶"), 1),
        M("div", uc, te(e.paths[l] || l), 1)
      ], 8, lc),
      n.expanded[l] ? (y(), C("div", cc, [
...
const fc = /* @__PURE__ */ ti(rc, [["render", dc]]), Ki = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: fc }, Symbol.toStringTag, { value: "Module" })), pc = ["data-placement"], gc = /* @__PURE__ */ Oe({
  __name: "ToolTip",
  props: {
    show: { type: Boolean },
    content: {},
...
}), mc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: gc }, Symbol.toStringTag, { value: "Module" })), vc = /* @__PURE__ */ Oe({
  __name: "InputIssues",
  props: {
    item: {
      type: Object,
    ...
    return (e, s) => {
      ...
      return y(), C(Se, null, [
        (r = (n = t.item.issues) == null ? void 0 : n.filter((a) => a.type === "error")) != null && r.length ? (y(), C("div", {
          ...
          M("pre", null, te(t.item.issues.filter((a) => a.type === "error").flatMap((a) => k(Te)(a.message)).join(`
`)), 1)
        ], 4)) : W("", !0),
        (l = (o = t.item.issues) == null ? void 0 : o.filter((a) => a.type === "warning")) != null && l.length ? (y(), C("div", {
          ...
          M("pre", null, te(t.item.issues.filter((a) => a.type === "warning").flatMap((a) => k(Te)(a.message)).join(`
`)), 1)
        ], 4)) : W("", !0)
      ], 64);
    };
  }
}), yc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: vc }, Symbol.toStringTag, { value: "Module" })), Qe = {
  precisionFixed: Kr,
  format: Xr,
  select: Me,
  selectAll: yn,
...
const Sc = { id: "machining" }, xc = {
  key: 0,
  class: "debug"
}, kc = { class: "inputs" }, Cc = {
  key: 0,
  class: "shape-name"
}, Ic = { class: "shape-dimensions" }, Lc = {
  key: 1,
  class: "sides-wrapper"
}, Pc = { class: "menu" }, $c = { class: "button-wrapper" }, Tc = { class: "row table-heading" }, Dc = {
  key: 0,
  class: "cell id"
}, Oc = {
  key: 0,
  class: "cell"
}, Ac = { class: "id" }, Ec = ["onClick"], Mc = { class: "remove" }, Rc = { key: 5 }, Fc = !1, _c = /* @__PURE__ */ Oe({
  __name: "Machining",
  props: /* @__PURE__ */ Fs({
  ...
  setup(i, { emit: t }) {
    var Be, _e, Et, Ut, je, be, Ae, ii, jt, vi, bt, wt, yi;
    const e = $t(() => Promise.resolve().then(() => Ki)), s = i, n = t, r = Z(() => ys(E.value)), o = Z(() => wc.call({ options: s.options }, ["units"])), l = Z(() => {
      var U;
    ...
    }), u = Z(() => !ee.value || ee.value === "banding" ? null : Nt[ee.value]), f = Z(() => !ee.value || ee.value === "banding" ? [] : Object.keys(Nt[ee.value]).filter(($) => Nt[ee.value][$].enabled)), p = Z(() => ee.value ? V() : []), I = Z(() => {
      var U, ue, ge, ze;
    ...
    const ae = () => {
      ...
      }), Q.init(), ot.value = !0, setTimeout(() => {
        Q.updateSize();
      }, 100));
    }, G = () => {
      j.value = j.value === 0 ? 1 : 0, Q.flip();
    }, X = () => {
      switch (ee.value) {
        case "holes":
          v();
      ...
      Ls($, U, ue, ge, ze, s.findExtrasPrice);
    }, nt = ($, U, ue, ge) => {
      Nn(
        $,
        U,
    ...
    const pt = H(null), ne = H(null), rt = H(!1), ot = H(!1), lt = H(!1), yt = H(!1), j = H(0), ee = H(null), Ze = H(0), Ue = H([]), Nt = gt({
      holes: {
        x: {
          enabled: !0,
          type: "unitDependent",
        ...
        diameter: {
          ...
          options: (Ut = s.options.holes.diameters) != null && Ut.length ? J(s.options.holes.diameters) : void 0,
          required: !0
        },
        depth: {
      ...
      hingeHoles: {
        ...
        depth: {
          ...
          output: (jt = s.options.holes.depths) != null && jt.length ? "float" : void 0,
      ...
      var $;
      return !(!(($ = E == null ? void 0 : E.value) != null && $.machining) || !rt.value || lt.value);
    };
    return Le(() => {
      var $;
      ...
      if (Pe()) {
        ...
        for (const $ of E.value.machining.corners)
          $.isPresent() || Is(E.value, "banding", $.getCorner(), !0);
        Q.createBanding(), h(!1);
      }
    }, { deep: !0, immediate: !0 }), Le(() => {
      var $;
      ...
      pt.value || (pt.value = new ResizeObserver((ue) => {
        clearTimeout(ne.value ?? void 0), ot.value && (ne.value = window.setTimeout(() => {
          if (yt.value) {
            yt.value = !1;
            return;
          }
          ue[0].contentRect.width !== Ze.value && (Ze.value = ue[0].contentRect.width, Ze.value && Q.updateSize());
        }, 10));
      }), pt.value.observe($)), rt.value = !0;
    }), ($, U) => {
      var ge, ze, He, Ve, si;
      const ue = Bt("font-awesome-icon");
      return y(), C("div", Sc, [
        $.env === "development" && Fc ? (y(), C("div", xc, [
          ve(k(e), {
        ...
        M("div", null, [
          M("div", kc, [
            ...
            (ge = E.value) != null && ge.name ? (y(), C("div", Cc, te(E.value.name), 1)) : W("", !0),
            M("div", Ic, te((ze = E.value) == null ? void 0 : ze.l) + " x " + te((He = E.value) == null ? void 0 : He.w) + " " + te((Ve = E.value) != null && Ve.t ? "x " + ((si = E.value) == null ? void 0 : si.t) : null), 1),
            $.options.faces.enabled ? (y(), C("div", Lc, [
              M("div", {
                ref: "sides",
                class: Ce(["sides", { flipped: j.value === 1 }]),
                onClick: G
              }, U[4] || (U[4] = [
            ...
            ee.value === "banding" && E.value ? (y(), pe(ls, {
              key: 3,
              shape: E.value,
              env: $.env,
              "extra-type": "banding",
            ...
            ee.value !== "banding" && p.value.length ? (y(), C("div", {
              ...
              M("div", Tc, [
                N() ? (y(), C("div", Dc)) : W("", !0),
                (y(!0), C(Se, null, De(u.value, (Ge, Je, he) => us((y(), C("div", {
                  key: he,
                  class: "cell"
                }, te(Ge.label ?? Je), 1)), [
                  [cs, Ge.enabled]
              ...
              (y(!0), C(Se, null, De(p.value, (Ge, Je) => (y(), C("div", {
                key: Je,
                class: "row"
              }, [
                N() ? (y(), C("div", Oc, [
                ...
                (y(!0), C(Se, null, De(f.value, (he, St) => (y(), C("div", {
                  ...
                  u.value[he].type !== "select" && u.value[he].type !== "checkbox" ? (y(), pe(ht, {
                    key: 0,
                    id: he + "-" + St,
                    warning: oe(Je, he),
                  ...
                  }, null, 8, ["id", "warning", "type", "placeholder", "disabled", "value", "units", "output", "onUpdate:value"])) : u.value[he].type === "checkbox" ? (y(), pe(ht, {
                    key: 1,
                    id: he + "-" + St,
                    type: "checkbox",
                    warning: oe(Je, he),
                    ...
                    output: u.value[he].output,
                    "onUpdate:value": (xt) => w(Ge, he, xt)
                  }, null, 8, ["id", "warning", "disabled", "value", "output", "onUpdate:value"])) : u.value[he].type === "select" ? (y(), pe(ht, {
                    key: 2,
                    id: he + "-" + St,
                    type: "select",
                    "enable-label": !1,
                ...
                (y(!0), C(Se, null, De(z(Je), (he, St) => (y(), C("div", {
                  key: St,
                  class: "group validation",
                  style: ke({ "grid-column-end": "span " + l.value })
                }, te(he), 5))), 128))
              ]))), 128))
            ], 6)) : ee.value !== "banding" ? (y(), C("div", Rc, " Please select from the menu above ")) : W("", !0)
          ]),
          M("div", {
            id: "machining-diagram",
            class: Ce(["diagram", { flipped: j.value === 1 }])
          }, null, 2)
        ])
      ]);
    };
  }
}), qc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: _c }, Symbol.toStringTag, { value: "Module" })), Bc = {
  name: "Drop",
  props: {
    requiredType: {
      type: String,
...
const Gc = /* @__PURE__ */ ti(Bc, [["render", Hc]]), Wc = { id: "import-file" }, Nc = /* @__PURE__ */ Oe({
  __name: "ImportCSV",
  props: {
    numberFormat: {
      type: String,
  ...
  setup(i, { emit: t }) {
    const e = i, s = t, { t: n } = Ui(["main", "errors"]), r = H([]), o = H([]), l = H([]), a = H([]), u = H({}), f = H([]), p = H(!1), I = H(null), h = H(null), m = [
    ...
    }), q = Z(() => e.customFields.map((A) => A.label)), N = (A, _) => {
      if (_) {
        const z = Object.keys(_), ie = [[]];
        z.forEach((ye) => {
          const de = _[ye], We = [];
          ie.forEach((nt) => {
            de.forEach((E) => We.push([...nt, E]));
      ...
      const ie = {
        ...
        finish: (oe) => V(oe, h.value, "finish"),
        orientationLock: z
      };
      return A in ie ? ie[A](_) : null;
    }, V = (A, _, z) => {
      if (A = P(A), !A) return !0;
      const ie = A.split(","), oe = ie.every((ye) => !ye || _.has(ye.toLowerCase()));
      if (!oe) {
      ...
      return ie.forEach((de, We) => {
        ye[de] = {}, Object.keys(_).forEach((nt, E) => {
          var pt;
          ye[de][z[E]] = ((pt = oe[We]) == null ? void 0 : pt.split("|")[E]) || "";
        });
      }), ye;
    }, G = () => r.value.map((A, _) => ({
      ...
      name: A.name,
      material: A.material,
      bandingOptions: w.value[_].banding ? Q("bandingOptions", A.banding) : null,
      finishOptions: w.value[_].finish ? Q("finishOptions", A.finish) : null,
      ...
      for (let _ = l.value.length; _--; ) {
        const z = l.value[_], ie = T(z);
        ie ? u.value[_] = ie : (u.value[_] = null, q.value.includes(z) && (u.value[_] = "customData." + e.customFields.find((oe) => oe.label === z).id));
      }
      K(), o.value.shift(), R(), se();
    }, T = (A) => {
      const _ = {
      ...
      p.value = !1, a.value = Object.values(u.value).map((_) => !_ || _ === "N" ? null : m.includes(_) ? _ : (p.value = !0, null));
      const A = a.value.filter((_, z) => a.value.indexOf(_) !== z);
      f.value = A.map((_) => a.value.reduce(
        (z, ie, oe) => (ie && ie === _ && z.push(oe), z),
        []
      ));
    }, P = (A) => A && A.replace(/\s*,\s*/g, ","), R = () => {
...
}), Uc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: Nc }, Symbol.toStringTag, { value: "Module" }));
...
const jc = {
  key: 0,
  class: "debug"
}, zc = { id: "formula-pricing" }, Vc = {
  key: 1,
  class: "extras"
}, Yc = { class: "heading" }, Xc = { id: "hardware-total" }, Kc = { class: "heading panels" }, Zc = !1, Jc = /* @__PURE__ */ Oe({
  ...
  setup(i, { emit: t }) {
    ...
    const f = H(null), p = H([]), I = H(!1), h = H(""), m = Z(() => {
      ...
      const X = Q();
      return tt(() => r("panel-result", X)), X;
    }), w = Z(() => {
      if (!l.value || !I.value || !p.value.length || p.value.every((v) => v.value === null)) return;
      const X = ae();
      return tt(() => r("hardware-result", X, q.value)), X;
    }), q = Z(() => {
      if (w.value)
        return Object.values(w.value).reduce((X, v) => X + v.totalCost, 0);
    });
    Le(m, (X) => {
      var P, R, le;
      if (!I.value || !X || !l.value || !((P = l.value) != null && P.inputShapes)) return;
      ...
      for (const se of Object.values(m.value)) {
        if (!se.name) continue;
        const A = v(se), _ = T.get(A), z = {
          ...se,
          name: se.name.toUpperCase() || (_ == null ? void 0 : _.name.toUpperCase()),
          material: ((R = se.material) == null ? void 0 : R.toUpperCase()) || ((le = _ == null ? void 0 : _.material) == null ? void 0 : le.toUpperCase()),
    ...
    const N = (X) => {
      s.debug && console.log(X);
    }, J = () => {
      p.value = Object.values(f.value.inputs).map((X) => ({
        value: X.default ?? null
      })), console.log(p.value);
    }, V = (X, v) => {
      p.value[X] && (p.value[X].value = v);
    }, Q = () => {
      try {
        return u.calculatePanelsFromFields(p.value);
      } catch (X) {
        return l.value.inputShapes.length = 0, console.error(X), null;
      }
    }, ae = () => {
      try {
    ...
    return (X, v) => {
      var T, K;
      return y(), C(Se, null, [
        a.value === "development" && Zc ? (y(), C("div", jc, [
        ...
        M("div", zc, [
          (T = f.value) != null && T.projectName ? (y(), pe(ht, {
            key: 0,
            id: "project-name",
            type: "string",
            label: "Project name",
            placeholder: "Name",
            value: h.value,
            "onUpdate:value": v[0] || (v[0] = (P) => h.value = P)
          }, null, 8, ["value"])) : W("", !0),
          (y(!0), C(Se, null, De((K = f.value) == null ? void 0 : K.inputs, (P, R, le) => {
            var se;
            return y(), pe(ht, {
              id: "formula-field-" + le,
              key: le,
          ...
          w.value ? (y(), C("div", Vc, [
            M("div", Yc, te(k(n)("Hardware")), 1),
            (y(!0), C(Se, null, De(w.value, (P, R) => (y(), C("div", { key: R }, te(P.name) + " x" + te(P.q) + " = " + te(i.formatPrice(P.totalCost)), 1))), 128)),
            M("div", Xc, te(k(n)("Hardware total")) + " = " + te(i.formatPrice(q.value)), 1)
          ])) : W("", !0),
          M("div", Kc, te(k(n)("Panels")), 1)
        ])
      ], 64);
    };
  }
}), Ih = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: Jc }, Symbol.toStringTag, { value: "Module" })), Qc = { id: "smartcut-notices" }, eh = { class: "content" }, th = ["onClick"], ih = ["innerHTML"], sh = /* @__PURE__ */ Oe({
  __name: "Notices",
  props: {
      ...
      return y(), pe(pn, { to: "body" }, [
        M("div", Qc, [
          ve(Hr, {
            ...
            default: ds(() => [
              (y(!0), C(Se, null, De(k(e), (u) => (y(), C("div", {
                key: u.id,
                ref_for: !0,
                ref: (f) => {
                  f && (n.value[u.id] = f);
...
}), Lh = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: sh }, Symbol.toStringTag, { value: "Module" }));
export {
  Qt as A,
  Jr as B,
  Ch as C,
