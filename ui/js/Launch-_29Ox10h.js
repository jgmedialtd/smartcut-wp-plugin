import { d as _, G as i, x as p, j as y, H as f, c as d, t as k, b as v, s as l, C as u, o as m } from "./vendor-vue-CeWGZ1lm.js";
const h = {
  key: 1,
  class: "error-message"
}, C = /* @__PURE__ */ _({
  ...
  setup(t, { expose: c }) {
    const o = l(!1), n = l(null), a = i({
      wordpress: u(() => import("./WordPress-ZynV2DJe.js")),
      vanilla: u(() => import("./Vanilla-AjF_uuti.js").then((s) => s.V))
    }), e = t, r = p(() => {
