import { F as le, I as ne } from "./EcommerceCalculator-Cpt6HXtv.js";
import { o as k, q as K, u as T, i as Oe, h as A, t as qe, n as je, v as fe, k as pe, w as Fe } from "./vendor-C76etQCp.js";
import { d as He, O as Xe, k as L, l as Ke, o as F, c as N, a as oe, m as re, u as Ze, b as V, j as ye, F as J, f as we, C as Qe, x as D, s as q, I as Ye, g as ae, t as ie, q as et } from "./vendor-vue-CeWGZ1lm.js";
import { _ as tt } from "./Launch-_29Ox10h.js";
function nt(n, e) {
  const o = {};
...
const R = pe(["x", "y", "z"]), B = pe(["top", "bottom", "left", "right", "front", "back"]), ot = k({
  l: R,
  w: R,
  t: R
...
const Ae = 32;
function Ft(n, e = {}) {
  if (!n.instances.some(H)) return n;
  const r = n.templates ?? {};
  let t = n.instances;
...
const Tt = {
  ...
  setup(n, { expose: e, emit: o }) {
    const r = Qe(() => import("./ObjectViewer-C89c1lhH.js")), t = n, a = o, s = Xe("calculator"), l = D(() => s());
    let u = null;
    const i = q(null), d = q([]), h = q(!1), g = q(""), z = D(() => {
    ...
    L(Ee, (c) => {
      ...
      for (const [y, v] of Object.entries(P.value)) {
        ...
        const S = p(v), O = f.get(S), j = (m[y] || {}).materialGroup, De = j ? t.materialPickMeta?.[j]?.code : void 0, Ge = j ? t.materialPicks?.[j] : void 0, te = De || Ge || v.material || "", xe = {
          ...v,
...
}), Gt = /* @__PURE__ */ tt(Bt, [["__scopeId", "data-v-7fbd1e39"]]);
export {
  Gt as default
};
