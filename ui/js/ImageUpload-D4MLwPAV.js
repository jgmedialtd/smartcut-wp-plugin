import { d as L, z as $, l as B, r as O, o, c as d, m as v, u as R, b as U, a as u, F as D, f as V, C as M, s as _ } from "./vendor-vue-CeWGZ1lm.js";
import { _ as P } from "./Launch-_29Ox10h.js";
const A = { id: "uploader" }, E = {
  key: 0,
  class: "debug"
}, S = {
  key: 1,
  class: "selected-files"
}, T = ["src"], G = ["onClick"], z = /* @__PURE__ */ L({
  __name: "ImageUpload",
  props: {
    shapeId: {
      type: String,
  ...
  emits: ["update", "remove"],
  setup(g, { emit: w }) {
    const b = M(() => import("./ObjectViewer-C89c1lhH.js")), h = _(null), a = _({
      shapeId: "",
      files: [],
      previewUrls: [],
      metadata: []
      ...
      if (!n) return;
      const r = Array.from(n), l = r.filter((i) => !F(i));
      if (l.length > 0) {
...
Only JPG and PNG files are allowed.`), t.value = "";
      ...
      const m = [...c, ...r], N = I(m), x = m.map((i, f) => ({
        originalName: i.name,
        newName: `${s.prefix}-${f + 1}-${s.uniqueId}${j(i.name)}`
      })), y = {
        shapeId: s.shapeId,
        files: m,
        previewUrls: N,
      ...
      const t = [...a.value.files], n = [...a.value.previewUrls], r = [...a.value.metadata];
      if (t.splice(e, 1), n.splice(e, 1), r.splice(e, 1), t.length === 0)
        a.value = {
          shapeId: s.shapeId,
          files: [],
          previewUrls: [],
    ...
    return $(() => {
      ...
      return o(), d("div", A, [
        ...
        a.value.files?.length ? (o(), d("div", S, [
          (o(!0), d(D, null, V(a.value.files, (r, l) => (o(), d("div", {
            key: l,
            class: "selected-file"
          }, [
            u("img", {
...
}), Q = /* @__PURE__ */ P(z, [["__scopeId", "data-v-516982a0"]]);
export {
  Q as default
};
