import { m as te, z as y, n as w, D as Q, o as ie, p as ne, q as se, w as ae, x as re, C as I, E as r, y as oe, A as f, B as S, F as C, G as le, H as i, L as E, P as O, R as T, J as R, K as A, N as v, O as z, Q as B, T as M, U as k, V as $, W as N, X as F, Y as G, Z as H, _ as D, $ as L, a0 as j, I as U, a1 as Y, a2 as X, a3 as _ } from "./InputUserGroup-Cp-L9c2U.js";
import { j as d, n as u, k as g, o as b, l as q, h as p, q as m } from "./vendor-C76etQCp.js";
import { P as J } from "./PointCollection-D5IP6MyO.js";
...
const he = {
  ...
  images: m(de).default([]).describe("Array of uploaded images"),
  maxImages: u().default(5).describe("Maximum number of images allowed"),
  allowedTypes: m(p()).default(["image/jpeg", "image/png", "image/gif"]).describe("Allowed MIME types"),
  ...
  tags: m(p()).default([]).describe("Tags associated with images")
  ...
  outline: m(x).default([]).describe("Closed polygon outline vertices (origin-normalized)"),
  ...
  holes: m(m(x)).default([]).describe("Inner contour holes for rendering (CW wound)"),
  ...
  placementOutline: m(x).nullable().optional().describe("Simplified polygon used for NFP/placement; transform reference for render")
}), ee = {
...
class V extends I {
  ...
  constructor(t = {}) {
    const e = { ...t };
    if (e.preventAutoRotation = !0, e.skipValidation = !0, e.parent && e.autoId && e.parent.autoId === e.autoId && delete e.autoId, e.children || (e.children = []), Array.isArray(e.children) && e.autoId && (e.children = e.children.filter(
      (n) => n && n.autoId !== e.autoId
...
class W extends oe {
  ...
  validate(t) {
    const e = [];
    if (this.images && this.images.length > this.maxImages && e.push(new f({
      item: t,
      ...
      for (let n = 0; n < this.images.length; n++) {
        ...
        if (s.url || e.push(new f({
          message: `Image ${n + 1} is missing URL`,
          type: "error"
        })), s.mimeType && !this.allowedTypes.includes(s.mimeType) && e.push(new f({
...
class K extends S {
   ...
   */
  positionContour(t) {
    if (!this.outline || this.outline.length < 3) return t;
