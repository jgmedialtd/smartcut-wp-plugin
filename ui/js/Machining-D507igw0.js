...
import { c as w, M as de, v as I, u as Ne, s as Oe, g as je } from "./result.zod-CxfvOYCR.js";
import { E as Ie, h as Ue, b as Ke } from "./EcommerceCalculator-zkjR6l-4.js";
...
const ct = { class: "inputs" }, ut = {
  ...
  setup(k, { emit: i }) {
    const n = Me(() => import("./ObjectViewer-U19I7q9o.js")), e = k, h = i, m = "production", d = P(), o = P(), c = z(() => Ue(s.value)), x = z(() => {
