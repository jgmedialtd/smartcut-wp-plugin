import { F as bt, G as Oe, bp as He, bq as Ke, br as w, bs as vt, bt as H, bu as kt, bv as Ye, Q as wt, bw as St, bx as xt, by as Pt, t as Ft, bz as Et } from "./components-BsQ77Xjs.js";
...
import { f as jt, k as Ot } from "./composables-CFLwu-TC.js";
...
const Lt = /* @__PURE__ */ Ie({
  ...
  setup(s, { expose: T, emit: B }) {
    const h = ue(() => import("./components-BsQ77Xjs.js").then((a) => a.bC)), l = ue(() => import("./components-BsQ77Xjs.js").then((a) => a.bD)), f = ue(() => import("./components-BsQ77Xjs.js").then((a) => a.bE)), m = B, z = "4.0.22", j = b(!1), o = b([]), _ = b({
      banding: null,
      finish: null,
      planing: null,
      machining: null
...
const Bt = (s, T, B, h = (l) => l.toString()) => {
  ...
  __name: "WordPress",
  setup(s) {
    const T = ue(() => import("./components-BsQ77Xjs.js").then((e) => e.bD)), B = ue(() => import("./components-BsQ77Xjs.js").then((e) => e.bB)), h = ue(() => import("./components-BsQ77Xjs.js").then((e) => e.bE)), { inputShapes: l } = jt(), f = "production", m = {}, z = {}, j = b(null);
    let o, _, t;
    const P = {
      banding: null,
      finish: null
