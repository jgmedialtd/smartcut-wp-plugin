import { k as P, o as S, j as w, q as D, h, i as B, u as F, l as z, n as u, B as ke, C as ps, Z as bt, D as ms, w as M, E as ie, F as ui, G as gs, H as ys, I as Pi, J as bs, K as ws, L as Ss, M as xs, N as vs, O as ks, Q as Ti } from "./vendor-C76etQCp.js";
import "./vendor-i18next-BVRe4kPe.js";
import { t as K, s as Is, e as Ps } from "./i18n-D1euh3nS.js";
import { m as Ts } from "./validation-keys-CsEDW3Vc.js";
...
const Di = P(["error", "warning"]), Oi = P(["saw", "stock", "part", "group", "machining", "extras", "custom"]);
S({
  message: h(),
  identifier: h(),
  field: D(D(h())),
...
const Ds = S({
  ...
  message: h().default(""),
  params: B(h(), F([h(), u(), w(), ke()])).optional(),
  ...
  type: Di.default("error"),
  category: D(Oi).nullable().default(null),
...
S({
  ...
  origin: h().optional(),
  dimension: P(["l", "w"]).optional(),
  direction: P(Os).nullable().optional(),
...
function Ve(t) {
  ...
  return e && di.set(t, i), { ...i };
}
typeof ps < "u" && bt && bt.prototype && (bt.prototype.behavior = function(t) {
  return ft(this, t);
});
function O(t, e = {}) {
  let s = z().refine((r) => r == null ? !0 : typeof r == "object" && r !== null ? ("autoId" in r || "id" in r, !0) : !1, {
    ...
    if (typeof r == "object" && r !== null && !r.__ref) {
      ...
      try {
        const a = Nt(), l = r.__entityType || t, c = a.get(l);
  ...
  return n = ft(n, o), Object.defineProperty(n, "__zRefClassName", {
    value: t,
    enumerable: !1,
    writable: !1,
    configurable: !1
...
const fi = ["topLeft", "topRight", "bottomLeft", "bottomRight"], Es = [
  "left",
  "centre",
  "right",
  "top",
  ...
  direction: P(Ls).nullable().optional(),
  type: h().optional(),
  corner: P(fi).optional(),
  shapePosition: P(fi).optional(),
  grid: P(Es).optional(),
...
}, Ci = h().default("").describe('Unique identifier (e.g., "1.0" for shapes/stock, "g1" for groups, "ss-1_a2b3" for segments, "1.0-proximity" for proximity rectangles)'), Rs = h().max(200).default("").describe("User input name"), Ns = h().default("").describe("Parent identifier for tracking copies and relationships"), Gt = h().describe("Internal product or material code"), Gs = w().default(!1).describe("Prevent automatic rotation optimization"), $s = w().default(!1).describe("Whether this is an offcut piece"), Fi = D(h()).default([]).describe("IDs of identical items").behavior({ clone: "copy" }), Ue = F([
  M(""),
  M("l"),
  M("w"),
  M(" ").transform(() => ""),
  ke().transform(() => "")
]).default("").describe("Grain direction of the material"), Ei = h().optional().describe("Color name"), La = F([M(""), h().regex(/^#[0-9A-Fa-f]{3,8}$/, { error: (t) => `Invalid hex colour "${t.input}" — use #RGB or #RRGGBB, e.g. "#1a2b3c"` })]).optional().describe("Color hex code"), Li = ie(
...
const $t = F([
  ...
  rot: $t.describe("Rotation: 0 (no rotation) or 1 (90 degrees)"),
...
S({
  ...
  groups: B(h(), Bs).describe("Groups of strip shape batches keyed by ID")
});
const Vs = P(["none", "schema", "business", "full"]), Y = S({
...
const zt = Y.extend({
  ...
  name: Rs,
  // Dimensions
  l: ie((t) => typeof t == "number" && !isFinite(t) ? 1 : t ?? 1, u().positive()).describe("Length (long side dimension)"),
  w: ie((t) => typeof t == "number" && !isFinite(t) ? 1 : t ?? 1, u().positive()).describe("Width (short side dimension)"),
  ...
  // Trim
  trim: zs.describe("Reduce the dimensions by specified trim values"),
  ...
  customData: B(h(), z()).default({}).describe("Custom user-defined data"),
  identicalTo: Fi,
...
const Mi = ["sheet", "linear", "roll"], Vt = ie(
...
).describe("Type of stock material"), _i = S({
...
jt.describe(JSON.stringify({
  name: "Container",
  version: "1.0.0",
  extends: "Rectangle",
  computedProperties: Object.keys(Wt)
}));
const qs = S({
  dimension: u().describe("Dimension of the strip shape batch"),
  rot: F([
  ...
  stripShapeBatches: S({
    subsetUsed: w().optional().describe("Whether a subset was used for strip shape batches"),
    groups: B(h(), qs).default({}).describe("Groups of strip shape batches keyed by ID")
...
const Ks = {}, Ys = S({
  ...
  cutDirection: ve.optional()
}).behavior({ clone: "reset" }), Zs = S({
...
]).behavior({ clone: "reset" }), qe = zt.extend({
  ...
  priority: B(h(), u()).default({}).describe("Priority levels for optimization"),
  weighting: B(h(), u()).optional().describe("Shape weighting for optimization"),
  ...
  score: hi.nullable().optional().describe("Current optimization score").behavior({
    clone: "reset",
    serialize: "exclude"
...
const Ni = ["horizontal", "vertical"], Gi = ["position", "user", "strip", "firstShape"], Xs = P(Ni).optional(), pi = S({
  x: u(),
  y: u(),
  autoId: h().optional(),
  rot: $t,
  ...
  positions: D(pi).default([]),
  // User-defined positions for free-placement user groups (from InputUserGroup)
  userPositions: D(pi).optional(),
  type: P(Gi).default("position"),
...
const en = ["l", "w"], tn = qe.extend({
...
}, $i = D(h()).default([]).describe("Parent IDs of stock(s) this shape is locked to"), nn = P(["l", "w"]).nullable().default(null), zi = F([
  M("l"),
  M("w"),
  ke()
]).default(null), rn = S({
  ...
  grain: Ue.optional()
}).describe("Which stock(s) this shape is a match for "), Bi = B(h(), z()).default({}), Vi = S({
...
$i.describe("IDs of stocks this shape is locked to");
const on = zi.describe("Direction that should face up");
S({
  /**
...
const an = S({
  ...
  reference: null,
  addedAsGroup: null
}).describe("Group metadata and reference"), Ot = qe.extend({
  // ========== Group Metadata ==========
  ...
  upDirection: nn.describe("Direction that should face up"),
  // ========== Extras ==========
...
Ot.describe(JSON.stringify({
  name: "Shape",
  description: "Shape to be cut from stock material",
  version: "1.0.0",
  extends: "Placeable",
  computedProperties: Object.keys(ji)
}));
const Ma = S({
  areaEfficiency: u(),
  finishArea: u(),
  ...
  analysis: ln.optional().behavior({ clone: "reset" }),
  ...
  stack: cn.optional().describe("Stack information").behavior({ clone: "reset" }),
  ...
  type: P(Mi).optional().describe("Type of stock material"),
  ...
  color: Ei.describe('Material color ({ hex: "#FF5733", name: "Red" } or legacy string)'),
...
class _ {
  ...
  static create(e, i, s) {
    ...
    const o = (r) => {
      ...
      if (r._type === e)
        return s ? s(r) : !0;
      const l = r.constructor?.name === i, f = "getType" in r && typeof r.getType == "function" && r.getType() === e, d = l || f, b = s ? s(r) : !0;
      return d && b;
    };
...
const hn = _.create(p.Cut, "Cut"), q = _.create(
  p.Shape,
  "Shape",
  (t) => !("shapes" in t)
), Hi = _.create(
...
), de = _.create(p.Stock, "Stock"), Ui = _.create(
  p.Group,
  "Group",
  ...
  const e = t._type;
  return e !== void 0 ? e === p.Group || e === p.UserGroup || e === p.StripGroup || e === p.FirstShapeGroup : Ui(t) || Be(t) || qi(t) || Ki(t);
}, pn = _.create(
  p.InputUserGroup,
  "InputUserGroup"
), Yi = _.create(p.Segment, "Segment"), mn = _.create(p.Offcut, "Offcut"), gn = (t) => !t || typeof t != "object" ? !1 : mn(t) ? !0 : t.offcut === !0, yn = (t) => {
  if (!t || typeof t != "object") return !1;
  const e = t._type;
  if (e && un.has(e)) return !0;
...
function Sn(t) {
  ...
  return hn(t) ? p.Cut : W(t) ? p.InputShape : Ht(t) ? p.InputStock : pn(t) ? p.InputUserGroup : Be(t) ? p.UserGroup : qi(t) ? p.StripGroup : Ki(t) ? p.FirstShapeGroup : Ui(t) ? p.Group : Hi(t) ? p.NestingShape : q(t) ? p.Shape : de(t) ? p.Stock : yn(t) ? p.Container : Yi(t) ? p.Segment : gn(t) ? p.Offcut : Zi(t) ? p.Rectangle : bn(t) ? p.Placeable : null;
}
const pe = (t) => {
  if (!t || typeof t != "object") return !1;
  const e = t;
...
function Pn(t, e) {
  const i = Ts(t), s = t.startsWith("errors.validation.") ? t : i, n = In(e);
  return {
    message: K(s, n),
    translationKey: s,
    params: n
...
class y {
  ...
  item = null;
  constructor(e = {}) {
    const i = Array.isArray(e.issues) ? e.issues : null, s = Ds.parse(e), n = y.determineIdentifier(s.item, s.index || []);
    let o = s.id || "";
    !o && s.item && "autoId" in s.item && s.item.autoId && (o = s.item.autoId);
    const r = s.shouldTranslate !== !1 ? Tn(s.message, s.params) : s.message;
    if (this.message = r, this.identifier = n, this.field = s.field.map((a) => [...a]), this.index = s.index ? [...s.index] : [], this.id = o, this.type = s.type, this.category = s.category || [], this.item = s.item, this.addToItemIssues(s.item), i && i.push(this), s.throwError) {
      const a = `Issue created for ${Sn(s.item)}: ${this.identifier || "N/A"} - ${this.field.map((l) => l.join(".")).join(", ")}`;
      throw new Error(a);
    }
  }
  /**
...
function Ra(t, e, i = !1) {
  ...
  const n = String(t);
  try {
    const o = Qi(n, !0), r = parseFloat(o ?? ""), a = o !== null && o !== "" && !isNaN(r) && isFinite(r);
    return {
      value: a ? r : t,
      valid: a,
...
function Cn(t) {
  ...
  if (!e) return null;
  try {
    const { thousandsSeparator: i, decimalSeparator: s } = An(), n = e.replace(new RegExp(`\\${i}`, "g"), "").replace(new RegExp(`\\${s}`, "g"), "."), o = Number(n);
    return isFinite(o) ? o : null;
  } catch (i) {
    throw new st(`Failed to parse locale number: "${t}". ${i.message || "Parsing error"}`);
  }
}
function Fn(t) {
  if (!t) return !1;
...
function Qi(t, e = !1) {
  ...
  try {
    ...
    if (a) {
      const c = a[1], f = a[2], d = a[3], b = We[d];
      if (b)
        return `${c}${f} ${b}`;
...
function I(t) {
  ...
  const e = t.o ?? {}, i = t.nf ?? e?.numberFormat ?? "decimal", s = t.dp ?? e?.decimalPlaces ?? wt, n = t.pl ?? e?.parseLocale ?? !1, o = t.fr ?? e?.fractionRoundTo ?? mi;
  if (i === "decimal") {
    if (typeof t.v == "number") {
      if (typeof s == "number" && s !== wt) {
  ...
  try {
    const r = Qi(t.v, n);
    return r === null || r === "" ? i === "decimal" ? null : "" : i === "decimal" ? Dn(r, s) : On(r, o);
  } catch (r) {
    throw r instanceof st ? r : new st(
...
function $(t, e) {
  if (e?.returnKey)
    return `fields.${t}`;
  const i = `fields.${t}`, s = K(i);
  if (s === i) {
    const n = $e[t] || t;
    return Te() && !$e[t] && console.warn(`[field-mappings] No translation or fallback for field: "${t}"`), n;
  }
  return Te() && console.log(`[field-mappings] Translated "${t}" -> "${s}"`), s;
}
const es = (t, e, i, s, n, o) => {
  const r = L(t, e);
  if (r == null || r === "") return;
  if (typeof r != "string") {
    new y({
      item: t,
      message: K("errors.validation.must_be_string", {
        0: $e[e]
      }),
      shouldTranslate: !1,
      field: [[e]],
  ...
  i.includes(a) || new y({
    item: t,
    message: K("errors.validation.must_be_values", {
      0: $e[e],
      1: i.join(", ")
    }),
    shouldTranslate: !1,
...
function _n(t) {
  return Mn(t, "issues") && Array.isArray(t.issues);
}
function $a(t, e, i = !1) {
  if (!_n(t) || !t.issues?.length)
    return !1;
  const s = i ? "warning" : "error";
  return t.issues.filter((r) => r.type === s).some((r) => r.field?.length ? r.field.some((a) => a.every((l, c) => l === Nn(e[c]))) : !1);
}
const Rn = {
...
const Gn = ["banding", "finish", "planing", "info", "machining", "addon"], za = h().refine(
  ...
  // ========== Identity ==========
  type: P(Gn).optional().describe("Type of extra"),
...
const zn = S({
  ...
  properties: B(h(), ts).optional(),
  disabledMessage: h().optional().describe("Message when location is disabled")
}), Bn = S({
  global: B(h(), ts).optional(),
  locations: D(zn).optional().describe("Location-specific constraints"),
...
S({
  ...
  faces: D(ui()).optional().describe("Available face locations"),
  sides: D(ui()).optional().describe("Available side locations"),
  constraints: Bn.optional()
});
const Vn = ht, jn = {
...
}, Wn = ["radius", "bevel"], Hn = Y.extend({
  // Corner type
  type: P(Wn).nullable().optional().describe("Type of corner modification"),
...
}, qn = ["l", "w"], Kn = ["top", "bottom", "left", "right", "merged"], Yn = S({
  // Coordinates
  x1: u().default(0),
  x2: u().default(0),
  y1: u().default(0),
  ...
  dimension: P(qn).optional(),
  position: P(Kn).optional(),
  ...
  direction: P(tr).default("l").describe("Groove direction (l=horizontal, w=vertical)"),
...
}, nr = ["l1", "l2", "w1", "w2"], rr = Y.extend({
  // Position
  position: u().min(0).default(0).describe("Position along the side"),
  side: P(nr).describe("Side where hinge is placed"),
...
}, Oe = ["l1", "l2", "w1", "w2"], ar = ["a", "b", "c", "d"], ye = [...Oe, ...ar], J = ["a", "b"], lr = ["regular", "hinge", "shelf"], cr = Y.extend({
  // Position
  ...
  // Configuration
  face: u().default(0).describe("Face index (0=front, 1=back)"),
  type: P(lr).default("regular").describe("Type of hole"),
  ...
  edge: P(Oe).nullable().default(null).describe("Edge the hole is bored into (null = face hole)")
}), ur = {
  // Inherit computed properties from validation base
  ...se,
...
const dr = (t, e) => k(t, e), fr = ["efficiency", "guillotine", "beam", "nesting", "none"], hr = ["l", "w", "flex", "none"], is = ["efficiency", "time"], pr = ["l", "w"], mr = ["efficiency", "smallest"], gr = ["dimensions", "identical", "none"], yr = ["sheet", "linear", "roll"], qt = F([
  u().int().positive(),
  ke(),
  gs()
]).transform((t) => t ?? 100).describe("Maximum stack height for beam saw stacking"), Kt = P(fr).nullable().optional().transform((t) => t === null ? void 0 : t), Yt = P(hr).nullable().optional().transform((t) => t === null ? void 0 : t), Zt = P(mr).default("efficiency").describe("Method for selecting stocks"), Xt = P(gr).default("identical").describe("How to stack identical parts"), ss = S({
  strategy: P(is).default("efficiency"),
  ...
  phaseDirection: B(h(), P(["l", "w"])).optional()
}).default({
  strategy: "efficiency",
  maxPhase: 0,
  headCuts: !1,
  ...
  primaryCompression: P(pr).default("w")
}).default({
...
const br = u().min(0).default(0), wr = u().min(0).default(0), ns = u().min(0).default(0), Sr = S({
  dimension: wr,
  minSpacing: ns
});
function Ct(t) {
...
const xr = k(
  ...
  Me({ allowZero: t.allowZero, nullable: !0 }).default(null),
  {
    label: t.label,
  ...
  Me({ allowZero: !0, nullable: !0 }).optional().transform((t) => {
    if (t != null)
      return t;
  }),
  {
  ...
  ys().max(500).transform((t) => t.replace(/,/g, " ")).optional(),
  {
    label: "fields.notes",
  ...
  // ========== Blade Configuration ==========
  bladeWidth: k(
    Me({ allowZero: !0, nullable: !1 }).default(0),
    {
  ...
  // ('rectangle-guillotine-max-1|2|3') are EXPERIMENTAL + BEAM-only: they only engage when this saw is
  // beam with a recognised profile AND the job is within the part cap; otherwise the job safely falls
  // back to Fast. A request-level `model` overrides this per-job.
  algorithm: k(
    h().optional(),
    {
  ...
  // ========== Guillotine Options ==========
  guillotineOptions: Pr,
  // ========== Efficiency Options ==========
  efficiencyOptions: Tr,
  // ========== General Options ==========
  options: S({
    stockSelection: kr,
    minSpacing: Me({ allowZero: !0, nullable: !1 }).default(0),
    stackingMode: Ir,
    minSpacingDimension: S({
      dimension: Me({ allowZero: !0, nullable: !0 }).optional(),
      minSpacing: Me({ allowZero: !0, nullable: !0 }).optional()
    }).optional()
  }).default({
  ...
  validCutPreferences: {
    compute: (t) => Ft(t.stockType, t.cutType),
    metadata: {
      cache: !0,
...
}).default({ l1: 0, l2: 0, w1: 0, w2: 0 }), zr = ie(
  (t) => {
    if (t == null)
  ...
  rot: $t.default(0),
  // ========== Flags ==========
  preventAutoRotation: le.boolean({
  ...
  // ========== Stock Matching ==========
  stockMatch: rn.nullable().optional(),
  // ========== Stock Reference ==========
  ...
  outline: D(S({ x: u(), y: u() })).nullable().optional(),
  ...
  holes: D(D(S({ x: u(), y: u() }))).nullable().optional()
}), Vr = {
  ...
  grain: rs(),
  preventGrainRotation: le.boolean({
  ...
  // ========== Positions ==========
  positions: D(Wr).default([]).describe("XY positions for each shape within the group"),
  // ========== Group Properties ==========
  ...
  positions: D(qr).min(2).describe("Part positions within the group. Each entry specifies a part index and its x,y coordinates."),
  ...
  stockType: Vt,
  stackHeight: qt.describe("Maximum stack height"),
  cutType: Kt,
  cutPreference: Yt,
  // Blade width (numeric for runtime)
  bladeWidth: br.describe("Blade width"),
  // Guillotine options
  guillotineOptions: ss,
  // Efficiency options
  efficiencyOptions: Jt,
...
const Le = 1e-10, Qr = 10, eo = Number.MAX_SAFE_INTEGER, to = 4294967295, j = (t) => typeof t == "number" && Number.isFinite(t), et = (t) => Array.isArray(t) && t.length > 0;
function je(t, e, i = Le) {
  if (t === e) return 0;
...
const io = {
  greaterThan: (t, e, i = Le) => !j(t) || !j(e) ? !1 : je(t, e, i) > 0,
  greaterThanOrEqualTo: (t, e, i = Le) => !j(t) || !j(e) ? !1 : je(t, e, i) >= 0,
  lessThan: (t, e, i = Le) => !j(t) || !j(e) ? !1 : je(t, e, i) < 0,
  lessThanOrEqualTo: (t, e, i = Le) => !j(t) || !j(e) ? !1 : je(t, e, i) <= 0,
  equalTo: (t, e, i = Le) => !j(t) || !j(e) ? !1 : je(t, e, i) === 0
};
function so(t) {
  return j(t) ? Number.isInteger(t) ? t : Number(t.toFixed(Qr)) : !1;
}
function no(t) {
  if (!j(t) || t < 0 || t > eo)
    throw new Error("Invalid length parameter");
  return Math.floor(crypto.getRandomValues(new Uint32Array(1))[0] / (to + 1) * t);
}
function ro(t, e) {
  if (!et(t))
...
const T = {
  ...
  getRandom: no,
  getRandomSample: ro,
  calculateStandardDeviation: Ye.calculateStandardDeviation.bind(Ye),
  calculateCoefficientOfVariation: Ye.calculateCoefficientOfVariation.bind(Ye)
};
function yi(t) {
  return t && typeof t == "object" && typeof t.toData == "function";
}
let bi = 0, wi = Date.now();
const oo = 1e4;
function ao() {
  return bi % oo === 0 && (wi = Date.now()), `${wi}-${(bi++).toString(36)}`;
}
class ce {
  ...
  static getCachedPartialSchema(e) {
    let i = ce._partialSchemaCache.get(e);
    return i || (i = e.partial(), ce._partialSchemaCache.set(e, i)), i;
  }
  // Private flag for compression mode (will be set as non-enumerable in constructor)
  _serializationMode;
  constructor(e) {
    this.autoId = e?.autoId || ao(), Object.defineProperty(this, "_serializationMode", {
      value: "full",
      writable: !0,
      enumerable: !1,
  ...
  getFieldBehaviors() {
    ...
    if (e.schema && typeof e.schema == "object" && "_def" in e.schema) {
      const i = Ve(e.schema), s = e.schema;
  ...
  update(e) {
    ...
    if (s && typeof s == "object" && "_def" in s) {
      ...
      let a;
      r ? a = e : a = ce.getCachedPartialSchema(s).parse(e);
      for (const l in a) {
  ...
  clone(e = null, i = {}) {
    ...
    let n;
    if (e) {
      const m = s.pop() || "0", v = parseInt(m, 10);
      isNaN(v) && s.push(m), n = String(e);
    } else {
      const m = s.pop() || "0", v = parseInt(m, 10);
      isNaN(v) ? (s.push(m), n = "1") : n = String(v + 1);
    }
    s.push(n);
    ...
    let d = {};
    f && (d = Ve(f));
    const b = l.defaults || (f ? f.parse({}) : {}) || {};
    for (const [m, v] of Object.entries(d))
      v.clone === "reset" && (m in b ? c[m] = b[m] : delete c[m]);
...
class C extends ce {
  ...
  constructor(e = {}) {
    ...
    if (o)
      ...
      if (a.success)
        ...
        const l = ce.getCachedPartialSchema(i).safeParse(e);
        l.success ? r = l.data : r = this.filterInvalidFields(e, l.error, i);
      }
    }
    if (i && r) {
      let a = C._schemaKeysCache.get(i);
      if (!a) {
        const l = i.shape || i._def?.shape;
        l && (a = Object.keys(l), C._schemaKeysCache.set(i, a));
      }
      if (a) {
        const l = {};
        for (const c of a)
  ...
  filterInvalidFields(e, i, s) {
    ...
    const a = ce.getCachedPartialSchema(s).safeParse(o);
  ...
  recreateNestedClasses(e, i) {
    ...
    let s = C._zRefFieldsCache.get(i);
    if (s === void 0) {
      s = null;
      const o = i.shape;
  ...
  deserializeValueWithClassName(e, i) {
    ...
    if (typeof e == "object" && e !== null) {
      const s = e.__entityType || i, o = Nt().get(s);
      if (o)
        try {
  ...
  recreateReference(e, i, s) {
    ...
    return e && typeof e == "object" ? (s && (e.id || e.autoId), C.recreateFunc ? C.recreateFunc(e, s, i) : { ...e, __ref: i }) : e;
  }
  /**
  ...
  applyComputedProperties() {
    const e = this.constructor;
    if (C._computedPropsInitialized.has(e)) return;
    const i = e.computedProperties;
    if (!i) {
      C._computedPropsInitialized.add(e);
      return;
    }
    const s = e.prototype;
  ...
  update(e) {
    ...
    if (n)
      ...
      const r = ce.getCachedPartialSchema(i).safeParse(e);
  ...
  static cleanEntityForAPI(e) {
    if (!e) return e;
    if (Array.isArray(e))
      return e.map((s) => C.cleanEntityForAPI(s));
    if (typeof e != "object")
      return e;
    const i = { ...e };
  ...
  static extractNumberFormatFields(e) {
    ...
    for (const [n, o] of Object.entries(s)) {
      ...
      if (r instanceof bs) {
        const a = r.options.some((c) => c instanceof ws), l = r.options.some((c) => c instanceof Ss);
        a && l && i.push(n);
      }
    }
    return i;
  ...
  static unwrapSchema(e) {
    ...
    if (e instanceof xs || e instanceof vs)
...
class _e extends C {
  ...
  validate() {
    const e = [];
    return (!T.isNumber(this.x1) || !T.isNumber(this.x2) || !T.isNumber(this.y1) || !T.isNumber(this.y2)) && e.push(new y({
      message: "Line coordinates must be valid numbers",
      type: "error"
    })), this.x1 === this.x2 && this.y1 === this.y2 && e.push(new y({
  ...
  static fromCoordinates(e, i, s, n, o, r) {
    return new _e({ x1: e, y1: i, x2: s, y2: n, origin: o, type: r });
  }
  get lineDimension() {
...
function Ce(t, e, i = !1) {
  ...
  return i && (s = ho(t, s)), n === e || ([s.l, s.w] = [s.w, s.l]), s;
}
function os(t) {
  if (!("l" in t) || !("w" in t)) throw new Error("rotatable item must have l & w properties");
}
function po(t) {
  fe(t) || (os(t), [t.l, t.w] = [t.w, t.l]);
}
function Si(t, e) {
  return T.lessThanOrEqualTo(t, e);
}
function Fe(t, e) {
  return Si(t.l, e.l) && Si(t.w, e.w);
}
function pt(t, e, i = null, s) {
  if (!e || !t)
    throw new Error("Container and shape are required");
  const n = s ? s.allowExactFit : "allowExactFitShapes" in e && e.allowExactFitShapes === !0, o = s ? s.withTrim : tt(e, !0), r = s ? s.withoutTrim : n ? tt(e, !1) : o, a = tt(t, !0);
  let l = o;
  ...
  if (t.orientationLock || i !== null) {
    const b = i ?? (c === "w" ? 1 : 0), m = Ce(t, b, !0);
    if (n) {
      const v = Ce(t, b, !1);
      if (T.equalTo(v.l, r.l) && T.equalTo(v.w, r.w))
        return Fe(v, l);
    }
    return Fe(m, l);
  }
  ...
  if (n) {
    const b = Ce(t, 0, !1);
    if (T.equalTo(b.l, r.l) && T.equalTo(b.w, r.w) && Fe(b, l)) return !0;
  }
  if (Fe(f, l)) return !0;
  const d = Ce(t, 1, !0);
  if (n) {
...
function mo(t) {
  ...
  let e = null;
  return (fe(t) || Be(t) || q(t) || W(t)) && (e = t.orientationLock), e;
}
function as(t, e) {
  const i = mo(t);
  if (!ue(i)) return null;
  if (!e || "direction" in t) return i;
  if (!fe(t) && ei(t)) return null;
  if ("getStock" in e) {
    const s = e.getStock;
    if (s && ue(s.grain))
...
function Lt(t, e = null, i = null) {
  if (!ue(e))
    throw new Error("no rotation provided to canRotate");
  if (e === !0 && (e = 1), e === !1 && (e = 0), t.preventAutoRotation && e !== 0 || !fe(t) && ei(t) && e !== 0 || i && !pt(t, i, e))
    return !1;
  const s = as(t, i);
  return !(s === "l" && e === 1 || s === "w" && e === 0);
}
function go(t, e = null, i = null) {
  const s = "rot" in t ? t.rot : 0;
  return e === null && (e = s === 0 ? 1 : 0), !fe(t) && ei(t) ? !0 : Lt(t, e, i) ? (s === e || po(t), !0) : !1;
}
function ae(t, e = null, i = null) {
  return e ? e = 1 : e = 0, i && e && !pt(t, i, e) ? !1 : go(t, e, i);
}
function ei(t) {
  os(t);
  const e = tt(t);
...
class mt extends C {
  ...
  constructor(e = {}) {
    super(e);
    let i = !1;
    de(this) && (i = this.infiniteLength), !e?.preventAutoRotation && !i && (this.orientationLock ? (this.orientationLock === "l" && ae(this, 0), this.orientationLock === "w" && ae(this, 1)) : this.w > this.l && ([this.l, this.w] = [this.w, this.l], this.grain && !e?.preventGrainRotation && (this.grain = rt(this.grain)))), this.calculateDimensions(), e.skipValidation || e.skipBusinessValidation || e.validationMode === "none" || e.validationMode === "schema" || this.validate();
  }
  /**
   ...
   */
  calculateDimensions() {
    this.area = this.l * this.w, this.longSide = Math.max(this.l, this.w), this.shortSide = Math.min(this.l, this.w), this.parentId = js(this.id);
  }
  /**
   * Get entity type
   */
   ...
   */
  validate() {
    if (this.issues = [], this.warnings = [], (this.l <= 0 || this.w <= 0) && this.issues.push(new y({
      ...
      e.x >= this.l && this.warnings.push(new y({
        message: "Trim values exceed length",
        type: "warning",
        field: [["trim"]],
        item: this
      })), e.y >= this.w && this.warnings.push(new y({
  ...
  applyTrim() {
    ...
    if (e <= 0 || i <= 0) {
      this.q = 0, this.issues.push(new y({
  ...
  getCorners() {
    return {
      bottomLeft: new Q(this.x, this.y),
      topLeft: new Q(this.x, this.y + this.w),
      topRight: new Q(this.x + this.l, this.y + this.w),
      bottomRight: new Q(this.x + this.l, this.y)
    };
  }
  /**
...
class ti extends mt {
  ...
  /**
    ...
    */
  update(e) {
    const i = ce.getCachedPartialSchema(ti.schema).parse(e);
    for (const s in i)
      this[s] = i[s];
  }
  /**
  ...
  /**
    ...
    */
  get getStock() {
    return de(this) ? this : Yi(this) ? this.stock : fe(this) ? this.stock : null;
  }
}
class me extends C {
  // Required: Define schema and computed properties
  static schema = Ri;
  static computedProperties = Ks;
  /**
   * Leave serializationProperties empty to trigger automatic enumeration
   * We use serializationExcludedProperties for exclusion-based approach
   */
...
class ii extends C {
  ...
  /**
    ...
    */
  static fromCoordinates(e, i, s, n, o, r) {
    return new ii({ x1: e, y1: i, x2: s, y2: n, position: r, stock: o });
  }
...
class si extends mt {
  ...
  constructor(e = {}) {
    ...
    (!this.firstShape || typeof this.firstShape != "object") && (this.firstShape = { sampleRotations: [], isFirstShape: !1 }), (!this.priority || typeof this.priority != "object") && (this.priority = {}), q(this) && (!this.group || typeof this.group != "object") && (this.group = {
      inUserGroup: !1,
      inGroup: !1,
      reference: null,
      addedAsGroup: null
  ...
  reset({
    ...
    if (this.added = !1, this.stock = null, this.placementOrder = void 0, this.x = 0, this.y = 0, e || (this.score = null, this.bestScore = null), this.firstShape.isFirstShape = !1, n || (this.firstShape.sampleRotations = []), this.patternMatch = !1, this.fitsStock = null, this.guillotineState instanceof me)
      ...
      this.guillotineState = new me();
    if (q(this) && (s || "group" in this && this.group && (this.group.placementOrder = void 0, this.group.inGroup = !1, this.group.inUserGroup = !1, this.group.reference = null, this.group.addedAsGroup = null)), fe(this) && "shapes" in this && Array.isArray(this.shapes)) {
      const o = Be(this) ? { keepScores: e, keepGuillotineBatchData: !0, keepGroupData: !0 } : void 0;
   ...
   */
  addToStock(e) {
    this.stock = e, this.added = !0, e.used = !0, this.grain = e.grain, !fe(this) && e?.grain && this.rot && (this.grain = rt(e.grain));
  }
  removeFromStock() {
    this.placementOrder = null, this.stock = null, this.added = !1, q(this) && (this.group.addedAsGroup = null, this.firstShape.isFirstShape = !1), fe(this) && this.shapes.forEach((e) => {
  ...
  getStripShapeBatchData(e) {
    ...
    return !i || wn(i) || !i.stripShapeBatches?.groups || !(e in i.stripShapeBatches.groups) ? !1 : i.stripShapeBatches.groups[e];
  }
  /**
   * Set best score
   */
  setBestScore(e, i = null) {
    ...
    this.bestScore = {
      ...
      total: e.score.total,
      score: e.score,
      group: q(e) ? e.group.reference : null,
      stock: e.stock,
      weighting: {},
  ...
  willItFit(e, i = null, s) {
    return de(e) && typeof this.fitsStock?.[e.parentId] < "u" ? this.fitsStock?.[e.parentId]?.[i ?? "any"] === !0 : pt(this, e, i, s);
  }
  /**
  ...
  getCoords(e, i = !1) {
    const s = new Q(this.x + this.l, this.y);
    s.corner = "bottomRight";
    const n = new Q(this.x, this.y + this.w);
    if (n.corner = "topLeft", e?.cutType !== "efficiency" && !i)
      return [n, s];
    const o = new Q(this.x, this.y);
    o.corner = "bottomLeft";
    const r = new Q(this.x + this.l, this.y + this.w);
  ...
  createPerimeterCuts(e = null) {
    ...
    return this.getPerimeterCutVectors().forEach((n) => i.push(new ii({
...
function yo() {
  if (vt)
    return Ze;
  try {
    Ze = { runTests: !1, throwErrorsOnFailedTests: !1 }, vt = !0;
  } catch {
    Ze = { runTests: !1, throwErrorsOnFailedTests: !1 }, vt = !0;
  }
  return Ze;
...
let kt;
function wo() {
  return kt === void 0 && (kt = Te()), kt;
}
function Xe(t = [], e = null) {
  if (!t?.length) return;
  const i = yo(), s = i?.testCollector || bo;
  if (!!(i && i.runTests && (wo() || s)))
    for (const o of t) {
      ...
      try {
        ...
        if (a = !1, l = c instanceof Error ? c.message : String(c), e ? xi(e, l) : xi(l), s && s.addResult({
          passed: !1,
          error: l,
...
class gt extends si {
  ...
  static schema = Ot;
  static computedProperties = ji;
  static defaults = Ot.parse({});
  constructor(e = {}) {
    super(e);
  }
  /**
...
class ni extends si {
  ...
  initShapes(e, i) {
    return e.map((s) => {
      ...
      if (q(s))
        return this.linkShapeToGroup(s), s;
      if (i && i.shapeList && s) {
        const o = i.shapeList.find((r) => r.autoId === s.autoId);
        if (o)
          return this.linkShapeToGroup(o), o;
      }
  ...
  /**
    ...
    */
  static create(e) {
    const i = { ...e.data, shapes: e.shapes }, s = new ni(i);
    ...
    if (!(!this.shapes || this.shapes.length === 0)) {
      ...
      if (this.positions && this.positions.length > 0)
        for (const i of this.positions) {
          ...
          s && (ae(s, i.rot, e) || console.error(`  ❌ FAILED to restore rotation for ${s.id} from ${s.rot} to ${i.rot}`));
        }
      if (this.positions && this.positions.length > 0)
        for (const i of this.positions) {
          const s = this.shapes.find((n) => n.autoId === i.autoId);
          s && s.rot !== i.rot && (console.warn(`[placeMyShapes] Shape ${s.id} has wrong rotation ${s.rot}, expected ${i.rot} - forcing rotation now`), ae(s, i.rot, e) || console.error(`[placeMyShapes] ❌ CRITICAL: Cannot fix rotation for ${s.id}`));
        }
      ...
      for (let i = 0; i < this.shapes.length; i++) {
        ...
        if (s.x = this.x + n.x, s.y = this.y + n.y, !ae(s, n.rot, e)) throw new Error("placeMyShapes - unable to set rotation for shape in group");
        i === 0 && this.x === 0 && this.y === 0 && (s.firstShape.isFirstShape = !0), s.group.addedAsGroup = this, Xe([
          () => ge(this.type === "position" ? s.group.inGroup : !s.group.inGroup).toBe(!0)
        ], `placeMyShapes: Shape ${s.id} inGroup flag should match group type (${this.type})`), Xe([
          () => ge(s.group.addedAsGroup).toBe(this),
          () => ge(typeof s.group.addedAsGroup).not.toBe("string")
  ...
  updatePositions() {
    ...
    let i = 0;
    const s = So(this.direction), n = vi(this.direction);
    let o = 0;
    for (const l of this.shapes) {
      ...
      s === "x" ? b.x = i : b.y = i, this.positions.push(b), l.group.inGroup = !0, i += o === this.shapes.length - 1 ? d : d + c, o++;
    }
    this.groupLength = i;
    const r = rt(n), a = this.shapes.reduce(
      (l, c) => {
    ...
    if (this.groupWidth = a, Te()) {
      const l = this.shapes.slice(0, -1).reduce((d, b) => d + b.getMinSpacing(this.container.saw), 0), f = this.shapes.reduce((d, b) => d + b[n], 0) + l;
      Xe([
        () => ge(
          T.equalTo(f, this.groupLength)
        ).toBe(!0),
        () => ge().toBe(this.groupLength),
        () => ge().toBe(this.groupWidth)
      ]);
    }
   ...
   */
  sortShapes() {
    const e = vi(this.direction), i = rt(e);
  ...
  destroy() {
    ...
    if (!this.added && this.shapes && this.shapes.length > 0) {
      ...
      Xe([
        () => ge(e.every((s) => !s.group?.inGroup)).toBe(!0),
        () => ge(e.every((s) => !s.group?.reference)).toBe(!0)
...
const vo = ({ item: t, index: e, isWarning: i = !1 }) => {
  const s = [];
  return es(t, "orientationLock", ["l", "w"], e, i, s), s;
}, ko = ({ item: t, index: e, isWarning: i = !1 }) => {
  const s = [];
  return es(t, "grain", ["l", "w"], e, i, s), s;
}, Io = ({ item: t, index: e, isWarning: i = !1 }) => {
  const s = [], n = L(t, "banding");
  return n != null && (typeof n != "object" || n === null) && new y({
    item: t,
    message: K("errors.validation.must_be_object", { 0: "banding" }),
    shouldTranslate: !1,
    field: [["banding"]],
    index: [e],
...
}, Po = ({ item: t, index: e, isWarning: i = !1, category: s = [] }) => {
  const n = [], o = L(t, "customData");
  if (o == null) return n;
  if (typeof o != "object" || o === null)
    return new y({
      item: t,
      message: K("errors.validation.must_be_object", {
        0: $e.customData
      }),
      shouldTranslate: !1,
      field: [["customData"]],
  ...
  for (const [, r] of Object.entries(o))
    if (r != null) {
      const a = typeof r;
      ["string", "number", "boolean"].includes(a) || new y({
        item: t,
        message: K("errors.validation.must_be_string_number_boolean", {
          0: $e.customData
        }),
        shouldTranslate: !1,
        field: [["customData"]],
...
}, Do = ({ item: t, index: e, max: i, isWarning: s = !1, category: n = [] }) => {
  const o = [], r = L(t, "x");
  return r === null || r === "" || r === void 0 || i != null && I({ v: r }) > i && new y({
    item: t,
...
}, Oo = ({ item: t, index: e, max: i, isWarning: s = !1, category: n = [] }) => {
  const o = [], r = L(t, "y");
  return r === null || r === "" || r === void 0 || i != null && I({ v: r }) > i && new y({
    item: t,
    message: "errors.validation.less_than_or_equal",
  ...
  const o = [], r = L(t, "l");
  return L(t, "infiniteLength") || (r === null || r === "" || r === void 0 || r === 0) && new y({
    item: t,
...
}, Co = ({ item: t, index: e, max: i, isWarning: s = !1, category: n = [] }) => {
  const o = [], r = L(t, "w");
  return (r === null || r === "" || r === void 0) && new y({
    item: t,
    message: "errors.validation.not_set",
    params: {
      0: $("w", { returnKey: !0 }),
...
}, Fo = ({ item: t, index: e, max: i, isWarning: s = !1, saw: n, category: o = [] }) => {
  const r = [], a = L(t, "t");
  return n?.cutType === "beam" && !a && new y({
    item: t,
...
}, Eo = ({ item: t, index: e, isWarning: i = !1, category: s = [] }) => {
...
const _o = ({
  ...
  return i.forEach((r, a) => {
    !(typeof r.isSquare == "function", r.isSquare) && !["l", "w"].includes(r.orientationLock) && new y({
      item: t,
      message: K("errors.groups.part_needs_orientation_lock", { 0: a + 1 }),
      shouldTranslate: !1,
  ...
  return i.slice(1).forEach((c, f) => {
    ...
    T.equalTo(d, l) || new y({
      item: t,
      message: K("errors.groups.dimension_not_correct", {
        0: f + 2,
        1: s === "l" ? "length" : "width",
        2: l,
        3: d
  ...
  for (let l = 0; l < s.length; l++)
    for (let c = l + 1; c < s.length; c++) {
      const f = s[l], d = s[c], b = (H) => i.find((Z) => Z.autoId === H) ?? i.find((Z) => typeof Z.getBaseAutoId == "function" && Z.getBaseAutoId() === H), m = b(f.autoId), v = b(d.autoId);
      if (!m || !v) continue;
      const x = m.trimmedDimensions || { l: m.l, w: m.w }, E = v.trimmedDimensions || { l: v.l, w: v.w }, g = { x: f.x, y: f.y, l: x.l, w: x.w }, A = { x: d.x, y: d.y, l: E.l, w: E.w };
      Lo(g, A, n) && new y({
        item: t,
        message: K("errors.groups.shapes_overlap", { 0: l + 1, 1: c + 1 }),
        shouldTranslate: !1,
        index: [e],
  ...
  return s > n && new y({
    item: t,
    message: K("errors.groups.not_enough_of_part", {
      0: o || (r ?? 0) + 1,
      1: s,
      2: n
    }),
...
}, N = (t, e, i) => e in t ? t[e] : (console.warn(Mt.missingProperty(String(e), i)), null), Je = (t, e) => (i, s) => {
  const n = t(i, s);
  return n !== 0 ? n : e(i, s);
}, Ee = (t, e) => {
  if (ot(t) && ot(e))
...
const It = {
  ...
  aspect(t, e) {
    if (ot(t) && ot(e) && t.aspect && e.aspect)
      return e.aspect - t.aspect;
    if (!("l" in t) || !("w" in t) || !("l" in e) || !("w" in e))
      return console.warn(Mt.missingAspect), 0;
  ...
  fillThenArea(t) {
    return (e, i) => !("l" in e) || !("w" in e) || !("l" in i) || !("w" in i) ? (console.warn(Mt.missingLongSide), 0) : i[t] === e[t] ? -Ee(e, i) : parseFloat(String(i[t])) - parseFloat(String(e[t]));
  },
  // Utility functions
  getLargest: zo,
  getSmallest: Bo
...
function Wo(t, e, i) {
  return i ? !ue(t.t) || !ue(e.t) ? !1 : T.equalTo(I({ v: t.t }), I({ v: e.t })) : !0;
}
function Ho(t, e, i) {
  return i?.stockType !== "linear" || !Ji(t) && !W(t) ? !0 : Lt(t, 0, e) && T.equalTo(I({ v: t.w }), I({ v: e.w })) || Lt(t, 1, e) && T.equalTo(I({ v: t.l }), I({ v: e.w }));
}
function Uo(t, e, i, s = 0) {
  const n = W(t[0]), o = i.stockType;
  if (t.some((g) => ue(g.stockLock) && g.stockLock.length))
    return { stockList: e, shapeList: t, unusableShapes: [], unusableStock: [], newIssues: [] };
  e = e.filter((g) => n || g.autoAdd === !0 || ue(g.q) && Number(g.q) > 0);
  const a = e.some((g) => ue(g.material)), l = e.some((g) => ue(g.t)), c = /* @__PURE__ */ new Set(), f = /* @__PURE__ */ new Set(), d = /* @__PURE__ */ new Set(), b = /* @__PURE__ */ new Set(), m = [];
  let v = s;
  for (const g of t) {
    const A = e.map((R, Pe) => {
      const oi = Vo(g) && pt(g, R), ai = jo(g, R, a), li = Wo(g, R, l), ci = Ho(g, R, i);
      return {
        stockItem: R,
        stockIndex: Pe,
        fit: oi,
        ...
        satisfiesAll: oi && ai && li && (o !== "linear" || ci)
      };
    });
    g.stockMatch = {
      fit: A.some((R) => R.fit),
      material: !a || A.some((R) => R.material),
      thickness: !l || A.some((R) => R.thickness),
      width: o !== "linear" || A.some((R) => R.width)
    };
    const H = A.filter((R) => R.satisfiesAll), Z = H.length > 0;
    if (!n && Z) {
      const R = H.map((Pe) => Pe.stockItem.parentId);
      g.stockLock = R, R.forEach((Pe) => c.add(Pe));
    }
    g.stockMatch.fit ? Z || (a && !g.stockMatch.material && (b.add(g), m.push(new y({
      category: ["part", "stock"],
      item: g,
      field: [["material"]],
      index: [v],
      message: "errors.validation.no_matching_stock_material"
    }))), l && !g.stockMatch.thickness && (b.add(g), m.push(new y({
      category: ["part", "stock"],
      item: g,
      field: [["t"]],
      index: [v],
      message: "errors.validation.no_matching_stock_thickness"
    }))), o === "linear" && !g.stockMatch.width && (d.add(g), m.push(new y({
      category: ["part", "stock"],
      item: g,
      field: [["w"]],
      index: [v],
      message: "errors.validation.no_matching_stock_width"
    }))), g.stockMatch.material && g.stockMatch.thickness && (o !== "linear" || g.stockMatch.width) && (b.add(g), m.push(new y({
      category: ["part", "stock"],
      item: g,
      field: [["material"], ["t"]],
      index: [v],
      message: "errors.validation.no_stock_matches_all_requirements"
    })))) : (f.add(g), m.push(new y({
      category: ["part", "stock"],
      item: g,
      field: [["l"], ["w"]],
      index: [v],
  ...
  let x, E;
  return n ? (x = t.filter((g) => f.has(g) || d.has(g) || b.has(g)).sort(It.ID), E = []) : (x = t.filter((g) => f.has(g) || d.has(g) || b.has(g) || !g.stockLock || !g.stockLock.length).sort(It.ID), E = e.filter((g) => !c.has(g.parentId)).sort(It.ID), e = e.filter((g) => de(g)).filter((g) => c.has(g.parentId)), t = t.filter((g) => !f.has(g) && !d.has(g) && !b.has(g) && g?.stockLock?.length)), {
    stockList: e,
    unusableStock: E,
    shapeList: t,
    unusableShapes: x,
...
const Ko = ({
  ...
  return !a || !l || !c || ("applyPartTrim" in t && typeof t.applyPartTrim == "function" && t.applyPartTrim(s, r), qo(t)) || Uo([t], e, i, n).newIssues.forEach((d) => {
    o.push(d);
  }), o;
}, Yo = ({
  item: t,
...
class at extends ti {
  ...
  validateStock(e) {
    ...
    const i = [];
    if (!e.autoAdd) {
      const n = V.q({ item: e, index: e?.index });
      i.push(...n);
    }
    const s = V.grain({ item: e, index: e?.index });
  ...
  getCroppedLength(e = [], i = 0) {
    if (!e?.length) return;
    const s = xo(e.filter((o) => o.added && o.stock.id === this.id), "x"), n = s.x + s.l;
...
class G extends C {
  ...
  validate(e) {
    ...
    if (oe(this.planing) && re(this.finish) && e?.t) {
      const s = this.planing.getTotalFacePlaning();
      s > 0 && e.t - s < 5 && i.push(new y({
  ...
  getTotalCost(e) {
    let i = 0;
    return pe(this.banding) && (i += this.banding.getCost(e)), re(this.finish) && (i += this.finish.getCost(e)), oe(this.planing) && (i += this.planing.getCost(e)), i;
  }
  /**
  ...
  getDescription() {
    const e = [];
    return pe(this.banding) && this.banding.hasValues() && e.push(this.banding.getDescription()), re(this.finish) && this.finish.hasValues() && e.push(this.finish.getDescription()), oe(this.planing) && this.planing.hasValues() && e.push(this.planing.getDescription()), e.length > 0 ? e.join("; ") : "No extras";
  }
  /**
   * Check if any extras are applied
   */
  hasExtras() {
    return !!(pe(this.banding) && this.banding.hasValues() || re(this.finish) && this.finish.hasValues() || oe(this.planing) && this.planing.hasValues());
  }
  /**
   * Clear all extras
   */
  clear() {
    pe(this.banding) && this.banding.clear(), re(this.finish) && this.finish.clear(), oe(this.planing) && this.planing.clear();
  }
  /**
   ...
   */
  setBanding(e) {
    e ? e instanceof Ge ? this.banding = e : this.banding = new Ge(e) : this.banding = void 0;
  }
  /**
   * Set finish
   */
   ...
   */
  isApplicable(e) {
    return !!(pe(this.banding) && this.banding.isApplicable(e) || re(this.finish) && this.finish.isApplicable(e) || oe(this.planing) && this.planing.isApplicable(e));
  }
  /**
  ...
  getSummary() {
    return {
      hasBanding: pe(this.banding) && this.banding.hasValues() || !1,
      hasFinish: re(this.finish) && this.finish.hasValues() || !1,
      hasPlaning: oe(this.planing) && this.planing.hasValues() || !1,
  ...
  static hasBanding(e) {
    ...
    if (!i) return !1;
    const s = i.banding;
    return s ? pe(s) && typeof s.hasValues == "function" ? s.hasValues() : s.sides && typeof s.sides == "object" ? Object.keys(s.sides).some((n) => {
      const o = s.sides[n];
  ...
  static hasFinish(e) {
    ...
    if (!i) return !1;
    const s = i.finish;
    return s ? re(s) && typeof s.hasValues == "function" ? s.hasValues() : s.faces && typeof s.faces == "object" ? Object.keys(s.faces).some((n) => {
      const o = s.faces[n];
      return o !== void 0 && o !== !1 && o !== "";
    }) : !1 : !1;
  }
  ...
  static hasPlaning(e) {
    ...
    if (!i) return !1;
    const s = i.planing;
    return s ? oe(s) && typeof s.hasValues == "function" ? s.hasValues() : s.sides && typeof s.sides == "object" && Object.keys(s.sides).some((o) => {
      const r = s.sides[o];
  ...
  static hasImageUpload(e) {
    ...
    return s ? xn(s) && typeof s.hasValues == "function" ? s.hasValues() : s.images && Array.isArray(s.images) ? s.images.length > 0 : !1 : !1;
  }
  /**
...
function Xo(t) {
  ...
  const b = a === "count" ? `this part has ${n}` : `this part is ${n} mm`;
  return `${d} must be ${c} ${s}${l} (${b})`;
}
function ja(t, e) {
...
}, Qo = /* @__PURE__ */ new Set(["holes", "corners", "hingeHoles"]);
function ea(t) {
  return Jo[t] ?? String(t);
}
function ta(t) {
  return Qo.has(t);
}
const _t = ye, Pt = J, ia = {
...
}, qa = (t, e = 0, i = !1) => t.startsWith("face.") ? `faces.${t.replace(/^face\./, "")}` : ra(t, e, i), Ka = (t, e) => {
...
}, oa = (t) => Is(t), cs = (t) => ne(t).scope.includes("faces"), us = (t) => ne(t).scope.includes("sides"), Ya = (t) => {
  const e = ne(t);
  ...
  const s = i.extras[e];
  cs(e) && (s.faces || (s.faces = {})), us(e) && (s.sides || (s.sides = {}));
}, ca = (t, e, i) => {
  la(t, e);
  const n = t.extras[e], { scope: o } = Ie(i);
  return o === "face" ? {
  ...
  if (he(e))
    switch (ya(e)) {
      ...
      case "object":
        {
          let c = yt(t, e, i) || {};
          typeof c != "object" && (c = {}), c[s] = n, Tt(t, e, i, c);
        }
        break;
    }
}, da = (t, e, i, s) => {
  ...
  if (r && o?.length)
    if (typeof r == "object" && !Array.isArray(r)) {
      ...
      for (const f of o) {
        ...
        if (d === !0) {
          const b = he(e), m = b?.labels.indexOf(f) ?? -1, v = m !== -1 && b?.options[m], x = v?.length === 1 ? v[0] : f;
          a.push(x);
          continue;
        }
        a.push(String(d));
  ...
  r.options || (r.options = {});
  const a = r.options;
  if (cs(e) && (r.faces || (r.faces = {}), a.faces || (a.faces = {})), us(e) && (r.sides || (r.sides = {}), a.sides || (a.sides = {})), s) {
    if (n.faces && r.faces) {
  ...
  const o = aa(i, n);
  fa(t, e, o === "boolean" ? [] : s, o === "boolean");
}, ha = (t) => t ? typeof t == "string" ? t.includes("|") ? t.split("|") : [t] : typeof t == "boolean" ? t ? ["true"] : [] : typeof t == "object" && !Array.isArray(t) && t !== null ? Object.values(t).filter((e) => e != null && e !== "" && e !== !1).map((e) => String(e)) : [String(t)] : [], ol = (t, e) => new Set(Object.keys(t || {})), pa = (t, e) => {
  const { extraType: i, pricing: s, codes: n, findExtrasPrice: o } = e, r = Object.keys(s || {}), a = r.length ? Math.max(...r.map((A) => A.split("|").length)) : 0, l = ha(t), c = l.length, f = { parts: l, selectedLevels: c, maxPricingLevels: a, missingLevels: 0, matchingKeyCount: 0, hasValidPrice: !1 };
  if (c === 0) return { ...f, status: "empty" };
  if (n) {
    const A = new Set(Object.values(n));
    if (c === 1 && A.has(l[0]))
      return { ...f, status: "complete", hasValidPrice: !0 };
  }
  if (a <= 1) return { ...f, status: "complete", hasValidPrice: !0 };
  const d = l.filter((A) => A.trim() !== ""), b = d.join("|");
  let m = !1;
  if (o)
    try {
      const A = o(i, d);
  ...
  if (c < a) {
    const A = l.join("|");
    v = r.filter((H) => H === A || H.startsWith(A + "|")).length, v === 1 && (x = !0);
  }
  if (!(!m && !x))
    return { ...f, status: "complete", matchingKeyCount: v, hasValidPrice: m };
  const g = c < a && v > 1;
  return {
    ...f,
  ...
  const o = [], r = [], a = na(e), l = Object.keys(i), c = Math.max(...l.map((d) => d.split("|").length));
  if (c <= 1)
    return { valid: !0, messages: [], incompleteLocations: [] };
  for (const d of a) {
    const { extraContainer: b } = ca(t, e, d), { key: m } = Ie(d), v = b[m];
    if (!v)
      continue;
    const x = pa(v, {
      extraType: e,
    ...
    if (x.status === "empty" || x.status === "complete")
      continue;
    const { parts: E, selectedLevels: g, hasValidPrice: A } = x, H = x.status === "incomplete";
    let Z = "";
    if (H) {
      const R = x.missingLevels, Pe = E.join(", ");
      Z = `${e} selection incomplete for ${d}. Selected: "${Pe}" but ${R} more level${R > 1 ? "s" : ""} required.`;
    } else g >= c && (Z = `${e} selection invalid for ${d}. No pricing available for "${E.join(", ")}".`);
    g > 0 && !A && (r.push(d), o.push(Z || `${e} pricing incomplete for ${d}: ${g}/${c} levels selected`));
  }
  return { valid: r.length === 0, messages: o, incompleteLocations: r };
}, ll = (t, e, i) => !i || !i[e] ? { valid: !0, violations: [] } : ma(t, i[e]), ma = (t, e) => {
  if (!e)
  ...
  dimensionName: ea(t.dimension),
  constraint: t.constraint,
  limit: t.limit,
  value: t.value,
  subject: e,
  kind: ta(t.dimension) ? "count" : "length"
}), cl = (t) => ds(t), ul = (t, e, i) => ds(e, oa(t));
function dl(t, e = "banding") {
  const i = t.extras?.[e];
  if (!i?.sides) return;
  const s = i.sides, n = s.l1, o = s.l2, r = s.w1, a = s.w2;
  s.l1 = r, s.l2 = a, s.w1 = n, s.w2 = o;
}
const fl = (t) => ["all", "faces", "sides"].includes(t) ? !1 : !t.includes(".");
let Rt = null;
const hl = (t) => {
  Rt = t;
}, he = (t) => Rt ? Rt.getExtrasConfig(t) : null, Tt = (t, e, i, s) => {
  t.extras || (t.extras = {}), t.extras[e] || (t.extras[e] = { sides: {}, faces: {} });
  const { scope: n, key: o } = Ie(i), r = n === "face" ? t.extras[e].faces : t.extras[e].sides;
  r[o] = s;
}, yt = (t, e, i) => {
  const { scope: s, key: n } = Ie(i);
  return (s === "face" ? t.extras?.[e]?.faces : t.extras?.[e]?.sides)?.[n] ?? null;
}, ga = (t, e, i) => {
  const { scope: s, key: n } = Ie(i), o = s === "face" ? t.extras?.[e]?.faces : t.extras?.[e]?.sides;
  o && n in o && delete o[n];
}, ya = (t) => {
  const e = he(t);
...
class De extends C {
  ...
  validate(e, i) {
    const s = [];
    if (this.type && this.size !== null && this.size <= 0 && s.push(new y({
      message: "Size must be positive",
      type: "error",
      field: [["size"]]
    })), (this.index < 0 || this.index > 3) && s.push(new y({
      ...
      if (e) {
        ...
        Number.isFinite(f) && o > f / 2 && s.push(new y({
          message: `Size cannot exceed half of the shortest side (${f / 2})`,
          type: "error",
          field: [["size"]]
        }));
      }
      const r = ee(i?.size?.min), a = ee(i?.size?.max);
      r !== void 0 && o < r && s.push(new y({
        message: `Size must be at least ${r}`,
        type: "error",
        field: [["size"]]
      })), a !== void 0 && o > a && s.push(new y({
   ...
   */
  static radius(e, i) {
    return new De({ type: "radius", size: e, index: i });
  }
  /**
   * Create a bevel corner
   */
  static bevel(e, i) {
    return new De({ type: "bevel", size: e, index: i });
  }
}
class ct extends C {
  static schema = ir;
...
class xe extends C {
  ...
  validate(e, i) {
    ...
    if ((this.x < 0 || this.y < 0) && s.push(new y({
      message: "Position cannot be negative",
      type: "error",
      field: [["x"], ["y"]]
    })), this.diameter <= 0 && s.push(new y({
      message: "Diameter must be positive",
      type: "error",
      field: [["diameter"]]
    })), this.depth !== void 0 && this.depth < 0 && s.push(new y({
      ...
      if (this.isEdgeHole()) {
        ...
        f > 0 && (c - n < 0 || c + n > f) && s.push(new y({
          message: "Edge hole extends beyond the edge",
          type: "error",
          field: [l ? ["x"] : ["y"]]
        })), d > 0 && this.depth !== void 0 && this.depth > d && s.push(new y({
          message: "Edge hole depth exceeds the part",
          type: "error",
          field: [["depth"]]
        }));
      } else
        o > 0 && (this.x - n < 0 || this.x + n > o) && s.push(new y({
          message: "Hole extends beyond the part length",
          type: "error",
          field: [["x"]]
        })), r > 0 && (this.y - n < 0 || this.y + n > r) && s.push(new y({
          message: "Hole extends beyond the part width",
          type: "error",
          field: [["y"]]
        })), a > 0 && this.depth !== void 0 && this.depth > a && s.push(new y({
    ...
    if (i) {
      const o = ee(i.diameter?.min), r = ee(i.diameter?.max);
      if (o !== void 0 && this.diameter < o && s.push(new y({
        message: `Diameter must be at least ${o}`,
        type: "error",
        field: [["diameter"]]
      })), r !== void 0 && this.diameter > r && s.push(new y({
        message: `Diameter must be at most ${r}`,
        type: "error",
        field: [["diameter"]]
      })), this.depth !== void 0) {
        const a = ee(i.depth?.min), l = ee(i.depth?.max);
        a !== void 0 && this.depth < a && s.push(new y({
          message: `Depth must be at least ${a}`,
          type: "error",
          field: [["depth"]]
        })), l !== void 0 && this.depth > l && s.push(new y({
  ...
  static fromCoordinates(e, i, s, n = 0) {
    return new xe({ x: e, y: i, diameter: s, face: n });
  }
  /**
    * Create from plain data (for deserialization)
    */
...
class Re extends C {
  ...
  validate(e, i) {
    ...
    if (this.position < 0 && s.push(new y({
      ...
      type: "error",
      field: [["diameter"]]
    })), this.hingeLength <= 0 && s.push(new y({
      ...
      this.diameter * this.numHoles > a && s.push(new y({
        message: "Holes do not fit within hinge length",
        type: "error",
        field: [["hingeLength"], ["outerSpacing"]]
      }));
    }
    const n = ee(i?.holeDistance?.min) ?? this.minimumHoleDistance;
    n !== void 0 && this.numHoles > 1 && (this.hingeLength - 2 * this.outerSpacing) / (this.numHoles - 1) < n && s.push(new y({
    ...
    if (o !== void 0 && this.diameter < o && s.push(new y({
      ...
      const a = e.longSide ?? e.l ?? 0, l = e.shortSide ?? e.w ?? 0, c = e.t ?? 0, f = this.side === "l1" || this.side === "l2", d = f ? a : l, b = f ? l : a, m = this.diameter / 2;
      b > 0 && (this.distanceFromEdge - m < 0 || this.distanceFromEdge + m > b) && s.push(new y({
        message: "Distance from edge places holes off the part",
        type: "error",
        field: [["distanceFromEdge"]]
      }));
      const v = this.position + this.outerSpacing, x = this.position + this.hingeLength - this.outerSpacing;
      d > 0 && (v - m < 0 || x + m > d) && s.push(new y({
        message: "Hinge holes extend beyond the edge",
        type: "error",
        field: [["position"], ["hingeLength"]]
      })), c > 0 && this.depth !== void 0 && this.depth > c && s.push(new y({
        message: "Hole depth exceeds material thickness",
        type: "error",
        field: [["depth"]]
      }));
  ...
  createHoles(e) {
    ...
    return this.generateHoles(i, s).map((o) => new xe(o));
  }
  /**
...
class ba extends C {
  ...
  /**
    ...
    */
  validate() {
    return this.issues = [], this.warnings = [], this.bladeWidth < 0 && this.issues.push(new y({
...
function ki(t, e) {
  ...
  return i.success ? [] : ze(i.error);
}
const fs = {
  clearValidation: ut,
  addIssue: Ne,
  validateWithSchema: ki,
  zodErrorsToIssues: ze,
  /**
   * Run standard validation flow
   */
  runValidation(t, e = {}) {
    return ut.call(this), e.skipSchemaValidation || ki(t, this).forEach((s) => Ne.call(this, s)), this.issues || [];
  }
};
class pl extends C {
  // Required: Define schema and computed properties for SchemaClass
  ...
  constructor(e = {}) {
    super(e);
    const i = Ct(this.stockType);
    i.includes(this.cutType) || (this.cutType = i.length > 0 ? i[0] : void 0);
    const s = Ft(this.stockType, this.cutType);
   ...
   */
  validate(e) {
    if (ut.call(this), e?.skipSchemaValidation || fs.runValidation.call(
      this,
      gi,
      e
      ...
      if (this.bladeWidth !== void 0 && this.bladeWidth !== null) {
        ...
        i === null || isNaN(i) || i < 0 ? Ne.call(this, new y({
          message: "Blade width must be a non-negative number",
          type: "error",
          field: [["bladeWidth"]]
        })) : i > 100 && Ne.call(this, new y({
          message: "Blade width seems unusually large (> 100)",
          type: "warning",
          field: [["bladeWidth"]]
        }));
      }
      this.stackHeight !== void 0 && this.stackHeight !== null && (this.stackHeight < 1 ? Ne.call(this, new y({
        message: "Stack height must be at least 1",
        type: "error",
        field: [["stackHeight"]]
      })) : this.stackHeight > 1e3 && Ne.call(this, new y({
...
class dt extends C {
  ...
  /**
    ...
    */
  addHole(e) {
    this.holes.push(e instanceof xe ? e : new xe(e)), this.validate();
  }
  /**
  ...
  /**
    ...
    */
  addHingeHole(e) {
    this.hingeHoles.push(e instanceof Re ? e : new Re(e)), this.validate();
  }
  /**
  ...
  /**
    ...
    */
  setCorner(e) {
    const i = e instanceof De ? e : new De(e);
  ...
  /**
    ...
    */
  addGroove(e) {
    this.grooves.push(e instanceof ct ? e : new ct(e)), this.validate();
  }
  /**
  ...
  getAllHingeHoles(e) {
    ...
    return this.hingeHoles.forEach((o) => {
      (o instanceof Re ? o : new Re(o)).generateHoles(i, s).forEach((a) => n.push(new xe(a)));
    }), n;
  }
  /**
    * Clear all machining
  ...
  getNumCorners() {
    return (this.corners || []).filter(
      (e) => e instanceof De ? e.isPresent() : !!e.type && e.size !== null && (e.size ?? 0) > 0
    ).length;
  }
  /**
...
function ka(t, e, i, s = !1) {
  const n = s ? Object.fromEntries(Oe.map((a) => [a, 0])) : { l1: 0, l2: 0, w1: 0, w2: 0 };
  if (!t) return n;
...
class hs extends C {
  ...
  constructor(e = {}, i = "decimal") {
    ...
    for (const r of o)
      s[r] === null || s[r] === void 0 ? delete s[r] : s[r] !== void 0 && (s[r] = va(s[r], i, n), s[r] === null && delete s[r]);
    s.name?.length ? s.name = Ps(s.name)?.toUpperCase() : s.name = "", s.material ? s.material = s.material.trim().toUpperCase() : s.material = "", typeof s.notes == "string" ? s.notes = s.notes.replace(/,/g, " ") : s.notes = "", s.trim && (s.trim = ka(s.trim, i, n, !0)), super(s), this.issues || (this.issues = []), this.warnings || (this.warnings = []);
  }
  /**
   * Get entity type
   */
   ...
   */
  validate(e) {
    return ut.call(this), e?.skipSchemaValidation || fs.runValidation.call(
      this,
      nt,
      e
    ), this.issues;
...
class ml extends hs {
  ...
  validate(e = {}) {
    ...
    if (e?.fields && Array.isArray(e.fields)) {
      ...
      for (let m = this.issues.length - 1; m >= 0; m--)
        this.issues[m].field.some((v) => c.includes(v[0])) && this.issues.splice(m, 1);
      for (let m = this.warnings.length - 1; m >= 0; m--)
        this.warnings[m].field.some((v) => c.includes(v[0])) && this.warnings.splice(m, 1);
      const f = e.fields.reduce((m, v) => {
        const x = v.split(".")[0];
        return m[x] = !0, m;
      }, {}), b = St.pick(f).safeParse(this.toData());
      if (!b.success) {
        const m = ze(b.error);
        this.issues.push(...m);
      }
      ...
      const c = St.safeParse(this.toData());
      if (!c.success) {
        const f = ze(c.error);
        this.issues.push(...f);
      }
    ...
    a("l") && V.l({
      ...
      index: r,
      category: ["part"]
    }), !n && i.length > 0, a("customData") && V.customData({
      item: this,
      index: r
    });
    const l = [];
  ...
  toShape(e) {
    ...
    return this.isSquare && (i.orientationLock = null), new gt(i);
  }
  changeStockType(e) {
    switch (e) {
      case "sheet":
...
class gl extends hs {
  ...
  validate(e, i) {
    ...
    if (e?.fields && Array.isArray(e.fields)) {
      const f = e.fields;
      for (let m = this.issues.length - 1; m >= 0; m--)
        this.issues[m].field.some((x) => f.includes(x[0])) && this.issues.splice(m, 1);
      for (let m = this.warnings.length - 1; m >= 0; m--)
        this.warnings[m].field.some((x) => f.includes(x[0])) && this.warnings.splice(m, 1);
      const d = this.toData();
      ...
      const b = e.fields.reduce((m, v) => {
        const x = v.split(".")[0];
        return m[x] = !0, m;
      }, {});
      try {
        const m = xt.pick(b);
        console.log("[InputStock.validate] Created partial schema for fields:", Object.keys(b));
        const v = m.safeParse(d);
      ...
      const f = xt.safeParse(this.toData());
      if (!f.success) {
        const d = ze(f.error);
        this.issues = d;
      }
  ...
  toStock(e, i) {
    ...
    return (i || this.saw) && (o.saw = i || this.saw), new at(o);
  }
  changeType(e) {
...
function Ia(t, e = 0) {
  ...
  for (const d of n)
    for (const b of n)
      d.autoId !== b.autoId && (Math.abs(d.x + d.l - b.x) < Ii && o.add(d.x + d.l), Math.abs(d.y + d.w - b.y) < Ii && r.add(d.y + d.w));
  const a = [...o].sort((d, b) => d - b), l = [...r].sort((d, b) => d - b);
  e > 0 && (a.length || l.length) && (n = n.map((d) => ({
    ...d,
    x: d.x + a.filter((b) => d.x >= b).length * e,
    y: d.y + l.filter((b) => d.y >= b).length * e
  })));
  let c = 0, f = 0;
  for (const d of n)
...
class yl extends C {
  ...
  validateInputUserGroup(e) {
    ...
    this.clearValidation(), e.q !== void 0 && V.q({ item: e, index: "index" in e && typeof e.index == "number" ? e.index : 0 }).filter((s) => s).forEach((s) => this.addIssue(s));
  }
  /**
  ...
  validateWithShapes(e = []) {
    ...
    const i = [...this.issues], s = this.findShapes(e), n = V.groupShapeCount({
      item: this,
      index: 0,
      shapes: s,
      requiredCount: 2
  ...
  findShapes(e) {
    if (this.shapeIds?.length && e.length) {
      ...
      for (const n of this.shapeIds) {
        const o = e.find((r) => "group" in r && r.group?.inUserGroup || s.includes(r) ? !1 : r.autoId === n || r.getBaseAutoId() === n || "id" in r && r.id === n);
        o && (W(o) || q(o)) && s.push(o);
      }
      return s.length < this.shapeIds.length && this.addIssue(new y({
  ...
  toGroup(e, i, s, n) {
    ...
    if (Array.isArray(e) || (Array.isArray(s) ? e = s : e = []), e.length) {
      const x = e.filter((g) => W(g) || q(g)), E = this.validateWithShapes(x);
      if (E.filter((g) => g.type === "error").length > 0)
        throw new Error(`Cannot create Group: ${E[0].message}`);
    }
    const r = this.findShapes(e || []);
    if (r.length === 0)
      throw new Error("No shapes found for Group creation");
    const a = r.map((x) => W(x) ? x.toShape() : x), l = a[0];
    a.forEach((x) => {
      if (e && Array.isArray(e)) {
        const E = e.findIndex((g) => "group" in g && g.group?.inUserGroup ? !1 : "parentId" in g && "parentId" in x && g.parentId === x.parentId || "id" in g && "id" in x && g.id === x.id);
        E !== -1 && e.splice(E, 1);
      }
      "group" in x && x.group && (x.group.inUserGroup = !0);
    });
    let c = this.positions?.length ? this.positions.map((x) => {
      const E = r.find((A) => A.autoId === x.autoId) ?? r.find((A) => A.getBaseAutoId() === x.autoId), g = E ? a[r.indexOf(E)] : a.find((A) => A.autoId === x.autoId);
      return {
        autoId: g?.autoId || x.autoId,
        x: x.x ?? 0,
        y: x.y ?? 0,
        rot: g?.rot ?? 0
      };
    ...
    if (c?.length) {
      const x = c.map((g) => {
        const A = a.find((H) => H.autoId === g.autoId);
        return {
          autoId: g.autoId,
          x: g.x,
          y: g.y,
      ...
      }), E = Ia(x, n?.bladeWidth ?? 0);
      c = E.positions, f = E.l, d = E.w;
    } else {
      const x = n?.bladeWidth ?? 0;
      let E = 0;
      for (const g of a)
        E += g.l + x, d = Math.max(d, g.w);
      f = E - x, f < 0 && (f = 0);
    }
    const b = c, m = {
    ...
    return n && "updateShapeSpacing" in v && typeof v.updateShapeSpacing == "function" && v.updateShapeSpacing(n), v;
  }
  /**
