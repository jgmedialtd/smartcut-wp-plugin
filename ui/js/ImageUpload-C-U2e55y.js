import { d as x, Y as $, r as U, h as D, L as O, b as o, o as d, e as _, j as u, i as f, u as R, g as A, F as B, q as V } from "./vendor-vue-CjllP6Mc.js";
import { _ as M } from "./Launch-D8mb8-9D.js";
const P = { id: "uploader" }, S = {
  ...
  emits: ["update", "remove"],
  setup(g, { emit: w }) {
    const F = A(() => import("./ObjectViewer-CQl5kqFl.js")), h = U(null), t = U({
      shapeId: "",
      files: [],
      previewUrls: [],
      metadata: []
