import { d as Ue, J as Ke, y as Xe, K as pe, k as W, l as Je, I as ge, z as Qe, r as Ze, o as g, c as v, a as L, u as T, m as te, b as y, t as F, g as E, j as ve, n as me, F as I, f as J, A as _e, w as et, B as fe, C as tt, s as q, x as Y, h as st, v as it, L as at } from "./vendor-vue-CeWGZ1lm.js";
import { h as C, M as Se, i as Q, u as be } from "./InputUserGroup-Cp-L9c2U.js";
import { c as xe, a as nt, h as lt, s as rt, g as ot, I as ht } from "./EcommerceCalculator-Cpt6HXtv.js";
import { t as c } from "./i18n-gSInbpCa.js";
...
class kt {
  ...
  createBanding() {
    ...
    [0, 1, 2, 3].forEach((u) => {
      ...
      switch (u) {
        case 0:
          if (!Q(a.sides.a) || a.sides.a === !1) return;
          D = {
            x: this.xScale(0) - n,
          ...
          break;
        case 1:
          if (!Q(a.sides.b) || a.sides.b === !1) return;
          D = {
          ...
          break;
        case 2:
          if (!Q(a.sides.c) || a.sides.c === !1) return;
          D = {
            x: this.xScale(this.shapeL) + n,
          ...
          break;
        case 3:
          if (!Q(a.sides.d) || a.sides.d === !1) return;
          D = {
            x: this.xScale(C({ v: S.size ?? 0, o: this })),
            y: this.getYScale()(this.shapeW) + (this.currentSide === 1 ? n : -n)
          }, H = {
...
const Dt = { class: "inputs" }, Lt = {
...
}, Et = { class: "grid-table" }, Mt = { class: "row table-heading" }, zt = {
  key: 0,
  class: "cell id"
}, Bt = {
  key: 0,
  ...
  setup(w, { emit: a }) {
    const n = tt(() => import("./ObjectViewer-C89c1lhH.js")), e = w, d = a, m = "production", p = q(), h = q(), { show: u, close: S, onToggle: D, onClosed: H, cleanup: k, isShown: $ } = nt(p), O = Y(() => lt(i.value)), se = Y(() => (e.customMachiningProducts?.length ?? 0) > 0), ie = Y(() => {
    ...
    }), M = Y(() => !l.value || l.value === "banding" ? null : ee[l.value]), U = Y(() => !l.value || l.value === "banding" ? [] : Object.keys(ee[l.value]).filter((t) => ee[l.value][t].enabled)), ae = Y(() => l.value ? Ge() : []), ke = Y(() => {
      ...
      return t + 1;
    }, ne = () => l.value !== "banding", Ye = (t) => l.value === "corners" || l.value === "holes" && t?.edge || t?.face === void 0 || t?.face === null ? !0 : t.face === z.value, V = (t, s = null) => {
      if (!t?.length) return [];
      let o = "None";
      s === "depth" && (o = "Through");
    ...
    const de = q(!1), ue = q(!1), _ = q(!1), z = q(0), l = q(null), G = q([]), ee = pe({
      holes: {
        x: {
          enabled: !0,
          type: "unitDependent",
    ...
    }, B = () => !(!i?.value?.machining || !de.value || _.value);
      ...
      return g(), v("dialog", {
        ...
        L("div", Dt, [
          ...
          l.value !== "banding" && ae.value.length ? (g(), v("div", {
            ...
            L("div", Mt, [
              ne() ? (g(), v("div", zt)) : y("", !0),
              (g(!0), v(I, null, J(M.value, (r, b) => st((g(), v("div", {
                key: b,
                class: "cell"
              }, F(r.label ?? b), 1)), [
                [it, r.enabled]
