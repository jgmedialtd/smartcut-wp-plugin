...
import { E as Ie, h as Ue, b as Ke } from "./EcommerceCalculator-Dh9Rp8oe.js";
...
const ct = { class: "inputs" }, ut = {
  ...
  setup(k, { emit: i }) {
    const n = Me(() => import("./ObjectViewer-D_txyYGU.js")), e = k, h = i, m = "production", d = P(), o = P(), c = z(() => Ue(s.value)), x = z(() => {
