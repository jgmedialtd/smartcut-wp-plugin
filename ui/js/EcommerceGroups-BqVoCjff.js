import { d as mt, k as O, H as A, r as ht, o as I, c as y, a as c, t as h, u as f, m as Y, i as P, b, n as j, F as ft, f as xt, s as D, x as E, g as z, w as q } from "./vendor-vue-DcIxm_xE.js";
import { s as U, l as L, d as gt } from "./vendor-d3-DI9vO-24.js";
import { b as Q, g as It, r as yt, I as _t } from "./InputUserGroup-BS7MVA1o.js";
import { a as wt, r as J, v as bt } from "./EcommerceCalculator-xTmaI3ss.js";
import { t as x } from "./i18n-BsG8Q9fA.js";
import { _ as kt } from "./Launch-CoGHL0vS.js";
const St = {
  id: "inputs-groups",
  ...
  setup(Z, { expose: tt, emit: et }) {
    const N = et, { inputs: i, inputSaw: Ht } = wt(), k = Z, a = D(null), _ = D(null), F = D(4), M = D([]), B = D(!1);
    ...
    function at() {
      ...
      const p = gt().on("start", function(t, l) {
        ...
        const g = m.invert(t.x) - r, w = v.invert(t.y) - u, d = $(g, w, l), V = U(this);
