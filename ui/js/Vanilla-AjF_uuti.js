import { N as Ke, s, k as Me, x as j, d as Ge, S as ze, l as Ye, o as K, c as be, m as Ne, u as se, j as Se, F as Ie, b as ue, a as Fe, t as Ue, h as Xe, v as Ze, C as ce, Q as et, I as ke, R as tt } from "./vendor-vue-CeWGZ1lm.js";
import { a0 as Re, a6 as at, a7 as u } from "./InputUserGroup-Cp-L9c2U.js";
import { q as Be, k as nt, t as rt, g as x, l as re, n as ot, p as Le } from "./EcommerceCalculator-Cpt6HXtv.js";
...
import { _ as ct } from "./Launch-_29Ox10h.js";
function we(h, p, P) {
  if (!h) return null;
...
function Tt(h) {
  ...
  const ve = j(() => f ? c.value.map((t) => ae.value.get(t)).filter((t) => t !== void 0) : p.value.filter((t) => Q(t)));
  function H() {
    c.value = [], ae.value.clear();
  }
  function me(t) {
    const e = p.value.find((a) => a.db_id === t) || U.value.find((a) => a.db_id === t);
    return e ? (H(), c.value.push(X(e)), ne(e, !0), e) : null;
  }
  function Ae(t) {
    const {
      colorHex: e,
...
const mt = {
  ...
  setup(h, { expose: p, emit: P }) {
    const w = ce(() => import("./Catalogue-BMz7GAbQ.js")), M = ce(() => import("./Configurator-BEyXPlRq.js")), y = ce(() => import("./ProductBrowser-YPmUyHbg.js")), m = ce(() => import("./Notices-BOibyVCW.js")), g = ce(() => import("./OrderLookup-CdhcpcML.js")), V = P, b = "production", W = "4.5.0", v = s(!1), c = s([]), f = s({
      banding: null,
      finish: null,
      planing: null,
      machining: null
...
}), bt = /* @__PURE__ */ ct(yt, [["__scopeId", "data-v-72da4f52"]]), At = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: bt }, Symbol.toStringTag, { value: "Module" }));
export {
  _t as S,
  At as V,
  X as g,
