...
}, ie = (r) => r == null ? "" : "" + r, Ce = (r, e, t) => {
  r.forEach((n) => {
    e[n] && (t[n] = e[n]);
  });
}, ke = /###/g, re = (r) => r && r.indexOf("###") > -1 ? r.replace(ke, ".") : r, ae = (r) => !r || c(r), z = (r, e, t) => {
...
const Ne = (r) => c(r) ? r.replace(/[&<>"'\/]/g, (e) => Pe[e]) : r;
class Ee {
  constructor(e) {
...
const Fe = [" ", ",", "?", "!", ";"], De = new Ee(20), je = (r, e, t) => {
  e = e || "", t = t || "";
  const n = Fe.filter((a) => e.indexOf(a) < 0 && t.indexOf(a) < 0);
  if (n.length === 0) return !0;
  const s = De.getRegExp(`(${n.map((a) => a === "?" ? "\\?" : a).join("|")})`);
  let i = !s.test(r);
  if (!i) {
    const a = r.indexOf(t);
  ...
  return s;
}, Y = (r) => r == null ? void 0 : r.replace("_", "-"), Ae = {
  type: "logger",
  log(r) {
    this.output("log", r);
  },
...
class G extends Z {
  ...
  extractFromKey(e, t) {
    ...
    const a = n && e.indexOf(n) > -1, l = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !je(e, n, s);
    if (a && !l) {
...
const ce = function(r, e, t) {
  let n = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : ".", s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !0, i = Re(r, e, t);
...
class Te {
  ...
  init() {
    ...
    this.escape = t !== void 0 ? t : Ne, this.escapeValue = n !== void 0 ? n : !0, this.useRawValueToEscape = s !== void 0 ? s : !1, this.prefix = i ? j(i) : a || "{{", this.suffix = l ? j(l) : o || "}}", this.formatSeparator = u || ",", this.unescapePrefix = d ? "" : h || "-", this.unescapeSuffix = this.unescapePrefix ? "" : d || "", this.nestingPrefix = f ? j(f) : m || j("$t("), this.nestingSuffix = g ? j(g) : p || j(")"), this.nestingOptionsSeparator = x || ",", this.maxReplaces = b || 1e3, this.alwaysFormat = w !== void 0 ? w : !1, this.resetRegExp();
  }
  reset() {
...
class Me extends Z {
  ...
  loaded(e, t, n) {
    ...
    this.queue.forEach((o) => {
      $e(o.loaded, [i], a), Ke(o, e), t && o.errors.push(t), o.pendingCount === 0 && !o.done && (Object.keys(o.loaded).forEach((u) => {
        l[u] || (l[u] = {});
        const d = o.loaded[u];
...
const xe = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/, We = function(r, e) {
  ...
  create(r, e, t, n) {
    ...
    t && (s.expires = /* @__PURE__ */ new Date(), s.expires.setTime(s.expires.getTime() + t * 60 * 1e3)), n && (s.domain = n), document.cookie = We(r, encodeURIComponent(e), s);
  },
  read(r) {
