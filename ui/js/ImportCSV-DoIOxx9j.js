import { m as ce, o as x, e as P, j as de, t as z, A as I, y as ue, d as fe, h as me, i as pe, u as K, f as he, g, c as Y } from "./vendor-vue-QD0FJS8o.js";
import { a6 as ge } from "./vendor-BnSUeZfc.js";
import { cC as M } from "./result.zod-B0BoTcpc.js";
import { _ as be } from "./Launch-NSW_K3VG.js";
import { a as ye } from "./EcommerceCalculator-ClNeqZHE.js";
import { t as c } from "./i18n-Dj6izb6_.js";
const ve = {
  name: "Drop",
  props: {
    requiredType: {
...
function we(f, p, d, o, v, b) {
  return x(), P("div", {
    ...
    onDrop: p[0] || (p[0] = I((...y) => b.onDrop && b.onDrop(...y), ["prevent"]))
  }, [
    de("div", null, z(d.thinking ? "Loading, please wait..." : d.label), 1)
  ], 34);
}
const ke = /* @__PURE__ */ be(ve, [["render", we]]), Ce = { id: "import-file" }, qe = /* @__PURE__ */ fe({
  __name: "ImportCSV",
  props: {
    numberFormat: {
      type: String,
  ...
  emits: ["error", "import"],
  setup(f, { emit: p }) {
    const { addNotice: d } = ye(), o = f, v = p, b = g([]), y = g([]), F = g([]), A = g([]), w = g({}), S = g([]), B = g(!1), $ = g(null), N = g(null), q = g({}), E = [
      "l",
      "w",
      "t",
      "q",
      ...
      if (Object.keys(q.value).length === b.value.length)
        return q.value;
      const e = {};
    ...
    }), G = Y(() => o.customFields.map((e) => e.label)), H = (e, t) => {
      ...
      if (n && a) {
        ...
        if (u) {
          ...
          m.forEach((k, C) => {
            if (k && k.trim() && h[C]) {
              const D = k.trim();
              if (D.includes("|") && o.bandingLabels.length > 1) {
                const L = D.split("|"), j = {};
      ...
      if (s && i) {
        ...
        if (u) {
          ...
          m.forEach((k, C) => {
            if (k && k.trim() && h[C]) {
              const D = k.trim();
              if (D.includes("|") && o.finishLabels.length > 1) {
                const L = D.split("|"), j = {};
      ...
      l: o.numberFormat === "decimal" ? M(e.l) : e.l,
      w: o.numberFormat === "decimal" ? M(e.w) : e.w,
      t: o.numberFormat === "decimal" ? M(e.t) : e.t,
...
`);
      ...
      for (let t = F.value.length; t--; ) {
        ...
        s ? w.value[t] = s : (w.value[t] = null, G.value.includes(n) && (w.value[t] = "customData." + o.customFields.find((a) => a.label === n).id));
      }
      ...
      B.value = !1, A.value = Object.values(w.value).map((t) => !t || t === "N" ? null : E.includes(t) ? t : (B.value = !0, null));
      const e = A.value.filter((t, n) => A.value.indexOf(t) !== n);
      S.value = e.map((t) => A.value.reduce(
    ...
    return me(() => {
      ...
      f.showTemplate ? (x(), P("a", {
        key: 0,
        href: "#",
        class: "template-download-link",
        onClick: I(ne, ["prevent"])
