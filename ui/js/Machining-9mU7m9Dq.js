...
import { b as Oe, h as je, _ as Ie } from "./EcommerceCalculator-CvSy71zh.js";
...
const ht = { class: "inputs" }, dt = {
  ...
  setup(A, { emit: s }) {
    const n = Ee(() => import("./ObjectViewer-DkGCIFpQ.js")), e = A, m = s, v = "production", h = P(), r = P(), d = z(() => je(i.value)), x = z(() => {
