import { d as L, v as O, r as U, o as $, m as D, a as o, b as d, e as _, f as u, g as f, u as R, h as A, F as B, k as V } from "./vendor-vue-BYiwvu61.js";
import { _ as M } from "./Launch-m3MPHA_z.js";
const P = { id: "uploader" }, S = {
  ...
  emits: ["update", "remove"],
  setup(g, { emit: w }) {
    const F = A(() => import("./EcommerceCalculator-rD4Yl4Hs.js").then((e) => e.O)), h = U(null), t = U({
      shapeId: "",
      files: [],
      previewUrls: [],
      metadata: []
