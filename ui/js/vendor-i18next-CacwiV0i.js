...
class _ extends Y {
  ...
  translate(e, t, s) {
    ...
    let h = g?.res;
    const m = g?.usedKey || o, y = g?.exactUsedKey || o, L = ["[object Number]", "[object Function]", "[object RegExp]"], x = i.joinArrays !== void 0 ? i.joinArrays : this.options.joinArrays, F = !this.i18nFormat || this.i18nFormat.handleAsObject, w = i.count !== void 0 && !d(i.count), R = _.hasDefaultValue(i), j = w ? this.pluralResolver.getSuffix(f, i.count, i) : "", D = i.ordinal && w ? this.pluralResolver.getSuffix(f, i.count, {
      ordinal: !1
    ...
    if (F && v && Ce && L.indexOf($e) < 0 && !(d(x) && Array.isArray(v))) {
      ...
      if (a) {
        const k = Array.isArray(v), O = k ? [] : {}, te = k ? y : m;
        for (const C in v)
    ...
    return d(e) && (e = [e]), e.forEach((l) => {
      ...
      f.forEach((y) => {
        this.isValidLookup(s) || (o = y, !ue[`${m[0]}-${y}`] && this.utils?.hasLoadedNamespace && !this.utils?.hasLoadedNamespace(o) && (ue[`${m[0]}-${y}`] = !0, this.logger.warn(`key "${i}" for languages "${m.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), m.forEach((L) => {
          ...
          let F;
          for (; F = x.pop(); )
            this.isValidLookup(s) || (n = F, s = this.getResource(L, y, F, t));
        }));
      });
    }), {
      res: s,
...
class Ue {
  ...
  getRule(e, t = {}) {
    const s = z(e === "dev" ? "en" : e), i = t.ordinal ? "ordinal" : "cardinal", n = JSON.stringify({
      cleanedCode: s,
      type: i
    });
...
class Me {
  ...
  interpolate(e, t, s, i) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {}, u = (g) => {
      ...
      return this.format(de(t, l, m, this.options.keySeparator, this.options.ignoreJSONStructure), y, s, {
        ...i,
        ...t,
        interpolationkey: m
      });
...
const He = (r) => {
  ...
  return (t, s, i) => {
    ...
    let o = e[a];
    return o || (o = r(z(s), i), e[a] = o), o(t);
  };
}, ze = (r) => (e, t, s) => r(z(t), s)(e);
class Be {
  constructor(e = {}) {
...
class H extends Y {
  ...
  cloneInstance(e = {}, t = J) {
    ...
    return n.translator = new _(n.services, i), n.translator.on("*", (o, ...l) => {
      n.emit(o, ...l);
...
function qe(r) {
  return Ye.call(_e.call(arguments, 1), (e) => {
    if (e)
      for (const t in e)
        r[t] === void 0 && (r[t] = e[t]);
  }), r;
