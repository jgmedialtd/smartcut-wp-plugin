import { F as U, b as B } from "./EcommerceCalculator-rD4Yl4Hs.js";
import { t as O } from "./i18n-BrgccvNc.js";
import { d as G, i as z, w as Q, r as m, c as w, o as W, a as p, b as o, e as j, f as h, g as X, u as b, h as Y, j as D, F as k, k as L, t as s, n as V } from "./vendor-vue-BYiwvu61.js";
const Z = {
  key: 0,
  class: "debug"
  ...
  setup(d, { emit: H }) {
    const R = Y(() => import("./EcommerceCalculator-rD4Yl4Hs.js").then((e) => e.O)), u = d, _ = H, K = z("calculator"), n = w(() => K()), A = m("production");
    let i = null;
