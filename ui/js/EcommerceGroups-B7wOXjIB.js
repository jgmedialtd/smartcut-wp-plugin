import { d as mt, w as M, n as X, L as ht, o as I, e as y, j as c, t as h, u as f, i as D, H as P, f as b, B as F, F as ft, C as xt, g as Y, c as R, y as W, A as V } from "./vendor-vue-QD0FJS8o.js";
import { i as U, l as z, m as gt } from "./vendor-d3-DC0ueG10.js";
import { cD as Q, cE as Z, aO as It, aP as yt, bZ as _t, b6 as wt } from "./result.zod-B0BoTcpc.js";
import { u as bt } from "./EcommerceCalculator-ClNeqZHE.js";
import { t as x } from "./i18n-Dj6izb6_.js";
import { _ as kt } from "./Launch-NSW_K3VG.js";
const St = {
  id: "inputs-groups",
  class: "ecommerce-groups"
}, Gt = { class: "groups-header" }, Ct = { class: "groups-title" }, At = { class: "groups-info" }, Xt = {
  key: 0,
  class: "menu groups"
}, Dt = { class: "row table-heading" }, Yt = { class: "cell" }, Ut = { class: "cell" }, Nt = ["onClick"], Ot = { class: "cell center" }, Mt = { class: "cell text clickable" }, Pt = { class: "number quantity cell" }, Bt = ["value", "onInput"], Tt = { class: "cell" }, jt = ["aria-label", "onClick"], Et = {
  key: 0,
  id: "groups-canvas"
}, Ft = {
  key: 1,
  ...
  class: "all issues"
}, Vt = 400, J = 300, B = 4, qt = /* @__PURE__ */ mt({
  ...
  setup(K, { expose: tt, emit: et }) {
    const N = et, { inputs: i, inputSaw: Ht } = bt(), k = K, a = Y(null), _ = Y(null), q = Y(4), O = Y([]), T = Y(!1);
    let S = null, m = null, v = null;
    const st = R(() => "34px auto 60px 30px"), G = R(() => a.value?.shapeIds?.length ? a.value.shapeIds.map((o) => {
    ...
    function C() {
      ...
      let p = Vt, t = p / u;
      t > J && (t = J, p = t * u), m = z().domain([e.minX - s, e.maxX + s]).range([B, p - B]), v = z().domain([e.minY - s, e.maxY + s]).range([t - B, B]), S = U("#groups-canvas").append("svg").attr("width", p).attr("height", t).attr("class", "group-canvas"), S.append("rect").attr("class", "group-background").attr("x", m(e.minX)).attr("y", v(e.maxY)).attr("width", m(e.maxX) - m(e.minX)).attr("height", v(e.minY) - v(e.maxY)), at();
    }
    function at() {
      ...
      const p = gt().on("start", function(t, l) {
        ...
        const g = m.invert(t.x) - r, w = v.invert(t.y) - u, d = $(g, w, l), E = U(this);
        E.select("rect.part-rect").attr("x", m(d.x)).attr("y", v(d.y + l.w)).classed("collision", !d.snapped).classed("valid", d.snapped), E.selectAll("text.dim-label").attr("x", () => m(d.x) + 2).attr(
          "y",
          ($t, vt) => vt === 0 ? v(d.y + l.w) + 10 : v(d.y) - 2
        ), E.select("text.part-index").attr("x", m(d.x + l.l / 2)).attr("y", v(d.y + l.w / 2) + 4);
      }).on("end", function(t, l) {
        U(this).attr("cursor", "grab");
        const g = m.invert(t.x) - r, w = v.invert(t.y) - u, d = $(g, w, l);
        d.snapped && (a.value.setShapePosition(l.autoId, d.x, d.y), l.x = d.x, l.y = d.y), X(() => C());
      });
      n.call(p);
    }
    function nt(o) {
    ...
    const ot = (o) => {
      ...
      j(), O.value = [], i.inputUserGroups.value.length = 0;
    }, j = () => {
      a.value = null, _.value = null, N("clear-highlight");
    }, L = () => {
      a.value && a.value.validate(i.inputShapes.value);
    }, A = () => {
      O.value = _t(i.inputUserGroups.value, i.inputShapes.value, !1);
    };
    M(() => i.inputShapes.value, () => {
      Q(i.inputUserGroups.value, i.inputShapes.value), A();
    }, { deep: !0 }), M(() => k.selectedShapeCounter, () => {
      it();
    }), M(() => a.value, () => {
      _.value = null, N("clear-highlight"), !T.value && (T.value = !0, L(), A(), X(() => {
        T.value = !1, C();
      }));
    }, { deep: !0 }), M(() => G.value, () => {
      a.value && (A(), L(), X(() => C()));
    }, { deep: !0 }), Q(i.inputUserGroups.value, i.inputShapes.value), A();
    const it = () => {
      ...
      i.inputUserGroups.value.push(new wt({})), a.value = i.inputUserGroups.value[i.inputUserGroups.value.length - 1];
    }, dt = (o) => {
      if (o > -1 && a.value) {
        ...
        _.value = null, N("clear-highlight"), X(() => C());
      }
    };
    return tt({
      deselect: j,
      ...
      const s = ht("FontAwesomeIcon");
      return I(), y("div", St, [
        c("div", Gt, [
          c("h3", Ct, h(f(x)("groups.title", "Part Groups")), 1),
          c("p", At, h(f(x)("groups.info", "Define groups of parts that should be cut from the same stock piece.")), 1)
        ]),
        f(i).inputUserGroups.value.length ? (I(), y("div", Xt, [
          c("button", {
            type: "button",
        ...
        c("div", null, [
          f(i).inputUserGroups.value.length ? (I(), y("div", {
            ...
            c("div", Dt, [
              ...
              c("div", Yt, h(f(x)("groups.parts", "Parts")), 1),
            ...
            (I(!0), y(ft, null, xt(f(i).inputUserGroups.value, (n, r) => (I(), y("div", {
              ...
              a.value?.autoId === n.autoId ? (I(), y("div", {
                ...
                class: "group vis",
                style: F({
                  "grid-column-end": "span " + q.value
                })
              }, [
                a.value?.shapeIds?.length ? (I(), y("div", Et)) : b("", !0),
                _.value === null && a.value?.shapeIds?.length ? (I(), y("div", Ft, [
                  D(s, { icon: ["fass", "info-circle"] }),
                ...
                _.value !== null ? (I(), y("button", {
                  ...
                  onClick: e[1] || (e[1] = V((u) => dt(_.value), ["stop"]))
                }, [
                  D(s, { icon: ["fass", "trash"] }),
...
`)), 1)
          ...
          c("button", {
            ...
            D(s, { icon: ["fass", "plus-large"] }),
            P(" " + h(f(x)("groups.add_group", "Add group")), 1)
          ]),
          O.value?.length ? (I(), y("div", Rt, [
            c("pre", null, h(O.value.slice(0, 5).map((n) => n.message).join(`
`)), 1)
          ])) : b("", !0)
        ])
      ]);
...
}), Kt = /* @__PURE__ */ kt(qt, [["__scopeId", "data-v-dae2a212"]]);
export {
  Kt as default
};
