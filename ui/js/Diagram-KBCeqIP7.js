import { d as oe, l as ae, J as le, U as re, k as B, I as ce, o as he, c as ue, g as de, s as N, K as fe, x as E } from "./vendor-vue-CeWGZ1lm.js";
import { e as Ct, z as pe, A as ge, B as me } from "./EcommerceCalculator-Cpt6HXtv.js";
import { h as ye, f as xe, l as R, g as et, e as st, s as b, r as C, i as J, j as be } from "./vendor-d3-DI9vO-24.js";
import { L as ve, a8 as Se, P as W, a9 as ke, aa as M, h as it, i as we, ab as U } from "./InputUserGroup-Cp-L9c2U.js";
import { P as $ } from "./PointCollection-D5IP6MyO.js";
...
function Pe(e, t) {
  ...
  return s.bottomLeft.x > 0 && s.bottomLeft.y > 0 && (i.bottomLeftDown = T(
    s.bottomLeft.x,
    s.bottomLeft.y,
    s.bottomLeft.x,
    0,
    ...
    "bottomLeft",
    "bottomLeftLeft"
  )), s.topLeft.x > 0 && s.topLeft.y < t.w && (i.topLeftLeft = T(
    s.topLeft.x,
    s.topLeft.y,
    0,
    s.topLeft.y,
    ...
    "topLeft",
    "topLeftTop"
  )), s.topRight.y < t.w && s.topRight.x < t.l && (i.topRightTop = T(
    s.topRight.x,
    s.topRight.y,
    s.topRight.x,
    t.w,
    ...
    "topRight",
    "topRightRight"
  )), s.bottomRight.x < t.l && s.bottomRight.y > 0 && (i.bottomRightRight = T(
    s.bottomRight.x,
    s.bottomRight.y,
    t.l,
    s.bottomRight.y,
...
function Le(e, t) {
  ...
  return e.sort(Rt), e.forEach((i) => {
    ke(i) ? (Z(s, i.getCoords(t)), i.shapes.forEach((n) => {
      if (n.x === null || n.x === void 0 || n.y === null || n.y === void 0) return;
