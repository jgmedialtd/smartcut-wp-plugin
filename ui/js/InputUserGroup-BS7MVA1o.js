import { k as P, o as x, j as w, q as D, h, i as V, u as F, l as z, n as u, B as ke, C as gs, Z as wt, D as ys, w as M, E as ee, F as di, G as bs, H as ws, I as Oi, J as Ss, K as xs, L as ks, M as vs, N as Is, O as Ps, Q as Di } from "./vendor-C76etQCp.js";
import "./vendor-i18next-DIDhOEvY.js";
import { t as q, s as Ts, e as Os } from "./i18n-uloQAa9l.js";
import { m as Ds } from "./validation-keys-CsEDW3Vc.js";
...
const Ci = P(["error", "warning"]), Ai = P(["saw", "stock", "part", "group", "machining", "extras"]);
x({
  message: h(),
  identifier: h(),
  field: D(D(h())),
...
const Cs = x({
  ...
  type: Ci.default("error"),
  category: D(Ai).nullable().default(null),
...
x({
  ...
  origin: h().optional(),
  dimension: P(["l", "w"]).optional(),
  direction: P(As).nullable().optional(),
...
typeof gs < "u" && wt && wt.prototype && (wt.prototype.behavior = function(t) {
  return ht(this, t);
});
function O(t, e = {}) {
...
const fi = ["topLeft", "topRight", "bottomLeft", "bottomRight"], Ms = [
  "left",
  "centre",
  "right",
  "top",
  ...
  direction: P(_s).nullable().optional(),
  type: h().optional(),
...
}, Ei = h().default("").describe('Unique identifier (e.g., "1.0" for shapes/stock, "g1" for groups, "ss-1_a2b3" for segments, "1.0-proximity" for proximity rectangles)'), Gs = h().max(200).default("").describe("User input name"), $s = h().default("").describe("Parent identifier for tracking copies and relationships"), $t = h().describe("Internal product or material code"), zs = w().default(!1).describe("Prevent automatic rotation optimization"), Vs = w().default(!1).describe("Whether this is an offcut piece"), Li = D(h()).default([]).describe("IDs of identical items").behavior({ clone: "copy" }), Ue = F([
  M(""),
  M("l"),
  M("w"),
  M(" ").transform(() => ""),
  ke().transform(() => "")
]).default("").describe("Grain direction of the material"), Mi = h().optional().describe("Color name"), _a = F([M(""), h().regex(/^#[0-9A-Fa-f]{3,8}$/, { error: (t) => `Invalid hex colour "${t.input}" — use #RGB or #RRGGBB, e.g. "#1a2b3c"` })]).optional().describe("Color hex code"), _i = ee((t) => t === null || t === " " || t === "n" || t === "none" || !["", "l", "w"].includes(t) ? "" : t, P(["", "l", "w"]).default("").describe("Orientation lock for rotation constraints")), Bs = x({
...
x({
  ...
  groups: V(h(), js).describe("Groups of strip shape batches keyed by ID")
});
const Ws = P(["none", "schema", "business", "full"]), K = x({
...
const Vt = K.extend({
  ...
  // Trim
  trim: Bs.describe("Reduce the dimensions by specified trim values"),
...
const Ri = ["sheet", "linear", "roll"], jt = ee(
...
).describe("Type of stock material"), Ni = x({
...
const Ys = x({
  ...
  stripShapeBatches: x({
    subsetUsed: w().optional().describe("Whether a subset was used for strip shape batches"),
    groups: V(h(), Ys).default({}).describe("Groups of strip shape batches keyed by ID")
...
const $i = ["horizontal", "vertical"], zi = ["position", "user", "strip", "firstShape"], Qs = P($i).optional(), pi = x({
  x: u(),
  y: u(),
  autoId: h().optional(),
  rot: zt
...
const sn = ["l", "w"], nn = qe.extend({
...
}, Vi = D(h()).default([]).describe("Parent IDs of stock(s) this shape is locked to"), on = P(["l", "w"]).nullable().default(null), Bi = F([
  M("l"),
  M("w"),
  ke()
]).default(null), an = x({
  ...
  grain: Ue.optional()
}).describe("Which stock(s) this shape is a match for "), ji = V(h(), z()).default({}), Wi = x({
...
Vi.describe("IDs of stocks this shape is locked to");
const ln = Bi.describe("Direction that should face up");
x({
  /**
...
const cn = x({
  ...
  upDirection: on.describe("Direction that should face up"),
  // ========== Extras ==========
...
Ct.describe(JSON.stringify({
  ...
  version: "1.0.0",
  extends: "Placeable",
  computedProperties: Object.keys(Hi)
}));
const Ra = x({
  areaEfficiency: u(),
  finishArea: u(),
  ...
  stack: dn.optional().describe("Stack information").behavior({ clone: "reset" }),
  ...
  type: P(Ri).optional().describe("Type of stock material"),
  ...
  color: Mi.describe('Material color ({ hex: "#FF5733", name: "Red" } or legacy string)'),
...
const mn = _.create(p.Cut, "Cut"), U = _.create(p.Shape, "Shape", (t) => !("shapes" in t)), qi = _.create(p.NestingShape, "NestingShape", (t) => !("shapes" in t) && "outline" in t), ue = _.create(p.Stock, "Stock"), Ki = _.create(p.Group, "Group", (t) => "shapes" in t && Array.isArray(t.shapes) && t.type !== "user" && t.type !== "strip"), Ye = _.create(p.UserGroup, "Group", (t) => "shapes" in t && t.type === "user"), Yi = _.create(p.StripGroup, "Group", (t) => "shapes" in t && t.type === "strip"), Zi = _.create(p.FirstShapeGroup, "Group", (t) => "shapes" in t && t.type === "firstShape"), de = (t) => {
  if (!t || typeof t != "object")
    return !1;
  const e = t._type;
  return e !== void 0 ? e === p.Group || e === p.UserGroup || e === p.StripGroup || e === p.FirstShapeGroup : Ki(t) || Ye(t) || Yi(t) || Zi(t);
}, gn = _.create(p.InputUserGroup, "InputUserGroup"), Xi = _.create(p.Segment, "Segment"), yn = _.create(p.Offcut, "Offcut"), bn = (t) => !t || typeof t != "object" ? !1 : yn(t) ? !0 : t.offcut === !0, wn = (t) => {
  if (!t || typeof t != "object")
    return !1;
  const e = t._type;
  if (e && fn.has(e))
...
function kn(t) {
  ...
  return mn(t) ? p.Cut : W(t) ? p.InputShape : Ut(t) ? p.InputStock : gn(t) ? p.InputUserGroup : Ye(t) ? p.UserGroup : Yi(t) ? p.StripGroup : Zi(t) ? p.FirstShapeGroup : Ki(t) ? p.Group : qi(t) ? p.NestingShape : U(t) ? p.Shape : ue(t) ? p.Stock : wn(t) ? p.Container : Xi(t) ? p.Segment : bn(t) ? p.Offcut : Ji(t) ? p.Rectangle : Sn(t) ? p.Placeable : null;
}
const he = (t) => {
  if (!t || typeof t != "object")
    return !1;
...
function On(t, e) {
  const i = Ds(t), s = t.startsWith("errors.validation.") ? t : i, n = Tn(e);
  return {
    message: q(s, n),
    translationKey: s,
    params: n
...
class g {
  ...
  item = null;
  constructor(e = {}) {
    const i = Array.isArray(e.issues) ? e.issues : null, s = Cs.parse(e), n = g.determineIdentifier(s.item, s.index || []);
    let o = s.id || "";
    !o && s.item && "autoId" in s.item && s.item.autoId && (o = s.item.autoId);
    const r = s.shouldTranslate !== !1 ? Dn(s.message, s.params) : s.message;
    if (this.message = r, this.identifier = n, this.field = s.field.map((a) => [...a]), this.index = s.index ? [...s.index] : [], this.id = o, this.type = s.type, this.category = s.category || [], this.item = s.item, this.addToItemIssues(s.item), i && i.push(this), s.throwError) {
      const a = `Issue created for ${kn(s.item)}: ${this.identifier || "N/A"} - ${this.field.map((l) => l.join(".")).join(", ")}`;
      throw new Error(a);
    }
  }
  /**
...
function Na({ v: t, nf: e = "decimal", dp: i = 2, fr: s = 0, o: n = null }) {
  if (t == null || t === "")
...
function Ga(t, e, i = !1) {
  ...
  const n = String(t);
  try {
    const o = ts(n, !0), r = parseFloat(o ?? ""), a = o !== null && o !== "" && !isNaN(r) && isFinite(r);
    return {
      value: a ? r : t,
      valid: a,
...
function En(t) {
  ...
  if (!e)
    return null;
  try {
    const { thousandsSeparator: i, decimalSeparator: s } = Fn(), n = e.replace(new RegExp(`\\${i}`, "g"), "").replace(new RegExp(`\\${s}`, "g"), "."), o = Number(n);
...
function I(t) {
  ...
  const e = t.o ?? {}, i = t.nf ?? e?.numberFormat ?? "decimal", s = t.dp ?? e?.decimalPlaces ?? St, n = t.pl ?? e?.parseLocale ?? !1, o = t.fr ?? e?.fractionRoundTo ?? yi;
  if (i === "decimal") {
  ...
  try {
    const r = ts(t.v, n);
    return r === null || r === "" ? i === "decimal" ? null : "" : i === "decimal" ? Cn(r, s) : An(r, o);
  } catch (r) {
...
function Nn(t) {
  return Rn(t, "issues") && Array.isArray(t.issues);
}
function Va(t, e, i = !1) {
  if (!Nn(t) || !t.issues?.length)
    return !1;
  const s = i ? "warning" : "error";
  return t.issues.filter((r) => r.type === s).some((r) => r.field?.length ? r.field.some((a) => a.every((l, c) => l === $n(e[c]))) : !1);
}
const Gn = {
...
const zn = ["banding", "finish", "planing", "info", "machining", "addon"], Ba = h().refine((t) => t.startsWith("side.") || t.startsWith("face."), { message: 'Location must start with "side." or "face."' }).transform((t) => t), H = F([
  w(),
  h(),
  u(),
  ...
  // ========== Identity ==========
  type: P(zn).optional().describe("Type of extra"),
...
const Bn = x({
  ...
  properties: V(h(), ss).optional(),
  disabledMessage: h().optional().describe("Message when location is disabled")
}), jn = x({
  global: V(h(), ss).optional(),
  locations: D(Bn).optional().describe("Location-specific constraints"),
...
const Wn = pt, Hn = {
...
}, Un = ["radius", "bevel"], qn = K.extend({
  // Corner type
  type: P(Un).nullable().optional().describe("Type of corner modification"),
...
}, Yn = ["l", "w"], Zn = ["top", "bottom", "left", "right", "merged"], Xn = x({
  // Coordinates
  x1: u().default(0),
  x2: u().default(0),
  y1: u().default(0),
  ...
  dimension: P(Yn).optional(),
  position: P(Zn).optional(),
  ...
  direction: P(sr).default("l").describe("Groove direction (l=horizontal, w=vertical)"),
...
}, or = ["l1", "l2", "w1", "w2"], ar = K.extend({
  // Position
  position: u().min(0).default(0).describe("Position along the side"),
  side: P(or).describe("Side where hinge is placed"),
...
}, De = ["l1", "l2", "w1", "w2"], cr = ["a", "b", "c", "d"], ge = [...De, ...cr], Z = ["a", "b"], ur = ["regular", "hinge", "shelf"], dr = K.extend({
  // Position
  ...
  // Configuration
  face: u().default(0).describe("Face index (0=front, 1=back)"),
  type: P(ur).default("regular").describe("Type of hole"),
...
const hr = (t, e) => k(t, e), pr = ["efficiency", "guillotine", "beam", "nesting", "none"], mr = ["l", "w", "flex", "none"], ns = ["efficiency", "time"], gr = ["l", "w"], yr = ["efficiency", "smallest"], br = ["dimensions", "identical", "none"], wr = ["sheet", "linear", "roll"], Kt = F([
  u().int().positive(),
  ke(),
  bs()
]).transform((t) => t ?? 100).describe("Maximum stack height for beam saw stacking"), Yt = P(pr).nullable().optional().transform((t) => t === null ? void 0 : t), Zt = P(mr).nullable().optional().transform((t) => t === null ? void 0 : t), Xt = P(yr).default("efficiency").describe("Method for selecting stocks"), Jt = P(br).default("identical").describe("How to stack identical parts"), rs = x({
  strategy: P(ns).default("efficiency"),
  ...
  primaryCompression: P(gr).default("w")
}).default({
...
const Sr = u().min(0).default(0), xr = u().min(0).default(0), os = u().min(0).default(0), kr = x({
  dimension: xr,
  minSpacing: os
});
function Ft(t) {
...
const vr = k(Yt, {
  ...
  strategy: k(P(ns).default("efficiency"), {
  ...
  step: 1,
  output: "number"
}), Fr = (t) => k(h().max(200).optional().transform((e) => e ? e.trim().toUpperCase() : ""), {
  label: "fields.name",
  placeholder: t?.placeholder || "",
  group: "general"
}), Er = () => k(h().max(200).optional().transform((t) => t ? t.trim().toUpperCase() : ""), {
  label: "fields.material",
  placeholder: "fields.material",
  group: "properties"
}), Lr = () => k(_e({ allowZero: !0, nullable: !0 }).optional().transform((t) => {
  if (t != null)
    return t;
}), {
  label: "fields.cost",
  ...
  step: 0.01,
  output: "number"
}), Mr = () => k(u().min(0).max(100).optional().default(0), {
  label: "fields.discount",
  placeholder: "fields.discount",
  group: "pricing",
  step: 1,
  output: "number"
}), _r = () => k(ws().max(500).transform((t) => t.replace(/,/g, " ")).optional(), {
  label: "fields.notes",
  placeholder: "fields.notes",
  group: "general"
}), Rr = (t) => k(w().default(!1), t), Nr = (t, e) => k(P(t), e), ae = {
  field: k,
  boolean: Rr,
  enum: Nr,
  custom: hr
  ...
  // ========== Stock Type ==========
  stockType: k(P([...wr]).default("sheet"), {
...
}).default({ l1: 0, l2: 0, w1: 0, w2: 0 }), Br = ee((t) => {
  if (t == null)
  ...
  stockLock: k(Vi, { label: "fields.stockLock" }),
  // ========== Stock Matching ==========
  stockMatch: an.nullable().optional(),
  // ========== Stock Reference ==========
  ...
  // ========== Custom Data ==========
  customData: k(ji, { label: "fields.customData", description: "Custom user-defined data" }),
  // ========== Labels (saw label printer / barcode machine) ==========
  ...
  labels: k(Wi, { label: "fields.labels", description: "Saw label-printer fields (barcode1/barcode2/room/pallet/drawing/order/colour/productInfo/productNumber)" }),
  // ========== Internal Code ==========
  code: $t.optional(),
  ...
  // ========== Positions ==========
  positions: D(Ur).default([]).describe("XY positions for each shape within the group"),
  // ========== Group Properties ==========
  ...
  positions: D(Yr).min(2).describe("Part positions within the group. Each entry specifies a part index and its x,y coordinates."),
...
const Me = 1e-10, to = 10, io = Number.MAX_SAFE_INTEGER, so = 4294967295, j = (t) => typeof t == "number" && Number.isFinite(t), tt = (t) => Array.isArray(t) && t.length > 0;
...
function ro(t) {
  return j(t) ? Number.isInteger(t) ? t : Number(t.toFixed(to)) : !1;
}
function oo(t) {
  if (!j(t) || t < 0 || t > io)
    throw new Error("Invalid length parameter");
  return Math.floor(crypto.getRandomValues(new Uint32Array(1))[0] / (so + 1) * t);
}
function ao(t, e) {
  if (!tt(t))
...
let Si = 0, xi = Date.now();
const lo = 1e4;
function co() {
  return Si % lo === 0 && (xi = Date.now()), `${xi}-${(Si++).toString(36)}`;
}
var re;
(function(t) {
  t.Full = "full", t.Compressed = "compressed";
...
class le {
  ...
  _serializationMode;
  constructor(e) {
    this.autoId = e?.autoId || co(), Object.defineProperty(this, "_serializationMode", {
      value: re.Full,
      writable: !0,
      enumerable: !1,
...
class A extends le {
  ...
  static extractNumberFormatFields(e) {
    ...
    for (const [n, o] of Object.entries(s)) {
      ...
      if (r instanceof Ss) {
        const a = r.options.some((c) => c instanceof xs), l = r.options.some((c) => c instanceof ks);
        a && l && i.push(n);
      }
    }
    return i;
  ...
  static unwrapSchema(e) {
    ...
    if (e instanceof vs || e instanceof Is)
...
function Fe(t, e, i = !1) {
  ...
  return i && (s = mo(t, s)), n === e || ([s.l, s.w] = [s.w, s.l]), s;
}
function ls(t) {
  if (!("l" in t) || !("w" in t))
...
function go(t) {
  de(t) || (ls(t), [t.l, t.w] = [t.w, t.l]);
}
function ki(t, e) {
  return T.lessThanOrEqualTo(t, e);
}
function Ee(t, e) {
  return ki(t.l, e.l) && ki(t.w, e.w);
}
...
function bo(t, e = null, i = null) {
  const s = "rot" in t ? t.rot : 0;
  return e === null && (e = s === 0 ? 1 : 0), !de(t) && ti(t) ? !0 : Mt(t, e, i) ? (s === e || go(t), !0) : !1;
}
function oe(t, e = null, i = null) {
  return e ? e = 1 : e = 0, i && e && !mt(t, i, e) ? !1 : bo(t, e, i);
}
function ti(t) {
  ls(t);
  const e = it(t);
...
class gt extends A {
   ...
   */
  calculateDimensions() {
    this.area = this.l * this.w, this.longSide = Math.max(this.l, this.w), this.shortSide = Math.min(this.l, this.w), this.parentId = Hs(this.id);
  }
  /**
   * Get entity type
   */
...
class ii extends gt {
  ...
  */
  get getStock() {
    return ue(this) ? this : Xi(this) ? this.stock : de(this) ? this.stock : null;
  }
}
class pe extends A {
...
class ni extends gt {
  ...
  getStripShapeBatchData(e) {
    ...
    return !i || xn(i) || !i.stripShapeBatches?.groups || !(e in i.stripShapeBatches.groups) ? !1 : i.stripShapeBatches.groups[e];
  }
  /**
   * Set best score
   */
...
function Je(t = [], e = null) {
  if (!t?.length)
    return;
  const i = wo(), s = i?.testCollector || So;
  if (!!(i && i.runTests && (xo() || s)))
    for (const o of t) {
      ...
      try {
        ...
        if (a = !1, l = c instanceof Error ? c.message : String(c), e ? vi(e, l) : vi(l), s && s.addResult({
          passed: !1,
          error: l,
...
class ri extends ni {
  ...
  */
  ...
  updatePositions() {
    ...
    let i = 0;
    const s = ko(this.direction), n = Ii(this.direction);
    let o = 0;
   ...
   */
  sortShapes() {
    const e = Ii(this.direction), i = ot(e);
...
const Io = ({ item: t, index: e, isWarning: i = !1 }) => {
  const s = [];
  return is(t, "orientationLock", ["l", "w"], e, i, s), s;
}, Po = ({ item: t, index: e, isWarning: i = !1 }) => {
  const s = [];
...
}, Oo = ({ item: t, index: e, isWarning: i = !1, category: s = [] }) => {
...
}, Lo = ({ item: t, index: e, max: i, isWarning: s = !1, saw: n, category: o = [] }) => {
  const r = [], a = L(t, "t");
...
}, Mo = ({ item: t, index: e, isWarning: i = !1, category: s = [] }) => {
...
const No = ({ item: t, index: e, shapes: i, requiredCount: s = 2, isWarning: n = !1, category: o = ["group"] }) => {
  const r = [];
...
}, Go = ({ item: t, index: e, shapes: i, isWarning: s = !1, category: n = ["group"] }) => {
  const o = [];
...
}, $o = ({ item: t, index: e, shapes: i, joinDirection: s, isWarning: n = !1, category: o = ["group"] }) => {
  const r = [];
  if (i.length < 2)
    return r;
...
}, zo = ({ item: t, index: e, shapes: i, positions: s, bladeWidth: n = 0, isWarning: o = !1, category: r = ["group"] }) => {
  const a = [];
  if (s.length < 2)
    return a;
  ...
  return a;
}, Vo = ({ item: t, index: e, shapeId: i, requiredQuantity: s, availableQuantity: n, shapeName: o, shapeIndex: r, isWarning: a = !1, category: l = ["group"] }) => {
  const c = [];
  return s > n && new g({
    item: t,
...
function qo(t, e, i) {
  return i?.stockType !== "linear" || !es(t) && !W(t) ? !0 : Mt(t, 0, e) && T.equalTo(I({ v: t.w }), I({ v: e.w })) || Mt(t, 1, e) && T.equalTo(I({ v: t.l }), I({ v: e.w }));
}
function Ko(t, e, i, s = 0) {
  ...
  for (const S of t) {
    const E = e.map((R, Pe) => {
      const ai = Wo(S) && mt(S, R), li = Ho(S, R, a), ci = Uo(S, R, l), ui = qo(S, R, i);
      return {
        stockItem: R,
        stockIndex: Pe,
        fit: ai,
...
const Zo = ({ item: t, inputStockList: e, saw: i, partTrim: s = 0, index: n }) => {
  const o = [], r = i.stockType, a = L(t, "q"), l = L(t, "l"), c = L(t, "w");
  return !a || !l || !c || ("applyPartTrim" in t && typeof t.applyPartTrim == "function" && t.applyPartTrim(s, r), Yo(t)) || Ko([t], e, i, n).newIssues.forEach((d) => {
    o.push(d);
  }), o;
}, Xo = ({ item: t, partTrim: e, index: i, isWarning: s = !1 }) => {
  const n = [];
  if (!e)
    return n;
  ...
  return n;
}, Jo = ({ item: t, index: e, isWarning: i = !1, category: s = [] }) => {
...
class lt extends ii {
  ...
  */
  ...
  getCroppedLength(e = [], i = 0) {
    if (!e?.length)
      return;
    const s = vo(e.filter((o) => o.added && o.stock.id === this.id), "x"), n = s.x + s.l;
    if (n > this.l)
...
class G extends A {
  ...
  static hasImageUpload(e) {
    ...
    return s ? vn(s) && typeof s.hasValues == "function" ? s.hasValues() : s.images && Array.isArray(s.images) ? s.images.length > 0 : !1 : !1;
  }
  /**
...
}, ta = /* @__PURE__ */ new Set(["holes", "corners", "hingeHoles"]);
function ia(t) {
  return ea[t] ?? String(t);
}
function sa(t) {
  return ta.has(t);
}
const Rt = ge, Tt = Z, na = {
...
}, Ua = (t) => (ie(t).faces || []).map((i) => {
  const s = ve(i);
  return s.scope === "face" ? s.key : void 0;
}).filter((i) => i !== void 0), qa = (t) => (ie(t).sides || []).map((i) => {
  const s = ve(i);
...
}, Ya = (t, e = 0, i = !1) => t.startsWith("face.") ? `faces.${t.replace(/^face\./, "")}` : aa(t, e, i), Za = (t, e) => {
...
}, la = (t) => Ts(t), ds = (t) => ie(t).scope.includes("faces"), fs = (t) => ie(t).scope.includes("sides"), Xa = (t) => {
  const e = ie(t);
  ...
  const s = i.extras[e];
  ds(e) && (s.faces || (s.faces = {})), fs(e) && (s.sides || (s.sides = {}));
}, da = (t, e, i) => {
  ua(t, e);
  ...
  r.options || (r.options = {});
  const a = r.options;
  if (ds(e) && (r.faces || (r.faces = {}), a.faces || (a.faces = {})), fs(e) && (r.sides || (r.sides = {}), a.sides || (a.sides = {})), s) {
    if (n.faces && r.faces) {
...
}, ma = (t) => t ? typeof t == "string" ? t.includes("|") ? t.split("|") : [t] : typeof t == "boolean" ? t ? ["true"] : [] : typeof t == "object" && !Array.isArray(t) && t !== null ? Object.values(t).filter((e) => e != null && e !== "" && e !== !1).map((e) => String(e)) : [String(t)] : [], ll = (t, e) => new Set(Object.keys(t || {})), ga = (t, e) => {
  const { extraType: i, pricing: s, codes: n, findExtrasPrice: o } = e, r = Object.keys(s || {}), a = r.length ? Math.max(...r.map((E) => E.split("|").length)) : 0, l = ma(t), c = l.length, f = { parts: l, selectedLevels: c, maxPricingLevels: a, missingLevels: 0, matchingKeyCount: 0, hasValidPrice: !1 };
  if (c === 0)
  ...
  const o = [], r = [], a = oa(e), l = Object.keys(i), c = Math.max(...l.map((d) => d.split("|").length));
  if (c <= 1)
    return { valid: !0, messages: [], incompleteLocations: [] };
  for (const d of a) {
    const { extraContainer: y } = da(t, e, d), { key: m } = ve(d), b = y[m];
    if (!b)
      continue;
    const v = ga(b, {
      extraType: e,
...
}, ul = (t, e, i) => !i || !i[e] ? { valid: !0, violations: [] } : ya(t, i[e]), ya = (t, e) => {
  if (!e)
  ...
  dimensionName: ia(t.dimension),
  constraint: t.constraint,
  limit: t.limit,
  value: t.value,
  subject: e,
  kind: sa(t.dimension) ? "count" : "length"
}), dl = (t) => hs(t), fl = (t, e, i) => hs(e, la(t));
function hl(t, e = "banding") {
  const i = t.extras?.[e];
  if (!i?.sides)
    return;
...
const pl = (t) => ["all", "faces", "sides"].includes(t) ? !1 : !t.includes(".");
let Nt = null;
const ml = (t) => {
  Nt = t;
...
const ps = {
  clearValidation: dt,
  addIssue: Ge,
  validateWithSchema: Pi,
  zodErrorsToIssues: Ve,
  /**
   * Run standard validation flow
   */
  runValidation(t, e = {}) {
    return dt.call(this), e.skipSchemaValidation || Pi(t, this).forEach((s) => Ge.call(this, s)), this.issues || [];
  }
};
class gl extends A {
  // Required: Define schema and computed properties for SchemaClass
   ...
   */
  validate(e) {
    if (dt.call(this), e?.skipSchemaValidation || ps.runValidation.call(this, bi, e), !e?.skipBusinessValidation) {
...
class ms extends A {
  ...
  constructor(e = {}, i = "decimal") {
    ...
    for (const r of o)
      s[r] === null || s[r] === void 0 ? delete s[r] : s[r] !== void 0 && (s[r] = Ia(s[r], i, n), s[r] === null && delete s[r]);
    s.name?.length ? s.name = Os(s.name)?.toUpperCase() : s.name = "", s.material ? s.material = s.material.trim().toUpperCase() : s.material = "", typeof s.notes == "string" ? s.notes = s.notes.replace(/,/g, " ") : s.notes = "", s.trim && (s.trim = Pa(s.trim, i, n, !0)), super(s), this.issues || (this.issues = []), this.warnings || (this.warnings = []);
  }
  /**
   * Get entity type
   */
   ...
   */
  validate(e) {
    return dt.call(this), e?.skipSchemaValidation || ps.runValidation.call(this, rt, e), this.issues;
  }
...
function Ta(t, e = 0) {
  ...
  for (const d of n)
    for (const y of n)
      d.autoId !== y.autoId && (Math.abs(d.x + d.l - y.x) < Ti && o.add(d.x + d.l), Math.abs(d.y + d.w - y.y) < Ti && r.add(d.y + d.w));
