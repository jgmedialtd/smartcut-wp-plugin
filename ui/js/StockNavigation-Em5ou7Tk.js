import { d as m, o, e as s, F as p, C as y, B as k, y as _, j as r, t as c, J as v, M as S } from "./vendor-vue-QD0FJS8o.js";
  ...
  setup(i, { emit: d }) {
    ...
    return (a, C) => (o(), s("div", b, [
      (o(!0), s(p, null, y(e.stockList, (t, n) => (o(), s("button", {
        ...
        onMousedown: (g) => u(t.autoId)
      }, [
        r("div", h, c(n + 1), 1),
        v(r("div", { class: "stack" }, c(t.stack.number), 513), [
