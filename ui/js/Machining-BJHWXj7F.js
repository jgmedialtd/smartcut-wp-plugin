...
import { c as y, M as he, v as I, u as Re, s as $e, a as Ne } from "./result.zod-P7rQl8ib.js";
import { b as Oe, h as je, _ as Ie } from "./EcommerceCalculator-5LWTyQpi.js";
...
const ht = { class: "inputs" }, dt = {
  ...
  setup(A, { emit: s }) {
    const n = Ee(() => import("./ObjectViewer-CykR8qB-.js")), e = A, m = s, v = "production", h = P(), r = P(), d = z(() => je(i.value)), x = z(() => {
