	...
	public function page_init()
	{
		...
		$this->add_settings_fields([
			...
			[
				'id' => 'finish_types',
				'label' => 'Finish types',
				'callback_args' => ['finish_types', 'Finish pricing is controlled by individual finish products. This field includes the slugs of your finish products. Separate with a comma.']
			],
			[
				'id' => 'min_finish_charge',
				'label' => 'Minimum finish charge',
				'callback_args' => ['min_finish_charge', 'Minimum charge for finishes. Set to zero for no minimum.']
			],
			[
				'id' => 'banding_types',
				'label' => 'Banding types',
