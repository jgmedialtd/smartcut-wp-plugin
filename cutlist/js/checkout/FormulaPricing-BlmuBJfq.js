...
import { I as ee } from "./Launch-fuvmW32C.js";
import { B as te, E as re, O as se, C as A, r as I, n as V, w as ne, o as ae, j as y, k as E, t as x, H, u as k, A as U, I as ie, F as D, l as B, v as b, K as oe } from "./main-BFZHuxOW.js";
...
const le = {
  ...
  setup(h, { emit: e }) {
    const t = oe(() => import("./ObjectViewer-sOARGFKO.js")), r = h, { t: n } = re({
      locale: "en_US",
      useScope: "global"
    ...
    ne(O, (l) => {
      ...
      const p = (u) => u != null && u.name ? u.name.toLowerCase() : "", P = new Map(
        a.value.inputShapes.map((u) => [p(u), u])
      ), f = /* @__PURE__ */ new Set();
      for (const u of Object.values(O.value)) {
        if (!u.name) continue;
        const q = p(u), v = P.get(q), T = {
          ...u,
...
`)[0]);
    ...
    return (l, p) => {
      ...
      return y(), E(D, null, [
        ...
        x("div", ue, [
          (y(!0), E(D, null, B((P = m.value) == null ? void 0 : P.inputs, (f, $, S) => {
            var N;
            return y(), H(ee, {
              id: "formula-field-" + S,
              key: S,
          ...
          c.value ? (y(), E("div", ce, [
            ...
            x("div", he, b(k(n)("Hardware total")) + " = " + b(h.formatPrice(C.value)), 1)
          ])) : U("", !0),
