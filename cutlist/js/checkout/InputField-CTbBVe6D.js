import { k as o, j as h, K as c, g as y, L as b, v as r, _ as m, o as n, l as u, t as d, q as s, n as g, F as f, w as p } from "./main-DmkM-F3z.js";
const k = {
  name: "CustomInput",
  props: {
    //element id
...
function N(a, t, e, F, C, l) {
  return n(), u(f, null, [
    ...
    e.type === "select" ? (n(), u("select", {
      ...
      (n(!0), u(f, null, p(e.options, (i) => (n(), u("option", {
        key: i.value,
        hidden: i.hidden,
        value: i.value
