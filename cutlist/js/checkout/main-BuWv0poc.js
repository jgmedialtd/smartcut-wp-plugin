...
const i18n = createI18n({
  ...
  modifiers: {
    ...
    title: (str) => str.split(" ").map((word) => word.charAt(0).toUpperCase() + word.slice(1)).join(" ")
  }
});
const Launch = /* @__PURE__ */ defineAsyncComponent(() => import("./Launch-CIMl3I9R.js").then((n) => n.L));
let app = null;
const mount = async () => {
...
export {
  ...
  unref as u,
  toDisplayString$1 as v,
  watch as w,
  withDirectives as x,
  vShow as y,
  createStaticVNode as z
};
//# sourceMappingURL=main-BuWv0poc.js.map
