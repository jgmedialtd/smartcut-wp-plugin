...
import { B as et, P as Ye, C as E, Q as tt, r as Y, f as ze, w as M, o as st, n as se, G as at, j as c, k as g, I as ae, u as Te, A as x, t as b, v as P, p as O, H as j, q as Ae, F as q, l as N, x as it, y as nt, K as lt } from "./main-Dy3ES8Z9.js";
import { e as z, f as S, h as Ee, v as V, i as rt, j as ht, k as Be, r as ot, u as dt, l as ut, I as ie, s as ct, n as pt } from "./Launch-DeD3i9WV.js";
class gt {
  constructor({
    HTMLElement: a,
    vueComponent: n,
...
const vt = { id: "machining" }, mt = {
  ...
  setup(T, { emit: a }) {
    ...
    const n = lt(() => import("./ObjectViewer-c81JUxbY.js")), t = T, v = a, o = E(() => rt(s.value)), L = E(() => ht.call({ options: t.options }, ["units"])), f = E(() => {
      var i;
    ...
    const J = Y(null), ue = Y(null), Xe = Y(!1), ce = Y(!1), pe = Y(!1), Z = Y(!1), ge = Y(!1), F = Y(0), l = Y(null), ee = Y(0), D = Y([]), te = ze({
      holes: {
        ...
        diameter: {
          ...
          options: (be = t.options.holes.diameters) != null && be.length ? _(t.options.holes.diameters) : void 0
        },
        depth: {
          ...
          options: (ye = t.options.holes.depths) != null && ye.length ? _(t.options.holes.depths) : void 0
        },
        face: {
      ...
      hingeHoles: {
        ...
        depth: {
          ...
          options: (Ce = t.options.holes.depths) != null && Ce.length ? _(t.options.holes.depths) : void 0
        },
        //[] separate option for hinges
        diameter: {
          enabled: !0,
          ...
          options: (De = t.options.holes.diameters) != null && De.length ? _(t.options.holes.diameters) : void 0
        },
        numHoles: {
          enabled: !0,
          type: "integer",
      ...
      corners: {
        type: {
          ...
          type: "select",
          output: "string",
          options: _(t.options.corners.types)
        },
        size: {
          enabled: !0,
          label: "Size",
