import { k as getInputType, j as getInputMode, K as getOutputType, g as getRef, L as parseBoolean, v as valueSet, _ as _export_sfc, o as openBlock, l as createElementBlock, t as toDisplayString, q as createCommentVNode, n as createBaseVNode, F as Fragment, w as renderList } from "./main-DUuuC60f.js";
const _sfc_main = {
  name: "CustomInput",
  props: {
    //element id
  ...
  methods: {
    ...
    handleInput(event) {
      ...
      if (value === "" && this.allowBlank) return "";
      switch (this.getType()) {
        case "integer":
      ...
      if (this.getType() === "integer" || this.getType() === "float") {
        if (isNaN(value)) return this.updateValue(0);
      }
      if (typeof this.min === "number") {
        if (value < this.min) value = this.min;
      }
      if (typeof this.max === "number" && (this.type === "integer" || this.type === "float")) {
