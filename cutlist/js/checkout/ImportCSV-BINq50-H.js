import { _ as _export_sfc, a as commonjsGlobal, d as getDefaultExportFromCjs, o as localeParseFloat } from "./Launch-CIMl3I9R.js";
import { m as markRaw, j as openBlock, k as createElementBlock, t as createBaseVNode, v as toDisplayString, p as normalizeClass, R as withModifiers, B as defineComponent, E as useI18n, r as ref, C as computed, o as onMounted, I as createVNode, u as unref } from "./main-BuWv0poc.js";
const _sfc_main$1 = {
  name: "Drop",
  props: {
    requiredType: {
...
const Drop = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    const convertPartDataToInputData = () => {
      return items.value.map((item, itemIndex) => ({
        l: props.units === "decimal" ? localeParseFloat(item.l) : item.l,
        w: props.units === "decimal" ? localeParseFloat(item.w) : item.w,
        t: props.units === "decimal" ? localeParseFloat(item.t) : item.t,
        q: item.q,
    ...
    const parse = (files) => {
      ...
      Papa.parse(file, {
        ...
        dynamicTyping: false,
        worker: true,
        complete: (results) => process(results),
        error: () => emit("error")
      });
    };
    ...
    const predictHeadingType = (header) => {
      const strings = {
        l: ["length", "l", "len", "lng", "long", "lgth", "lg", t("l"), t("length")],
        w: ["width", "w", "wd", "wide", "height", "h", "ht", "high", t("w"), t("width")],
        t: ["thickness", "t", "th", "depth", "dp", "dpth", "thk", "thick", t("t"), t("thickness")],
        name: ["name", "nom", "n", "nm", "nme", "label", "lbl", "description", "desc", t("name")],
        q: ["quantity", "qty", "q", "quant", "qnty", "qnt", t("quantity"), t("q"), "count"],
        material: ["material", "mat", "m", "matl", "mtl", "mtrl", "mtr", t("quantity")],
        orientationLock: ["rotation", "rot", "ro", "r", "o", "orientation", "orient", "or", "direction", "dir", t("orientation")],
        banding: ["b", "banding", "band", "ba", "bnd", "edging", "edge", "edn", t("banding")],
        finish: ["finish", "paint"]
      };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(Drop, {
          label: unref(t)("Drop CSV file here"),
...
//# sourceMappingURL=ImportCSV-BINq50-H.js.map
