import { C as CheckoutCalculator, _ as _export_sfc, r as resolveComponent, o as openBlock, c as createBlock } from "./main-VTn5Qv8T.js";
const _sfc_main = {
  name: "Vanilla",
  components: {
    CheckoutCalculator
  ...
  methods: {
    ...
    result(result) {
      const event = new CustomEvent("smartcut-result", { detail: result });
...
//# sourceMappingURL=Vanilla-CHCp9dfr.js.map
