import { _ as Oe, a as xe, d as Re, o as ye } from "./Launch-DeD3i9WV.js";
import { m as De, j as we, k as Ce, t as Le, v as Te, p as Ae, R as Ie, B as Se, E as Fe, r as Z, C as ke, o as qe, I as Me, u as ze } from "./main-Dy3ES8Z9.js";
const Pe = {
  name: "Drop",
  props: {
    requiredType: {
...
function je(q, P, _, g, x, B) {
  return we(), Ce("div", {
    ...
    onDrop: P[0] || (P[0] = Ie((...j) => B.onDrop && B.onDrop(...j), ["prevent"]))
  }, [
...
`, p = '"', i = p + p, a = !1, n = null, h = !1;
      ...
      function m(o, k, L) {
        ...
        var M = Array.isArray(o) && 0 < o.length, S = !Array.isArray(k[0]);
        if (M && u) {
          for (var F = 0; F < o.length; F++) 0 < F && (E += l), E += v(o[F], F);
          0 < k.length && (E += f);
        }
        for (var d = 0; d < k.length; d++) {
          var y = M ? o.length : k[d].length, R = !1, I = M ? Object.keys(k[d]).length === 0 : k[d].length === 0;
      ...
      function v(o, k) {
        ...
        return (L = L || r === !0 || typeof r == "function" && r(o, k) || Array.isArray(r) && r[k] || function(M, S) {
          for (var F = 0; F < S.length; F++) if (-1 < M.indexOf(S[F])) return !0;
          return !1;
    ...
    function fe(t) {
      ...
      function E() {
        return o && u && (F("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + c.DefaultDelimiter + "'"), u = !1), t.skipEmptyLines && (o.data = o.data.filter(function(d) {
          ...
          if (!o) return;
          function d(R, I) {
            b(t.transformHeader) && (R = t.transformHeader(R, I)), v.push(R);
          }
          ...
          function d(R, I) {
            ...
            for (C = 0; C < R.length; C++) {
              var T = C, O = R[C];
              t.header && (T = C >= v.length ? "__parsed_extra" : v[C]), t.transform && (O = t.transform(O, T)), O = S(T, O), T === "__parsed_extra" ? (z[T] = z[T] || [], z[T].push(O)) : z[T] = O;
            }
            return t.header && (C > v.length ? F("FieldMismatch", "TooManyFields", "Too many fields: expected " + v.length + " fields but parsed " + C, h + I) : C < v.length && F("FieldMismatch", "TooFewFields", "Too few fields: expected " + v.length + " fields but parsed " + C, h + I)), z;
          }
          var y = 1;
      ...
      function S(d, y) {
        return R = d, t.dynamicTypingFunction && t.dynamicTyping[R] === void 0 && (t.dynamicTyping[R] = t.dynamicTypingFunction(R)), (t.dynamicTyping[R] || t.dynamicTyping) === !0 ? y === "true" || y === "TRUE" || y !== "false" && y !== "FALSE" && (function(I) {
          if (p.test(I)) {
            var C = parseFloat(I);
            if (f < C && C < l) return !0;
          }
      ...
      function F(d, y, R, I) {
        ...
        I !== void 0 && (C.row = I), o.errors.push(C);
      }
...
` : "\r";
        }(d, I)), u = !1, t.delimiter) b(t.delimiter) && (t.delimiter = t.delimiter(d), o.meta.delimiter = t.delimiter);
        else {
...
`);
      ...
      this.parse = function(s, m, v) {
        ...
        var o = s.length, k = r.length, L = u.length, E = l.length, M = b(f), S = [], F = [], d = [], y = n = 0;
        if (!s) return W();
        if (t.header && !m) {
          var R = s.split(u)[0].split(r), I = [], C = {}, z = !1;
          for (var T in R) {
            var O = R[T];
            b(t.transformHeader) && (O = t.transformHeader(O, T));
            var V = O, H = C[O] || 0;
            for (0 < H && (z = !0, V = O + "_" + H), C[O] = H + 1; I.includes(V); ) V = V + "_" + H;
            I.push(V);
          }
          if (z) {
            var J = s.split(u);
            J[0] = I.join(r), s = J.join(u);
          }
        }
        if (i || i !== !1 && s.indexOf(e) === -1) {
          for (var G = s.split(u), K = 0; K < G.length; K++) {
            ...
            if (!l || d.substring(0, E) !== l) {
              if (M) {
                if (S = [], le(d.split(r)), me(), h) return W();
              } else le(d.split(r));
              if (p && p <= K) return S = S.slice(0, p), W(!0);
            }
          }
          return W();
        }
        for (var D = s.indexOf(r, n), A = s.indexOf(u, n), ue = new RegExp(oe(a) + oe(e), "g"), w = s.indexOf(e, n); ; ) if (s[n] !== e) if (l && d.length === 0 && s.substring(n, n + E) === l) {
          ...
          if (p && S.length >= p) return W(!0);
        }
        else for (w = n, n++; ; ) {
          if ((w = s.indexOf(e, w + 1)) === -1) return v || F.push({ type: "Quotes", code: "MissingQuotes", message: "Quoted field unterminated", row: S.length, index: n }), ne();
          ...
          if (e !== a || s[w + 1] !== a) {
            if (e === a || w === 0 || s[w - 1] !== a) {
              ...
              F.push({ type: "Quotes", code: "InvalidQuotes", message: "Trailing quote on quoted field is malformed", row: S.length, index: n }), w++;
            }
          } else w++;
        }
        return ne();
        ...
        function W($) {
          return { data: S, errors: F, meta: { delimiter: r, linebreak: u, aborted: h, truncated: !!$, cursor: y + (m || 0) } };
        }
        function me() {
          f(W()), S = [], F = [];
        }
...
var Be = Ee.exports;
const Ne = /* @__PURE__ */ Re(Be), He = { id: "import-file" }, $e = /* @__PURE__ */ Se({
  __name: "ImportCSV",
  props: {
    units: {
      type: String,
